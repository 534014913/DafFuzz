  ...
  ensures (true)
{
  arg_218 := -890724430;
  {
    ...
    print "(meth-for lift_213_0)\n";
    {
      ...
      var lift_219 := 'S';
      print "(section 25 ", arg_217, "\n", ")\n";
      lift_219 := lift_220;
      lift_222 := lift_220;
      lift_223 := lift_223;
      print "(section 26 ", -1994224075, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_93 := 72351710;
  {
    print "(meth-for lift_88_0)\n";
    {
      ...
      var lift_95 := lift_96;
      var lift_94 := lift_95;
      print "(section 19 ", arg_92, "\n", ")\n";
      lift_94 := lift_95;
      print "(section 20 ", arg_92, "\n", ")\n";
      print "(section 21 ", arg_93, "\n", ")\n";
      lift_97 := lift_110;
    }
  ...
  ensures (true)
{
  ...
  arg_93 := 72351710;
  {
    print "(meth-for lift_88_1)\n";
    {
      ...
      var lift_95 := lift_96;
      var lift_94 := lift_95;
      print "(section 16 ", arg_92, "\n", ")\n";
      lift_94 := lift_95;
      print "(section 17 ", arg_92, "\n", ")\n";
      print "(section 18 ", arg_93, "\n", ")\n";
      lift_97 := lift_110;
    }
  ...
  var methoddefvar_90, methoddefvar_91 := lift_88_0();
  {
    ...
    }
    {
      ...
      if (true) {
        ...
        lift_152 := lift_153;
        lift_154 := lift_152;
        print "(section 3 ", methoddefvar_90, "\n", ")\n";
        print "(section 4 ", lift_23, "\n", ")\n";
      }
      {
        print "(section 5 ", lift_46, "\n", ")\n";
        print "(section 6 ", lift_46, "\n", ")\n";
        lift_155 := lift_33;
      }
    }
    {
      {
        print "(section 7 ", lift_74, "\n", ")\n";
      }
    }
    var methoddefvar_158 := lift_156_0(lift_53, lift_41, lift_81);
    {
      ...
      print "(section 9 ", methoddefvar_90, "\n", ")\n";
    }
