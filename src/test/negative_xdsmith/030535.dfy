  ...
  ensures (true)
{
  ...
  arg_739 := 338949442;
  {
    print "(params-for lift_732_0 arg_736 ", arg_736, ")\n";
    print "(params-for lift_732_0 arg_737 ", arg_737, ")\n";
    print "(meth-for lift_732_0)\n";
    {
      var lift_740 := 650765709;
      print "(section 98 ", arg_736, "\n", ")\n";
      print "(section 99 ", arg_736, "\n", ")\n";
      lift_740 := arg_737;
      print "(section 100 ", arg_736, "\n", ")\n";
    }
    print "(rets-for lift_732_0 arg_738 ", arg_738, ")\n";
    print "(rets-for lift_732_0 arg_739 ", arg_739, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_718 := -667266988;
  {
    print "(params-for lift_714_0 arg_717 ", arg_717, ")\n";
    print "(meth-for lift_714_0)\n";
    {
      var lift_730 := ();
      ...
      print "(section 96 ", arg_718, "\n", ")\n";
      print "(section 97 ", arg_717, "\n", ")\n";
      lift_719 := lift_720;
      lift_721 := multiset{lift_722, lift_722, lift_726, lift_729};
    }
    print "(rets-for lift_714_0 arg_718 ", arg_718, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_692 := -564418979;
  {
    print "(params-for lift_687_0 arg_690 ", arg_690, ")\n";
    print "(params-for lift_687_0 arg_691 ", arg_691, ")\n";
    print "(meth-for lift_687_0)\n";
    {
      var lift_699 := ();
    ...
    print "(rets-for lift_687_0 arg_692 ", arg_692, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_680 := 861832419;
  {
    print "(params-for lift_672_0 arg_676 ", arg_676, ")\n";
    print "(params-for lift_672_0 arg_677 ", arg_677, ")\n";
    print "(params-for lift_672_0 arg_678 ", arg_678, ")\n";
    print "(meth-for lift_672_0)\n";
    {
      print "(section 95 ", arg_679, "\n", ")\n";
    }
    print "(rets-for lift_672_0 arg_679 ", arg_679, ")\n";
    print "(rets-for lift_672_0 arg_680 ", arg_680, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_566 := -942227716;
  {
    print "(params-for lift_560_0 arg_563 ", arg_563, ")\n";
    print "(params-for lift_560_0 arg_564 ", arg_564, ")\n";
    print "(params-for lift_560_0 arg_565 ", arg_565, ")\n";
    print "(meth-for lift_560_0)\n";
    {
      ...
      print "(section 93 ", arg_563, "\n", ")\n";
      print "(section 94 ", arg_563, "\n", ")\n";
      lift_567 := lift_567;
      lift_570 := lift_570;
      lift_571 := lift_572;
    }
    print "(rets-for lift_560_0 arg_566 ", arg_566, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_566 := -942227716;
  {
    print "(params-for lift_560_1 arg_563 ", arg_563, ")\n";
    print "(params-for lift_560_1 arg_564 ", arg_564, ")\n";
    print "(params-for lift_560_1 arg_565 ", arg_565, ")\n";
    print "(meth-for lift_560_1)\n";
    {
      var lift_573 := 'S';
      var lift_572 := (lift_573, true);
      var lift_571 := lift_572;
      ...
      var lift_568 := (arg_564, arg_564);
      var lift_567 := (arg_565, lift_568, lift_569);
      print "(section 91 ", arg_563, "\n", ")\n";
      print "(section 92 ", arg_563, "\n", ")\n";
      lift_567 := lift_567;
      lift_570 := lift_570;
      lift_571 := lift_572;
    }
    print "(rets-for lift_560_1 arg_566 ", arg_566, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_534 := 1330505922;
  {
    print "(params-for lift_527_0 arg_531 ", arg_531, ")\n";
    print "(params-for lift_527_0 arg_532 ", arg_532, ")\n";
    print "(meth-for lift_527_0)\n";
    {
      ...
      lift_535 := lift_535;
      lift_538 := lift_538;
      print "(section 89 ", arg_533, "\n", ")\n";
      print "(section 90 ", 917707557, "\n", ")\n";
      lift_543 := false;
    }
    print "(rets-for lift_527_0 arg_533 ", arg_533, ")\n";
    print "(rets-for lift_527_0 arg_534 ", arg_534, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_477 := 1765532087;
  {
    print "(params-for lift_472_0 arg_475 ", arg_475, ")\n";
    print "(params-for lift_472_0 arg_476 ", arg_476, ")\n";
  ...
  ensures (true)
{
  arg_477 := 1765532087;
  {
    print "(params-for lift_472_1 arg_475 ", arg_475, ")\n";
    print "(params-for lift_472_1 arg_476 ", arg_476, ")\n";
    print "(meth-for lift_472_1)\n";
    {
      ...
      var lift_479 := 'O';
      var lift_478 := 'a';
      print "(section 85 ", arg_475, "\n", ")\n";
      lift_478 := lift_479;
      lift_480 := lift_481;
      lift_487 := lift_479;
      print "(section 86 ", arg_476, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_351 := -632020812;
  {
    print "(meth-for lift_346_3)\n";
    {
      print "(section 81 ", arg_351, "\n", ")\n";
    }
    print "(rets-for lift_346_3 arg_350 ", arg_350, ")\n";
    print "(rets-for lift_346_3 arg_351 ", arg_351, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_351 := -632020812;
  {
    print "(meth-for lift_346_4)\n";
    {
      print "(section 80 ", arg_351, "\n", ")\n";
    }
    print "(rets-for lift_346_4 arg_350 ", arg_350, ")\n";
    print "(rets-for lift_346_4 arg_351 ", arg_351, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_247 := -1594256479;
  {
    ...
    print "(meth-for lift_243_0)\n";
    {
      ...
      print "(section 77 ", arg_247, "\n", ")\n";
      lift_248 := lift_248;
      print "(section 78 ", 133419952, "\n", ")\n";
  ...
  ensures (true)
{
  arg_208 := -319743548;
  {
    print "(params-for lift_202_1 arg_205 ", arg_205, ")\n";
    ...
    print "(rets-for lift_202_1 arg_208 ", arg_208, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_208 := -319743548;
  {
    print "(params-for lift_202_2 arg_205 ", arg_205, ")\n";
    print "(params-for lift_202_2 arg_206 ", arg_206, ")\n";
    print "(params-for lift_202_2 arg_207 ", arg_207, ")\n";
    print "(meth-for lift_202_2)\n";
    {
      var lift_228 := [-1301219253, -1927665534];
      var lift_227 := [arg_207, arg_207, -2003538903, arg_207, arg_205];
      var lift_226 := ();
    ...
    print "(rets-for lift_202_2 arg_208 ", arg_208, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_208 := -319743548;
  {
    print "(params-for lift_202_3 arg_205 ", arg_205, ")\n";
    print "(params-for lift_202_3 arg_206 ", arg_206, ")\n";
    print "(params-for lift_202_3 arg_207 ", arg_207, ")\n";
    print "(meth-for lift_202_3)\n";
    {
      var lift_228 := [-1301219253, -1927665534];
      var lift_227 := [arg_207, arg_207, -2003538903, arg_207, arg_205];
      var lift_226 := ();
    ...
    print "(rets-for lift_202_3 arg_208 ", arg_208, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_106 := 458637931;
  {
    ...
    print "(meth-for lift_100_0)\n";
    {
      ...
      print "(section 75 ", lift_107, "\n", ")\n";
      print "(section 76 ", arg_104, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_51 := -266493590;
  {
    print "(meth-for lift_46_0)\n";
    {
      ...
      print "(section 73 ", lift_52, "\n", ")\n";
      lift_53 := lift_54;
      lift_58 := lift_58;
      print "(section 74 ", arg_50, "\n", ")\n";
    }
    print "(rets-for lift_46_0 arg_50 ", arg_50, ")\n";
  ...
  ensures (true)
{
  ...
  arg_51 := -266493590;
  {
    print "(meth-for lift_46_1)\n";
    {
      ...
      var lift_53 := lift_54;
      var lift_52 := 1683344853;
      print "(section 71 ", lift_52, "\n", ")\n";
      lift_53 := lift_54;
      lift_58 := lift_58;
      print "(section 72 ", arg_50, "\n", ")\n";
    }
    print "(rets-for lift_46_1 arg_50 ", arg_50, ")\n";
    print "(rets-for lift_46_1 arg_51 ", arg_51, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_51 := -266493590;
  {
    print "(meth-for lift_46_2)\n";
    {
      ...
      lift_53 := lift_54;
      lift_58 := lift_58;
      print "(section 70 ", arg_50, "\n", ")\n";
    }
    print "(rets-for lift_46_2 arg_50 ", arg_50, ")\n";
    print "(rets-for lift_46_2 arg_51 ", arg_51, ")\n";
  }
}
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    print 
      "(section 1 ",
      (safeSeqRef(
        [lift_29, 'I', lift_19, lift_21, lift_18],
        -2040562906,
        lift_18
      ) as int),
      "\n",
    ...
    var methoddefvar_102, methoddefvar_103 := lift_100_0(lift_108.0);
    {
      ...
      lift_109 := lift_88;
      print "(section 7 ", methoddefvar_102, "\n", ")\n";
      lift_110 := lift_123;
    ...
    );
    {
      ...
      {
        lift_258 := lift_258;
        print "(section 16 ", lift_80, "\n", ")\n";
      }
      var methoddefvar_264, methoddefvar_265 := lift_46_2();
      {
        print "(section 17 ", lift_183, "\n", ")\n";
  ...
  print 
    "(section 19 ",
    safeSeqRef(lift_270, 1128811558, lift_279).2.2,
    "\n",
    ")\n";
  {
    ...
    );
    {
      ...
      if (false) {
        print "(section 20 ", -1924348186, "\n", ")\n";
        lift_295 := lift_30;
      } else {
        lift_296 := lift_296;
        print "(section 21 ", lift_156, "\n", ")\n";
        lift_303 := lift_304;
      }
      var methoddefvar_307, methoddefvar_308 := lift_305_0(lift_25, lift_97);
      {
        var lift_340 := true;
        lift_340 := lift_119;
        print "(section 22 ", lift_99, "\n", ")\n";
      }
      {
        print "(section 23 ", lift_95, "\n", ")\n";
        print "(section 24 ", 984596660, "\n", ")\n";
        lift_341 := lift_342;
        lift_345 := lift_184;
      }
    ...
    if ((lift_376(
      ...
      var lift_464 := {lift_20, lift_96, lift_165, lift_183, lift_184};
      {
        ...
        print "(section 34 ", lift_294, "\n", ")\n";
        {
          ...
          lift_462 := lift_21;
          lift_463 := lift_463;
          print "(section 35 ", lift_178, "\n", ")\n";
        }
        lift_469 := lift_468;
        var methoddefvar_470, methoddefvar_471 := lift_346_2();
        {
          print "(section 36 ", lift_64, "\n", ")\n";
        }
      ...
      }
      {
        ...
        var methoddefvar_491 := lift_472_1(lift_374, lift_173);
        {
          ...
          print "(section 37 ", lift_281, "\n", ")\n";
          lift_492 := lift_493;
          lift_495 := lift_495;
          print "(section 38 ", lift_467, "\n", ")\n";
        }
        if (lift_14) {
          print "(section 39 ", -145684461, "\n", ")\n";
          print "(section 40 ", lift_172, "\n", ")\n";
          print "(section 41 ", lift_467, "\n", ")\n";
          lift_509 := lift_399;
        } else {
          print "(section 42 ", lift_278, "\n", ")\n";
          lift_510 := lift_510;
          lift_516 := lift_516;
        }
        {
          lift_524 := lift_263;
          print "(section 43 ", lift_178, "\n", ")\n";
        }
      }
    }
    if ((lift_164.2 <= (lift_195[lift_458 := lengthNormalize(
      ...
      var methoddefvar_529, methoddefvar_530 := lift_527_0(lift_95, lift_282);
      {
        ...
        print "(section 45 ", methoddefvar_529, "\n", ")\n";
        print "(section 46 ", lift_505, "\n", ")\n";
        print "(section 47 ", methoddefvar_529, "\n", ")\n";
        lift_544 := 'w';
      }
      {
        if (lift_163) {
          print "(section 48 ", lift_173, "\n", ")\n";
        } else {
          print "(section 49 ", lift_506, "\n", ")\n";
          lift_545 := lift_428;
          lift_546 := lift_546;
          lift_555 := lift_555;
        }
      ...
      if ((lift_546 !! {
        ...
        {
          lift_575 := lift_580;
          print "(section 50 ", lift_574, "\n", ")\n";
          print "(section 51 ", lift_287, "\n", ")\n";
          lift_581 := lift_427;
        }
        lift_582 := lift_618;
        lift_627 := lift_30;
        ...
        if (false) {
          print "(section 53 ", lift_594, "\n", ")\n";
          print "(section 54 ", lift_173, "\n", ")\n";
          print "(section 55 ", lift_173, "\n", ")\n";
          lift_628 := lift_628;
          print "(section 56 ", lift_502, "\n", ")\n";
        } else {
          lift_629 := lift_292;
          print "(section 57 ", lift_520, "\n", ")\n";
        }
      } else {
        lift_630 := lift_591;
      }
      var methoddefvar_631 := lift_560_1(lift_114, -1881758862, lift_2);
      {
        ...
        print "(section 58 ", lift_282, "\n", ")\n";
        lift_632 := lift_553;
        print "(section 59 ", lift_374, "\n", ")\n";
        print "(section 60 ", 1882188940, "\n", ")\n";
        lift_634 := lift_647;
      }
    } else {
      ...
      if (({(lift_637, true)} in lift_648)) {
        ...
        {
          var lift_670 := 'j';
          print "(section 61 ", lift_138, "\n", ")\n";
          print "(section 62 ", lift_99, "\n", ")\n";
          print "(section 63 ", lift_99, "\n", ")\n";
          lift_670 := lift_513;
          lift_671 := lift_425;
        }
