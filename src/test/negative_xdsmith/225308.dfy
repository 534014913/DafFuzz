  ...
  ensures (true)
{
  ...
  arg_195 := 626138849;
  {
    ...
    print "(rets-for lift_188_0 arg_194 ", arg_194, ")\n";
  ...
  ensures (true)
{
  arg_134 := 1560963002;
  {
    print "(meth-for lift_131_0)\n";
    {
      ...
      lift_135 := -1079867144;
      print "(section 32 ", arg_134, "\n", ")\n";
      print "(section 33 ", lift_135, "\n", ")\n";
      lift_136 := lift_136;
    }
  ...
  ensures (true)
{
  arg_89 := -974144484;
  {
    ...
    {
      print "(section 29 ", arg_87, "\n", ")\n";
      print "(section 30 ", arg_88, "\n", ")\n";
  ...
  ensures (true)
{
  ...
  arg_19 := 1570174420;
  {
    ...
    print "(meth-for lift_13_0)\n";
    {
      ...
      print "(section 27 ", arg_19, "\n", ")\n";
      lift_20 := lift_20;
      print "(section 28 ", arg_17, "\n", ")\n";
      lift_22 := lift_23;
      lift_25 := lift_25;
    }
  ...
  var lift_1 := lift_2;
  {
    ...
    );
    {
      ...
      if (lift_210) {
        ...
        lift_258 := lift_258;
        print "(section 24 ", lift_62, "\n", ")\n";
      }
      lift_264 := lift_8;
      print "(section 25 ", methoddefvar_244, "\n", ")\n";
      lift_265 := ();
    }
  }
  print 
    "(section 26 ",
    (lift_266.2.0[safeSeqRef(
