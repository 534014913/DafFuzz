  ...
  ensures (true)
{
  arg_117 := 2017283918;
  {
    print "(params-for lift_112_0 arg_115 ", arg_115, ")\n";
  ...
  ensures (true)
{
  ...
  arg_53 := -1229474442;
  {
    ...
    {
      print "(section 12 ", arg_52, "\n", ")\n";
    }
    print "(rets-for lift_48_0 arg_52 ", arg_52, ")\n";
    print "(rets-for lift_48_0 arg_53 ", arg_53, ")\n";
  }
}
...
method Main () {
  ...
  );
  {
    ...
    if ((lift_76 !! lift_76 !! lift_82)) {
      ...
      print "(section 0 ", lift_85, "\n", ")\n";
      lift_87 := lift_88;
      var methoddefvar_91 := lift_89_0();
      {
        var lift_110 := lift_111;
        print "(section 1 ", lift_81, "\n", ")\n";
