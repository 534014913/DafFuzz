...
method lift_31_0 (arg_34 : int)
  returns (arg_35 : int)
  requires (((arg_34 == 151424415) && true))
  ensures (((arg_35 == 1639333937) && true))
{
  arg_35 := 1639333937;
  {
    var lift_42 := ();
    ...
    assert (((-771222257 - lift_36) < (-771222257 - lift_36)) || ((-2313666768 - lift_36) == (lift_36 + lift_36)));
    assert (((lift_37 + 1285189386) - (1285189385 + lift_37)) == ((-1285189380 - lift_37) + (1285189382 + 1285189384)));
    assert (((-771222257 - lift_36) < (-771222257 - lift_36)) || ((-2313666768 - lift_36) == (lift_36 + lift_36)));
    lift_38 := lift_38;
  }
}
...
method lift_1_0 (arg_5 : int)
  ...
  ensures (((arg_7 == 1925484043) && ((arg_6 == 323807179) && true)))
{
  arg_6 := 323807179;
  arg_7 := 1925484043;
  {
...
method Main () {
  ...
  );
  {
    ...
    {
      assert (((lift_30 == lift_30) && (lift_30 == lift_30)) && ((lift_30 == 0) && (lift_30 == lift_30)));
      lift_43 := lift_45;
    }
    assert ((1 - ((lift_47[()] as int) + (lift_47[(
      
    )] as int))) == ((1 + -1) - ((lift_47[()] as int) - 1)));
  }
