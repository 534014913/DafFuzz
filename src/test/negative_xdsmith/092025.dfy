  ...
  ensures (true)
{
  arg_921 := -1366825070;
  {
    print "(meth-for lift_918_0)\n";
    {
      var lift_925 := false;
      var lift_924 := 1756007999;
      var lift_923 := lift_924;
      var lift_922 := arg_921;
      print "(section 204 ", lift_922, "\n", ")\n";
      lift_923 := lift_923;
      lift_925 := lift_925;
    }
    print "(rets-for lift_918_0 arg_921 ", arg_921, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_902 := 1807623144;
  {
    print "(meth-for lift_897_0)\n";
    {
      ...
      lift_903 := lift_903;
      print "(section 202 ", lift_907, "\n", ")\n";
      print "(section 203 ", lift_908, "\n", ")\n";
      lift_910 := ();
    }
    print "(rets-for lift_897_0 arg_901 ", arg_901, ")\n";
    print "(rets-for lift_897_0 arg_902 ", arg_902, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_764 := 1361306061;
  {
    print "(meth-for lift_761_0)\n";
    {
      var lift_768 := false;
      var lift_767 := lift_768;
      var lift_766 := lift_767;
      var lift_765 := arg_764;
      print "(section 201 ", lift_765, "\n", ")\n";
      lift_766 := lift_767;
    }
    print "(rets-for lift_761_0 arg_764 ", arg_764, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_645 := 2112786655;
  {
    print "(params-for lift_641_0 arg_644 ", arg_644, ")\n";
    print "(meth-for lift_641_0)\n";
    {
      var lift_646 := 809508960;
      lift_646 := 2119996727;
    }
    print "(rets-for lift_641_0 arg_645 ", arg_645, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_625 := -1941800613;
  {
    print "(params-for lift_620_0 arg_623 ", arg_623, ")\n";
    print "(params-for lift_620_0 arg_624 ", arg_624, ")\n";
    print "(meth-for lift_620_0)\n";
    {
      var lift_627 := 'n';
      var lift_626 := false;
      lift_626 := lift_626;
      print "(section 200 ", arg_625, "\n", ")\n";
      lift_627 := 's';
    }
    print "(rets-for lift_620_0 arg_625 ", arg_625, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_614 := 1500978495;
  {
    print "(params-for lift_610_0 arg_613 ", arg_613, ")\n";
    print "(meth-for lift_610_0)\n";
    {
      ...
      lift_615 := lift_615;
      print "(section 197 ", arg_614, "\n", ")\n";
      print "(section 198 ", arg_614, "\n", ")\n";
      print "(section 199 ", arg_613, "\n", ")\n";
    }
    print "(rets-for lift_610_0 arg_614 ", arg_614, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_614 := 1500978495;
  {
    print "(params-for lift_610_1 arg_613 ", arg_613, ")\n";
    print "(meth-for lift_610_1)\n";
    {
      var lift_618 := (false, 'F', arg_614);
      var lift_617 := [arg_614, arg_613, arg_614, arg_613];
      var lift_616 := lift_617;
      var lift_615 := (lift_616, lift_618, 210530226);
      lift_615 := lift_615;
      print "(section 194 ", arg_614, "\n", ")\n";
      print "(section 195 ", arg_614, "\n", ")\n";
      print "(section 196 ", arg_613, "\n", ")\n";
    }
    print "(rets-for lift_610_1 arg_614 ", arg_614, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_601 := -1251127453;
  {
    print "(meth-for lift_598_0)\n";
    {
      ...
      print "(section 193 ", 252106555, "\n", ")\n";
      lift_607 := (lift_606, lift_609);
    }
    print "(rets-for lift_598_0 arg_601 ", arg_601, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_601 := -1251127453;
  {
    print "(meth-for lift_598_1)\n";
    {
      ...
      var lift_602 := lift_603;
      lift_602 := [lift_606, lift_605, lift_606, lift_605, lift_605];
      print "(section 192 ", 252106555, "\n", ")\n";
      lift_607 := (lift_606, lift_609);
    }
    print "(rets-for lift_598_1 arg_601 ", arg_601, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_577 := -633947996;
  {
    ...
    print "(params-for lift_570_0 arg_575 ", arg_575, ")\n";
    print "(meth-for lift_570_0)\n";
    {
      ...
      lift_578 := arg_575;
      print "(section 190 ", 1455852705, "\n", ")\n";
      lift_579 := lift_580;
      lift_581 := lift_580;
      print "(section 191 ", arg_577, "\n", ")\n";
    }
    print "(rets-for lift_570_0 arg_576 ", arg_576, ")\n";
    print "(rets-for lift_570_0 arg_577 ", arg_577, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_577 := -633947996;
  {
    print "(params-for lift_570_1 arg_574 ", arg_574, ")\n";
    print "(params-for lift_570_1 arg_575 ", arg_575, ")\n";
    print "(meth-for lift_570_1)\n";
    {
      var lift_581 := false;
      var lift_580 := false;
      var lift_579 := true;
      var lift_578 := 46057927;
      lift_578 := arg_575;
      print "(section 188 ", 1455852705, "\n", ")\n";
      lift_579 := lift_580;
      lift_581 := lift_580;
      print "(section 189 ", arg_577, "\n", ")\n";
    }
    print "(rets-for lift_570_1 arg_576 ", arg_576, ")\n";
    print "(rets-for lift_570_1 arg_577 ", arg_577, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_524 := -1450656133;
  {
    ...
    print "(meth-for lift_518_1)\n";
    {
      ...
      lift_542 := (var tmpData : seq<bool> := []; tmpData);
      lift_543 := -1485887204;
      print "(section 186 ", arg_523, "\n", ")\n";
    }
    print "(rets-for lift_518_1 arg_523 ", arg_523, ")\n";
    print "(rets-for lift_518_1 arg_524 ", arg_524, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_524 := -1450656133;
  {
    print "(params-for lift_518_2 arg_522 ", arg_522, ")\n";
    print "(meth-for lift_518_2)\n";
    {
      var lift_543 := arg_523;
      var lift_542 := (var tmpData : seq<bool> := []; tmpData);
      var lift_541 := false;
      ...
      lift_542 := (var tmpData : seq<bool> := []; tmpData);
      lift_543 := -1485887204;
      print "(section 185 ", arg_523, "\n", ")\n";
    }
    print "(rets-for lift_518_2 arg_523 ", arg_523, ")\n";
    print "(rets-for lift_518_2 arg_524 ", arg_524, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_468 := -1597447794;
  {
    ...
    {
      print "(section 181 ", arg_466, "\n", ")\n";
      print "(section 182 ", arg_466, "\n", ")\n";
      print "(section 183 ", arg_467, "\n", ")\n";
      print "(section 184 ", arg_467, "\n", ")\n";
    }
    print "(rets-for lift_462_0 arg_467 ", arg_467, ")\n";
    print "(rets-for lift_462_0 arg_468 ", arg_468, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_468 := -1597447794;
  {
    print "(params-for lift_462_1 arg_466 ", arg_466, ")\n";
    print "(meth-for lift_462_1)\n";
    {
      print "(section 177 ", arg_466, "\n", ")\n";
      print "(section 178 ", arg_466, "\n", ")\n";
      print "(section 179 ", arg_467, "\n", ")\n";
      print "(section 180 ", arg_467, "\n", ")\n";
    }
    print "(rets-for lift_462_1 arg_467 ", arg_467, ")\n";
    print "(rets-for lift_462_1 arg_468 ", arg_468, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_311 := -535231444;
  {
    ...
    print "(meth-for lift_305_0)\n";
    {
      ...
      lift_312 := lift_316;
      lift_317 := lift_318;
      print "(section 176 ", arg_311, "\n", ")\n";
      lift_319 := lift_319;
      lift_320 := (var tmpData : set<bool> := {}; tmpData);
    }
    print "(rets-for lift_305_0 arg_310 ", arg_310, ")\n";
  ...
  ensures (true)
{
  ...
  arg_311 := -535231444;
  {
    ...
    print "(meth-for lift_305_1)\n";
    {
      ...
      lift_312 := lift_316;
      lift_317 := lift_318;
      print "(section 175 ", arg_311, "\n", ")\n";
      lift_319 := lift_319;
      lift_320 := (var tmpData : set<bool> := {}; tmpData);
    }
    print "(rets-for lift_305_1 arg_310 ", arg_310, ")\n";
  ...
  ensures (true)
{
  ...
  arg_311 := -535231444;
  {
    print "(params-for lift_305_2 arg_309 ", arg_309, ")\n";
    print "(meth-for lift_305_2)\n";
    {
      var lift_321 := false;
      var lift_320 := {true, lift_321};
      var lift_319 := ();
      ...
      lift_312 := lift_316;
      lift_317 := lift_318;
      print "(section 174 ", arg_311, "\n", ")\n";
      lift_319 := lift_319;
      lift_320 := (var tmpData : set<bool> := {}; tmpData);
    }
    print "(rets-for lift_305_2 arg_310 ", arg_310, ")\n";
    print "(rets-for lift_305_2 arg_311 ", arg_311, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_270 := -22401346;
  {
    ...
    print "(rets-for lift_265_1 arg_269 ", arg_269, ")\n";
    print "(rets-for lift_265_1 arg_270 ", arg_270, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_270 := -22401346;
  {
    ...
    print "(rets-for lift_265_2 arg_269 ", arg_269, ")\n";
    print "(rets-for lift_265_2 arg_270 ", arg_270, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_270 := -22401346;
  {
    ...
    print "(rets-for lift_265_3 arg_269 ", arg_269, ")\n";
    print "(rets-for lift_265_3 arg_270 ", arg_270, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_240 := -824115845;
  {
    ...
    print "(params-for lift_232_0 arg_238 ", arg_238, ")\n";
    print "(meth-for lift_232_0)\n";
    {
      print "(section 173 ", arg_238, "\n", ")\n";
    }
    print "(rets-for lift_232_0 arg_239 ", arg_239, ")\n";
    print "(rets-for lift_232_0 arg_240 ", arg_240, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_240 := -824115845;
  {
    ...
    print "(params-for lift_232_1 arg_238 ", arg_238, ")\n";
    print "(meth-for lift_232_1)\n";
    {
      print "(section 172 ", arg_238, "\n", ")\n";
    }
    print "(rets-for lift_232_1 arg_239 ", arg_239, ")\n";
    print "(rets-for lift_232_1 arg_240 ", arg_240, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_218 := 2045604491;
  {
    print "(meth-for lift_215_0)\n";
    {
      ...
      lift_219 := lift_222;
      lift_228 := lift_227;
      print "(section 169 ", lift_229, "\n", ")\n";
      print "(section 170 ", lift_229, "\n", ")\n";
      print "(section 171 ", lift_229, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_218 := 2045604491;
  {
    print "(meth-for lift_215_1)\n";
    {
      ...
      lift_219 := lift_222;
      lift_228 := lift_227;
      print "(section 166 ", lift_229, "\n", ")\n";
      print "(section 167 ", lift_229, "\n", ")\n";
      print "(section 168 ", lift_229, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_189 := -755902438;
  {
    ...
    print "(params-for lift_181_0 arg_186 ", arg_186, ")\n";
    print "(params-for lift_181_0 arg_187 ", arg_187, ")\n";
    print "(meth-for lift_181_0)\n";
    {
      ...
      lift_190 := arg_185;
      lift_191 := lift_191;
      print "(section 164 ", arg_186, "\n", ")\n";
      print "(section 165 ", arg_188, "\n", ")\n";
    }
    print "(rets-for lift_181_0 arg_188 ", arg_188, ")\n";
    print "(rets-for lift_181_0 arg_189 ", arg_189, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_189 := -755902438;
  {
    print "(params-for lift_181_1 arg_185 ", arg_185, ")\n";
    print "(params-for lift_181_1 arg_186 ", arg_186, ")\n";
    print "(params-for lift_181_1 arg_187 ", arg_187, ")\n";
    print "(meth-for lift_181_1)\n";
    {
      ...
      lift_190 := arg_185;
      lift_191 := lift_191;
      print "(section 162 ", arg_186, "\n", ")\n";
      print "(section 163 ", arg_188, "\n", ")\n";
    }
    print "(rets-for lift_181_1 arg_188 ", arg_188, ")\n";
    print "(rets-for lift_181_1 arg_189 ", arg_189, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_93 := -1107060713;
  {
    print "(params-for lift_86_1 arg_90 ", arg_90, ")\n";
    print "(params-for lift_86_1 arg_91 ", arg_91, ")\n";
    print "(meth-for lift_86_1)\n";
    {
      ...
      var lift_94 := 'O';
      lift_94 := lift_95;
      print "(section 160 ", arg_91, "\n", ")\n";
      lift_96 := lift_96;
    }
    print "(rets-for lift_86_1 arg_92 ", arg_92, ")\n";
    print "(rets-for lift_86_1 arg_93 ", arg_93, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_93 := -1107060713;
  {
    print "(params-for lift_86_2 arg_90 ", arg_90, ")\n";
    print "(params-for lift_86_2 arg_91 ", arg_91, ")\n";
    print "(meth-for lift_86_2)\n";
    {
      var lift_107 := 't';
      var lift_106 := lift_107;
      var lift_105 := false;
      ...
      var lift_94 := 'O';
      lift_94 := lift_95;
      print "(section 159 ", arg_91, "\n", ")\n";
      lift_96 := lift_96;
    }
    print "(rets-for lift_86_2 arg_92 ", arg_92, ")\n";
    print "(rets-for lift_86_2 arg_93 ", arg_93, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_93 := -1107060713;
  {
    print "(params-for lift_86_3 arg_90 ", arg_90, ")\n";
    print "(params-for lift_86_3 arg_91 ", arg_91, ")\n";
    print "(meth-for lift_86_3)\n";
    {
      var lift_107 := 't';
      var lift_106 := lift_107;
      var lift_105 := false;
      ...
      var lift_94 := 'O';
      lift_94 := lift_95;
      print "(section 158 ", arg_91, "\n", ")\n";
      lift_96 := lift_96;
    }
    print "(rets-for lift_86_3 arg_92 ", arg_92, ")\n";
    print "(rets-for lift_86_3 arg_93 ", arg_93, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_93 := -1107060713;
  {
    print "(params-for lift_86_4 arg_90 ", arg_90, ")\n";
    print "(params-for lift_86_4 arg_91 ", arg_91, ")\n";
    print "(meth-for lift_86_4)\n";
    {
      var lift_107 := 't';
      var lift_106 := lift_107;
      var lift_105 := false;
      ...
      var lift_94 := 'O';
      lift_94 := lift_95;
      print "(section 157 ", arg_91, "\n", ")\n";
      lift_96 := lift_96;
    }
    print "(rets-for lift_86_4 arg_92 ", arg_92, ")\n";
    print "(rets-for lift_86_4 arg_93 ", arg_93, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_84 := -657356466;
  {
    ...
    print "(rets-for lift_78_1 arg_84 ", arg_84, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_57 := 2114065206;
  {
    ...
    print "(meth-for lift_51_0)\n";
    {
      ...
      print "(section 155 ", arg_56, "\n", ")\n";
      lift_58 := lift_58;
      print "(section 156 ", arg_54, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_57 := 2114065206;
  {
    ...
    {
      var lift_58 := multiset{arg_57, arg_56, arg_55, arg_57};
      print "(section 153 ", arg_56, "\n", ")\n";
      lift_58 := lift_58;
      print "(section 154 ", arg_54, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_38 := -1728966937;
  {
    print "(params-for lift_33_1 arg_36 ", arg_36, ")\n";
  ...
  ensures (true)
{
  arg_38 := -1728966937;
  {
    print "(params-for lift_33_2 arg_36 ", arg_36, ")\n";
  ...
  ensures (true)
{
  arg_38 := -1728966937;
  {
    print "(params-for lift_33_3 arg_36 ", arg_36, ")\n";
    print "(params-for lift_33_3 arg_37 ", arg_37, ")\n";
    ...
    print "(rets-for lift_33_3 arg_38 ", arg_38, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_26 := 1816412335;
  {
    ...
    print "(meth-for lift_22_0)\n";
    {
      ...
      var lift_28 := true;
      var lift_27 := arg_25;
      print "(section 149 ", arg_25, "\n", ")\n";
      print "(section 150 ", lift_27, "\n", ")\n";
      lift_28 := lift_29;
      print "(section 151 ", arg_26, "\n", ")\n";
      print "(section 152 ", arg_25, "\n", ")\n";
    }
    print "(rets-for lift_22_0 arg_26 ", arg_26, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_26 := 1816412335;
  {
    print "(params-for lift_22_1 arg_25 ", arg_25, ")\n";
    print "(meth-for lift_22_1)\n";
    {
      var lift_29 := true;
      var lift_28 := true;
      var lift_27 := arg_25;
      print "(section 145 ", arg_25, "\n", ")\n";
      print "(section 146 ", lift_27, "\n", ")\n";
      lift_28 := lift_29;
      print "(section 147 ", arg_26, "\n", ")\n";
      print "(section 148 ", arg_25, "\n", ")\n";
    }
    print "(rets-for lift_22_1 arg_26 ", arg_26, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_26 := 1816412335;
  {
    print "(params-for lift_22_2 arg_25 ", arg_25, ")\n";
    print "(meth-for lift_22_2)\n";
    {
      var lift_29 := true;
      var lift_28 := true;
      var lift_27 := arg_25;
      print "(section 141 ", arg_25, "\n", ")\n";
      print "(section 142 ", lift_27, "\n", ")\n";
      lift_28 := lift_29;
      print "(section 143 ", arg_26, "\n", ")\n";
      print "(section 144 ", arg_25, "\n", ")\n";
    }
    print "(rets-for lift_22_2 arg_26 ", arg_26, ")\n";
  }
}
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    var methoddefvar_24 := lift_22_0(|lift_30|);
    {
      ...
      var methoddefvar_35 := lift_33_0(lift_4, lift_4);
      {
        ...
        lift_49 := lift_49;
        lift_50 := lift_50;
        print "(section 0 ", methoddefvar_24, "\n", ")\n";
      }
      var methoddefvar_53 := lift_51_0(lift_3, methoddefvar_24, lift_3);
      {
        lift_59 := methoddefvar_53;
        lift_60 := lift_60;
        print "(section 1 ", methoddefvar_53, "\n", ")\n";
        print "(section 2 ", methoddefvar_24, "\n", ")\n";
      }
    }
    ...
    );
    {
      ...
      {
        print "(section 5 ", lift_63, "\n", ")\n";
        print "(section 6 ", lift_62, "\n", ")\n";
      }
    }
    var methoddefvar_88, methoddefvar_89 := lift_86_0(|lift_108|, |lift_108|);
    {
      ...
      if (lift_12) {
        ...
        print "(section 8 ", 1370583763, "\n", ")\n";
        print "(section 9 ", methoddefvar_88, "\n", ")\n";
        lift_111 := lift_113;
      } else {
      ...
      }
      {
        ...
        lift_128 := lift_129;
        print "(section 12 ", lift_136, "\n", ")\n";
        lift_145 := ();
        print "(section 13 ", methoddefvar_89, "\n", ")\n";
      }
    }
  } else {
    ...
    lift_147 := lift_161.1.2;
    {
      ...
      if ((lift_146 !in lift_176)) {
        ...
        {
          print "(section 16 ", lift_136, "\n", ")\n";
          lift_195 := lift_175;
          lift_196 := lift_141;
          print "(section 17 ", 501342171, "\n", ")\n";
        }
        {
          print "(section 18 ", lift_62, "\n", ")\n";
    ...
    }
    {
      ...
      if ((lift_63 > lift_207)) {
        ...
        {
          print "(section 28 ", lift_196, "\n", ")\n";
          print "(section 29 ", lift_62, "\n", ")\n";
          print "(section 30 ", lift_196, "\n", ")\n";
          print "(section 31 ", lift_252, "\n", ")\n";
          lift_322 := lift_124;
        }
        {
          lift_323 := lift_12;
          lift_324 := lift_324;
          print "(section 32 ", lift_143, "\n", ")\n";
          print "(section 33 ", lift_62, "\n", ")\n";
          print "(section 34 ", lift_4, "\n", ")\n";
        }
        if (lift_263) {
          var lift_325 := true;
          print "(section 35 ", lift_143, "\n", ")\n";
          print "(section 36 ", lift_210, "\n", ")\n";
          lift_325 := lift_12;
          print "(section 37 ", lift_61, "\n", ")\n";
        } else {
          print "(section 38 ", lift_136, "\n", ")\n";
          lift_326 := lift_329;
          print "(section 39 ", lift_253, "\n", ")\n";
        ...
        if (lift_211) {
          print "(section 41 ", lift_196, "\n", ")\n";
          print "(section 42 ", -1699166998, "\n", ")\n";
          lift_343 := lift_263;
        } else {
          lift_344 := lift_348;
          lift_349 := lift_136;
          print "(section 43 ", lift_136, "\n", ")\n";
        }
      }
    }
    ...
    );
    {
      var methoddefvar_352 := lift_215_1();
      {
        ...
        print "(section 44 ", lift_141, "\n", ")\n";
        print "(section 45 ", 1437777314, "\n", ")\n";
      }
      lift_361 := lift_74;
      print "(section 46 ", lift_61, "\n", ")\n";
      if (lift_343) {
        print "(section 47 ", lift_133, "\n", ")\n";
      } else {
  ...
  if ((((lift_386[lift_174 := lengthNormalize(lift_133)]) in (
    ...
    );
    {
      ...
      if (lift_159) {
        ...
        print "(section 51 ", lift_143, "\n", ")\n";
      }
      {
        print "(section 52 ", lift_451, "\n", ")\n";
        lift_453 := lift_4;
        print "(section 53 ", lift_253, "\n", ")\n";
        print "(section 54 ", lift_374, "\n", ")\n";
        lift_454 := lift_432;
      }
    }
    var methoddefvar_455, methoddefvar_456 := lift_265_1();
    {
      ...
      var methoddefvar_457, methoddefvar_458 := lift_305_1(lift_452);
      {
        ...
        print "(section 55 ", -431051656, "\n", ")\n";
        lift_459 := lift_459;
        lift_460 := lift_460;
        print "(section 56 ", methoddefvar_455, "\n", ")\n";
      }
      print "(section 57 ", 1747354930, "\n", ")\n";
    ...
    if (((
      ...
      if ((lift_141 < lift_494)) {
        ...
        {
          print "(section 62 ", methoddefvar_520, "\n", ")\n";
        }
        if (lift_370) {
          var lift_554 := 'N';
    ...
    var lift_583 := [lift_584, lift_584];
    {
      ...
      };
      {
        ...
        );
        {
          ...
          print "(section 65 ", lift_477, "\n", ")\n";
          lift_582 := lift_583;
          lift_586 := lift_596;
          print "(section 66 ", lift_451, "\n", ")\n";
        }
      }
    }
  }
  var methoddefvar_600 := lift_598_0();
  {
    ...
    print "(section 67 ", (lift_397 as int), "\n", ")\n";
    print "(section 68 ", |lift_357|, "\n", ")\n";
    var methoddefvar_612 := lift_610_0(361397526);
    {
      var lift_619 := lift_178;
      print "(section 69 ", lift_136, "\n", ")\n";
      print "(section 70 ", lift_207, "\n", ")\n";
      lift_619 := lift_124;
    }
    var methoddefvar_622 := lift_620_0(lift_476, lift_494);
    {
      var lift_628 := {lift_629};
      print "(section 71 ", lift_136, "\n", ")\n";
      lift_628 := lift_633;
      print "(section 72 ", 1872203010, "\n", ")\n";
      print "(section 73 ", lift_365, "\n", ")\n";
    }
  }
  if ((lift_419.1 <= lift_130.0.1)) {
    ...
    var methoddefvar_639, methoddefvar_640 := lift_86_2(|lift_197|, |"aV"|);
    {
      ...
      {
        lift_647 := lift_144;
        print "(section 74 ", lift_133, "\n", ")\n";
        lift_648 := lift_632;
      }
      print "(section 75 ", lift_196, "\n", ")\n";
      print "(section 76 ", lift_481, "\n", ")\n";
      lift_649 := lift_653;
      print "(section 77 ", lift_479, "\n", ")\n";
    }
    print "(section 78 ", |lift_497|, "\n", ")\n";
    {
      ...
      var methoddefvar_659, methoddefvar_660 := lift_462_1(lift_365);
      {
        ...
        print "(section 79 ", lift_509, "\n", ")\n";
        lift_661 := lift_661;
        print "(section 80 ", lift_446, "\n", ")\n";
        print "(section 81 ", lift_210, "\n", ")\n";
      }
      ...
      }
      {
        ...
        if (lift_249) {
          ...
          lift_708 := lift_632;
          lift_709 := lift_710;
          print "(section 84 ", lift_501, "\n", ")\n";
        }
        {
          var lift_717 := (lift_718, lift_720);
          print "(section 85 ", lift_446, "\n", ")\n";
          lift_717 := lift_721;
          print "(section 86 ", lift_591, "\n", ")\n";
          lift_738 := lift_738;
        }
      }
      if (('=' in lift_650)) {
        {
          ...
          print "(section 87 ", lift_367, "\n", ")\n";
          print "(section 88 ", lift_478, "\n", ")\n";
          print "(section 89 ", lift_590, "\n", ")\n";
          lift_750 := lift_750;
          print "(section 90 ", lift_746, "\n", ")\n";
        }
        ...
        {
          print "(section 91 ", lift_366, "\n", ")\n";
        }
        {
          lift_754 := lift_754;
          print "(section 92 ", 679713404, "\n", ")\n";
          print "(section 93 ", lift_501, "\n", ")\n";
        }
        var methoddefvar_756, methoddefvar_757 := lift_265_2();
        {
          print "(section 94 ", lift_729, "\n", ")\n";
          print "(section 95 ", lift_679, "\n", ")\n";
        }
        lift_758 := lift_122;
      } else {
        print "(section 96 ", lift_365, "\n", ")\n";
        print "(section 97 ", lift_727, "\n", ")\n";
      }
    }
  } else {
    ...
    var methoddefvar_760 := lift_610_1(|{{(), (), lift_340, lift_632}}|);
    {
      ...
      {
        print "(section 98 ", lift_483, "\n", ")\n";
        print "(section 99 ", lift_62, "\n", ")\n";
        lift_769 := lift_769;
        print "(section 100 ", -225152680, "\n", ")\n";
      }
      var methoddefvar_771, methoddefvar_772 := lift_518_1(lift_730);
      {
        ...
        lift_773 := lift_373;
        lift_774 := lift_340;
        print "(section 101 ", 1679387352, "\n", ")\n";
        lift_775 := false;
      }
      if (lift_421) {
        print "(section 102 ", lift_63, "\n", ")\n";
        print "(section 103 ", -676235214, "\n", ")\n";
      } else {
        ...
        print "(section 104 ", lift_262, "\n", ")\n";
        lift_776 := lift_14;
        lift_777 := lift_777;
        print "(section 105 ", lift_746, "\n", ")\n";
      }
      print "(section 106 ", lift_482, "\n", ")\n";
    }
    {
      var methoddefvar_784, methoddefvar_785 := lift_265_3();
      {
        ...
        lift_786 := lift_359;
        lift_787 := lift_124;
        print "(section 107 ", lift_482, "\n", ")\n";
      }
    }
    print 
      "(section 108 ",
      lift_788(lift_745, lift_567, lift_178, lift_695, lift_683).2,
      "\n",
      ")\n";
    if (!(false)) {
      ...
      lift_806 := lift_173.0;
      lift_807 := lift_808.0;
      print "(section 109 ", lift_65(lift_817, lift_126), "\n", ")\n";
      ...
      if (lift_391.0) {
        lift_825 := lift_734;
        print "(section 110 ", lift_252, "\n", ")\n";
        {
          print "(section 111 ", lift_730, "\n", ")\n";
          lift_826 := lift_826;
        }
      } else {
        if (lift_333) {
          var lift_827 := lift_111;
          print "(section 112 ", lift_730, "\n", ")\n";
          lift_827 := {lift_252, lift_262, lift_451, -844354279};
          print "(section 113 ", lift_730, "\n", ")\n";
        } else {
        ...
        }
        {
          ...
          lift_829 := lift_716;
          print "(section 114 ", -536995237, "\n", ")\n";
        }
        {
          lift_830 := lift_432;
          print "(section 115 ", lift_112, "\n", ")\n";
        }
        {
      ...
      var methoddefvar_866 := lift_22_2(lift_451);
      {
        ...
        lift_867 := lift_867;
        print "(section 118 ", lift_746, "\n", ")\n";
        lift_873 := lift_874;
        print "(section 119 ", lift_374, "\n", ")\n";
      }
    ...
    );
    {
      ...
      var lift_915 := true;
      {
        print "(section 121 ", lift_746, "\n", ")\n";
        lift_891 := (
          {lift_893, lift_677, lift_726, lift_893, lift_893},
          lift_769
        );
        print "(section 122 ", lift_452, "\n", ")\n";
        print "(section 123 ", 598572234, "\n", ")\n";
      }
      ...
      }
      {
        ...
        print "(section 124 ", lift_482, "\n", ")\n";
        print "(section 125 ", lift_482, "\n", ")\n";
      }
      lift_915 := lift_749;
      {
  ...
  var methoddefvar_920 := lift_918_0();
  {
    ...
    var lift_957 := {lift_423, lift_419, lift_406, lift_345};
    {
      var methoddefvar_926 := lift_598_1();
      {
        ...
        print "(section 127 ", lift_856, "\n", ")\n";
      }
      print "(section 128 ", lift_703, "\n", ")\n";
      var methoddefvar_952, methoddefvar_953 := lift_518_2(lift_585);
      {
        print "(section 129 ", 144370610, "\n", ")\n";
      }
      {
        var lift_954 := '?';
        print "(section 130 ", lift_251, "\n", ")\n";
        lift_954 := lift_127;
        lift_955 := lift_853;
        print "(section 131 ", lift_196, "\n", ")\n";
        lift_957 := lift_957;
      }
    }
    lift_958 := lift_982;
    if (lift_739.2) {
      ...
      if (lift_684) {
        ...
        lift_997 := 'a';
        lift_998 := true;
        print "(section 132 ", lift_864, "\n", ")\n";
      } else {
        var lift_999 := lift_346;
        print "(section 133 ", lift_679, "\n", ")\n";
        lift_999 := lift_704;
      }
      {
      ...
      if (lift_698) {
        lift_1021 := lift_1025;
        print "(section 135 ", lift_143, "\n", ")\n";
        print "(section 136 ", lift_591, "\n", ")\n";
        print "(section 137 ", lift_871, "\n", ")\n";
        lift_1026 := lift_1031;
      } else {
        print "(section 138 ", lift_452, "\n", ")\n";
      }
