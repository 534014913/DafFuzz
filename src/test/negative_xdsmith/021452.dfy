  ...
  ensures (true)
{
  ...
  arg_18 := -203011400;
  {
    ...
    print "(params-for lift_10_0 arg_16 ", arg_16, ")\n";
    print "(meth-for lift_10_0)\n";
    {
      ...
      var lift_20 := lift_21;
      var lift_19 := {arg_14};
      print "(section 18 ", arg_15, "\n", ")\n";
      lift_19 := lift_20;
      lift_23 := arg_16;
      lift_24 := lift_24;
    }
    print "(rets-for lift_10_0 arg_17 ", arg_17, ")\n";
    print "(rets-for lift_10_0 arg_18 ", arg_18, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_7 := 582736985;
  {
    print "(meth-for lift_4_0)\n";
    {
      ...
      lift_8 := lift_9;
      print "(section 16 ", 330496869, "\n", ")\n";
      print "(section 17 ", lift_9, "\n", ")\n";
    }
    print "(rets-for lift_4_0 arg_7 ", arg_7, ")\n";
  }
}
...
method Main () {
  ...
  print "(section 0 ", |safeSeqTake(lift_1, |lift_1|)|, "\n", ")\n";
  var methoddefvar_6 := lift_4_0();
  {
    ...
    );
    {
      ...
      print "(section 1 ", methoddefvar_13, "\n", ")\n";
    }
    if (lift_45(lift_50, lift_55, lift_56)) {
      ...
      if (lift_57) {
        ...
        var lift_61 := lift_62;
        print "(section 5 ", methoddefvar_6, "\n", ")\n";
        lift_61 := lift_61;
      }
      print "(section 6 ", 1241159548, "\n", ")\n";
      {
        print "(section 7 ", 1686531611, "\n", ")\n";
      }
      if (lift_3) {
        print "(section 8 ", methoddefvar_6, "\n", ")\n";
