...
method lift_565_0 ()
  ...
  requires (true)
  ensures (((arg_570 == -670847366) && ((arg_569 == -1214348549) && true)))
{
  arg_569 := -1214348549;
  arg_570 := -670847366;
  {
...
method lift_554_0 ()
  returns (arg_557 : int)
  requires (true)
  ensures (((arg_557 == -1877269627) && true))
{
  arg_557 := -1877269627;
  {
    var lift_558 := 1352739526;
    assert (((1352739524 - 1352739526) == (lift_558 + lift_558)) || ((1352739524 < lift_558) && (1352739526 == lift_558)));
  }
}
...
method lift_421_2 (arg_424 : int, arg_425 : int, arg_426 : int)
  returns (arg_427 : int)
  requires (((arg_426 == 1773418759) && ((arg_425 == 1162518670) && ((arg_424 == 2106436865) && true))))
  ensures (((arg_427 == 1035437) && true))
{
  arg_427 := 1035437;
  {
    var lift_435 := 'Y';
    ...
    var lift_429 := ((lift_430, lift_430, lift_431), lift_432, lift_435);
    var lift_428 := {lift_429};
    assert (((-1851623655 - -1851623653) == (-1851623654 - -1851623653)) || ((-1851623653 == -1851623653) && (-1851623653 == -1851623653)));
    lift_428 := lift_428;
  }
}
...
method lift_421_3 (arg_424 : int, arg_425 : int, arg_426 : int)
  returns (arg_427 : int)
  requires (((arg_426 == 1349699262) && ((arg_425 == -734192976) && ((arg_424 == -1992778640) && true))))
  ensures (((arg_427 == 1035437) && true))
{
  arg_427 := 1035437;
  {
    ...
    var lift_429 := ((lift_430, lift_430, lift_431), lift_432, lift_435);
    var lift_428 := {lift_429};
    assert (((-1851623653 == -1851623653) || (-1851623653 == -1851623653)) && ((-1851623653 + -1851623653) < (-5554870953 - -1851623653)));
    lift_428 := lift_428;
  }
}
...
method lift_332_0 (arg_336 : int, arg_337 : int, arg_338 : int)
  ...
  requires (((arg_338 == 1003274107) && ((arg_337 == 1266588802) && ((arg_336 == -727249315) && true))))
  ensures (((arg_340 == 1879008371) && ((arg_339 == -1475213771) && true)))
{
  arg_339 := -1475213771;
  arg_340 := 1879008371;
  {
    var lift_341 := -2028426329;
    assert (((-5556186886 < -1852062295) && (-5556186886 < -1852062295)) && ((-5556186887 - -1852062295) == (-5556186887 - -1852062295)));
    assert (((-2181747948 - arg_336) == (-2181747947 - arg_336)) || ((-2181747947 - arg_336) == (-2181747947 - -727249315)));
    lift_341 := arg_336;
  }
}
...
method lift_256_0 (arg_259 : int)
  returns (arg_260 : int)
  requires (((arg_259 == -727249315) && true))
  ensures (((arg_260 == 1040732366) && true))
{
  arg_260 := 1040732366;
  {
...
method lift_224_0 ()
  ...
  requires (true)
  ensures (((arg_229 == 1754698636) && ((arg_228 == -1748186006) && true)))
{
  arg_228 := -1748186006;
  arg_229 := 1754698636;
  {
    ...
    assert (((lift_230 < lift_230) && (1734953134 == lift_230)) || ((1734953132 - 1734953133) == (1734953132 - lift_230)));
    lift_231 := lift_230;
    lift_232 := lift_232;
    assert (((1748186007 + lift_233) < (-1748186004 - lift_233)) || ((lift_233 == -1748186002) || (-1748186007 == -1748186008)));
    lift_234 := lift_233;
  }
}
...
method lift_183_0 ()
  returns (arg_186 : int)
  requires (true)
  ensures (((arg_186 == 1302157696) && true))
{
  arg_186 := 1302157696;
  {
    ...
    lift_187 := lift_188;
    assert (((arg_186 - 3906473089) + (1302157695 + arg_186)) == ((1302157694 - 1302157695) + (1302157693 - 1302157694)));
  }
}

method lift_153_0 (arg_156 : int, arg_157 : int)
  returns (arg_158 : int)
  requires (((arg_157 == 817069590) && ((arg_156 == -1992778640) && true)))
  ensures (((arg_158 == -1847414375) && true))
{
  arg_158 := -1847414375;
  {
    ...
    lift_159 := lift_159;
    assert (((-817069593 + arg_157) - (arg_157 - arg_157)) < ((817069588 - arg_157) - (817069589 - arg_157)));
    lift_161 := lift_161;
    assert (((-817069590 - 817069590) == (arg_157 - 2451208770)) && ((-2451208771 - arg_157) < (-817069590 - 817069590)));
...
method lift_153_1 (arg_156 : int, arg_157 : int)
  returns (arg_158 : int)
  requires (((arg_157 == 817069590) && ((arg_156 == 1447424565) && true)))
  ensures (((arg_158 == -1847414375) && true))
{
  arg_158 := -1847414375;
  {
...
method lift_153_2 (arg_156 : int, arg_157 : int)
  returns (arg_158 : int)
  requires (((arg_157 == -1873860774) && ((arg_156 == 3) && true)))
  ensures (((arg_158 == -1847414375) && true))
{
  arg_158 := -1847414375;
  {
    ...
    var lift_159 := {(), lift_160, lift_160};
    lift_159 := lift_159;
    assert (((0 + -1873860776) - arg_157) < ((-1873860775 + -1873860774) - (arg_157 + arg_157)));
    lift_161 := lift_161;
    assert (((arg_157 + -1873860774) + (-1873860775 - arg_157)) < ((0 - 1873860774) + (-1873860775 - arg_157)));
    lift_162 := (lift_163, (arg_156, arg_158));
  }
}
...
method lift_153_3 (arg_156 : int, arg_157 : int)
  returns (arg_158 : int)
  requires (((arg_157 == -676825957) && ((arg_156 == -734192976) && true)))
  ensures (((arg_158 == -1847414375) && true))
{
  arg_158 := -1847414375;
  {
    ...
    var lift_159 := {(), lift_160, lift_160};
    lift_159 := lift_159;
    assert ((arg_157 + (-2707303830 - arg_157)) == ((-2030477872 - arg_157) + (-2030477872 - arg_157)));
    lift_161 := lift_161;
    assert ((arg_157 + (-2707303830 - arg_157)) == ((-2030477872 - arg_157) + (-2030477872 - arg_157)));
    lift_162 := (lift_163, (arg_156, arg_158));
  }
...
method Main () {
  ...
  if (((
    ...
    assert ((-1 == (-234047357 + lift_126.1.1)) || ((234047354 - lift_126.1.1) == (234047355 - lift_126.1.1)));
    if (lift_140.0.1) {
      ...
      var lift_149 := 'F';
      {
        ...
        if (lift_125) {
          ...
          assert ((lift_91 < (1447424566 - -1)) || ((1447424563 - lift_91) == (1447424564 - lift_91)));
          assert ((lift_91 < (1447424566 - -1)) || ((1447424563 - lift_91) == (1447424564 - lift_91)));
          lift_151 := lift_47;
          assert ((lift_79 + (-2707303830 - lift_79)) == ((-2030477872 - lift_79) + (-2030477872 - lift_79)));
          lift_152 := 'v';
        }
      ...
      var methoddefvar_203 := lift_153_1(lift_91, lift_6);
      {
        ...
        assert (((lift_131 < lift_131) && (lift_131 == lift_131)) || ((lift_131 - lift_131) < lift_131));
        lift_204 := lift_204;
        assert (((-1847414377 - -1847414375) < (-1847414376 - methoddefvar_203)) || ((-1847414377 - methoddefvar_203) == (-1847414376 - methoddefvar_203)));
        lift_205 := lift_213;
        lift_214 := lift_214;
      }
    } else {
    ...
    var methoddefvar_226, methoddefvar_227 := lift_224_0();
    {
      ...
      if (lift_47) {
        ...
        lift_235 := lift_235;
        lift_236 := lift_241;
        assert (((-1 - lift_223) == (-2 - lift_223)) || ((-1 - lift_223) == (-1 - 1003274107)));
        assert (((-2 - lift_85) + (lift_85 + lift_85)) == 506494484);
        lift_242 := lift_27;
      } else {
        lift_243 := lift_129;
        lift_244 := lift_25;
      ...
      {
        assert (((-817069593 + lift_6) - (lift_6 - lift_6)) < ((817069588 - lift_6) - (817069589 - lift_6)));
        lift_248 := lift_86;
        assert (methoddefvar_246 == ((methoddefvar_246 - 1) + (-1748186005 - methoddefvar_246)));
        assert (((1870078929 - 1870078929) + (-1870078929 - 1870078929)) == ((-1870078928 - 1870078929) + (-1870078931 - -1870078930)));
        lift_249 := lift_255;
      }
    ...
    {
      var lift_342 := ();
      assert (((-42170391 == -42170391) || (-42170391 == -42170391)) && ((-42170390 == -42170391) || (-42170391 == -42170391)));
      ...
      );
      {
        ...
        lift_343 := lift_343;
        lift_368 := lift_146;
        assert (((-1250577564 + lift_242) - (-1250577562 + lift_242)) == ((1250577558 - lift_242) + (1250577558 - lift_242)));
      }
    }
  } else {
  ...
  );
  {
    ...
    assert (lift_37.1 == ((1162518669 - -2) + (1162518668 - 1162518669)));
    assert (((lift_27 < lift_27) && (lift_27 < lift_27)) || ((lift_27 < 1) || (1 < lift_27)));
    {
      ...
      if (false) {
        ...
        lift_544 := lift_41;
        assert (((-2 < lift_456) && (lift_456 < -2)) || ((-1 < lift_456) && (lift_456 == lift_456)));
      }
      lift_545 := lift_549;
      var methoddefvar_556 := lift_554_0();
      {
        ...
        lift_560 := lift_562;
        lift_563 := lift_564;
        assert (((-2181747948 - lift_212) == (-2181747947 - lift_212)) || ((-2181747947 - lift_212) == (-2181747947 - -727249315)));
      }
      {
        assert (((lift_1 - 1873860774) - lift_1) == ((-1873860776 + 1873860776) + lift_1));
      }
    }
  }
  var methoddefvar_567, methoddefvar_568 := lift_565_0();
  {
    ...
    var methoddefvar_575 := lift_421_3(lift_3, lift_360, lift_131);
    {
      ...
      lift_576 := lift_505;
      lift_577 := lift_50;
      assert (((0 + -1873860776) - lift_1) < ((-1873860775 + -1873860774) - (lift_1 + lift_1)));
      assert (methoddefvar_567 == -1214348549);
    }
    var methoddefvar_578 := lift_153_3(lift_361, lift_79);
    {
      assert (((-1220215274 + lift_520) == (1220215275 - lift_520)) || ((1220215271 < lift_520) && (lift_520 == 1220215272)));
      assert (((1430011544 - 1430011546) + (1430011544 - 1430011546)) == ((-1430011551 + lift_457) - (-1430011545 + 1430011544)));
      lift_579 := lift_145;
    }
  }
}
