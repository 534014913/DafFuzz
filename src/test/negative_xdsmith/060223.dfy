...
method lift_60_0 ()
  ...
  requires (true)
  ensures (((arg_65 == 1741567267) && ((arg_64 == -1140606562) && true)))
{
  arg_64 := -1140606562;
  arg_65 := 1741567267;
  {
    ...
    lift_66 := lift_66;
    assert (((lift_89 == lift_89) || (lift_89 == lift_89)) && ((lift_89 + lift_89) < (-1068109191 - lift_89)));
    assert (((lift_80 + lift_80) + (-1140606563 - lift_80)) < ((lift_80 - -1140606563) + lift_80));
    assert (lift_89 == ((lift_89 - -1) + (-356036400 - lift_89)));
  }
}
  ...
  ensures (((arg_65 == 1741567267) && ((arg_64 == -1140606562) && true)))
{
  ...
  arg_65 := 1741567267;
  {
    ...
    lift_66 := lift_66;
    assert (((lift_89 == -356036398) || (lift_89 == -356036398)) || ((lift_89 < -356036399) || (-356036403 == lift_89)));
    assert (((-1140606564 - lift_80) < (-1140606563 - -1140606562)) && (lift_80 < (1140606563 + lift_80)));
    assert (((-356036403 - lift_89) < (-356036402 - -356036399)) && ((-356036402 < lift_89) || (-356036402 < lift_89)));
  }
}

method lift_34_0 (arg_37 : int, arg_38 : int)
  returns (arg_39 : int)
  requires (((arg_38 == -985124167) && ((arg_37 == 568435563) && true)))
  ensures (((arg_39 == 557334683) && true))
{
  arg_39 := 557334683;
  {
...
method lift_1_0 (arg_5 : int, arg_6 : int)
  ...
  requires (((arg_6 == 4) && ((arg_5 == 4) && true)))
  ensures (((arg_8 == 212900865) && ((arg_7 == 1565014356) && true)))
{
  arg_7 := 1565014356;
  arg_8 := 212900865;
  {
...
method lift_1_1 (arg_5 : int, arg_6 : int)
  returns (arg_7 : int, arg_8 : int)
  requires (((arg_6 == 331398287) && ((arg_5 == 1887852975) && true)))
  ensures (((arg_8 == 212900865) && ((arg_7 == 1565014356) && true)))
{
  arg_7 := 1565014356;
  arg_8 := 212900865;
...
method lift_1_2 (arg_5 : int, arg_6 : int)
  returns (arg_7 : int, arg_8 : int)
  requires (((arg_6 == 557334683) && ((arg_5 == 616686415) && true)))
  ensures (((arg_8 == 212900865) && ((arg_7 == 1565014356) && true)))
{
  arg_7 := 1565014356;
  arg_8 := 212900865;
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_15, methoddefvar_16 := lift_1_1(lift_14, lift_13);
    {
      ...
      assert ((methoddefvar_16 - (-425801730 + 212900864)) == (1 + (methoddefvar_16 + methoddefvar_16)));
      lift_17 := lift_21;
    }
  }
  ...
  var methoddefvar_36 := lift_34_0(lift_46.0.1, lift_55.0);
  {
    ...
    var lift_91 := lift_92;
    {
      assert (((-799173947 == -799173947) || (-799173947 == -799173947)) && ((-799173947 + -799173947) < (-2397521835 - -799173947)));
      var methoddefvar_62, methoddefvar_63 := lift_60_0();
      {
        var lift_90 := true;
        assert (((-985124168 - lift_59) < (-985124168 - lift_59)) || (lift_59 == -985124167));
        lift_90 := lift_53;
        lift_91 := lift_92;
        assert (((lift_13 + -331398288) + (-1 - lift_13)) < ((lift_13 - 662796576) - (0 - 331398287)));
      }
      lift_95 := multiset{lift_96};
    }
    {
      lift_101 := methoddefvar_36;
      assert (((lift_13 < lift_13) && (-1 == lift_13)) || ((-331398288 - 0) == (-1 - lift_13)));
      assert (lift_50 < ((3966535039 + lift_50) + lift_50));
      assert (((-232124635 + -232124635) + (-232124636 - -232124635)) < ((-232124635 - -232124636) + -232124635));
    }
    ...
    );
    {
      ...
      lift_118 := lift_118;
      lift_121 := lift_122;
      assert (((lift_13 - 994194863) - (-331398288 + lift_13)) == ((0 - 331398287) + (-1 - lift_13)));
    }
    assert (((lift_124(
      lift_130,
      lift_120,
      lift_19
    ) - 735949523) + 1) == ((lift_124(
      lift_130,
      lift_120,
      lift_19
    ) - 735949521) + (-735949521 - lift_124(lift_130, lift_120, lift_19))));
  }
  if (lift_30.0) {
    ...
    var methoddefvar_222, methoddefvar_223 := lift_60_1();
    {
      ...
      lift_224 := -160544195;
      assert (((methoddefvar_223 < methoddefvar_223) && (methoddefvar_223 == methoddefvar_223)) || ((methoddefvar_223 < methoddefvar_223) || (1 < methoddefvar_223)));
    }
    lift_225 := lift_226.1;
  }
  lift_240 := lift_290;
