  ...
  ensures (true)
{
  arg_115 := -328754032;
  {
    ...
    {
      print "(section 18 ", arg_113, "\n", ")\n";
      print "(section 19 ", -315840877, "\n", ")\n";
    }
...
method Main () {
  ...
  var lift_1 := lift_2;
  {
    ...
    print "(section 0 ", |safeSeqRef(lift_1, lift_4, lift_5)|, "\n", ")\n";
    print 
      "(section 1 ",
      (
        lift_4,
      ...
      "\n",
      ")\n";
    print "(section 2 ", lift_12.1(|lift_20|), "\n", ")\n";
    {
      ...
      if ((lift_31 <== false <== lift_34)) {
        ...
        var methoddefvar_37, methoddefvar_38 := lift_35_0(lift_4, lift_4);
        {
          ...
          print "(section 4 ", methoddefvar_37, "\n", ")\n";
          lift_71 := lift_72;
          lift_75 := ();
        }
      } else {
      ...
      }
      {
        ...
        var methoddefvar_127 := lift_125_0(lift_27);
        {
          ...
          print "(section 13 ", -8887131, "\n", ")\n";
        }
      }
    }
  }
  print "(section 14 ", (lift_87 as int), "\n", ")\n";
  print 
    "(section 15 ",
    safeSeqRef(safeSeqTake(lift_133, lift_94), lift_107, lift_134)(
