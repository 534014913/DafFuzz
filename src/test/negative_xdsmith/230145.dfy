...
method lift_553_0 (arg_556 : int, arg_557 : int)
  returns (arg_558 : int)
  requires (((arg_557 == 77) && ((arg_556 == 1) && true)))
  ensures (((arg_558 == 70220683) && true))
{
  arg_558 := 70220683;
  {
...
method lift_419_1 (arg_423 : int, arg_424 : int, arg_425 : int)
  returns (arg_426 : int, arg_427 : int)
  requires (((arg_425 == -591992182) && ((arg_424 == -863025498) && ((arg_423 == -1980965025) && true))))
  ensures (((arg_427 == 47537885) && ((arg_426 == 615779537) && true)))
{
  arg_426 := 615779537;
  arg_427 := 47537885;
  {
    ...
    assert (0 == (-863025498 - arg_424));
    assert (((1 - 3355700400) - (-1118566799 + -1118566799)) == ((-1118566799 - 1) + (-1118566800 - -1118566799)));
    lift_428 := lift_446;
    lift_450 := lift_450;
    lift_455 := lift_456;
  }
...
method lift_419_2 (arg_423 : int, arg_424 : int, arg_425 : int)
  returns (arg_426 : int, arg_427 : int)
  requires (((arg_425 == 821390974) && ((arg_424 == 912581434) && ((arg_423 == -863025498) && true))))
  ensures (((arg_427 == 47537885) && ((arg_426 == 615779537) && true)))
{
  arg_426 := 615779537;
  arg_427 := 47537885;
  {
    ...
    assert (((-912581439 + arg_424) - (-912581437 + arg_424)) == ((912581433 - arg_424) + (912581433 - arg_424)));
    assert (((-1118566799 + -1118566799) + (-1118566800 - -1118566799)) < ((0 - 1118566799) + (-1118566800 - -1118566799)));
    lift_428 := lift_446;
    lift_450 := lift_450;
    lift_455 := lift_456;
  }
...
method lift_310_0 (arg_313 : int, arg_314 : int, arg_315 : int)
  returns (arg_316 : int)
  requires (((arg_315 == 888971391) && ((arg_314 == -229856684) && ((arg_313 == 912581434) && true))))
  ensures (((arg_316 == 246955236) && true))
{
  arg_316 := 246955236;
  {
...
method lift_310_1 (arg_313 : int, arg_314 : int, arg_315 : int)
  returns (arg_316 : int)
  requires (((arg_315 == -898991157) && ((arg_314 == -1216049183) && ((arg_313 == -1019696416) && true))))
  ensures (((arg_316 == 246955236) && true))
{
  arg_316 := 246955236;
  {
...
method lift_121_1 (arg_124 : int, arg_125 : int)
  returns (arg_126 : int)
  requires (((arg_125 == -1980965025) && ((arg_124 == 653841380) && true)))
  ensures (((arg_126 == -2093837169) && true))
{
  arg_126 := -2093837169;
  {
    var lift_127 := 535183062;
    assert (((535183061 - lift_127) == (535183061 - 535183062)) || ((535183060 - lift_127) == (535183061 - lift_127)));
  }
}
...
method lift_21_0 (arg_24 : int, arg_25 : int, arg_26 : int)
  returns (arg_27 : int)
  requires (((arg_26 == 1979530157) && ((arg_25 == 2) && ((arg_24 == 1979530157) && true))))
  ensures (((arg_27 == -1433020431) && true))
{
  arg_27 := -1433020431;
  {
    ...
    lift_28 := arg_27;
    assert (((arg_27 - 1433020432) == (-1433020431 + arg_27)) || ((arg_27 < arg_27) || (arg_27 == -1433020431)));
    lift_29 := lift_29;
    assert ((arg_25 - (-1 + arg_25)) == ((5 - arg_25) - arg_25));
    lift_33 := lift_33;
  }
}
...
method lift_1_0 ()
  ...
  requires (true)
  ensures (((arg_6 == 1979530157) && ((arg_5 == 632505382) && true)))
{
  arg_5 := 632505382;
  arg_6 := 1979530157;
  {
    ...
    assert (((1979530156 - arg_6) == (1979530156 - 1979530157)) || ((1979530156 - arg_6) == (1979530156 - 1979530157)));
    lift_13 := lift_13;
    lift_14 := lift_14;
  }
}
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0();
  {
    ...
    var methoddefvar_23 := lift_21_0(methoddefvar_4, lift_16, methoddefvar_4);
    {
      ...
      assert (((1979530156 - lift_19) == (1979530156 - 1979530157)) || ((1979530156 - lift_19) == (1979530156 - 1979530157)));
      assert (((-3865722452 - -1288574150) < -1288574150) || ((-3865722453 - -1288574150) == (-3865722452 - -1288574150)));
      lift_36 := lift_36;
      assert (((-860480010 < -860480010) && (-860480010 < -860480010)) || ((-860480010 < -860480009) && (-860480010 == -860480010)));
      lift_44 := lift_44;
    }
  }
  if ((safeSeqRef(
    ...
    {
      if (lift_170.0) {
        assert ((1473564064 + (lift_204 - -1473564061)) == 1473564063);
      } else {
        var lift_229 := false;
        {
    ...
    if ((lift_230.1 !! (lift_238 + lift_238))) {
      ...
      var methoddefvar_298 := lift_121_1(lift_196, lift_53);
      {
        ...
        lift_300 := lift_166;
        lift_301 := lift_301;
        assert (((lift_213 < lift_213) || (lift_213 < lift_213)) || ((912581435 == lift_213) || (lift_213 == 912581434)));
      }
      assert (((safeSeqRef(
        [lift_166, lift_244, lift_203, lift_166],
        lift_111,
        lift_41
      ) == safeSeqRef(
        [lift_166, lift_244, lift_203, lift_166],
      ...
      lift_302 := lift_303(lift_307);
      {
        ...
        {
          var lift_318 := ();
          assert (-898991157 == lift_139);
          lift_318 := lift_156;
          assert (((-912581439 + lift_212) - (-912581437 + lift_212)) == ((912581433 - lift_212) + (912581433 - lift_212)));
        }
        assert (((526143954 - lift_243) == (526143954 - 526143955)) || ((526143953 - lift_243) == (526143954 - lift_243)));
        assert ((lift_241 + (0 - lift_241)) == (lift_241 - (-966779454 - lift_241)));
        lift_319 := true;
        {
          var lift_321 := (lift_244, lift_240);
          lift_320 := lift_227;
          lift_321 := lift_322;
          assert (((lift_55 + lift_55) + (-821390975 - lift_55)) < ((lift_55 - 1642781948) + lift_55));
          assert ((1473564064 + (lift_204 - -1473564061)) == 1473564063);
          assert ((1473564064 + (lift_203 - -1473564061)) == 1473564063);
        }
      }
  ...
  if (((lift_250.1 - lift_257 - {lift_192, lift_206, lift_192}) in lift_332(
    ...
    if (lift_461.2.1) {
      ...
      if ((lift_46 == {lift_197, lift_264, -904928613, lift_213} >= {
        ...
        var lift_475 := true;
        if (lift_71) {
          assert (((1567380982 - 1567380985) < (1567380982 - 1567380985)) || ((1567380985 == 1567380985) && (1567380985 == 1567380985)));
          lift_474 := lift_43;
          lift_475 := lift_236;
          assert (((-1797982320 - lift_139) - (-898991160 - lift_139)) == (lift_139 + (-898991160 - -898991159)));
        } else {
          lift_476 := lift_480;
        }
        {
          ...
          lift_489 := lift_158;
          assert (((lift_41 < lift_41) && (lift_41 < lift_41)) || ((lift_41 - 2) < (-1216049183 - 1)));
          lift_490 := lift_509;
        }
        assert (((-4 - lift_57) - (-1 - lift_57)) < ((lift_57 - 888971392) + (-1 - 0)));
        lift_510 := [(), (), lift_482];
      }
      {
        assert (-898991157 == lift_138);
        lift_511 := lift_511;
        assert (((lift_138 + lift_138) + (-898991158 - lift_138)) < ((lift_138 - -1797982314) + lift_138));
        assert ((lift_265 + (-425130872 - lift_265)) == ((-637696307 - lift_265) - (212565437 + lift_265)));
      }
  ...
  );
  {
    ...
    );
    {
      ...
      lift_584 := 1193484250;
      assert (((lift_468 + lift_468) + (-2530685865 - lift_468)) < ((lift_468 - 1687123910) + lift_468));
    }
  }
}
