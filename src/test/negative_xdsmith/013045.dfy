  ...
  ensures (true)
{
  ...
  arg_122 := -1889298652;
  {
    ...
    {
      print "(section 7 ", arg_122, "\n", ")\n";
      print "(section 8 ", arg_122, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_77 := -1123632001;
  {
    ...
    print "(meth-for lift_71_0)\n";
    {
      ...
      lift_78 := lift_84;
      print "(section 4 ", 977243175, "\n", ")\n";
      print "(section 5 ", arg_75, "\n", ")\n";
    }
...
method Main () {
  ...
  );
  {
    ...
    var lift_65 := lift_66;
    print "(section 0 ", lift_65.0, "\n", ")\n";
    print "(section 1 ", lift_69.0, "\n", ")\n";
  }
  ...
  );
  {
    ...
    {
      lift_114 := lift_115;
      print "(section 2 ", lift_67, "\n", ")\n";
      print "(section 3 ", methoddefvar_73, "\n", ")\n";
    }
