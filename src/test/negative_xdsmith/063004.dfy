  ...
  ensures (true)
{
  ...
  arg_102 := 817046864;
  {
    ...
    print "(meth-for lift_95_0)\n";
    {
      ...
      print "(section 12 ", arg_101, "\n", ")\n";
      print "(section 13 ", arg_102, "\n", ")\n";
      lift_103 := lift_105;
      lift_112 := ();
      lift_113 := lift_113;
    }
  ...
  ensures (true)
{
  ...
  arg_102 := 817046864;
  {
    ...
    print "(meth-for lift_95_1)\n";
    {
      ...
      var lift_104 := (var tmpData : set<bool> := {}; tmpData);
      var lift_103 := multiset{lift_104, lift_104};
      print "(section 10 ", arg_101, "\n", ")\n";
      print "(section 11 ", arg_102, "\n", ")\n";
      lift_103 := lift_105;
      lift_112 := ();
      lift_113 := lift_113;
    }
    print "(rets-for lift_95_1 arg_101 ", arg_101, ")\n";
  ...
  ensures (true)
{
  arg_20 := 1101552906;
  {
    print "(params-for lift_14_0 arg_17 ", arg_17, ")\n";
    print "(params-for lift_14_0 arg_18 ", arg_18, ")\n";
    print "(params-for lift_14_0 arg_19 ", arg_19, ")\n";
    print "(meth-for lift_14_0)\n";
    {
      ...
      lift_21 := lift_22;
      print "(section 9 ", arg_19, "\n", ")\n";
      lift_27 := lift_27;
    }
    print "(rets-for lift_14_0 arg_20 ", arg_20, ")\n";
  }
}
...
method Main () {
  ...
  if (((lift_1 == lift_2 >= lift_3.0) !in (safeSeqRef(
    ...
    print "(section 0 ", |safeSeqDrop(lift_12, lift_5)|, "\n", ")\n";
