  ...
  ensures (true)
{
  arg_88 := -954123150;
  {
    ...
    {
      print "(section 15 ", arg_88, "\n", ")\n";
      print "(section 16 ", 893884662, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_15 := -1996306122;
  {
    print "(meth-for lift_12_0)\n";
    {
      ...
      lift_16 := lift_21;
      print "(section 11 ", -2113232835, "\n", ")\n";
      print "(section 12 ", lift_26, "\n", ")\n";
    }
    print "(rets-for lift_12_0 arg_15 ", arg_15, ")\n";
  }
}
  ...
  var lift_1 := true;
  {
    ...
    var lift_10 := -1625673151;
    {
      ...
      var lift_2 := ();
      {
        ...
        if (lift_1) {
          lift_2 := lift_2;
          print "(section 0 ", 121404775, "\n", ")\n";
          print "(section 1 ", lift_3, "\n", ")\n";
        } else {
          print "(section 2 ", lift_3, "\n", ")\n";
          print "(section 3 ", 1314616071, "\n", ")\n";
        }
      ...
      print "(section 7 ", safeSeqRef(lift_83, lift_51, lift_84), "\n", ")\n";
    }
    var methoddefvar_87 := lift_85_0();
    {
      print "(section 8 ", lift_56, "\n", ")\n";
    }
    print "(section 9 ", lift_89.2.2, "\n", ")\n";
  }
  lift_109 := safeSeqRef(
