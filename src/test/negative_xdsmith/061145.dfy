  ...
  ensures (true)
{
  ...
  arg_455 := 349689160;
  {
    ...
    print "(params-for lift_447_0 arg_453 ", arg_453, ")\n";
    ...
    print "(rets-for lift_447_0 arg_454 ", arg_454, ")\n";
    print "(rets-for lift_447_0 arg_455 ", arg_455, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_441 := 2038129876;
  {
    ...
    {
      print "(section 43 ", -1205033703, "\n", ")\n";
      print "(section 44 ", arg_440, "\n", ")\n";
    }
    print "(rets-for lift_435_0 arg_440 ", arg_440, ")\n";
  ...
  ensures (true)
{
  arg_290 := -380848613;
  {
    ...
    print "(params-for lift_284_0 arg_289 ", arg_289, ")\n";
    print "(meth-for lift_284_0)\n";
    {
      var lift_291 := arg_289;
      print "(section 37 ", arg_289, "\n", ")\n";
      print "(section 38 ", arg_288, "\n", ")\n";
      print "(section 39 ", arg_287, "\n", ")\n";
      print "(section 40 ", lift_291, "\n", ")\n";
    }
    print "(rets-for lift_284_0 arg_290 ", arg_290, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_81 := 103289733;
  {
    ...
    print "(rets-for lift_76_2 arg_80 ", arg_80, ")\n";
    print "(rets-for lift_76_2 arg_81 ", arg_81, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_81 := 103289733;
  {
    ...
    print "(rets-for lift_76_3 arg_80 ", arg_80, ")\n";
    print "(rets-for lift_76_3 arg_81 ", arg_81, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_74 := -1921927057;
  {
    ...
    {
      var lift_75 := ();
      print "(section 32 ", arg_71, "\n", ")\n";
      print "(section 33 ", arg_71, "\n", ")\n";
      lift_75 := ();
    }
...
method Main () {
  ...
  if (lift_27.1) {
    ...
    if (!((lift_179 !! (var tmpData : multiset<char> := multiset{}; tmpData) !! lift_179))) {
      ...
      print "(section 14 ", (lift_12[lift_132] as int), "\n", ")\n";
      lift_283 := |lift_236|;
    } else {
      print "(section 15 ", lift_122.0, "\n", ")\n";
    }
    {
      ...
      {
        lift_292 := lift_111;
        print "(section 16 ", 2023661013, "\n", ")\n";
        print "(section 17 ", -1487381288, "\n", ")\n";
        print "(section 18 ", lift_224, "\n", ")\n";
      }
  ...
  if ((lift_116 >= lift_360.2.2)) {
    ...
    if ((('F' in lift_400) && (-1182354476 !in lift_395))) {
      ...
      }
      {
        ...
        var methoddefvar_437, methoddefvar_438 := lift_435_0(lift_383);
        {
          ...
          print "(section 23 ", -2035145978, "\n", ")\n";
          lift_445 := lift_445;
          print "(section 24 ", lift_119, "\n", ")\n";
        }
      }
    }
  } else {
    ...
    );
    {
      ...
      {
        print "(section 25 ", -2100454414, "\n", ")\n";
        lift_472 := lift_472;
        print "(section 26 ", lift_313, "\n", ")\n";
        lift_475 := lift_475;
      ...
      {
        print "(section 28 ", 226364429, "\n", ")\n";
        lift_479 := lift_479;
        print "(section 29 ", lift_205, "\n", ")\n";
      }
      print "(section 30 ", lift_476, "\n", ")\n";
    }
  }
}
