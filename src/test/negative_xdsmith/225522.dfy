  ...
  ensures (((arg_4 == -863803812) && true))
{
  arg_4 := -863803812;
  {
    ...
    lift_5 := lift_5;
    lift_6 := lift_6;
    assert (1678089993 == ((3356179987 + -1) - 1678089993));
    lift_23 := lift_23;
    assert (lift_36 == 1157185860);
  }
}
  ...
  var methoddefvar_3 := lift_1_0();
  {
    ...
    var lift_49 := [lift_50, lift_54, lift_54];
    {
      ...
      if (lift_37) {
        ...
        assert (((-8263884133 + lift_40) - (-1652776827 + lift_40)) == ((-1652776827 - lift_40) + (-1652776827 - lift_40)));
      }
      if (lift_37) {
        var lift_47 := {lift_46};
        lift_41 := lift_42;
      ...
      lift_60 := lift_60;
      if (true) {
        assert ((2 - (-348832277 + 348832278)) == 1);
        assert ((145459759 + (145459759 + 145459759)) == ((-145459758 - 290919517) - (-145459759 - 145459759)));
      } else {
        assert false;
      }
    }
