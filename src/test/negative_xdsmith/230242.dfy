...
method Main () {
  ...
  var lift_2 := lift_3;
  {
    ...
    assert (((-6 + 0) == (-6 + |safeSeqDrop(
      lift_1,
      lift_16
    )|)) && ((|safeSeqDrop(lift_1, lift_16)| < |safeSeqDrop(
      lift_1,
      lift_16
    )|) || (|safeSeqDrop(lift_1, lift_16)| == |safeSeqDrop(lift_1, lift_16)|)));
    assert (((-4516792281 + 1505597426) - (-1505597427 + 1505597426)) == ((-1 - 1505597426) + (-1 - 1505597426)));
  }
}
