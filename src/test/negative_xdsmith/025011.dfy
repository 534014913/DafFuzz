  ...
  ensures (true)
{
  arg_390 := -162262159;
  {
    ...
    print "(meth-for lift_386_0)\n";
    {
      ...
      lift_391 := lift_392;
      print "(section 59 ", arg_390, "\n", ")\n";
      lift_395 := lift_393;
      print "(section 60 ", 1810209482, "\n", ")\n";
      print "(section 61 ", 1221686774, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_390 := -162262159;
  {
    print "(params-for lift_386_1 arg_389 ", arg_389, ")\n";
    print "(meth-for lift_386_1)\n";
    {
      var lift_395 := 'u';
      var lift_394 := 'd';
      var lift_393 := '|';
      ...
      var lift_391 := "<*KI-b:CjRmx_z!";
      lift_391 := lift_392;
      print "(section 56 ", arg_390, "\n", ")\n";
      lift_395 := lift_393;
      print "(section 57 ", 1810209482, "\n", ")\n";
      print "(section 58 ", 1221686774, "\n", ")\n";
    }
    print "(rets-for lift_386_1 arg_390 ", arg_390, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_361 := -1766618648;
  {
    ...
    print "(rets-for lift_354_0 arg_360 ", arg_360, ")\n";
  ...
  ensures (true)
{
  ...
  arg_361 := -1766618648;
  {
    print "(params-for lift_354_1 arg_358 ", arg_358, ")\n";
    print "(params-for lift_354_1 arg_359 ", arg_359, ")\n";
    ...
    print "(rets-for lift_354_1 arg_360 ", arg_360, ")\n";
    print "(rets-for lift_354_1 arg_361 ", arg_361, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_249 := 1355616318;
  {
    print "(meth-for lift_244_0)\n";
    {
      ...
      print "(section 55 ", arg_249, "\n", ")\n";
      lift_255 := lift_257;
    }
    print "(rets-for lift_244_0 arg_248 ", arg_248, ")\n";
  ...
  ensures (true)
{
  ...
  arg_249 := 1355616318;
  {
    print "(meth-for lift_244_1)\n";
    {
      ...
      var lift_250 := {lift_251};
      lift_250 := {lift_251, lift_252, lift_254};
      print "(section 54 ", arg_249, "\n", ")\n";
      lift_255 := lift_257;
    }
    print "(rets-for lift_244_1 arg_248 ", arg_248, ")\n";
    print "(rets-for lift_244_1 arg_249 ", arg_249, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_232 := 781184014;
  {
    print "(meth-for lift_227_0)\n";
    {
      ...
      lift_233 := lift_233;
      print "(section 51 ", arg_231, "\n", ")\n";
      print "(section 52 ", lift_240, "\n", ")\n";
      print "(section 53 ", arg_232, "\n", ")\n";
      lift_241 := lift_241;
    }
  ...
  ensures (true)
{
  ...
  arg_232 := 781184014;
  {
    print "(meth-for lift_227_1)\n";
    {
      ...
      var lift_233 := {lift_234, lift_235, {lift_238}, lift_234};
      lift_233 := lift_233;
      print "(section 48 ", arg_231, "\n", ")\n";
      print "(section 49 ", lift_240, "\n", ")\n";
      print "(section 50 ", arg_232, "\n", ")\n";
      lift_241 := lift_241;
    }
  ...
  ensures (true)
{
  ...
  arg_181 := 1942136690;
  {
    ...
    {
      print "(section 45 ", arg_180, "\n", ")\n";
      print "(section 46 ", -1421165538, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_181 := 1942136690;
  {
    ...
    print "(meth-for lift_175_1)\n";
    {
      ...
      print "(section 44 ", -1421165538, "\n", ")\n";
    }
    print "(rets-for lift_175_1 arg_180 ", arg_180, ")\n";
  ...
  ensures (true)
{
  ...
  arg_70 := -1396065495;
  {
    print "(params-for lift_62_3 arg_66 ", arg_66, ")\n";
    print "(params-for lift_62_3 arg_67 ", arg_67, ")\n";
    print "(params-for lift_62_3 arg_68 ", arg_68, ")\n";
    print "(meth-for lift_62_3)\n";
    {
      var lift_77 := '\'';
      var lift_76 := (lift_77, ());
      var lift_75 := ();
    ...
    print "(rets-for lift_62_3 arg_69 ", arg_69, ")\n";
    print "(rets-for lift_62_3 arg_70 ", arg_70, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_55 := -1888132609;
  {
    ...
    {
      var lift_56 := arg_52;
      print "(section 39 ", lift_56, "\n", ")\n";
      print "(section 40 ", arg_55, "\n", ")\n";
    }
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    lift_41 := lift_42.1.0;
    {
      ...
      if (((lift_41, lift_17) !in lift_80)) {
        ...
        {
          print "(section 4 ", lift_113, "\n", ")\n";
          lift_174 := lift_174;
        }
        {
          print "(section 5 ", lift_12, "\n", ")\n";
          print "(section 6 ", lift_154, "\n", ")\n";
        }
      } else {
        ...
        print "(section 8 ", lift_12, "\n", ")\n";
        {
          ...
          lift_182 := lift_182;
          print "(section 10 ", -484180190, "\n", ")\n";
          lift_183 := lift_6;
          print "(section 11 ", lift_114, "\n", ")\n";
        }
      }
      print "(section 12 ", lift_184(lift_44, lift_98, lift_190), "\n", ")\n";
  ...
  var methoddefvar_246, methoddefvar_247 := lift_244_0();
  {
    ...
    );
    {
      ...
      lift_269 := lift_291;
      print "(section 19 ", methoddefvar_267, "\n", ")\n";
    }
    print "(section 20 ", lift_184(lift_81, lift_98, lift_190), "\n", ")\n";
    if ((
      false,
      (
        '!',
      ...
      {
        lift_312 := lift_313;
        print "(section 21 ", lift_34, "\n", ")\n";
        lift_320 := false;
        print "(section 22 ", lift_37, "\n", ")\n";
        print "(section 23 ", lift_124, "\n", ")\n";
      }
    } else {
