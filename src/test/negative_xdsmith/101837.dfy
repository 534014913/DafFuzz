...
method lift_225_0 (arg_228 : int)
  returns (arg_229 : int)
  requires (((arg_228 == -1095101957) && true))
  ensures (((arg_229 == 2069981818) && true))
{
  arg_229 := 2069981818;
  {
    var lift_238 := 'l';
...
method lift_191_0 ()
  ...
  requires (true)
  ensures (((arg_196 == 1413046073) && ((arg_195 == -1703811888) && true)))
{
  arg_195 := -1703811888;
  arg_196 := 1413046073;
  {
    ...
    lift_197 := 460517606;
    assert (((-1703811889 - arg_195) - (arg_195 - -1703811886)) == 1);
...
method lift_185_0 (arg_188 : int, arg_189 : int)
  returns (arg_190 : int)
  requires (((arg_189 == 1) && ((arg_188 == 4) && true)))
  ensures (((arg_190 == 245618269) && true))
{
  arg_190 := 245618269;
  {
    assert (((arg_188 - 5) - (arg_188 - arg_188)) == -1);
  }
}

method lift_132_0 (arg_136 : int)
  returns (arg_137 : int, arg_138 : int)
  requires (((arg_136 == -1095101957) && true))
  ensures (((arg_138 == -1075509306) && ((arg_137 == 2048559058) && true)))
{
  arg_137 := 2048559058;
  arg_138 := -1075509306;
  {
    assert (((-1780638704 + 1780638702) == (1780638705 - 1780638702)) || ((1780638703 == 1780638702) || (1780638702 == 1780638702)));
  }
}

method lift_132_1 (arg_136 : int)
  returns (arg_137 : int, arg_138 : int)
  requires (((arg_136 == 636516664) && true))
  ensures (((arg_138 == -1075509306) && ((arg_137 == 2048559058) && true)))
{
  arg_137 := 2048559058;
  arg_138 := -1075509306;
  {
    assert (((1780638700 - 1780638702) == (1780638702 - 1780638704)) && ((1780638700 - 1780638702) < (1780638701 - 1780638702)));
  }
}

method lift_84_0 (arg_87 : int, arg_88 : int)
  returns (arg_89 : int)
  requires (((arg_88 == -1095101957) && ((arg_87 == 636516664) && true)))
  ensures (((arg_89 == -100074197) && true))
{
  arg_89 := -100074197;
  {
    var lift_119 := false;
    ...
    lift_90 := lift_91;
    lift_103 := lift_103;
    assert (((-636516665 + arg_87) + (-1 - arg_87)) < ((arg_87 - 636516665) + (-1 - 0)));
    lift_106 := ();
    lift_107 := lift_113;
  }
}
...
method lift_84_1 (arg_87 : int, arg_88 : int)
  returns (arg_89 : int)
  requires (((arg_88 == 122) && ((arg_87 == 1) && true)))
  ensures (((arg_89 == -100074197) && true))
{
  arg_89 := -100074197;
  {
    ...
    lift_90 := lift_91;
    lift_103 := lift_103;
    assert (((arg_87 == arg_87) || (arg_87 < arg_87)) && ((arg_87 == 2) || (1 == arg_87)));
    lift_106 := ();
    lift_107 := lift_113;
  }
}
...
method lift_84_2 (arg_87 : int, arg_88 : int)
  returns (arg_89 : int)
  requires (((arg_88 == 361623013) && ((arg_87 == 3) && true)))
  ensures (((arg_89 == -100074197) && true))
{
  arg_89 := -100074197;
  {
    ...
    lift_90 := lift_91;
    lift_103 := lift_103;
    assert (((arg_87 < arg_87) && (-1 == arg_87)) || ((-4 - 0) == (-1 - arg_87)));
    lift_106 := ();
    lift_107 := lift_113;
  }
}
...
method lift_16_1 (arg_19 : int, arg_20 : int, arg_21 : int)
  returns (arg_22 : int)
  requires (((arg_21 == -1661384568) && ((arg_20 == 1575137477) && ((arg_19 == -1805795408) && true))))
  ensures (((arg_22 == -1594453084) && true))
{
  arg_22 := -1594453084;
  {
    var lift_50 := (arg_19, arg_19, arg_19);
    ...
    var lift_24 := ();
    var lift_23 := multiset{lift_24, lift_24, lift_25};
    assert (((-6645538273 - arg_21) - (arg_21 + arg_21)) < arg_21);
    lift_23 := lift_23;
    lift_26 := lift_31;
    lift_34 := lift_44;
  }
...
method lift_16_2 (arg_19 : int, arg_20 : int, arg_21 : int)
  returns (arg_22 : int)
  requires (((arg_21 == -633133386) && ((arg_20 == -673963644) && ((arg_19 == 552006459) && true))))
  ensures (((arg_22 == -1594453084) && true))
{
  arg_22 := -1594453084;
  {
    ...
    var lift_24 := ();
    var lift_23 := multiset{lift_24, lift_24, lift_25};
    assert (((arg_21 < arg_21) && (arg_21 == arg_21)) || ((arg_21 == -633133386) || (arg_21 < arg_21)));
    lift_23 := lift_23;
    lift_26 := lift_31;
    lift_34 := lift_44;
  }
...
method Main () {
  ...
  var lift_1 := false;
  {
    ...
    if (((multiset{false, lift_1, lift_1, lift_2}[lift_2 := lengthNormalize(
      ...
      };
      {
        ...
        if (false) {
          ...
          assert (636516663 < lift_54);
          lift_58 := lift_58;
        }
        if (lift_1) {
          assert false;
        } else {
          assert ((lift_4 + (-1095101958 - lift_4)) == ((0 - 2190203915) + (0 - lift_4)));
        }
        lift_59 := lift_59;
        assert (((-636516669 + lift_53) - (-636516667 + lift_53)) == ((636516663 - lift_53) + (636516663 - lift_53)));
        lift_70 := lift_74;
      }
      var methoddefvar_86 := lift_84_0(lift_53, lift_3);
      {
        ...
        assert ((lift_3 + (-1095101958 - lift_3)) == ((0 - 2190203915) + (0 - lift_3)));
        lift_128 := lift_128;
        assert (((-1151154609 - lift_65) - (-2302309219 - lift_65)) == ((1 - lift_65) + 1));
        lift_130 := lift_130;
      }
    ...
    );
    {
      ...
      {
        assert ((lift_3 + (-1095101958 - lift_3)) == ((0 - 2190203915) + (0 - lift_3)));
        assert (((-1312993186 - 1312993185) == (-1312993186 + -1312993186)) || ((-1312993186 < -1312993186) || (-1312993186 == -1312993186)));
        lift_216 := lift_216;
        lift_224 := true;
        assert (((-245618270 + 491236541) - (-245618268 + methoddefvar_187)) == (methoddefvar_187 + (245618270 - methoddefvar_187)));
      }
  ...
  );
  {
    ...
    if ((lift_13 !! lift_13)) {
      ...
      var methoddefvar_351 := lift_16_1(lift_322, lift_291, -1661384568);
      {
        ...
        lift_353 := lift_354;
        assert (((-100074198 - methoddefvar_281) < (-100074198 - methoddefvar_281)) || ((methoddefvar_281 == methoddefvar_281) && (methoddefvar_281 < 100074197)));
        lift_357 := lift_141;
      }
      var methoddefvar_358 := lift_16_2(lift_323, lift_253, lift_175);
      {
        lift_359 := lift_362;
        assert (((-410238808 + lift_220) - (-205119405 + lift_220)) == ((205119401 - lift_220) + (0 - lift_220)));
      }
      if (lift_145) {
        var lift_374 := [lift_267, lift_267, lift_268, lift_375];
        var lift_373 := ();
        lift_373 := lift_63;
        assert (((0 - 3285305873) - (-1095101957 + lift_4)) == ((lift_4 - 1) + (-1095101958 - lift_4)));
        assert (((-575391043 - 575391045) + (575391044 + -575391043)) == ((-575391043 - 1) + (-1150782086 - -575391043)));
        lift_374 := lift_374;
      } else {
        assert false;
        assert false;
      }
      assert (((-1151154607 - 0) < (-1151154609 - lift_65)) || ((-1151154609 - lift_65) < (-1151154609 - lift_65)));
      assert (((lift_256 == 817781304) && (-1 < lift_256)) || (lift_256 < lift_256));
    }
  }
  assert (((lift_378.0.1.1 - 288897035) + (lift_378.0.1.1 - 288897035)) == ((lift_378.0.1.1 - 1444485175) - (-288897035 + lift_378.0.1.1)));
}
