  ...
  ensures (true)
{
  ...
  arg_188 := -46939350;
  {
    print "(meth-for lift_183_0)\n";
    {
      ...
      print "(section 24 ", arg_188, "\n", ")\n";
      lift_189 := lift_191;
      lift_199 := lift_199;
      lift_200 := lift_201;
    }
    print "(rets-for lift_183_0 arg_187 ", arg_187, ")\n";
...
method Main () {
  ...
  );
  {
    ...
    if ((lift_69 ==> lift_70)) {
      if (lift_67) {
        ...
        print "(section 4 ", lift_55, "\n", ")\n";
      } else {
        print "(section 5 ", lift_42, "\n", ")\n";
        print "(section 6 ", lift_45, "\n", ")\n";
        print "(section 7 ", lift_56, "\n", ")\n";
        print "(section 8 ", lift_65, "\n", ")\n";
      }
    } else {
      var lift_73 := false;
      lift_73 := lift_74;
    }
    print "(section 9 ", (lift_35 as int), "\n", ")\n";
    print "(section 10 ", safeSeqRef(lift_75, lift_44, lift_63), "\n", ")\n";
    var methoddefvar_78, methoddefvar_79 := lift_76_0(lift_44, methoddefvar_3);
    {
      print "(section 11 ", -187889269, "\n", ")\n";
      print "(section 12 ", methoddefvar_78, "\n", ")\n";
  ...
  var methoddefvar_113, methoddefvar_114 := lift_111_0(|{'u', lift_41}|);
  {
    ...
    print "(section 14 ", (lift_151[lift_36] as int), "\n", ")\n";
    lift_157 := (
      lift_157,
      (
        {
