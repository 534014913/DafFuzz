...
method lift_139_1 ()
  returns (arg_143 : int, arg_144 : int)
  requires (true)
  ensures (((arg_144 == 986104026) && ((arg_143 == -239973805) && true)))
{
  arg_143 := -239973805;
  arg_144 := 986104026;
  {
    ...
    var lift_146 := 'O';
    var lift_145 := (lift_146, (lift_147, lift_146, arg_144));
    assert (((arg_144 + arg_144) + (-986104027 - arg_144)) < ((arg_144 - 1972208052) + arg_144));
    lift_145 := lift_145;
    lift_148 := (var tmpData : seq<()> := []; tmpData);
    assert ((arg_144 < -1) || ((arg_144 < arg_144) || (arg_144 < 986104026)));
    assert (((-1338869292 - -1338869291) < (-1338869292 - -1338869291)) || ((-1338869291 - -1338869291) == (-1338869291 - -1338869291)));
  }
}
  ...
  ensures (((arg_81 == -306307283) && true))
{
  arg_81 := -306307283;
  {
    ...
    assert (((1 - arg_81) < arg_81) || ((arg_81 == arg_81) && (-306307283 == arg_81)));
    assert ((0 - (-1 - lift_82)) == 321234431);
    lift_83 := lift_83;
    lift_87 := lift_87;
  }
}
...
method lift_50_0 (arg_54 : int, arg_55 : int)
  ...
  requires (((arg_55 == -2074637566) && ((arg_54 == -2074637566) && true)))
  ensures (((arg_57 == 857398175) && ((arg_56 == 2117216764) && true)))
{
  arg_56 := 2117216764;
  arg_57 := 857398175;
  {
    assert (((arg_56 < arg_56) || (2117216764 == arg_56)) || ((arg_56 < arg_56) && (arg_56 < arg_56)));
  }
}

method lift_24_0 (arg_27 : int)
  returns (arg_28 : int)
  requires (((arg_27 == 434421338) && true))
  ensures (((arg_28 == 1742213942) && true))
{
  arg_28 := 1742213942;
  {
    var lift_36 := ();
...
method Main () {
  ...
  var methoddefvar_26 := lift_24_0(safeSeqRef(lift_37, -1607208532, lift_44).0);
  {
    ...
    var methoddefvar_52, methoddefvar_53 := lift_50_0(lift_42, lift_42);
    {
      ...
      assert (((-2172106698 + lift_46) - (-434421340 + lift_46)) == ((-434421341 - lift_46) + (-434421341 - lift_46)));
      lift_58 := lift_64;
      lift_72 := lift_72;
    }
    var methoddefvar_80 := lift_78_0();
    {
      assert (((-6223912700 - -2074637566) == (-6223912700 - lift_42)) || ((-6223912701 - lift_42) == (-6223912700 - lift_42)));
      lift_88 := lift_88;
    }
    if ((lift_72 in lift_89)) {
      ...
      var methoddefvar_150, methoddefvar_151 := lift_139_1();
      {
        ...
        lift_152 := lift_152;
        assert (((-385621166 + lift_47) - (-385621164 + lift_47)) == ((385621160 - lift_47) + (385621160 - lift_47)));
        lift_153 := lift_120;
        assert (((-385621166 + lift_49) - (-385621164 + lift_49)) == ((385621160 - lift_49) + (385621160 - lift_49)));
        lift_154 := lift_182;
      }
      assert (((-385621166 + lift_48) - (-385621164 + lift_48)) == ((385621160 - lift_48) + (385621160 - lift_48)));
      lift_183 := lift_183;
    }
  }
