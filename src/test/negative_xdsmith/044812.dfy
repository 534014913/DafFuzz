  ...
  ensures (true)
{
  arg_161 := 1836391411;
  {
    print "(meth-for lift_158_0)\n";
    {
      ...
      lift_162 := lift_184;
      print "(section 22 ", arg_161, "\n", ")\n";
      lift_185 := multiset{lift_186};
      lift_187 := lift_187;
    }
    print "(rets-for lift_158_0 arg_161 ", arg_161, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_161 := 1836391411;
  {
    print "(meth-for lift_158_1)\n";
    {
      ...
      var lift_162 := lift_163;
      lift_162 := lift_184;
      print "(section 21 ", arg_161, "\n", ")\n";
      lift_185 := multiset{lift_186};
      lift_187 := lift_187;
    }
    print "(rets-for lift_158_1 arg_161 ", arg_161, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_115 := -697340480;
  {
    print "(meth-for lift_110_0)\n";
    {
      ...
      print "(section 18 ", lift_136, "\n", ")\n";
      lift_142 := lift_142;
      print "(section 19 ", lift_136, "\n", ")\n";
    }
    print "(rets-for lift_110_0 arg_114 ", arg_114, ")\n";
...
method Main () {
  ...
  );
  {
    ...
    if ((lift_32 == lift_32 < lift_33)) {
      ...
      {
        print "(section 6 ", 1962068666, "\n", ")\n";
        lift_145 := lift_146;
        print "(section 7 ", lift_32, "\n", ")\n";
      }
      var methoddefvar_149 := lift_147_0(lift_34);
      {
        lift_152 := lift_152;
        print "(section 8 ", -917820472, "\n", ")\n";
      ...
      var methoddefvar_160 := lift_158_0();
      {
        ...
        lift_189 := 653681794;
        lift_190 := lift_190;
        print "(section 10 ", 1006063488, "\n", ")\n";
      }
      {
        print "(section 11 ", lift_23, "\n", ")\n";
        print "(section 12 ", -1045555063, "\n", ")\n";
      }
      lift_196 := lift_68;
  ...
  print 
    "(section 14 ",
    |(safeSeqRef(lift_223, lift_157, lift_231)[(
      lift_236,
      (true, [((), ()), (lift_225, ()), lift_239, lift_239, lift_239]),
      'E'
    ).0 := lengthNormalize(lift_85)])|,
    "\n",
    ")\n";
  var methoddefvar_241 := lift_158_1();
  {
    print "(section 15 ", lift_242.2, "\n", ")\n";
  }
}
