  ...
  ensures (true)
{
  ...
  arg_607 := -1130596777;
  {
    print "(params-for lift_600_0 arg_604 ", arg_604, ")\n";
    print "(params-for lift_600_0 arg_605 ", arg_605, ")\n";
    ...
    print "(rets-for lift_600_0 arg_606 ", arg_606, ")\n";
    print "(rets-for lift_600_0 arg_607 ", arg_607, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_579 := -677443260;
  {
    print "(params-for lift_571_0 arg_575 ", arg_575, ")\n";
    print "(params-for lift_571_0 arg_576 ", arg_576, ")\n";
    print "(params-for lift_571_0 arg_577 ", arg_577, ")\n";
    print "(meth-for lift_571_0)\n";
    {
      ...
      lift_580 := lift_580;
      lift_583 := lift_583;
      print "(section 121 ", arg_578, "\n", ")\n";
      print "(section 122 ", -2132675893, "\n", ")\n";
    }
    print "(rets-for lift_571_0 arg_578 ", arg_578, ")\n";
    print "(rets-for lift_571_0 arg_579 ", arg_579, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_542 := -1165028246;
  {
    print "(meth-for lift_539_0)\n";
    {
      ...
      print "(section 118 ", lift_543, "\n", ")\n";
      print "(section 119 ", lift_543, "\n", ")\n";
      print "(section 120 ", -1441361909, "\n", ")\n";
    }
    print "(rets-for lift_539_0 arg_542 ", arg_542, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_524 := 512457139;
  {
    print "(params-for lift_520_0 arg_523 ", arg_523, ")\n";
    print "(meth-for lift_520_0)\n";
    {
      ...
      print "(section 115 ", arg_523, "\n", ")\n";
      print "(section 116 ", arg_524, "\n", ")\n";
      lift_525 := lift_525;
      print "(section 117 ", arg_524, "\n", ")\n";
    }
    print "(rets-for lift_520_0 arg_524 ", arg_524, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_358 := -1260914747;
  {
    ...
    print "(meth-for lift_352_0)\n";
    {
      ...
      print "(section 112 ", lift_359, "\n", ")\n";
      print "(section 113 ", arg_355, "\n", ")\n";
      lift_360 := lift_361;
      print "(section 114 ", arg_356, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_358 := -1260914747;
  {
    print "(params-for lift_352_1 arg_355 ", arg_355, ")\n";
    ...
    print "(meth-for lift_352_1)\n";
    {
      ...
      var lift_360 := 'C';
      var lift_359 := arg_356;
      print "(section 107 ", arg_356, "\n", ")\n";
      print "(section 108 ", lift_359, "\n", ")\n";
      print "(section 109 ", arg_355, "\n", ")\n";
      lift_360 := lift_361;
  ...
  ensures (true)
{
  arg_358 := -1260914747;
  {
    print "(params-for lift_352_2 arg_355 ", arg_355, ")\n";
    print "(params-for lift_352_2 arg_356 ", arg_356, ")\n";
    print "(params-for lift_352_2 arg_357 ", arg_357, ")\n";
    print "(meth-for lift_352_2)\n";
    {
      ...
      print "(section 104 ", lift_359, "\n", ")\n";
      print "(section 105 ", arg_355, "\n", ")\n";
      lift_360 := lift_361;
      print "(section 106 ", arg_356, "\n", ")\n";
    }
    print "(rets-for lift_352_2 arg_358 ", arg_358, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_327 := 2131570439;
  {
    ...
    {
      print "(section 100 ", arg_326, "\n", ")\n";
      print "(section 101 ", arg_326, "\n", ")\n";
      print "(section 102 ", arg_327, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_294 := 1131355581;
  {
    ...
    print "(meth-for lift_288_0)\n";
    {
      ...
      print "(section 99 ", lift_295, "\n", ")\n";
    }
    print "(rets-for lift_288_0 arg_293 ", arg_293, ")\n";
    print "(rets-for lift_288_0 arg_294 ", arg_294, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_294 := 1131355581;
  {
    print "(params-for lift_288_1 arg_292 ", arg_292, ")\n";
    print "(meth-for lift_288_1)\n";
    {
      var lift_295 := -1856141932;
      print "(section 98 ", lift_295, "\n", ")\n";
    }
    print "(rets-for lift_288_1 arg_293 ", arg_293, ")\n";
    print "(rets-for lift_288_1 arg_294 ", arg_294, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_226 := -1432468955;
  {
    print "(meth-for lift_223_0)\n";
    {
      ...
      lift_236 := lift_235;
      print "(section 94 ", lift_237, "\n", ")\n";
      lift_238 := lift_241;
      print "(section 95 ", -1403602258, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_109 := 116279274;
  {
    print "(params-for lift_104_1 arg_107 ", arg_107, ")\n";
  ...
  ensures (true)
{
  arg_26 := -1998966317;
  {
    ...
    print "(meth-for lift_22_0)\n";
    {
      ...
      print "(section 87 ", arg_25, "\n", ")\n";
      print "(section 88 ", arg_25, "\n", ")\n";
      lift_27 := lift_27;
      print "(section 89 ", arg_26, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_20 := -2088729020;
  {
    print "(meth-for lift_15_1)\n";
    {
      var lift_21 := (var tmpData : seq<seq<char>> := []; tmpData);
      lift_21 := lift_21;
      print "(section 85 ", arg_20, "\n", ")\n";
    }
    print "(rets-for lift_15_1 arg_19 ", arg_19, ")\n";
    print "(rets-for lift_15_1 arg_20 ", arg_20, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_20 := -2088729020;
  {
    print "(meth-for lift_15_2)\n";
    {
      var lift_21 := (var tmpData : seq<seq<char>> := []; tmpData);
      lift_21 := lift_21;
      print "(section 84 ", arg_20, "\n", ")\n";
    }
    print "(rets-for lift_15_2 arg_19 ", arg_19, ")\n";
    print "(rets-for lift_15_2 arg_20 ", arg_20, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_12 := -1788652815;
  {
    ...
    {
      var lift_13 := false;
      print "(section 82 ", arg_11, "\n", ")\n";
      lift_13 := lift_13;
      print "(section 83 ", arg_12, "\n", ")\n";
    }
    print "(rets-for lift_5_0 arg_11 ", arg_11, ")\n";
    print "(rets-for lift_5_0 arg_12 ", arg_12, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_12 := -1788652815;
  {
    ...
    {
      var lift_13 := false;
      print "(section 80 ", arg_11, "\n", ")\n";
      lift_13 := lift_13;
      print "(section 81 ", arg_12, "\n", ")\n";
    }
    print "(rets-for lift_5_1 arg_11 ", arg_11, ")\n";
    print "(rets-for lift_5_1 arg_12 ", arg_12, ")\n";
  }
}
...
method Main () {
  ...
  var lift_2 := lift_3;
  {
    ...
    if (!(safeSeqRef(lift_1, lift_4, true))) {
      ...
      print 
        "(section 4 ",
        (multiset{true, lift_3, lift_3, lift_3, lift_2}[true] as int),
        "\n",
        ")\n";
      ...
      var methoddefvar_160, methoddefvar_161 := lift_15_2();
      {
        var lift_162 := 't';
        lift_162 := lift_68;
        print "(section 15 ", methoddefvar_161, "\n", ")\n";
        print "(section 16 ", lift_86, "\n", ")\n";
        lift_163 := lift_163;
        print "(section 17 ", methoddefvar_161, "\n", ")\n";
      }
    ...
    if (((multiset{
      ...
      print "(section 27 ", -146539946, "\n", ")\n";
      lift_207 := lift_206;
      print 
        "(section 28 ",
        lift_208(
          lift_215,
          {(false, -1086747129, 'G'), lift_216, lift_222, lift_216, lift_216},
          [true, lift_178, lift_3, lift_137]
        ),
        "\n",
        ")\n";
      ...
      var methoddefvar_244 := lift_242_0(lift_148, 220939046, 766256911);
      {
        ...
        print "(section 30 ", lift_148, "\n", ")\n";
        print "(section 31 ", -2108790434, "\n", ")\n";
        print "(section 32 ", -114018479, "\n", ")\n";
    ...
    }
    {
      ...
      if ((() !in lift_303)) {
        ...
        var methoddefvar_325 := lift_323_0(-1160268692);
        {
          ...
          lift_328 := lift_154;
          print "(section 38 ", -63357437, "\n", ")\n";
          print "(section 39 ", 992473264, "\n", ")\n";
          lift_329 := lift_195;
          lift_330 := lift_318;
        }
      }
  ...
  if ((lift_436.1.1 >= (lift_449.2 - (
    ...
    );
    {
      ...
      var methoddefvar_522 := lift_520_0(lift_422);
      {
        ...
        lift_534 := lift_139;
        lift_535 := lift_149;
        print "(section 48 ", lift_71, "\n", ")\n";
        lift_536 := lift_537;
        print "(section 49 ", lift_91, "\n", ")\n";
      }
      var methoddefvar_541 := lift_539_0();
      {
        print "(section 50 ", lift_71, "\n", ")\n";
        print "(section 51 ", lift_315, "\n", ")\n";
        print "(section 52 ", lift_148, "\n", ")\n";
        print "(section 53 ", lift_396, "\n", ")\n";
        print "(section 54 ", lift_442, "\n", ")\n";
      }
      if (lift_392) {
        var lift_545 := 1978128649;
        lift_545 := 33151350;
        print "(section 55 ", lift_284, "\n", ")\n";
        print "(section 56 ", lift_81, "\n", ")\n";
        print "(section 57 ", lift_445, "\n", ")\n";
      } else {
        print "(section 58 ", lift_80, "\n", ")\n";
        lift_546 := lift_550;
        lift_554 := lift_555;
      }
      lift_561 := lift_562;
    ...
    var methoddefvar_564, methoddefvar_565 := lift_47_1(|lift_305|);
    {
      ...
      if (false) {
        print "(section 59 ", lift_396, "\n", ")\n";
        lift_566 := lift_567;
        print "(section 60 ", lift_81, "\n", ")\n";
      } else {
        print "(section 61 ", lift_219, "\n", ")\n";
      }
      ...
      {
        lift_584 := lift_347;
        print "(section 62 ", lift_387, "\n", ")\n";
        lift_585 := lift_563;
        print "(section 63 ", -407649429, "\n", ")\n";
      }
      if (lift_137) {
        ...
        lift_586 := lift_173;
        print "(section 65 ", methoddefvar_564, "\n", ")\n";
        lift_587 := lift_164;
        print "(section 66 ", lift_164, "\n", ")\n";
        print "(section 67 ", lift_455, "\n", ")\n";
      }
      lift_588 := lift_588;
      print "(section 68 ", lift_315, "\n", ")\n";
    }
    if ((lift_505.0 !! multiset{
      ...
      {
        print "(section 69 ", lift_148, "\n", ")\n";
      }
      print "(section 70 ", 480617441, "\n", ")\n";
    } else {
      ...
      if ((lift_589 !! lift_446)) {
        ...
        var methoddefvar_671 := lift_352_1(lift_423, lift_423, lift_39);
        {
          ...
          print "(section 72 ", lift_39, "\n", ")\n";
          print "(section 73 ", -1032832779, "\n", ")\n";
          lift_672 := lift_596;
          lift_673 := lift_678;
        }
        var methoddefvar_679 := lift_352_2(lift_662, lift_85, lift_81);
        {
          ...
          print "(section 74 ", lift_84, "\n", ")\n";
          lift_688 := lift_688;
          lift_689 := lift_202;
        }
        {
          lift_690 := multiset{lift_419, lift_562, lift_419};
          print "(section 75 ", lift_84, "\n", ")\n";
          print "(section 76 ", lift_219, "\n", ")\n";
          print "(section 77 ", lift_402, "\n", ")\n";
        }
      }
    }
  } else {
