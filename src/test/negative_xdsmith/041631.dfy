  ...
  ensures (true)
{
  arg_186 := -1293869334;
  {
    print "(params-for lift_182_0 arg_185 ", arg_185, ")\n";
  ...
  ensures (true)
{
  arg_131 := -1407544511;
  {
    ...
    print "(meth-for lift_127_0)\n";
    {
      ...
      lift_132 := arg_131;
      print "(section 17 ", arg_131, "\n", ")\n";
    }
    print "(rets-for lift_127_0 arg_131 ", arg_131, ")\n";
  }
}
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0(|lift_15.2|);
  {
    ...
    if (safeSeqRef(lift_76, methoddefvar_3, true)) {
      ...
      {
        print "(section 9 ", 936148265, "\n", ")\n";
        print "(section 10 ", lift_62, "\n", ")\n";
        print "(section 11 ", lift_62, "\n", ")\n";
        lift_196 := {lift_197, lift_197};
        print "(section 12 ", lift_177, "\n", ")\n";
      }
      {
        var lift_206 := 'w';
        lift_205 := lift_205;
        lift_206 := lift_153;
        print "(section 13 ", lift_198, "\n", ")\n";
        lift_207 := lift_207;
      }
    }
  }
