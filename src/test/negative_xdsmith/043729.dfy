  ...
  ensures (true)
{
  arg_235 := 1242311766;
  {
    print "(meth-for lift_232_0)\n";
    {
      ...
      print "(section 31 ", arg_235, "\n", ")\n";
      lift_236 := arg_235;
      print "(section 32 ", 1466092188, "\n", ")\n";
      print "(section 33 ", lift_236, "\n", ")\n";
      lift_237 := lift_237;
    }
  ...
  ensures (true)
{
  arg_146 := 1330433219;
  {
    ...
    {
      print "(section 27 ", arg_144, "\n", ")\n";
      print "(section 28 ", 1433360416, "\n", ")\n";
    }
  ...
  var methoddefvar_76, methoddefvar_77 := lift_74_0(|lift_60|);
  {
    ...
    if (lift_24) {
      ...
      }
      {
        ...
        print "(section 5 ", -1902143035, "\n", ")\n";
        print "(section 6 ", lift_128, "\n", ")\n";
        print "(section 7 ", lift_109, "\n", ")\n";
      }
      if (lift_17) {
        print "(section 8 ", -1396310468, "\n", ")\n";
        print "(section 9 ", lift_72, "\n", ")\n";
      } else {
        print "(section 10 ", lift_29, "\n", ")\n";
        print "(section 11 ", 1397078675, "\n", ")\n";
        lift_134 := lift_32;
      }
    }
    if (("\"tn$iuy>A;~qZbqTPVb_$?am" in lift_135)) {
      ...
      print "(section 19 ", 1058775617, "\n", ")\n";
      lift_213 := false;
      if (lift_62) {
        print "(section 20 ", lift_191, "\n", ")\n";
        print "(section 21 ", lift_39, "\n", ")\n";
        print "(section 22 ", -1395499740, "\n", ")\n";
      } else {
        lift_215 := lift_217;
      }
    }
    var methoddefvar_234 := lift_232_0();
    {
      ...
      lift_242 := lift_242;
      print "(section 23 ", lift_192, "\n", ")\n";
      print "(section 24 ", 267643996, "\n", ")\n";
      lift_256 := lift_210;
    }
  }
}
