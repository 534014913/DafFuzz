  ...
  ensures (true)
{
  ...
  arg_126 := -511381532;
  {
    ...
    print "(meth-for lift_119_0)\n";
    {
      ...
      var lift_127 := false;
      lift_127 := false;
      print "(section 13 ", 292997757, "\n", ")\n";
      print "(section 14 ", 867083563, "\n", ")\n";
      lift_128 := lift_128;
    }
  ...
  ensures (true)
{
  ...
  arg_96 := -2104799220;
  {
    ...
    print "(rets-for lift_91_0 arg_95 ", arg_95, ")\n";
...
method Main () {
  ...
  var lift_1 := multiset{lift_2, true};
  {
    print 
      "(section 0 ",
      ((lift_1[lift_2 := lengthNormalize(lift_4)])[lift_2] as int),
      "\n",
      ")\n";
  }
