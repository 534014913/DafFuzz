  ...
  ensures (true)
{
  ...
  arg_466 := -374075363;
  {
    ...
    print "(params-for lift_458_0 arg_464 ", arg_464, ")\n";
    print "(meth-for lift_458_0)\n";
    {
      ...
      print "(section 76 ", arg_465, "\n", ")\n";
      lift_472 := lift_473;
    }
    print "(rets-for lift_458_0 arg_465 ", arg_465, ")\n";
    print "(rets-for lift_458_0 arg_466 ", arg_466, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_413 := -1365495532;
  {
    ...
    print "(meth-for lift_406_0)\n";
    {
      ...
      lift_414 := lift_414;
      lift_418 := lift_419;
      print "(section 73 ", arg_413, "\n", ")\n";
      print "(section 74 ", arg_413, "\n", ")\n";
      print "(section 75 ", arg_413, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_381 := 592546262;
  {
    print "(params-for lift_375_0 arg_378 ", arg_378, ")\n";
    ...
    print "(meth-for lift_375_0)\n";
    {
      ...
      lift_382 := lift_382;
      lift_383 := -517328116;
      print "(section 71 ", arg_379, "\n", ")\n";
      lift_384 := lift_384;
      print "(section 72 ", arg_378, "\n", ")\n";
    }
    print "(rets-for lift_375_0 arg_381 ", arg_381, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_381 := 592546262;
  {
    print "(params-for lift_375_1 arg_378 ", arg_378, ")\n";
    print "(params-for lift_375_1 arg_379 ", arg_379, ")\n";
    print "(params-for lift_375_1 arg_380 ", arg_380, ")\n";
    print "(meth-for lift_375_1)\n";
    {
      ...
      lift_382 := lift_382;
      lift_383 := -517328116;
      print "(section 69 ", arg_379, "\n", ")\n";
      lift_384 := lift_384;
      print "(section 70 ", arg_378, "\n", ")\n";
    }
    print "(rets-for lift_375_1 arg_381 ", arg_381, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_381 := 592546262;
  {
    print "(params-for lift_375_2 arg_378 ", arg_378, ")\n";
    print "(params-for lift_375_2 arg_379 ", arg_379, ")\n";
    print "(params-for lift_375_2 arg_380 ", arg_380, ")\n";
    print "(meth-for lift_375_2)\n";
    {
      var lift_385 := '^';
      var lift_384 := ['k', lift_385, lift_385, lift_385];
      var lift_383 := 963593691;
      ...
      lift_382 := lift_382;
      lift_383 := -517328116;
      print "(section 67 ", arg_379, "\n", ")\n";
      lift_384 := lift_384;
      print "(section 68 ", arg_378, "\n", ")\n";
    }
    print "(rets-for lift_375_2 arg_381 ", arg_381, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_370 := 214366210;
  {
    print "(params-for lift_363_0 arg_367 ", arg_367, ")\n";
    print "(params-for lift_363_0 arg_368 ", arg_368, ")\n";
    print "(meth-for lift_363_0)\n";
    {
      ...
      print "(section 66 ", arg_370, "\n", ")\n";
      lift_371 := {lift_372, (), (), (), lift_373};
    }
    print "(rets-for lift_363_0 arg_369 ", arg_369, ")\n";
    print "(rets-for lift_363_0 arg_370 ", arg_370, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_311 := -531352499;
  {
    ...
    print "(meth-for lift_305_0)\n";
    {
      ...
      print "(section 64 ", arg_310, "\n", ")\n";
      lift_312 := lift_312;
      print "(section 65 ", arg_310, "\n", ")\n";
      lift_352 := lift_356;
      lift_359 := lift_360;
    }
  ...
  ensures (true)
{
  arg_311 := -531352499;
  {
    ...
    print "(meth-for lift_305_1)\n";
    {
      ...
      var lift_312 := [lift_313, lift_313, lift_327, lift_313, lift_328];
      print "(section 62 ", arg_310, "\n", ")\n";
      lift_312 := lift_312;
      print "(section 63 ", arg_310, "\n", ")\n";
      lift_352 := lift_356;
      lift_359 := lift_360;
    }
  ...
  ensures (true)
{
  arg_232 := -542791338;
  {
    ...
    print "(meth-for lift_228_0)\n";
    {
      ...
      lift_233 := lift_247;
      print "(section 59 ", -1485696181, "\n", ")\n";
      lift_261 := lift_261;
      print "(section 60 ", -1680360196, "\n", ")\n";
  ...
  ensures (true)
{
  arg_232 := -542791338;
  {
    ...
    print "(meth-for lift_228_1)\n";
    {
      ...
      var lift_233 := multiset{lift_234};
      lift_233 := lift_247;
      print "(section 56 ", -1485696181, "\n", ")\n";
      lift_261 := lift_261;
      print "(section 57 ", -1680360196, "\n", ")\n";
      print "(section 58 ", arg_232, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_97 := 1022447662;
  {
    ...
    {
      print "(section 54 ", arg_96, "\n", ")\n";
    }
    print "(rets-for lift_92_1 arg_96 ", arg_96, ")\n";
    print "(rets-for lift_92_1 arg_97 ", arg_97, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_97 := 1022447662;
  {
    print "(meth-for lift_92_2)\n";
    {
      print "(section 53 ", arg_96, "\n", ")\n";
    }
    print "(rets-for lift_92_2 arg_96 ", arg_96, ")\n";
    print "(rets-for lift_92_2 arg_97 ", arg_97, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_69 := -2016459107;
  {
    ...
    print "(meth-for lift_64_0)\n";
    {
      ...
      lift_71 := lift_71;
      lift_72 := lift_84;
      print "(section 51 ", lift_83, "\n", ")\n";
      print "(section 52 ", arg_67, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_69 := -2016459107;
  {
    ...
    print "(meth-for lift_64_1)\n";
    {
      ...
      lift_71 := lift_71;
      lift_72 := lift_84;
      print "(section 49 ", lift_83, "\n", ")\n";
      print "(section 50 ", arg_67, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_69 := -2016459107;
  {
    print "(params-for lift_64_2 arg_67 ", arg_67, ")\n";
    print "(params-for lift_64_2 arg_68 ", arg_68, ")\n";
    print "(meth-for lift_64_2)\n";
    {
      var lift_85 := -815209441;
      var lift_84 := (
        (var tmpData : multiset<((bool, bool), (char, char, int), (int, int))> := multiset{}; tmpData),
      ...
      lift_71 := lift_71;
      lift_72 := lift_84;
      print "(section 47 ", lift_83, "\n", ")\n";
      print "(section 48 ", arg_67, "\n", ")\n";
    }
    print "(rets-for lift_64_2 arg_69 ", arg_69, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_36 := -928309557;
  {
    print "(meth-for lift_31_0)\n";
    {
      ...
      lift_37 := 385948186;
      lift_38 := lift_38;
      print "(section 45 ", arg_36, "\n", ")\n";
      print "(section 46 ", lift_37, "\n", ")\n";
      lift_46 := lift_51;
    }
  ...
  ensures (true)
{
  arg_27 := -770825437;
  {
    ...
    print "(rets-for lift_24_1 arg_27 ", arg_27, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_7 := 2078949297;
  {
    ...
    print "(meth-for lift_1_0)\n";
    {
      ...
      var lift_9 := false;
      var lift_8 := true;
      print "(section 43 ", -2071039883, "\n", ")\n";
      lift_8 := lift_8;
      print "(section 44 ", arg_7, "\n", ")\n";
      lift_9 := true;
      lift_10 := lift_10;
    }
  ...
  ensures (true)
{
  ...
  arg_7 := 2078949297;
  {
    ...
    print "(meth-for lift_1_1)\n";
    {
      ...
      var lift_9 := false;
      var lift_8 := true;
      print "(section 41 ", -2071039883, "\n", ")\n";
      lift_8 := lift_8;
      print "(section 42 ", arg_7, "\n", ")\n";
      lift_9 := true;
      lift_10 := lift_10;
    }
  ...
  }
  {
    ...
    var methoddefvar_26 := lift_24_0();
    {
      ...
      var methoddefvar_66 := lift_64_0(lift_86, lift_58);
      {
        ...
        lift_87 := lift_88;
        lift_89 := lift_90;
        print "(section 6 ", methoddefvar_26, "\n", ")\n";
        print "(section 7 ", lift_86, "\n", ")\n";
        print "(section 8 ", lift_86, "\n", ")\n";
      }
  ...
  );
  {
    ...
    if (({
      ...
      if (true) {
        ...
        print "(section 13 ", methoddefvar_124, "\n", ")\n";
        lift_193 := lift_193;
        lift_206 := lift_209;
      ...
      {
        lift_216 := [lift_179];
        print "(section 14 ", lift_105, "\n", ")\n";
        lift_217 := lift_217;
      }
      var methoddefvar_230 := lift_228_0(lift_115);
      {
        var lift_288 := -1988449054;
        print "(section 15 ", lift_181, "\n", ")\n";
        lift_267 := lift_281;
        lift_287 := lift_163;
        lift_288 := lift_283;
      }
      print "(section 16 ", lift_163, "\n", ")\n";
    }
  }
  {
    ...
    if ((
      ...
      if ((lift_279 || lift_122)) {
        ...
        if (lift_279) {
          print "(section 21 ", lift_286, "\n", ")\n";
          print "(section 22 ", lift_164, "\n", ")\n";
        } else {
          print "(section 23 ", lift_23, "\n", ")\n";
        }
      ...
      var methoddefvar_377 := lift_375_0(lift_128, -619678016, lift_116);
      {
        lift_386 := lift_163;
        lift_387 := lift_295;
        print "(section 25 ", lift_131, "\n", ")\n";
      }
      var methoddefvar_389 := lift_64_2(lift_131, lift_58);
      {
        print "(section 26 ", lift_224, "\n", ")\n";
        lift_390 := lift_391;
        lift_392 := lift_392;
      }
    } else {
      ...
      print 
        "(section 28 ",
        safeSeqRef(lift_130, lift_224, -186229737),
        "\n",
        ")\n";
      lift_433 := lift_435.1;
      var methoddefvar_440 := lift_305_1(lift_434, lift_105, 270580832);
      {
        ...
        lift_442 := lift_442;
        lift_443 := lift_443;
        print "(section 29 ", lift_386, "\n", ")\n";
        print "(section 30 ", 2029843449, "\n", ")\n";
      }
    }
    if (!(("&bin%kLpPXsg;&OlZJc^o@" !in lift_444))) {
      print "(section 31 ", |lift_137|, "\n", ")\n";
    } else {
      ...
      var methoddefvar_448 := lift_24_1();
      {
        ...
        print "(section 32 ", lift_108, "\n", ")\n";
        lift_449 := false;
        print "(section 33 ", lift_286, "\n", ")\n";
        lift_450 := lift_451;
        lift_453 := lift_455;
      }
    ...
    if (((lift_138 !! lift_143) && (lift_180 == lift_400))) {
      ...
      if ((1389101750 in lift_295)) {
        print "(section 36 ", lift_128, "\n", ")\n";
      } else {
        var lift_499 := (lift_491, lift_431, lift_106);
        print "(section 37 ", lift_224, "\n", ")\n";
        lift_489 := lift_499;
      }
      lift_500 := (false, ()).1;
    } else {
      ...
      var lift_514 := lift_515;
      {
        ...
        print "(section 38 ", lift_220, "\n", ")\n";
        var methoddefvar_508 := lift_228_1(lift_274);
        {
          lift_509 := lift_439;
        }
        print "(section 39 ", lift_182, "\n", ")\n";
