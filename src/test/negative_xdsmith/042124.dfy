...
method Main () {
  ...
  assert (((-9 - |(safeSeqRef(lift_1, lift_12, lift_2) + (
    lift_3,
    1441417790,
    {((lift_18, lift_26, lift_26), ('_', -963269101), lift_8), lift_28, lift_28}
  ).0 + lift_2)|) - (-2 - |(safeSeqRef(lift_1, lift_12, lift_2) + (
    lift_3,
    1441417790,
    {((lift_18, lift_26, lift_26), ('_', -963269101), lift_8), lift_28, lift_28}
  ).0 + lift_2)|)) == ((|(safeSeqRef(lift_1, lift_12, lift_2) + (
    lift_3,
    1441417790,
    {((lift_18, lift_26, lift_26), ('_', -963269101), lift_8), lift_28, lift_28}
  ).0 + lift_2)| - 7) - (-2 - |(safeSeqRef(lift_1, lift_12, lift_2) + (
    lift_3,
    1441417790,
    {((lift_18, lift_26, lift_26), ('_', -963269101), lift_8), lift_28, lift_28}
  ).0 + lift_2)|)));
