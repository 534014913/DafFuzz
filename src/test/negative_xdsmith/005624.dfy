...
method lift_633_0 (arg_636 : int, arg_637 : int, arg_638 : int)
  returns (arg_639 : int)
  requires (((arg_638 == 1650708043) && ((arg_637 == 1007996073) && ((arg_636 == -1894382973) && true))))
  ensures (((arg_639 == -132925316) && true))
{
  arg_639 := -132925316;
  {
    var lift_643 := false;
...
method lift_588_0 ()
  ...
  requires (true)
  ensures (((arg_593 == 877896653) && ((arg_592 == 882196399) && true)))
{
  arg_592 := 882196399;
  arg_593 := 877896653;
  {
    ...
    lift_594 := lift_594;
    lift_595 := lift_595;
    assert (((-2 - arg_593) < (-1 - 877896653)) || (877896653 == arg_593));
  }
}
...
method lift_538_0 ()
  ...
  requires (true)
  ensures (((arg_543 == 1665936285) && ((arg_542 == 1738456702) && true)))
{
  arg_542 := 1738456702;
  arg_543 := 1665936285;
  {
    ...
    var lift_544 := 'd';
    assert (((-1546000408 + -1546000408) + -1546000408) < ((-1546000406 - 1546000406) + -1546000408));
    lift_544 := lift_545;
  }
}
  ...
  ensures (((arg_543 == 1665936285) && ((arg_542 == 1738456702) && true)))
{
  ...
  arg_543 := 1665936285;
  {
    ...
    var lift_545 := lift_546;
    var lift_544 := 'd';
    assert ((-1546000408 == (-3092000815 - -1546000408)) || (-1546000408 == (-3092000816 - -1546000408)));
    lift_544 := lift_545;
  }
}
...
method lift_396_1 (arg_400 : int)
  returns (arg_401 : int, arg_402 : int)
  requires (((arg_400 == 638062931) && true))
  ensures (((arg_402 == -29393279) && ((arg_401 == 433413859) && true)))
{
  arg_401 := 433413859;
  arg_402 := -29393279;
  {
    ...
    lift_423 := lift_427;
    lift_434 := lift_439;
    assert (-1581802490 == -1581802490);
    assert ((1471687876 < (1471687877 - 0)) || ((1471687874 - 1471687875) == (1471687874 - 1471687876)));
  }
}

method lift_396_2 (arg_400 : int)
  returns (arg_401 : int, arg_402 : int)
  requires (((arg_400 == 1904725466) && true))
  ensures (((arg_402 == -29393279) && ((arg_401 == 433413859) && true)))
{
  arg_401 := 433413859;
  arg_402 := -29393279;
  {
    ...
    lift_423 := lift_427;
    lift_434 := lift_439;
    assert (((-1581802490 == -1581802490) || (-1581802490 < -1581802490)) && ((-1581802490 + -1581802490) == (-4745407470 - -1581802490)));
    assert (((1471687876 + 1471687876) + (-1471687877 - 1471687876)) < ((1471687876 - 2943375752) + 1471687876));
  }
}
...
method lift_344_1 ()
  returns (arg_347 : int)
  requires (true)
  ensures (((arg_347 == -1390662657) && true))
{
  arg_347 := -1390662657;
  {
    var lift_349 := -351152904;
    var lift_348 := 838662552;
    assert (((838662551 - lift_348) < (838662551 - lift_348)) || ((838662551 - 838662552) == (838662551 - lift_348)));
    assert (((838662551 - lift_348) < (838662551 - lift_348)) || ((838662551 - 838662552) == (838662551 - lift_348)));
    assert (2 == ((1 + -1390662656) - arg_347));
    assert (((lift_349 < -351152903) && (-351152904 == lift_349)) || ((lift_349 < lift_349) || (-351152906 < lift_349)));
  }
}
  ...
  ensures (false)
{
  ...
  arg_265 := 294658034;
  {
    ...
    var lift_278 := true;
    var lift_277 := multiset{lift_278, lift_279, lift_279, lift_281, lift_280};
    var lift_276 := 'A';
...
method lift_77_2 (arg_81 : int, arg_82 : int)
  returns (arg_83 : int, arg_84 : int)
  requires (((arg_82 == 1936226612) && ((arg_81 == 728323583) && true)))
  ensures (((arg_84 == -1755010333) && ((arg_83 == 1185557019) && true)))
{
  arg_83 := 1185557019;
  arg_84 := -1755010333;
  {
    ...
    var lift_86 := lift_87;
    var lift_85 := lift_86;
    assert (((-1936226612 - arg_82) < -1) || ((arg_82 < arg_82) || (arg_82 < arg_82)));
    lift_85 := lift_86;
    assert (((arg_84 == arg_84) || (arg_84 < arg_84)) && ((arg_84 + arg_84) == (-5265030999 - -1755010333)));
    assert (((arg_82 - 5808679838) - (-1936226613 + arg_82)) == ((0 - 1936226612) + (-1 - arg_82)));
  }
}
...
method lift_58_1 (arg_61 : int, arg_62 : int)
  returns (arg_63 : int)
  requires (((arg_62 == -524439904) && ((arg_61 == 1384652136) && true)))
  ensures (((arg_63 == -2145060020) && true))
{
  arg_63 := -2145060020;
  {
    var lift_67 := (var tmpData : set<()> := {}; tmpData);
    ...
    var lift_64 := false;
    lift_64 := lift_64;
    assert (-2769304274 == ((-1 - lift_65) + (-1 - lift_65)));
    assert (((930993903 + 930993903) + (-930993905 - 930993903)) < ((930993903 + 930993903) - (2792981710 - 930993903)));
    lift_66 := lift_66;
    assert (((225959917 + -225959917) + -451919834) < ((225959917 - 451919834) + 225959917));
  }
}
...
method Main () {
  ...
  if ((!((lift_1 < lift_2)) <==> (lift_6.1 > |lift_1|) <==> (lift_5 > (lift_3[lift_9] as int)))) {
    ...
    if ((lift_465.2 == lift_467)) {
      ...
      assert (((-10311349523 + lift_38.1) - (-2062269905 + lift_38.1)) == ((-2062269906 - lift_38.1) + (-2062269906 - lift_38.1)));
      if (lift_226) {
        var lift_481 := ();
        {
        ...
        lift_522 := lift_157;
        {
          ...
          lift_523 := lift_369;
          lift_524 := lift_145;
          assert (((lift_316 == lift_316) && (lift_316 < 1650708043)) && ((-1 - lift_316) == (-1 - lift_316)));
          assert ((lift_9 < (3649292183 - lift_9)) || ((lift_9 == 1824646094) || (lift_9 < 1824646092)));
        }
        lift_525 := lift_526;
        {
          assert (((lift_448 + 1923825721) < 1) || (lift_448 < lift_448));
          assert (((-2 - lift_192) + 1) == ((0 - 1384652135) + (-2 - 0)));
        }
        var methoddefvar_532 := lift_344_1();
        {
          assert (((1486770733 - 1486770735) < (1486770734 - lift_521)) || ((1486770733 - lift_521) == (1486770734 - lift_521)));
          assert (((-4962129259 - lift_46) < lift_46) && ((lift_46 == lift_46) || (lift_46 == lift_46)));
          lift_533 := lift_474;
      ...
      }
      {
        ...
        assert (((-612274845 - lift_122) == (-612274845 - -612274844)) || ((-612274845 - lift_122) == (-612274845 - -612274844)));
      }
      ...
      var methoddefvar_549, methoddefvar_550 := lift_396_1(638062931);
      {
        ...
        lift_570 := lift_50;
        lift_571 := lift_571;
        assert (-2769304274 == ((-1 - lift_191) + (-1 - lift_191)));
        lift_581 := lift_23;
      }
    } else {
      var lift_587 := true;
    ...
    var methoddefvar_590, methoddefvar_591 := lift_588_0();
    {
      ...
      if (lift_158) {
        ...
        lift_611 := lift_611;
        assert ((-3750974188 - (-1875487097 + 1875487099)) == ((-1875487094 - 1875487098) + (1875487098 + -1875487096)));
        lift_612 := lift_612;
      }
      assert (((lift_5 + lift_5) + (-982191322 - lift_5)) < ((lift_5 - -982191322) + lift_5));
    }
    var methoddefvar_613, methoddefvar_614 := lift_538_1();
    {
      ...
      {
        assert (((lift_557 + lift_557) < lift_557) || ((-460293218 - lift_557) == (-460293217 - lift_557)));
        lift_644 := lift_225;
        assert (((-524439907 - lift_201) - (-524439905 - lift_201)) == ((-524439905 - lift_201) + (-524439905 - lift_201)));
      }
      lift_645 := lift_652;
    }
    if (((lift_630, (), ()).0 < lift_561)) {
      ...
      {
        assert (((lift_623 == -1005644481) || (lift_623 < lift_623)) || ((-1005644482 < lift_623) && (lift_623 == lift_623)));
        lift_707 := lift_160;
        lift_708 := lift_301;
        assert (-2769304274 == ((-1 - lift_192) + (-1 - lift_192)));
      }
      {
        ...
        var methoddefvar_709, methoddefvar_710 := lift_588_1();
        {
          ...
          lift_712 := lift_712;
          lift_715 := lift_715;
          assert (((1607275622 + -1607275622) == 0) || ((-1607275622 == -1607275622) && (-1607275622 < -1607275622)));
        }
      }
