...
method lift_269_0 ()
  returns (arg_272 : int)
  requires (true)
  ensures (((arg_272 == -1515059394) && true))
{
  arg_272 := -1515059394;
  {
    var lift_281 := false;
    ...
    assert (0 == (-1515059394 - arg_272));
    assert (((arg_272 == arg_272) || (arg_272 < arg_272)) && ((-1515059394 == arg_272) && (arg_272 == arg_272)));
    lift_273 := lift_274;
    assert (((arg_272 < arg_272) && (arg_272 == arg_272)) || ((arg_272 < 0) || (0 == arg_272)));
    lift_279 := lift_278;
  }
}
...
method lift_226_0 (arg_230 : int, arg_231 : int, arg_232 : int)
  ...
  requires (((arg_232 == 0) && ((arg_231 == 1137654867) && ((arg_230 == 2) && true))))
  ensures (((arg_234 == -520251402) && ((arg_233 == 1258768583) && true)))
{
  arg_233 := 1258768583;
  arg_234 := -520251402;
  {
    ...
    assert (((arg_233 < arg_233) && (1258768584 == arg_233)) || ((1258768582 - 1258768583) == (1258768582 - arg_233)));
    assert (((1243988249 == 1243988249) || (1243988249 < 1243988249)) && ((-1243988250 - 1243988249) == (-3731964748 + 1243988249)));
...
method lift_106_0 (arg_109 : int, arg_110 : int, arg_111 : int)
  returns (arg_112 : int)
  requires (((arg_111 == -268198020) && ((arg_110 == -2126801690) && ((arg_109 == 1240368136) && true))))
  ensures (((arg_112 == -1973942083) && true))
{
  arg_112 := -1973942083;
  {
    var lift_140 := ();
...
method lift_106_1 (arg_109 : int, arg_110 : int, arg_111 : int)
  returns (arg_112 : int)
  requires (((arg_111 == -1831526068) && ((arg_110 == -757281571) && ((arg_109 == 1897894335) && true))))
  ensures (((arg_112 == -1973942083) && true))
{
  arg_112 := -1973942083;
  {
...
method lift_95_0 ()
  ...
  requires (true)
  ensures (((arg_100 == -1240034049) && ((arg_99 == -861159728) && true)))
{
  arg_99 := -861159728;
  arg_100 := -1240034049;
  {
...
method lift_44_0 (arg_47 : int, arg_48 : int, arg_49 : int)
  returns (arg_50 : int)
  requires (((arg_49 == 1443064572) && ((arg_48 == 780668279) && ((arg_47 == -1348625434) && true))))
  ensures (((arg_50 == 1897142073) && true))
{
  arg_50 := 1897142073;
  {
    var lift_51 := -1345849179;
    lift_51 := arg_50;
    assert (((-1311930495 - -1311930493) == (-1311930494 - -1311930493)) || ((-1311930494 - -1311930493) == (-1311930494 - -1311930493)));
    assert (((-1348625437 == arg_47) || (arg_47 < arg_47)) || ((arg_47 == arg_47) && (-1348625434 == arg_47)));
    assert (((-1897142074 - arg_50) + (1897142072 - arg_50)) == ((1897142072 - 1897142073) - (1897142074 + arg_50)));
    assert (2 == ((1 + -1348625433) - arg_47));
  }
}
...
method lift_1_0 (arg_4 : int)
  returns (arg_5 : int)
  requires (((arg_4 == 780668279) && true))
  ensures (((arg_5 == -1125695343) && true))
{
  arg_5 := -1125695343;
  {
    var lift_27 := true;
    ...
    lift_6 := lift_6;
    assert (((352271027 < lift_9) && (lift_9 == lift_9)) && ((352271026 - 352271028) < (352271027 - lift_9)));
    lift_10 := lift_10;
    lift_17 := lift_15;
    lift_19 := lift_19;
  }
...
method lift_1_1 (arg_4 : int)
  returns (arg_5 : int)
  requires (((arg_4 == -1672547917) && true))
  ensures (((arg_5 == -1125695343) && true))
{
  arg_5 := -1125695343;
  {
    ...
    var lift_6 := {lift_7, lift_7, lift_7, lift_8};
    lift_6 := lift_6;
    assert ((lift_9 + (lift_9 - lift_9)) < (lift_9 + lift_9));
    lift_10 := lift_10;
    lift_17 := lift_15;
    lift_19 := lift_19;
  }
...
method Main () {
  ...
  var methoddefvar_3 := lift_1_0(lift_28.1.2);
  {
    ...
    if ((lift_33 !! lift_34 !! lift_34)) {
      ...
      if (lift_29) {
        ...
        assert (((lift_32 == -780668278) || (lift_32 < -780668279)) || ((-780668280 - 780668279) == (-780668280 - lift_32)));
      }
    }
    {
      var methoddefvar_97, methoddefvar_98 := lift_95_0();
      {
        assert (((1240368133 - lift_89) < (1240368133 - lift_89)) || ((1240368136 == lift_89) && (1240368136 == lift_89)));
      }
      if (lift_92) {
        var lift_102 := lift_103;
        assert (((-735206724 == -735206724) && (-735206724 < -735206724)) || ((-735206727 - -735206724) == (-735206724 - -735206721)));
        lift_102 := lift_103;
        assert (((-1492916686 < -1492916686) || (-1492916686 < -1492916686)) || ((-1492916686 < 1492916688) || (-1492916686 == 1492916689)));
      } else {
        assert false;
      }
      assert (((-2 - 450572451) < (-450572450 + 450572451)) || ((-3 - 450572451) == (-2 - 450572451)));
      assert (methoddefvar_3 == ((methoddefvar_3 - 1125695342) + (-1 - methoddefvar_3)));
      var methoddefvar_108 := lift_106_0(lift_89, -2126801690, lift_59);
      {
        assert ((-160066579 < lift_104) || (lift_104 == -160066581));
      }
    }
    lift_141 := safeSeqRef(lift_142, lift_88, lift_77);
    {
      ...
      {
        lift_144 := lift_83;
        assert (((-3 - 908968836) < (-2 - 908968836)) && ((908968836 < 908968836) || (-1 < 908968836)));
        assert (((-1681470770 - lift_54) == (-1681470770 - -1681470769)) || ((lift_54 < lift_54) || (lift_54 < lift_54)));
        assert (((lift_60 == lift_60) || (lift_60 < lift_60)) && ((lift_60 + lift_60) == (-804594060 - -268198020)));
        lift_145 := (lift_29, lift_34, lift_170);
      }
      assert (472485119 < 472485120);
    }
  }
  ...
  {
    assert (((123 - ('|' as int)) == (123 - 124)) || ((('|' as int) < ('|' as int)) && (('|' as int) < ('|' as int))));
  }
  ...
  );
  {
    ...
    if ((lift_215 <= lift_77)) {
      {
        assert (((-1258768584 - 1) - (-1 - methoddefvar_228)) < ((-1258768585 + 1258768583) - (-1 - 0)));
      }
    } else {
