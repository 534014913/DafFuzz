...
method lift_54_0 (arg_58 : int, arg_59 : int)
  ...
  requires (((arg_59 == 829077645) && ((arg_58 == -786196295) && true)))
  ensures (((arg_61 == 1130080638) && ((arg_60 == -1454224179) && true)))
{
  arg_60 := -1454224179;
  arg_61 := 1130080638;
  {
...
method lift_20_0 (arg_23 : int, arg_24 : int)
  returns (arg_25 : int)
  requires (((arg_24 == -1117005619) && ((arg_23 == 1343209544) && true)))
  ensures (((arg_25 == -1626350071) && true))
{
  arg_25 := -1626350071;
  {
    assert (((-1626350075 - arg_25) == (-1626350074 - arg_25)) || ((-1626350074 - -1626350071) == (-1626350074 - arg_25)));
  }
}

method lift_1_0 (arg_4 : int)
  returns (arg_5 : int)
  requires (((arg_4 == -786196295) && true))
  ensures (((arg_5 == 1343209544) && true))
{
  arg_5 := 1343209544;
  {
    assert (((517339630 + 517339630) + (-517339631 - 517339630)) < ((517339630 - 1034679260) + 517339630));
    assert ((arg_4 + (-3144785184 - arg_4)) == ((-2358588887 - arg_4) + (-2358588887 - arg_4)));
    assert (arg_5 == ((0 - 1343209545) - (0 - 2686419089)));
  }
}
...
method Main () {
  ...
  var methoddefvar_3 := lift_1_0(lift_6);
  {
    ...
    var lift_26 := -1117005619;
    {
      ...
      if (lift_7) {
        assert (((85685694 - 85685698) - (-85685699 + 85685694)) < (-1 - (85685694 - 85685697)));
        assert ((lift_6 + (-3144785184 - lift_6)) == ((-2358588887 - lift_6) + (-2358588887 - lift_6)));
        assert (((1343209542 - methoddefvar_3) == (1343209544 - 1343209546)) && ((methoddefvar_3 == methoddefvar_3) || (methoddefvar_3 == methoddefvar_3)));
        lift_8 := lift_10;
      ...
      var methoddefvar_22 := lift_20_0(lift_11, lift_26);
      {
        ...
        lift_28 := lift_29;
        lift_31 := lift_33;
        assert (((lift_26 < lift_26) && (lift_26 == lift_26)) || ((lift_26 < -1117005618) && (lift_26 == lift_26)));
      }
      if (lift_18) {
        var lift_36 := lift_11;
        lift_36 := lift_37;
        assert (((-833763245 - lift_37) == (-833763245 - -277921081)) || ((-833763246 - lift_37) == (-833763245 - lift_37)));
        lift_38 := lift_34;
        lift_39 := ();
      } else {
        assert false;
    ...
    }
    {
      ...
      lift_41 := true;
      {
        ...
        lift_47 := lift_37;
        lift_48 := lift_48;
        assert (((-2028701332 + lift_53) == (-676233780 - lift_53)) || ((676233777 + 676233777) == (lift_53 - 676233777)));
      }
    }
    var methoddefvar_56, methoddefvar_57 := lift_54_0(lift_6, 829077645);
    {
      assert (((-2358588892 - lift_6) - (-786196298 - lift_6)) == (lift_6 + lift_6));
      lift_93 := lift_30;
    }
  }
}
