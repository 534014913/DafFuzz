...
method lift_121_0 (arg_124 : int)
  returns (arg_125 : int)
  requires (((arg_124 == -424582258) && true))
  ensures (((arg_125 == 1292651810) && true))
{
  arg_125 := 1292651810;
  {
    var lift_170 := false;
    ...
    var lift_129 := multiset{lift_130, lift_130, lift_135, lift_138, lift_135};
    var lift_128 := lift_129;
    var lift_127 := (lift_128, lift_149, lift_150);
    var lift_126 := arg_124;
    assert (((-849164517 - arg_124) < arg_124) || ((424582259 + arg_124) == (-1273746776 - arg_124)));
    assert (((-849164517 - arg_124) < arg_124) || ((424582259 + arg_124) == (-1273746776 - arg_124)));
    assert (((-849164517 - arg_124) < arg_124) || ((424582259 + arg_124) == (-1273746776 - arg_124)));
    assert (-424582259 < lift_126);
    lift_127 := lift_127;
  }
}
...
method lift_87_0 ()
  returns (arg_90 : int)
  requires (true)
  ensures (((arg_90 == 920574015) && true))
{
  arg_90 := 920574015;
  {
    var lift_91 := 'e';
    lift_91 := 'o';
    assert (((1841148030 - arg_90) == arg_90) || ((arg_90 == -1) || (-1 == arg_90)));
  }
}

method lift_81_0 (arg_84 : int)
  returns (arg_85 : int)
  requires (((arg_84 == -1166552114) && true))
  ensures (((arg_85 == 1775172421) && true))
{
  arg_85 := 1775172421;
  {
    assert (((arg_85 == arg_85) || (arg_85 < arg_85)) && ((1775172418 - arg_85) == (-1775172424 + arg_85)));
  }
}

method lift_61_0 (arg_64 : int, arg_65 : int)
  returns (arg_66 : int)
  requires (((arg_65 == 900213127) && ((arg_64 == -1189016040) && true)))
  ensures (((arg_66 == -1172537151) && true))
{
  arg_66 := -1172537151;
  {
    var lift_78 := ();
    ...
    assert (((-1 - arg_65) < 1) || ((900213128 == arg_65) || (arg_65 < arg_65)));
    lift_67 := lift_72;
  }
}
...
method lift_50_0 (arg_54 : int, arg_55 : int)
  ...
  requires (((arg_55 == 900213127) && ((arg_54 == -500441927) && true)))
  ensures (((arg_57 == -1304451872) && ((arg_56 == -751911611) && true)))
{
  arg_56 := -751911611;
  arg_57 := -1304451872;
  {
    ...
    var lift_58 := lift_59;
    lift_58 := lift_58;
    assert (((-751911612 - arg_56) + (-751911612 - arg_56)) == ((-751911611 + arg_56) - (-751911609 + arg_56)));
    assert (((-900213127 - 900213127) == (arg_55 - 2700639381)) && ((-2700639382 - arg_55) < (-900213127 - 900213127)));
    assert (((-1 - arg_55) < 1) || ((900213128 == arg_55) || (arg_55 < arg_55)));
  }
}

method lift_40_0 (arg_43 : int, arg_44 : int, arg_45 : int)
  returns (arg_46 : int)
  requires (((arg_45 == 385245673) && ((arg_44 == 1093248060) && ((arg_43 == -1454154642) && true))))
  ensures (((arg_46 == -359264460) && true))
{
  arg_46 := -359264460;
  {
    var lift_49 := ();
    ...
    assert (arg_45 == ((arg_45 - 385245676) - (arg_45 - 770491349)));
    assert (344526581 == ((344526580 - -2) + (344526579 - 344526580)));
    lift_47 := lift_47;
  }
}
...
method lift_25_0 (arg_29 : int, arg_30 : int, arg_31 : int)
  ...
  requires (((arg_31 == 358253706) && ((arg_30 == 900213127) && ((arg_29 == 900213127) && true))))
  ensures (((arg_33 == 1396838111) && ((arg_32 == -1886763246) && true)))
{
  arg_32 := -1886763246;
  arg_33 := 1396838111;
  {
  ...
  ensures (((arg_4 == 900213127) && true))
{
  arg_4 := 900213127;
  {
    ...
    var lift_6 := [lift_7];
    var lift_5 := lift_6;
    assert (((-1 - arg_4) < 1) || ((900213128 == arg_4) || (arg_4 < arg_4)));
    assert (-1839183264 == ((-1839183264 - 1839183265) - (-1839183264 - 1)));
    lift_5 := lift_5;
    assert (((lift_8 < lift_8) || (lift_8 < -963722807)) && ((lift_8 == lift_8) || (lift_8 < lift_8)));
  }
}
...
method Main () {
  ...
  var methoddefvar_3 := lift_1_0();
  {
    ...
    var lift_10 := [lift_11, lift_12, lift_12, (), lift_11];
    {
      var lift_18 := methoddefvar_3;
      {
        var lift_9 := lift_10;
        lift_9 := [(), lift_12];
        assert (((-900213127 - 900213127) == (methoddefvar_3 - 2700639381)) && ((-2700639382 - methoddefvar_3) < (-900213127 - 900213127)));
        lift_13 := lift_13;
      }
      if (true) {
        var lift_20 := {lift_21, lift_21, lift_21};
        var lift_19 := lift_11;
        assert (((-1 - methoddefvar_3) < 1) || ((900213128 == methoddefvar_3) || (methoddefvar_3 < methoddefvar_3)));
        assert (((-233952769 < -233952769) && (-701858308 == -233952769)) || ((-701858308 - -233952769) == (-701858308 - -233952769)));
        assert (((-1 - lift_18) < 1) || ((900213128 == lift_18) || (lift_18 < lift_18)));
        lift_19 := lift_12;
        lift_20 := lift_20;
      } else {
        assert false;
      ...
      {
        lift_35 := lift_36;
        assert ((methoddefvar_27 + (-7547052988 - methoddefvar_27)) == ((-5660289740 - methoddefvar_27) + (-5660289740 - methoddefvar_27)));
      }
      var methoddefvar_42 := lift_40_0(-1454154642, 1093248060, lift_23);
      {
        assert (((-1189016040 == lift_39) || (-1189016040 == lift_39)) || ((lift_39 + 1189016040) == (-1189016039 - lift_39)));
      }
      var methoddefvar_52, methoddefvar_53 := lift_50_0(-500441927, lift_18);
      {
        assert (((-1 - methoddefvar_3) < 1) || ((900213128 == methoddefvar_3) || (methoddefvar_3 < methoddefvar_3)));
        assert ((2343664244 - 1171832122) < 1171832122);
      }
    }
    {
      var lift_79 := 'E';
    ...
    {
      assert (((-1 - 2133776781) == (2133776781 + 2133776781)) || ((0 + -2) < (2133776781 - 2133776782)));
      assert (((0 - 3567048122) - (-1189016040 + lift_39)) == ((lift_39 - 1) + (-1189016041 - lift_39)));
    }
    var methoddefvar_89 := lift_87_0();
    {
      assert (((-385245674 + lift_23) - -2) == ((770491348 - lift_23) + (-1 - lift_23)));
    }
  }
  lift_92 := lift_102.0(lift_39, (lift_13 == {lift_14})).2;
  assert (((-2 - |lift_14|) - (0 - |lift_14|)) == ((0 - |lift_14|) + (0 - |lift_14|)));
  var methoddefvar_123 := lift_121_0(lift_102.1.2);
  {
    ...
    lift_171 := lift_172.0;
    {
      ...
      lift_177 := lift_178;
      assert (((lift_179 == lift_179) && (lift_179 < lift_179)) || ((lift_179 + lift_179) < (1 - 2)));
    }
  }
}
