  ...
  ensures (true)
{
  arg_485 := 935435494;
  {
    ...
    print "(params-for lift_480_0 arg_484 ", arg_484, ")\n";
    print "(meth-for lift_480_0)\n";
    {
      ...
      print "(section 55 ", arg_485, "\n", ")\n";
      print "(section 56 ", lift_486, "\n", ")\n";
      lift_487 := lift_486;
      lift_488 := lift_487;
      print "(section 57 ", lift_489, "\n", ")\n";
    }
    print "(rets-for lift_480_0 arg_485 ", arg_485, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_465 := 1570107820;
  {
    print "(params-for lift_457_0 arg_461 ", arg_461, ")\n";
    print "(params-for lift_457_0 arg_462 ", arg_462, ")\n";
    print "(params-for lift_457_0 arg_463 ", arg_463, ")\n";
    print "(meth-for lift_457_0)\n";
    {
      ...
      print "(section 54 ", -1860112616, "\n", ")\n";
      lift_474 := lift_474;
      lift_477 := lift_478;
    }
    print "(rets-for lift_457_0 arg_464 ", arg_464, ")\n";
    print "(rets-for lift_457_0 arg_465 ", arg_465, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_423 := 1792460564;
  {
    print "(params-for lift_418_0 arg_421 ", arg_421, ")\n";
  ...
  ensures (true)
{
  arg_271 := 1382335485;
  {
    print "(meth-for lift_268_0)\n";
    {
      ...
      print "(section 51 ", arg_271, "\n", ")\n";
    }
    print "(rets-for lift_268_0 arg_271 ", arg_271, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_271 := 1382335485;
  {
    print "(meth-for lift_268_1)\n";
    {
      ...
      lift_272 := (lift_273, lift_288, lift_300);
      print "(section 48 ", lift_314, "\n", ")\n";
      print "(section 49 ", arg_271, "\n", ")\n";
    }
    print "(rets-for lift_268_1 arg_271 ", arg_271, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_129 := -282269316;
  {
    ...
    {
      print "(section 44 ", arg_128, "\n", ")\n";
      print "(section 45 ", -1507339905, "\n", ")\n";
      print "(section 46 ", -1185139430, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_105 := -292320564;
  {
    ...
    {
      var lift_106 := true;
      print "(section 39 ", arg_104, "\n", ")\n";
      print "(section 40 ", arg_104, "\n", ")\n";
      lift_106 := lift_106;
      print "(section 41 ", arg_105, "\n", ")\n";
      print "(section 42 ", 240843631, "\n", ")\n";
    }
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0(|lift_39.0|, lift_43.0);
  {
    ...
    print "(section 0 ", (lift_46 as int), "\n", ")\n";
    lift_49 := lift_64.2;
    {
      var lift_108 := false;
  ...
  var methoddefvar_119, methoddefvar_120 := lift_117_0();
  {
    ...
    if ((lift_107 <== true)) {
      ...
      if (lift_115) {
        print "(section 6 ", lift_146, "\n", ")\n";
        lift_198 := lift_198;
        lift_199 := lift_200;
      } else {
        print "(section 7 ", lift_69, "\n", ")\n";
        print "(section 8 ", lift_70, "\n", ")\n";
        lift_201 := lift_217;
        lift_227 := lift_227;
      }
      lift_233 := lift_233;
  ...
  var methoddefvar_270 := lift_268_0();
  {
    ...
    print 
      "(section 11 ",
      (multiset{((), lift_156), lift_315, lift_316, lift_315}[lift_320] as int),
      "\n",
      ")\n";
    if ((lift_76 > lift_151)) {
      var lift_359 := lift_356;
      var lift_341 := lift_259;
      print "(section 12 ", lift_239, "\n", ")\n";
      if (lift_216) {
        var lift_340 := [multiset{(lift_84, true)}];
        lift_322 := lift_340;
        lift_341 := lift_267;
        lift_342 := lift_342;
        print "(section 13 ", lift_77, "\n", ")\n";
      ...
      if (lift_133) {
        var lift_362 := ();
        print "(section 18 ", -1362619629, "\n", ")\n";
        print "(section 19 ", lift_79, "\n", ")\n";
        lift_362 := lift_155;
        print "(section 20 ", lift_87, "\n", ")\n";
      } else {
      ...
      {
        print "(section 22 ", lift_70, "\n", ")\n";
        lift_388 := (lift_135, lift_155);
      }
      lift_390 := lift_396;
    }
    print "(section 23 ", safeSeqRef(lift_59, lift_385, lift_87), "\n", ")\n";
  ...
  );
  {
    ...
    }
    {
      ...
      {
        print "(section 31 ", lift_151, "\n", ")\n";
        print "(section 32 ", -1397672788, "\n", ")\n";
        lift_479 := lift_338;
      }
      var methoddefvar_482 := lift_480_0(methoddefvar_420, 1312891480);
      {
        ...
        lift_490 := lift_490;
        lift_492 := lift_492;
        print "(section 33 ", lift_454, "\n", ")\n";
        lift_493 := lift_499;
        print "(section 34 ", lift_221, "\n", ")\n";
      }
      print "(section 35 ", lift_377, "\n", ")\n";
      lift_501 := lift_517;
    }
  }
}
