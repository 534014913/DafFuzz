  ...
  ensures (true)
{
  arg_201 := 1436665054;
  {
    print "(params-for lift_196_0 arg_199 ", arg_199, ")\n";
  ...
  ensures (true)
{
  ...
  arg_167 := 579260805;
  {
    ...
    print "(params-for lift_159_0 arg_165 ", arg_165, ")\n";
    print "(meth-for lift_159_0)\n";
    {
      var lift_169 := ();
      var lift_168 := -1128875697;
      print "(section 22 ", arg_163, "\n", ")\n";
      print "(section 23 ", 986602718, "\n", ")\n";
      print "(section 24 ", arg_164, "\n", ")\n";
      lift_168 := arg_167;
      lift_169 := ();
    }
    print "(rets-for lift_159_0 arg_166 ", arg_166, ")\n";
    print "(rets-for lift_159_0 arg_167 ", arg_167, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_138 := 400175121;
  {
    ...
    print "(meth-for lift_131_0)\n";
    {
      ...
      lift_148 := lift_149;
      lift_150 := false;
      print "(section 21 ", arg_136, "\n", ")\n";
    }
    print "(rets-for lift_131_0 arg_137 ", arg_137, ")\n";
    print "(rets-for lift_131_0 arg_138 ", arg_138, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_98 := 373653586;
  {
    ...
    print "(params-for lift_92_0 arg_97 ", arg_97, ")\n";
    print "(meth-for lift_92_0)\n";
    {
      print "(section 20 ", arg_98, "\n", ")\n";
    }
    print "(rets-for lift_92_0 arg_98 ", arg_98, ")\n";
  }
}
...
method Main () {
  ...
  );
  {
    ...
    if ((lift_124 < {lift_126, lift_125, lift_67, lift_67} < {lift_56})) {
      ...
      {
        print "(section 1 ", 2127089245, "\n", ")\n";
        print "(section 2 ", lift_64, "\n", ")\n";
        lift_151 := lift_151;
        print "(section 3 ", lift_79, "\n", ")\n";
        lift_153 := lift_82;
      }
      if (lift_85) {
        print "(section 4 ", lift_117, "\n", ")\n";
        lift_154 := lift_82;
        print "(section 5 ", lift_123, "\n", ")\n";
        lift_155 := lift_85;
        print "(section 6 ", -1974786676, "\n", ")\n";
      } else {
    ...
    }
    {
      ...
      {
        lift_195 := lift_77;
        print "(section 13 ", lift_79, "\n", ")\n";
        print "(section 14 ", lift_58, "\n", ")\n";
      }
      print "(section 15 ", lift_121, "\n", ")\n";
