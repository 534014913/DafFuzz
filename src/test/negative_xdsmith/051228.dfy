  ...
  ensures (true)
{
  arg_828 := 273958820;
  {
    print "(params-for lift_822_0 arg_825 ", arg_825, ")\n";
    print "(params-for lift_822_0 arg_826 ", arg_826, ")\n";
    print "(params-for lift_822_0 arg_827 ", arg_827, ")\n";
    print "(meth-for lift_822_0)\n";
    {
      ...
      lift_831 := lift_829;
      lift_832 := lift_832;
      print "(section 117 ", arg_826, "\n", ")\n";
      print "(section 118 ", arg_826, "\n", ")\n";
    }
    print "(rets-for lift_822_0 arg_828 ", arg_828, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_800 := 1937517525;
  {
    print "(meth-for lift_795_0)\n";
    {
      ...
      var lift_801 := '|';
      lift_801 := lift_801;
      print "(section 116 ", lift_802, "\n", ")\n";
    }
    print "(rets-for lift_795_0 arg_799 ", arg_799, ")\n";
    print "(rets-for lift_795_0 arg_800 ", arg_800, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_788 := 2004364802;
  {
    print "(params-for lift_780_0 arg_784 ", arg_784, ")\n";
    print "(params-for lift_780_0 arg_785 ", arg_785, ")\n";
    print "(params-for lift_780_0 arg_786 ", arg_786, ")\n";
    print "(meth-for lift_780_0)\n";
    {
      print "(section 114 ", arg_784, "\n", ")\n";
      print "(section 115 ", arg_785, "\n", ")\n";
    }
    print "(rets-for lift_780_0 arg_787 ", arg_787, ")\n";
    print "(rets-for lift_780_0 arg_788 ", arg_788, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_746 := -1698432794;
  {
    print "(params-for lift_738_0 arg_742 ", arg_742, ")\n";
    print "(params-for lift_738_0 arg_743 ", arg_743, ")\n";
    print "(params-for lift_738_0 arg_744 ", arg_744, ")\n";
    print "(meth-for lift_738_0)\n";
    {
      var lift_747 := 1450912159;
      lift_747 := 132665405;
    }
    print "(rets-for lift_738_0 arg_745 ", arg_745, ")\n";
    print "(rets-for lift_738_0 arg_746 ", arg_746, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_746 := -1698432794;
  {
    print "(params-for lift_738_1 arg_742 ", arg_742, ")\n";
    print "(params-for lift_738_1 arg_743 ", arg_743, ")\n";
    print "(params-for lift_738_1 arg_744 ", arg_744, ")\n";
    print "(meth-for lift_738_1)\n";
    {
      var lift_747 := 1450912159;
      lift_747 := 132665405;
    }
    print "(rets-for lift_738_1 arg_745 ", arg_745, ")\n";
    print "(rets-for lift_738_1 arg_746 ", arg_746, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_647 := 425366940;
  {
    print "(params-for lift_641_0 arg_645 ", arg_645, ")\n";
    print "(meth-for lift_641_0)\n";
    {
      ...
      print "(section 112 ", arg_647, "\n", ")\n";
      lift_648 := lift_649;
      print "(section 113 ", -640330625, "\n", ")\n";
      lift_650 := lift_656;
      lift_662 := lift_655;
    }
    print "(rets-for lift_641_0 arg_646 ", arg_646, ")\n";
    print "(rets-for lift_641_0 arg_647 ", arg_647, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_630 := -648993298;
  {
    print "(params-for lift_625_0 arg_628 ", arg_628, ")\n";
    print "(params-for lift_625_0 arg_629 ", arg_629, ")\n";
    print "(meth-for lift_625_0)\n";
    {
      var lift_631 := (var tmpData : set<set<(int, bool)>> := {}; tmpData);
      lift_631 := lift_631;
    }
    print "(rets-for lift_625_0 arg_630 ", arg_630, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_630 := -648993298;
  {
    print "(params-for lift_625_1 arg_628 ", arg_628, ")\n";
    print "(params-for lift_625_1 arg_629 ", arg_629, ")\n";
    print "(meth-for lift_625_1)\n";
    {
      var lift_631 := (var tmpData : set<set<(int, bool)>> := {}; tmpData);
      lift_631 := lift_631;
    }
    print "(rets-for lift_625_1 arg_630 ", arg_630, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_479 := 2040211588;
  {
    print "(meth-for lift_476_0)\n";
    {
      ...
      lift_480 := lift_481;
      print "(section 109 ", arg_479, "\n", ")\n";
      lift_482 := lift_485;
      print "(section 110 ", lift_486, "\n", ")\n";
      print "(section 111 ", arg_479, "\n", ")\n";
    }
    print "(rets-for lift_476_0 arg_479 ", arg_479, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_479 := 2040211588;
  {
    print "(meth-for lift_476_1)\n";
    {
      ...
      lift_482 := lift_485;
      print "(section 107 ", lift_486, "\n", ")\n";
      print "(section 108 ", arg_479, "\n", ")\n";
    }
    print "(rets-for lift_476_1 arg_479 ", arg_479, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_325 := 765963996;
  {
    ...
    print "(meth-for lift_319_1)\n";
    {
      ...
      lift_326 := lift_328;
      lift_329 := lift_331;
      print "(section 104 ", lift_330, "\n", ")\n";
    }
    print "(rets-for lift_319_1 arg_324 ", arg_324, ")\n";
  ...
  ensures (true)
{
  ...
  arg_301 := 1039425094;
  {
    ...
    print "(meth-for lift_295_0)\n";
    {
      ...
      lift_302 := lift_302;
      print "(section 102 ", 493782979, "\n", ")\n";
      print "(section 103 ", arg_300, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_232 := -511523590;
  {
    ...
    print "(meth-for lift_228_0)\n";
    {
      ...
      print "(section 100 ", arg_231, "\n", ")\n";
      print "(section 101 ", lift_233, "\n", ")\n";
      lift_234 := lift_234;
      lift_237 := false;
      lift_238 := lift_239;
    }
  ...
  ensures (true)
{
  arg_232 := -511523590;
  {
    ...
    print "(meth-for lift_228_1)\n";
    {
      ...
      var lift_234 := (lift_235, lift_236);
      var lift_233 := 1912115909;
      print "(section 98 ", arg_231, "\n", ")\n";
      print "(section 99 ", lift_233, "\n", ")\n";
      lift_234 := lift_234;
      lift_237 := false;
      lift_238 := lift_239;
    }
    print "(rets-for lift_228_1 arg_232 ", arg_232, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_232 := -511523590;
  {
    print "(params-for lift_228_2 arg_231 ", arg_231, ")\n";
    print "(meth-for lift_228_2)\n";
    {
      var lift_239 := ();
      var lift_238 := lift_239;
      var lift_237 := false;
      ...
      var lift_234 := (lift_235, lift_236);
      var lift_233 := 1912115909;
      print "(section 96 ", arg_231, "\n", ")\n";
      print "(section 97 ", lift_233, "\n", ")\n";
      lift_234 := lift_234;
      lift_237 := false;
      lift_238 := lift_239;
    }
    print "(rets-for lift_228_2 arg_232 ", arg_232, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_134 := 1481706790;
  {
    ...
    print "(meth-for lift_130_0)\n";
    {
      ...
      print "(section 94 ", arg_134, "\n", ")\n";
      lift_135 := [arg_134, arg_133];
      lift_138 := {lift_140};
      print "(section 95 ", lift_136, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_134 := 1481706790;
  {
    ...
    print "(meth-for lift_130_1)\n";
    {
      ...
      var lift_136 := 1300509391;
      var lift_135 := [lift_136, lift_137, lift_136, arg_134, arg_133];
      print "(section 92 ", arg_134, "\n", ")\n";
      lift_135 := [arg_134, arg_133];
      lift_138 := {lift_140};
      print "(section 93 ", lift_136, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_134 := 1481706790;
  {
    print "(params-for lift_130_2 arg_133 ", arg_133, ")\n";
    print "(meth-for lift_130_2)\n";
    {
      ...
      var lift_136 := 1300509391;
      var lift_135 := [lift_136, lift_137, lift_136, arg_134, arg_133];
      print "(section 90 ", arg_134, "\n", ")\n";
      lift_135 := [arg_134, arg_133];
      lift_138 := {lift_140};
      print "(section 91 ", lift_136, "\n", ")\n";
    }
    print "(rets-for lift_130_2 arg_134 ", arg_134, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_134 := 1481706790;
  {
    print "(params-for lift_130_3 arg_133 ", arg_133, ")\n";
    print "(meth-for lift_130_3)\n";
    {
      var lift_140 := 'p';
      var lift_139 := '!';
      var lift_138 := {'w', lift_139, lift_140, 'P'};
      ...
      var lift_136 := 1300509391;
      var lift_135 := [lift_136, lift_137, lift_136, arg_134, arg_133];
      print "(section 88 ", arg_134, "\n", ")\n";
      lift_135 := [arg_134, arg_133];
      lift_138 := {lift_140};
      print "(section 89 ", lift_136, "\n", ")\n";
    }
    print "(rets-for lift_130_3 arg_134 ", arg_134, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_124 := 952764856;
  {
    print "(meth-for lift_119_0)\n";
    {
      ...
      var lift_125 := '?';
      lift_125 := lift_125;
      print "(section 86 ", arg_124, "\n", ")\n";
      lift_126 := lift_126;
      lift_127 := lift_127;
      print "(section 87 ", lift_126, "\n", ")\n";
    }
    print "(rets-for lift_119_0 arg_123 ", arg_123, ")\n";
  ...
  ensures (true)
{
  ...
  arg_124 := 952764856;
  {
    print "(meth-for lift_119_1)\n";
    {
      ...
      var lift_125 := '?';
      lift_125 := lift_125;
      print "(section 84 ", arg_124, "\n", ")\n";
      lift_126 := lift_126;
      lift_127 := lift_127;
      print "(section 85 ", lift_126, "\n", ")\n";
    }
    print "(rets-for lift_119_1 arg_123 ", arg_123, ")\n";
  ...
  ensures (true)
{
  ...
  arg_124 := 952764856;
  {
    print "(meth-for lift_119_2)\n";
    {
      ...
      lift_126 := lift_126;
      lift_127 := lift_127;
      print "(section 83 ", lift_126, "\n", ")\n";
    }
    print "(rets-for lift_119_2 arg_123 ", arg_123, ")\n";
    print "(rets-for lift_119_2 arg_124 ", arg_124, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_124 := 952764856;
  {
    print "(meth-for lift_119_3)\n";
    {
      ...
      var lift_125 := '?';
      lift_125 := lift_125;
      print "(section 80 ", arg_124, "\n", ")\n";
      lift_126 := lift_126;
      lift_127 := lift_127;
      print "(section 81 ", lift_126, "\n", ")\n";
    }
    print "(rets-for lift_119_3 arg_123 ", arg_123, ")\n";
    print "(rets-for lift_119_3 arg_124 ", arg_124, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_124 := 952764856;
  {
    print "(meth-for lift_119_4)\n";
    {
      ...
      var lift_125 := '?';
      lift_125 := lift_125;
      print "(section 78 ", arg_124, "\n", ")\n";
      lift_126 := lift_126;
      lift_127 := lift_127;
      print "(section 79 ", lift_126, "\n", ")\n";
    }
    print "(rets-for lift_119_4 arg_123 ", arg_123, ")\n";
    print "(rets-for lift_119_4 arg_124 ", arg_124, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_124 := 952764856;
  {
    print "(meth-for lift_119_5)\n";
    {
      ...
      var lift_125 := '?';
      lift_125 := lift_125;
      print "(section 76 ", arg_124, "\n", ")\n";
      lift_126 := lift_126;
      lift_127 := lift_127;
      print "(section 77 ", lift_126, "\n", ")\n";
    }
    print "(rets-for lift_119_5 arg_123 ", arg_123, ")\n";
    print "(rets-for lift_119_5 arg_124 ", arg_124, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_7 := 712153940;
  {
    ...
    print "(meth-for lift_1_0)\n";
    {
      ...
      var lift_8 := ('D', lift_9);
      lift_8 := lift_12;
      print "(section 74 ", 89008575, "\n", ")\n";
      lift_20 := lift_41;
      print "(section 75 ", -1023151416, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_7 := 712153940;
  {
    ...
    print "(meth-for lift_1_1)\n";
    {
      ...
      var lift_8 := ('D', lift_9);
      lift_8 := lift_12;
      print "(section 72 ", 89008575, "\n", ")\n";
      lift_20 := lift_41;
      print "(section 73 ", -1023151416, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_7 := 712153940;
  {
    ...
    print "(meth-for lift_1_2)\n";
    {
      ...
      var lift_8 := ('D', lift_9);
      lift_8 := lift_12;
      print "(section 70 ", 89008575, "\n", ")\n";
      lift_20 := lift_41;
      print "(section 71 ", -1023151416, "\n", ")\n";
    }
  ...
  );
  {
    ...
    if ((lift_85 <== lift_72 <== lift_59)) {
      ...
      if (lift_91) {
        ...
        lift_93 := lift_93;
        lift_110 := lift_110;
        print "(section 2 ", lift_112, "\n", ")\n";
      } else {
        print "(section 3 ", lift_114, "\n", ")\n";
        lift_115 := lift_116;
      }
      var methoddefvar_121, methoddefvar_122 := lift_119_0();
      {
        lift_129 := lift_96;
        print "(section 4 ", methoddefvar_121, "\n", ")\n";
      }
    ...
    print "(section 9 ", (lift_118 as int), "\n", ")\n";
  }
  if (((
    ...
    var methoddefvar_230 := lift_228_0(|lift_163|);
    {
      ...
      var methoddefvar_242 := lift_130_1(lift_240);
      {
        lift_243 := lift_243;
        lift_248 := lift_266;
        print "(section 10 ", 482641939, "\n", ")\n";
        print "(section 11 ", lift_143, "\n", ")\n";
        print "(section 12 ", lift_153, "\n", ")\n";
      }
      {
        print "(section 13 ", -420666535, "\n", ")\n";
        lift_267 := lift_106;
        lift_268 := lift_114;
        print "(section 14 ", lift_141, "\n", ")\n";
      }
      lift_269 := lift_269;
    }
    if (lift_79) {
      ...
      if (lift_287(lift_290)) {
        ...
        var methoddefvar_321, methoddefvar_322 := lift_319_0(lift_240);
        {
          ...
          lift_338 := lift_340;
          lift_348 := [lift_185];
          print "(section 23 ", lift_335, "\n", ")\n";
        }
        if (lift_72) {
          print "(section 24 ", lift_336, "\n", ")\n";
        } else {
          print "(section 25 ", lift_255, "\n", ")\n";
          lift_349 := lift_259;
        }
      }
      print "(section 26 ", lift_339.0, "\n", ")\n";
    } else {
      ...
      if (lift_181) {
        ...
        print "(section 27 ", lift_144, "\n", ")\n";
        var methoddefvar_350 := lift_228_1(lift_313);
        {
          lift_351 := lift_352;
          print "(section 28 ", -100388253, "\n", ")\n";
        }
        if (false) {
          ...
          lift_355 := lift_355;
          print "(section 29 ", lift_144, "\n", ")\n";
          print "(section 30 ", lift_142, "\n", ")\n";
          print "(section 31 ", lift_345, "\n", ")\n";
        }
        print "(section 32 ", lift_113, "\n", ")\n";
      } else {
      ...
      }
      {
        ...
        {
          print "(section 35 ", 2030339399, "\n", ")\n";
          lift_400 := lift_401;
          lift_403 := lift_403;
          print "(section 36 ", lift_425, "\n", ")\n";
          print "(section 37 ", lift_153, "\n", ")\n";
        }
        {
          var lift_458 := lift_457;
          lift_426 := {lift_437, lift_440, lift_440};
          print "(section 38 ", lift_269, "\n", ")\n";
          lift_456 := lift_85;
          lift_457 := lift_458;
          lift_459 := lift_459;
        }
      ...
      {
        print "(section 39 ", lift_429, "\n", ")\n";
        lift_487 := lift_252;
        print "(section 40 ", lift_335, "\n", ")\n";
        lift_488 := true;
      }
      {
    ...
    if (((-754309202, ()), lift_55, multiset{lift_280, lift_77, lift_411}).1) {
      ...
      if ((lift_542 !in multiset{lift_542, lift_542, lift_542})) {
        print "(section 43 ", lift_54, "\n", ")\n";
      } else {
        var lift_634 := {lift_572, lift_572, lift_571, lift_572};
        var lift_633 := lift_191;
        print "(section 44 ", lift_469, "\n", ")\n";
        print "(section 45 ", lift_455, "\n", ")\n";
      ...
      if ((lift_684 >= lift_407)) {
        {
          ...
          lift_686 := lift_549;
          lift_687 := lift_313;
          print "(section 47 ", lift_335, "\n", ")\n";
        }
        var methoddefvar_688 := lift_130_3(lift_394);
        {
          print "(section 48 ", lift_522, "\n", ")\n";
        }
      } else {
        ...
        if (lift_90) {
          ...
          print "(section 49 ", -565348323, "\n", ")\n";
          print "(section 50 ", lift_114, "\n", ")\n";
          lift_700 := lift_469;
        }
        ...
        {
          lift_718 := 'u';
          print "(section 51 ", 1443253083, "\n", ")\n";
          print "(section 52 ", lift_692, "\n", ")\n";
          lift_719 := lift_684;
        }
        {
          print "(section 53 ", lift_498, "\n", ")\n";
          lift_720 := lift_488;
          lift_722 := lift_523;
          print "(section 54 ", -3405851, "\n", ")\n";
          lift_723 := lift_723;
        }
      }
      print "(section 55 ", |"$gs!;=s+nR=wlKxrww"|, "\n", ")\n";
    }
    ...
    {
      print "(section 56 ", -687606282, "\n", ")\n";
      print "(section 57 ", lift_516, "\n", ")\n";
    }
  }
  {
    var lift_837 := (
    ...
    var methoddefvar_748, methoddefvar_749 := lift_319_1(|lift_169|);
    {
      ...
      if (true) {
        ...
        lift_750 := lift_734;
        print "(section 58 ", lift_517, "\n", ")\n";
        lift_751 := lift_752;
        lift_753 := lift_753;
      } else {
        var lift_763 := (lift_180, lift_706);
        print "(section 59 ", lift_544, "\n", ")\n";
        lift_763 := lift_764;
        print "(section 60 ", lift_142, "\n", ")\n";
      }
      var methoddefvar_775 := lift_476_1();
      {
        var lift_776 := true;
        print "(section 61 ", lift_771, "\n", ")\n";
        print "(section 62 ", lift_54, "\n", ")\n";
        lift_776 := lift_86;
      }
      print "(section 63 ", lift_774, "\n", ")\n";
    }
    {
      ...
      if (lift_777()) {
        ...
        var methoddefvar_790 := lift_625_1(lift_499, lift_317);
        {
          lift_791 := lift_548;
          lift_792 := lift_792;
          print "(section 64 ", lift_424, "\n", ")\n";
          lift_794 := lift_317;
        }
        var methoddefvar_797, methoddefvar_798 := lift_795_0();
        {
          lift_803 := lift_259;
          print "(section 65 ", 811672211, "\n", ")\n";
        }
      } else {
      ...
      }
      {
        ...
        var methoddefvar_824 := lift_822_0(lift_695, lift_672, lift_716);
        {
          ...
          lift_833 := lift_549;
          print "(section 67 ", lift_141, "\n", ")\n";
          lift_834 := lift_115;
          lift_837 := lift_837;
          print "(section 68 ", lift_500, "\n", ")\n";
        }
      }
    }
    print "(section 69 ", (lift_760.2 as int), "\n", ")\n";
  }
}
