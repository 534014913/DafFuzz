  ...
  ensures (true)
{
  arg_426 := -1540756376;
  {
    ...
    print "(rets-for lift_422_1 arg_426 ", arg_426, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_398 := 1499823257;
  {
    ...
    print "(params-for lift_391_1 arg_396 ", arg_396, ")\n";
    print "(meth-for lift_391_1)\n";
    {
      ...
      lift_399 := true;
      lift_400 := lift_400;
      print "(section 48 ", arg_395, "\n", ")\n";
      lift_401 := true;
    }
    print "(rets-for lift_391_1 arg_397 ", arg_397, ")\n";
    print "(rets-for lift_391_1 arg_398 ", arg_398, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_377 := 317124267;
  {
    print "(params-for lift_371_0 arg_375 ", arg_375, ")\n";
    ...
    print "(rets-for lift_371_0 arg_377 ", arg_377, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_317 := -1914514249;
  {
    print "(meth-for lift_314_0)\n";
    {
      ...
      var lift_318 := ();
      print "(section 45 ", -1492347657, "\n", ")\n";
      lift_318 := lift_318;
      lift_319 := lift_325;
      print "(section 46 ", 857438761, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_317 := -1914514249;
  {
    print "(meth-for lift_314_1)\n";
    {
      ...
      var lift_319 := (lift_320, lift_322, lift_323);
      var lift_318 := ();
      print "(section 43 ", -1492347657, "\n", ")\n";
      lift_318 := lift_318;
      lift_319 := lift_325;
      print "(section 44 ", 857438761, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_255 := -869786953;
  {
    ...
    print "(params-for lift_248_0 arg_253 ", arg_253, ")\n";
    print "(meth-for lift_248_0)\n";
    {
      ...
      print "(section 41 ", arg_252, "\n", ")\n";
      lift_256 := lift_267;
      print "(section 42 ", arg_254, "\n", ")\n";
    }
    print "(rets-for lift_248_0 arg_254 ", arg_254, ")\n";
    print "(rets-for lift_248_0 arg_255 ", arg_255, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_255 := -869786953;
  {
    ...
    print "(params-for lift_248_1 arg_253 ", arg_253, ")\n";
    print "(meth-for lift_248_1)\n";
    {
      ...
      var lift_257 := (lift_258, lift_259);
      var lift_256 := (lift_257, lift_260, arg_255);
      print "(section 39 ", arg_252, "\n", ")\n";
      lift_256 := lift_267;
      print "(section 40 ", arg_254, "\n", ")\n";
    }
    print "(rets-for lift_248_1 arg_254 ", arg_254, ")\n";
    print "(rets-for lift_248_1 arg_255 ", arg_255, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_192 := -713516865;
  {
    ...
    print "(params-for lift_184_0 arg_189 ", arg_189, ")\n";
    print "(params-for lift_184_0 arg_190 ", arg_190, ")\n";
    print "(meth-for lift_184_0)\n";
    {
      ...
      lift_193 := lift_195;
      print "(section 37 ", arg_192, "\n", ")\n";
      lift_196 := lift_196;
      lift_201 := arg_188;
      print "(section 38 ", arg_192, "\n", ")\n";
    }
    print "(rets-for lift_184_0 arg_191 ", arg_191, ")\n";
    print "(rets-for lift_184_0 arg_192 ", arg_192, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_192 := -713516865;
  {
    ...
    print "(params-for lift_184_1 arg_189 ", arg_189, ")\n";
    print "(params-for lift_184_1 arg_190 ", arg_190, ")\n";
    print "(meth-for lift_184_1)\n";
    {
      ...
      var lift_193 := (lift_194, arg_190);
      lift_193 := lift_195;
      print "(section 35 ", arg_192, "\n", ")\n";
      lift_196 := lift_196;
      lift_201 := arg_188;
      print "(section 36 ", arg_192, "\n", ")\n";
    }
    print "(rets-for lift_184_1 arg_191 ", arg_191, ")\n";
    print "(rets-for lift_184_1 arg_192 ", arg_192, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_192 := -713516865;
  {
    ...
    print "(params-for lift_184_2 arg_189 ", arg_189, ")\n";
    print "(params-for lift_184_2 arg_190 ", arg_190, ")\n";
    print "(meth-for lift_184_2)\n";
    {
      ...
      var lift_193 := (lift_194, arg_190);
      lift_193 := lift_195;
      print "(section 33 ", arg_192, "\n", ")\n";
      lift_196 := lift_196;
      lift_201 := arg_188;
      print "(section 34 ", arg_192, "\n", ")\n";
    }
    print "(rets-for lift_184_2 arg_191 ", arg_191, ")\n";
    print "(rets-for lift_184_2 arg_192 ", arg_192, ")\n";
  }
}
  ...
  if ((!((lift_1 < lift_3 <= lift_3)) <== (({
    ...
    if ((safeSeqRef(
      ...
      if ((multiset{
        ...
        {
          print "(section 7 ", lift_182, "\n", ")\n";
          print "(section 8 ", 582356788, "\n", ")\n";
        }
        var methoddefvar_276 := lift_274_0(lift_22, 1788936210);
        {
          print "(section 9 ", 1276263018, "\n", ")\n";
          lift_289 := [lift_246, lift_205, (), ()];
          lift_290 := lift_291;
          print "(section 10 ", 1878719717, "\n", ")\n";
      ...
      }
      {
        ...
        lift_385 := lift_347;
        print "(section 18 ", lift_168, "\n", ")\n";
        lift_386 := lift_57;
      }
    }
    print 
      "(section 19 ",
      (lift_12[safeSeqRef([lift_73], lift_41, lift_55)] as int),
      "\n",
      ")\n";
  } else {
    ...
    var methoddefvar_387 := lift_314_1();
    {
      ...
      print "(section 21 ", lift_149, "\n", ")\n";
      {
        lift_388 := lift_347;
        print "(section 22 ", -778945965, "\n", ")\n";
        lift_389 := lift_350;
        lift_390 := lift_352;
      }
    }
    ...
    print 
      ...
      |(
        (
          "RDd>&^N^rP=PfWtbfhXA!tPymb|CzvDv;Vml",
          (
            (-1863619240, '<'),
            ((
              arg_420 : set<()>,
              arg_421 : (multiset<int>, multiset<bool>, multiset<bool>)
    ...
    );
    {
      ...
      {
        print "(section 25 ", lift_148, "\n", ")\n";
        print "(section 26 ", lift_16, "\n", ")\n";
        lift_447 := lift_447;
        lift_460 := lift_460;
      }
