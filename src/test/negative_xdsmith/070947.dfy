...
method lift_8_0 ()
  returns (arg_11 : int)
  requires (true)
  ensures (((arg_11 == -1048328189) && true))
{
  arg_11 := -1048328189;
  {
    var lift_14 := 'G';
    var lift_13 := lift_14;
    var lift_12 := lift_13;
    assert (((-1048328191 - -1048328189) < (-1048328190 - arg_11)) && ((-1048328191 - arg_11) < (-1048328190 - arg_11)));
    assert (((-1048328188 - 0) < (-1048328190 - arg_11)) || ((-1048328190 - arg_11) < (-1048328190 - arg_11)));
    lift_12 := ':';
  }
}
  ...
  ensures (((arg_11 == -1048328189) && true))
{
  arg_11 := -1048328189;
  {
    ...
    var lift_13 := lift_14;
    var lift_12 := lift_13;
    assert (((arg_11 < arg_11) || (arg_11 < arg_11)) || ((arg_11 + arg_11) < (arg_11 - 1048328187)));
    assert (((-1048328191 - -1048328189) < (-1048328190 - arg_11)) && ((-1048328191 - arg_11) < (-1048328190 - arg_11)));
    lift_12 := ':';
  }
}
...
method Main () {
  ...
  if ((
    ...
    {
      {
        assert (((-3144984567 - methoddefvar_10) == (-1048328189 + methoddefvar_10)) || ((-1048328191 - methoddefvar_10) == (-1048328190 - methoddefvar_10)));
        assert (((-1048328191 - -1048328189) < (-1048328190 - methoddefvar_10)) && ((-1048328191 - methoddefvar_10) < (-1048328190 - methoddefvar_10)));
      }
    }
    var methoddefvar_15 := lift_8_1();
    {
      ...
      if (lift_3) {
        ...
        var lift_21 := lift_20;
        assert ((methoddefvar_15 == (methoddefvar_15 - -1)) || ((methoddefvar_15 == 1048328187) && (-1048328190 < methoddefvar_15)));
        assert (((lift_20 == lift_20) && (-3701780510 == lift_20)) || ((0 + -3701780509) < lift_20));
        assert (((lift_21 + lift_21) + (-1233926837 - lift_21)) == -2467853673);
        lift_22 := lift_22;
      }
    }
  } else {
  ...
  )] as int)) - (-3 - (lift_155[lift_199(
    lift_208.1,
    (multiset{lift_159, 1461755070}[lift_152 := lengthNormalize(lift_104)]),
    safeSeqRef(lift_214, 111982092, lift_220),
    lift_222(lift_230, -1586695964, lift_103, (lift_137, lift_37), ())
  )] as int))) < ((lift_155[lift_199(
    lift_208.1,
    (multiset{lift_159, 1461755070}[lift_152 := lengthNormalize(lift_104)]),
    safeSeqRef(lift_214, 111982092, lift_220),
    lift_222(lift_230, -1586695964, lift_103, (lift_137, lift_37), ())
