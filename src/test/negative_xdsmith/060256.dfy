  ...
  ensures (true)
{
  ...
  arg_307 := 191986653;
  {
    ...
    print "(meth-for lift_300_0)\n";
    {
      ...
      lift_308 := lift_311;
      print "(section 48 ", arg_307, "\n", ")\n";
      lift_315 := lift_315;
      print "(section 49 ", -2014608894, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_275 := 1819197635;
  {
    print "(meth-for lift_270_0)\n";
    {
      ...
      var lift_276 := 'r';
      lift_276 := lift_276;
      print "(section 46 ", arg_274, "\n", ")\n";
      lift_277 := lift_280;
      lift_283 := lift_283;
      print "(section 47 ", arg_274, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_187 := -801141885;
  {
    print "(meth-for lift_184_0)\n";
    {
      ...
      print "(section 44 ", lift_188, "\n", ")\n";
      print "(section 45 ", lift_188, "\n", ")\n";
    }
    print "(rets-for lift_184_0 arg_187 ", arg_187, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_163 := -1821749621;
  {
    ...
    print "(meth-for lift_155_0)\n";
    {
      ...
      print "(section 42 ", arg_160, "\n", ")\n";
      lift_164 := lift_165;
      print "(section 43 ", arg_162, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_113 := -1245674452;
  {
    ...
    print "(meth-for lift_105_0)\n";
    {
      ...
      var lift_114 := ();
      lift_114 := lift_114;
      print "(section 37 ", arg_111, "\n", ")\n";
      print "(section 38 ", arg_113, "\n", ")\n";
      lift_115 := lift_119;
      lift_130 := lift_130;
    }
...
method Main () {
  ...
  if ((((lift_1 - lift_1)[lift_4] as int) < ((lift_2 - lift_3) * safeSeqRef(
    ...
    print 
      "(section 0 ",
      (lift_8(lift_16, lift_4)[safeSeqRef(lift_17, -310839959, ())] as int),
      "\n",
      ")\n";
    ...
    if ((([
      ...
      if (lift_102.1) {
        ...
        );
        {
          ...
          lift_132 := lift_135;
          print "(section 7 ", methoddefvar_108, "\n", ")\n";
        ...
        );
        {
          ...
          lift_167 := lift_167;
          print "(section 11 ", methoddefvar_157, "\n", ")\n";
          lift_180 := lift_180;
        }
      } else {
        if (lift_175) {
          print "(section 12 ", lift_149, "\n", ")\n";
          print "(section 13 ", lift_4, "\n", ")\n";
          print "(section 14 ", lift_65, "\n", ")\n";
          lift_182 := lift_182;
        } else {
          print "(section 15 ", lift_56, "\n", ")\n";
          print "(section 16 ", lift_2, "\n", ")\n";
          print "(section 17 ", lift_2, "\n", ")\n";
        }
        var methoddefvar_186 := lift_184_0();
        {
          print "(section 18 ", lift_2, "\n", ")\n";
        }
        lift_189 := lift_193;
        var methoddefvar_196, methoddefvar_197 := lift_194_0(lift_149, lift_2);
        {
          ...
          lift_221 := lift_42;
          lift_222 := lift_89;
          print "(section 19 ", -1688749726, "\n", ")\n";
        }
        if (lift_178) {
          lift_223 := lift_4;
          print "(section 20 ", lift_3, "\n", ")\n";
        } else {
          lift_224 := lift_74;
          print "(section 21 ", lift_174, "\n", ")\n";
      ...
      {
        print "(section 26 ", lift_4, "\n", ")\n";
        print "(section 27 ", lift_56, "\n", ")\n";
        print "(section 28 ", methoddefvar_243, "\n", ")\n";
        lift_262 := lift_262;
        lift_263 := lift_263;
      }
      lift_268 := lift_268;
    ...
    );
    {
      ...
      );
      {
        ...
        print "(section 31 ", methoddefvar_287, "\n", ")\n";
        lift_299 := lift_50;
      }
    ...
    );
    {
      ...
      {
        var lift_362 := lift_2;
        print "(section 35 ", lift_2, "\n", ")\n";
        lift_358 := lift_358;
        print "(section 36 ", lift_218, "\n", ")\n";
        lift_362 := lift_340;
      }
      lift_363 := lift_48;
    }
