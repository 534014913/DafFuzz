  ...
  ensures (true)
{
  arg_183 := -1767376094;
  {
    ...
    print "(params-for lift_177_1 arg_182 ", arg_182, ")\n";
...
method Main () {
  ...
  var lift_27 := {'N', 'a', lift_28};
  {
    ...
    var methoddefvar_58, methoddefvar_59 := lift_56_0(|lift_79|);
    {
      ...
      {
        print "(section 1 ", methoddefvar_58, "\n", ")\n";
        lift_88 := lift_88;
  ...
  }
  {
    print 
      "(section 10 ",
      |({'L', lift_168, lift_28, lift_213, lift_173} - lift_171)|,
      "\n",
      ")\n";
  }
}
