  ...
  ensures (true)
{
  arg_469 := -254499770;
  {
    print "(params-for lift_465_0 arg_468 ", arg_468, ")\n";
    print "(meth-for lift_465_0)\n";
    {
      var lift_474 := 'z';
      ...
      print "(section 89 ", arg_469, "\n", ")\n";
      lift_470 := -196583109;
      lift_471 := lift_471;
      print "(section 90 ", lift_470, "\n", ")\n";
    }
    print "(rets-for lift_465_0 arg_469 ", arg_469, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_434 := 1143452532;
  {
    ...
    print "(params-for lift_428_0 arg_433 ", arg_433, ")\n";
    print "(meth-for lift_428_0)\n";
    {
      var lift_436 := ();
      var lift_435 := ();
      print "(section 87 ", arg_434, "\n", ")\n";
      lift_435 := lift_436;
      print "(section 88 ", arg_431, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_406 := 904290949;
  {
    ...
    print "(rets-for lift_401_0 arg_405 ", arg_405, ")\n";
    print "(rets-for lift_401_0 arg_406 ", arg_406, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_251 := -1710047082;
  {
    ...
    print "(params-for lift_243_0 arg_249 ", arg_249, ")\n";
    print "(meth-for lift_243_0)\n";
    {
      var lift_252 := 1243417746;
      print "(section 84 ", 638157947, "\n", ")\n";
      print "(section 85 ", arg_248, "\n", ")\n";
      lift_252 := arg_247;
    }
    print "(rets-for lift_243_0 arg_250 ", arg_250, ")\n";
    print "(rets-for lift_243_0 arg_251 ", arg_251, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_97 := -1624822003;
  {
    ...
    print "(meth-for lift_91_0)\n";
    {
      ...
      print "(section 79 ", arg_96, "\n", ")\n";
      print "(section 80 ", lift_98, "\n", ")\n";
      print "(section 81 ", arg_95, "\n", ")\n";
      print "(section 82 ", arg_95, "\n", ")\n";
      lift_99 := lift_99;
    }
  ...
  ensures (true)
{
  ...
  arg_82 := 1948107033;
  {
    ...
    {
      print "(section 77 ", arg_81, "\n", ")\n";
      print "(section 78 ", arg_81, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_65 := -998210300;
  {
    ...
    print "(meth-for lift_58_1)\n";
    {
      var lift_67 := (var tmpData : seq<int> := []; tmpData);
      var lift_66 := -734447531;
      print "(section 73 ", arg_65, "\n", ")\n";
      print "(section 74 ", lift_66, "\n", ")\n";
      lift_67 := [arg_64, arg_64, lift_66, arg_62, arg_64];
    }
  ...
  ensures (true)
{
  ...
  arg_65 := -998210300;
  {
    ...
    print "(meth-for lift_58_2)\n";
    {
      var lift_67 := (var tmpData : seq<int> := []; tmpData);
      var lift_66 := -734447531;
      print "(section 71 ", arg_65, "\n", ")\n";
      print "(section 72 ", lift_66, "\n", ")\n";
      lift_67 := [arg_64, arg_64, lift_66, arg_62, arg_64];
    }
  ...
  ensures (true)
{
  ...
  arg_38 := 1482901565;
  {
    ...
    print "(meth-for lift_32_0)\n";
    {
      ...
      lift_39 := lift_39;
      lift_44 := lift_44;
      print "(section 68 ", arg_37, "\n", ")\n";
      print "(section 69 ", arg_36, "\n", ")\n";
      print "(section 70 ", lift_53, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_38 := 1482901565;
  {
    ...
    print "(meth-for lift_32_1)\n";
    {
      ...
      lift_39 := lift_39;
      lift_44 := lift_44;
      print "(section 65 ", arg_37, "\n", ")\n";
      print "(section 66 ", arg_36, "\n", ")\n";
      print "(section 67 ", lift_53, "\n", ")\n";
    }
    print "(rets-for lift_32_1 arg_37 ", arg_37, ")\n";
  ...
  ensures (true)
{
  ...
  arg_38 := 1482901565;
  {
    ...
    print "(meth-for lift_32_2)\n";
    {
      ...
      lift_39 := lift_39;
      lift_44 := lift_44;
      print "(section 62 ", arg_37, "\n", ")\n";
      print "(section 63 ", arg_36, "\n", ")\n";
      print "(section 64 ", lift_53, "\n", ")\n";
    }
    print "(rets-for lift_32_2 arg_37 ", arg_37, ")\n";
...
method Main () {
  ...
  if ((((lift_1 + lift_7) - multiset(lift_18)) >= ((lift_7 - lift_7) - multiset(
    ...
    if ((('l', true, lift_25).2 !! lift_26.2)) {
      ...
      {
        print "(section 2 ", methoddefvar_76, "\n", ")\n";
        lift_83 := [lift_84];
    ...
    );
    {
      ...
      if ((lift_30 < lift_30)) {
        ...
        var methoddefvar_185, methoddefvar_186 := lift_183_0(lift_5, lift_9);
        {
          ...
          lift_228 := lift_136;
          print "(section 21 ", 1283904198, "\n", ")\n";
        }
        if (lift_124) {
          lift_229 := lift_229;
          lift_231 := lift_172;
          print "(section 22 ", lift_68, "\n", ")\n";
        } else {
    ...
    if (lift_236.1(lift_169, |lift_104|)) {
      ...
      var lift_269 := lift_270;
      {
        ...
        print "(section 24 ", lift_54, "\n", ")\n";
        if (lift_123) {
          print "(section 25 ", lift_135, "\n", ")\n";
          lift_269 := lift_271;
        } else {
          print "(section 26 ", -210264364, "\n", ")\n";
        }
        lift_272 := lift_261;
      }
      if (lift_72) {
        ...
        if (lift_69) {
          ...
          lift_319 := lift_87;
          lift_320 := lift_320;
          print "(section 31 ", lift_173, "\n", ")\n";
        }
      }
      print "(section 32 ", lift_321.2, "\n", ")\n";
    } else {
      ...
      lift_327 := lift_85.0;
      {
        ...
        {
          print "(section 33 ", -322485990, "\n", ")\n";
          print "(section 34 ", lift_300, "\n", ")\n";
          print "(section 35 ", 1839220442, "\n", ")\n";
          print "(section 36 ", lift_324, "\n", ")\n";
          print "(section 37 ", lift_294, "\n", ")\n";
        }
        lift_328 := lift_341;
        var methoddefvar_342, methoddefvar_343 := lift_58_1(lift_326, lift_54);
        {
          ...
          lift_344 := lift_344;
          lift_345 := lift_346;
          print "(section 38 ", lift_324, "\n", ")\n";
          lift_347 := lift_6;
          lift_348 := lift_348;
        }
        {
          print "(section 39 ", lift_5, "\n", ")\n";
          lift_349 := lift_357;
          print "(section 40 ", lift_364, "\n", ")\n";
          print "(section 41 ", lift_298, "\n", ")\n";
          print "(section 42 ", -2040350812, "\n", ")\n";
        }
    ...
    if (((lift_104 + lift_386) !in lift_389.2)) {
      ...
      {
        print "(section 44 ", lift_381, "\n", ")\n";
        lift_413 := lift_413;
        lift_414 := lift_421;
        lift_427 := lift_21;
        print "(section 45 ", lift_364, "\n", ")\n";
      }
      var methoddefvar_430 := lift_428_0(lift_418, lift_422, lift_176);
      {
        ...
        lift_439 := lift_440;
        print "(section 47 ", lift_308, "\n", ")\n";
      }
      print "(section 48 ", lift_163.0, "\n", ")\n";
    ...
    print "(section 51 ", (lift_287 as int), "\n", ")\n";
    print "(section 52 ", lift_482.1.0, "\n", ")\n";
    if (!((lift_131 < multiset{lift_352, true, lift_137}))) {
      print "(section 53 ", |lift_1|, "\n", ")\n";
    } else {
      var lift_494 := ();
      var lift_487 := 1641848504;
      if ((lift_338 == lift_3 == lift_332)) {
        print "(section 54 ", lift_477, "\n", ")\n";
        lift_487 := lift_294;
      } else {
        print "(section 55 ", -1219071169, "\n", ")\n";
        lift_488 := lift_488;
      }
      if ((lift_24 >= lift_10)) {
        {
          print "(section 56 ", lift_324, "\n", ")\n";
          print "(section 57 ", lift_324, "\n", ")\n";
          print "(section 58 ", lift_383, "\n", ")\n";
          print "(section 59 ", lift_381, "\n", ")\n";
        }
      } else {
        {
          print "(section 60 ", 301393122, "\n", ")\n";
          lift_493 := 1754836732;
          print "(section 61 ", 1977143964, "\n", ")\n";
        }
      }
      lift_494 := lift_461.0;
    }
