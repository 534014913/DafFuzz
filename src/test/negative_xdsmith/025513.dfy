  ...
  ensures (true)
{
  ...
  arg_529 := -1017065961;
  {
    ...
    print "(params-for lift_521_0 arg_527 ", arg_527, ")\n";
    ...
    print "(rets-for lift_521_0 arg_528 ", arg_528, ")\n";
    print "(rets-for lift_521_0 arg_529 ", arg_529, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_340 := -732454361;
  {
    print "(meth-for lift_337_0)\n";
    {
      ...
      print "(section 89 ", lift_341, "\n", ")\n";
    }
    print "(rets-for lift_337_0 arg_340 ", arg_340, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_324 := 1630545579;
  {
    ...
    print "(params-for lift_316_0 arg_322 ", arg_322, ")\n";
    print "(meth-for lift_316_0)\n";
    {
      ...
      var lift_326 := ();
      var lift_325 := ();
      print "(section 86 ", arg_323, "\n", ")\n";
      print "(section 87 ", arg_320, "\n", ")\n";
      lift_325 := lift_326;
      print "(section 88 ", arg_324, "\n", ")\n";
      lift_327 := lift_325;
    }
    print "(rets-for lift_316_0 arg_323 ", arg_323, ")\n";
    print "(rets-for lift_316_0 arg_324 ", arg_324, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_202 := 245383114;
  {
    print "(meth-for lift_199_1)\n";
    {
      var lift_205 := true;
      var lift_204 := true;
      var lift_203 := -436451810;
      print "(section 81 ", lift_203, "\n", ")\n";
      lift_204 := lift_205;
    }
    print "(rets-for lift_199_1 arg_202 ", arg_202, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_182 := -1626268414;
  {
    print "(meth-for lift_177_0)\n";
    {
      ...
      lift_183 := lift_183;
      print "(section 79 ", arg_182, "\n", ")\n";
      lift_184 := lift_184;
      print "(section 80 ", arg_182, "\n", ")\n";
      lift_185 := lift_185;
    }
  ...
  ensures (true)
{
  ...
  arg_182 := -1626268414;
  {
    print "(meth-for lift_177_1)\n";
    {
      ...
      var lift_183 := (var tmpData : seq<set<set<bool>>> := []; tmpData);
      lift_183 := lift_183;
      print "(section 77 ", arg_182, "\n", ")\n";
      lift_184 := lift_184;
      print "(section 78 ", arg_182, "\n", ")\n";
      lift_185 := lift_185;
    }
    print "(rets-for lift_177_1 arg_181 ", arg_181, ")\n";
  ...
  ensures (true)
{
  arg_94 := -1364261662;
  {
    ...
    print "(meth-for lift_90_0)\n";
    {
      ...
      print "(section 73 ", arg_93, "\n", ")\n";
      lift_95 := lift_95;
      print "(section 74 ", arg_93, "\n", ")\n";
      lift_96 := lift_97;
    }
  ...
  ensures (true)
{
  arg_94 := -1364261662;
  {
    ...
    print "(meth-for lift_90_1)\n";
    {
      ...
      var lift_96 := lift_97;
      var lift_95 := -1486617771;
      print "(section 71 ", arg_93, "\n", ")\n";
      lift_95 := lift_95;
      print "(section 72 ", arg_93, "\n", ")\n";
      lift_96 := lift_97;
    }
  ...
  ensures (true)
{
  arg_94 := -1364261662;
  {
    ...
    print "(meth-for lift_90_2)\n";
    {
      ...
      var lift_96 := lift_97;
      var lift_95 := -1486617771;
      print "(section 69 ", arg_93, "\n", ")\n";
      lift_95 := lift_95;
      print "(section 70 ", arg_93, "\n", ")\n";
      lift_96 := lift_97;
    }
...
method Main () {
  ...
  var lift_20 := lift_21;
  {
    ...
    if ((lift_54.0 in lift_73(lift_81))) {
      ...
      print "(section 18 ", (lift_71[lift_53] as int), "\n", ")\n";
      var methoddefvar_151 := lift_27_1(lift_89, lift_132);
      {
        print "(section 19 ", lift_86, "\n", ")\n";
        lift_152 := lift_152;
        print "(section 20 ", lift_89, "\n", ")\n";
        print "(section 21 ", 1130174542, "\n", ")\n";
        print "(section 22 ", lift_87, "\n", ")\n";
      }
    }
  }
  ...
  );
  {
    ...
    if ((true <==> lift_174 <==> lift_68)) {
      ...
      {
        lift_214 := ();
        print "(section 24 ", -1840143983, "\n", ")\n";
      }
      print "(section 25 ", lift_193, "\n", ")\n";
      var methoddefvar_217, methoddefvar_218 := lift_215_0(lift_193, lift_106);
      {
        var lift_236 := lift_229;
        lift_229 := lift_236;
        print "(section 26 ", methoddefvar_218, "\n", ")\n";
        print "(section 27 ", lift_89, "\n", ")\n";
      }
    ...
    print "(section 30 ", (lift_207[lift_169] as int), "\n", ")\n";
  }
  {
    ...
    var lift_308 := (lift_56, lift_214);
    {
      ...
      }
      {
        ...
        var methoddefvar_339 := lift_337_0();
        {
          ...
          print "(section 32 ", lift_86, "\n", ")\n";
          print "(section 33 ", lift_331, "\n", ")\n";
          lift_342 := lift_342;
          lift_348 := {lift_349};
          lift_351 := '$';
        }
        if (lift_233) {
          ...
          print "(section 34 ", lift_352, "\n", ")\n";
          lift_353 := lift_356;
          print "(section 35 ", 860300115, "\n", ")\n";
          lift_367 := lift_168;
          lift_368 := lift_72;
        } else {
          var lift_370 := (lift_169, lift_371);
          print "(section 36 ", lift_314, "\n", ")\n";
          print "(section 37 ", lift_133, "\n", ")\n";
          print "(section 38 ", -1171595661, "\n", ")\n";
          print "(section 39 ", 836315460, "\n", ")\n";
          lift_370 := lift_370;
        }
        ...
        {
          lift_379 := lift_233;
          print "(section 41 ", lift_85, "\n", ")\n";
          print "(section 42 ", lift_358, "\n", ")\n";
          print "(section 43 ", lift_133, "\n", ")\n";
        }
      }
      lift_380 := lift_232.0;
      if ((lift_110 !in lift_83)) {
        ...
        {
          print "(section 44 ", -1938962117, "\n", ")\n";
          print "(section 45 ", -1059397744, "\n", ")\n";
          print "(section 46 ", lift_106, "\n", ")\n";
        }
        lift_412 := lift_190;
      } else {
        ...
        var methoddefvar_416 := lift_199_1();
        {
          ...
          lift_417 := lift_301;
          print "(section 48 ", lift_352, "\n", ")\n";
          print "(section 49 ", lift_198, "\n", ")\n";
          lift_418 := lift_332;
          print "(section 50 ", lift_307, "\n", ")\n";
        }
        if (true) {
          print "(section 51 ", -276725861, "\n", ")\n";
          lift_419 := lift_430;
        } else {
          var lift_440 := (lift_83, lift_66, lift_400);
          lift_432 := lift_440;
          print "(section 52 ", lift_305, "\n", ")\n";
          print "(section 53 ", -1660095645, "\n", ")\n";
      ...
      }
      {
        ...
        if (lift_160) {
          print "(section 55 ", lift_315, "\n", ")\n";
          print "(section 56 ", -240985274, "\n", ")\n";
        } else {
          var lift_447 := [lift_417];
          var lift_446 := (lift_447, lift_379);
          print "(section 57 ", lift_352, "\n", ")\n";
          lift_441 := multiset{lift_195, lift_86, lift_366};
          lift_446 := lift_448;
          print "(section 58 ", lift_358, "\n", ")\n";
        }
        if (lift_24) {
          var lift_454 := 1347103204;
          lift_454 := 1630593644;
          print "(section 59 ", lift_366, "\n", ")\n";
          print "(section 60 ", lift_85, "\n", ")\n";
          print "(section 61 ", lift_366, "\n", ")\n";
          lift_455 := -795760072;
        } else {
          lift_456 := 1976508990;
          lift_457 := lift_84;
          print "(section 62 ", lift_132, "\n", ")\n";
          lift_458 := lift_463;
        }
      }
    }
    var methoddefvar_474, methoddefvar_475 := lift_472_0();
    {
      ...
      var methoddefvar_492, methoddefvar_493 := lift_237_1(lift_88);
      {
        ...
        print "(section 63 ", 267386520, "\n", ")\n";
        print "(section 64 ", lift_428, "\n", ")\n";
      }
      lift_510 := lift_511;
      print "(section 65 ", lift_365, "\n", ")\n";
    }
