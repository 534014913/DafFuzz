  ...
  ensures (true)
{
  ...
  arg_295 := -175020141;
  {
    ...
    print "(params-for lift_287_0 arg_292 ", arg_292, ")\n";
    print "(params-for lift_287_0 arg_293 ", arg_293, ")\n";
    print "(meth-for lift_287_0)\n";
    {
      var lift_296 := ();
      print "(section 45 ", arg_293, "\n", ")\n";
      lift_296 := lift_296;
    }
    print "(rets-for lift_287_0 arg_294 ", arg_294, ")\n";
    print "(rets-for lift_287_0 arg_295 ", arg_295, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_282 := -609565301;
  {
    print "(params-for lift_278_0 arg_281 ", arg_281, ")\n";
    print "(meth-for lift_278_0)\n";
    {
      var lift_284 := true;
      var lift_283 := true;
      lift_283 := lift_284;
      print "(section 44 ", arg_281, "\n", ")\n";
    }
    print "(rets-for lift_278_0 arg_282 ", arg_282, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_178 := 1406599432;
  {
    print "(params-for lift_172_1 arg_175 ", arg_175, ")\n";
    print "(params-for lift_172_1 arg_176 ", arg_176, ")\n";
    print "(params-for lift_172_1 arg_177 ", arg_177, ")\n";
    print "(meth-for lift_172_1)\n";
    {
      ...
      var lift_180 := false;
      var lift_179 := lift_180;
      print "(section 38 ", arg_177, "\n", ")\n";
      print "(section 39 ", arg_178, "\n", ")\n";
      print "(section 40 ", arg_178, "\n", ")\n";
      lift_179 := lift_181;
      lift_183 := lift_180;
    }
    print "(rets-for lift_172_1 arg_178 ", arg_178, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_152 := 701984722;
  {
    ...
    print "(meth-for lift_144_0)\n";
    {
      ...
      lift_153 := lift_153;
      print "(section 36 ", arg_151, "\n", ")\n";
      print "(section 37 ", -1600488723, "\n", ")\n";
      lift_160 := lift_161;
    }
  ...
  ensures (true)
{
  arg_115 := 2067344513;
  {
    print "(meth-for lift_112_0)\n";
    {
      ...
      print "(section 34 ", -1190030121, "\n", ")\n";
      lift_116 := lift_117;
      print "(section 35 ", arg_115, "\n", ")\n";
      lift_125 := lift_128;
    }
    print "(rets-for lift_112_0 arg_115 ", arg_115, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_44 := -1307797013;
  {
    ...
    print "(meth-for lift_40_0)\n";
    {
      ...
      print "(section 32 ", arg_43, "\n", ")\n";
      lift_45 := lift_55;
      lift_69 := lift_70;
      print "(section 33 ", lift_67, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_19 := 1111492678;
  {
    ...
    print "(meth-for lift_13_0)\n";
    {
      ...
      var lift_20 := lift_21;
      lift_20 := lift_22;
      print "(section 30 ", arg_17, "\n", ")\n";
    }
    print "(rets-for lift_13_0 arg_18 ", arg_18, ")\n";
    print "(rets-for lift_13_0 arg_19 ", arg_19, ")\n";
  }
}
...
method Main () {
  ...
  print 
    "(section 0 ",
    ((lift_1 == lift_2), lift_3(lift_2, lift_9), (lift_2 !in lift_10)).1,
    "\n",
    ")\n";
  var methoddefvar_15, methoddefvar_16 := lift_13_0(lift_23);
  {
    ...
    if ((lift_12 in lift_25)) {
      ...
      {
        print "(section 1 ", methoddefvar_16, "\n", ")\n";
      ...
      {
        print "(section 4 ", methoddefvar_15, "\n", ")\n";
        print "(section 5 ", lift_82, "\n", ")\n";
        print "(section 6 ", methoddefvar_16, "\n", ")\n";
      ...
      if (lift_39) {
        ...
        print "(section 8 ", -1811474929, "\n", ")\n";
      }
    } else {
      {
        print "(section 9 ", lift_37, "\n", ")\n";
      }
    }
    print "(section 10 ", (lift_11 as int), "\n", ")\n";
    lift_87 := lift_94.2;
    var methoddefvar_114 := lift_112_0();
    {
      ...
      lift_134 := lift_141;
      print "(section 11 ", methoddefvar_114, "\n", ")\n";
    ...
    }
    {
      ...
      {
        print "(section 12 ", -802817095, "\n", ")\n";
      }
      if (lift_97) {
        lift_162 := lift_163;
        lift_166 := lift_9;
        lift_167 := lift_9;
        print "(section 13 ", 736031286, "\n", ")\n";
      } else {
        lift_168 := lift_23;
  ...
  );
  {
    ...
    }
    {
      ...
      {
        print "(section 18 ", methoddefvar_238, "\n", ")\n";
    ...
    if ((lift_82 > lift_205)) {
      ...
      {
        var lift_297 := ();
        print "(section 26 ", lift_200, "\n", ")\n";
        print "(section 27 ", lift_23, "\n", ")\n";
        print "(section 28 ", lift_199, "\n", ")\n";
        print "(section 29 ", 1617916158, "\n", ")\n";
        lift_297 := lift_9;
      }
    }
  }
