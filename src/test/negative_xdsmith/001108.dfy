  ...
  ensures (true)
{
  ...
  arg_122 := 1562302215;
  {
    ...
    print "(meth-for lift_114_0)\n";
    {
      ...
      var lift_123 := true;
      lift_123 := lift_124;
      print "(section 21 ", arg_121, "\n", ")\n";
      lift_127 := lift_127;
      print "(section 22 ", arg_118, "\n", ")\n";
      lift_132 := lift_133;
    }
  ...
  ensures (true)
{
  ...
  arg_46 := -1574336124;
  {
    ...
    print "(params-for lift_38_0 arg_44 ", arg_44, ")\n";
    print "(meth-for lift_38_0)\n";
    {
      var lift_47 := 499574795;
      print "(section 19 ", -1027710036, "\n", ")\n";
      lift_47 := arg_44;
      print "(section 20 ", arg_46, "\n", ")\n";
    }
    print "(rets-for lift_38_0 arg_45 ", arg_45, ")\n";
    print "(rets-for lift_38_0 arg_46 ", arg_46, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_46 := -1574336124;
  {
    print "(params-for lift_38_1 arg_42 ", arg_42, ")\n";
    print "(params-for lift_38_1 arg_43 ", arg_43, ")\n";
    print "(params-for lift_38_1 arg_44 ", arg_44, ")\n";
    print "(meth-for lift_38_1)\n";
    {
      var lift_47 := 499574795;
      print "(section 17 ", -1027710036, "\n", ")\n";
      lift_47 := arg_44;
      print "(section 18 ", arg_46, "\n", ")\n";
    }
    print "(rets-for lift_38_1 arg_45 ", arg_45, ")\n";
    print "(rets-for lift_38_1 arg_46 ", arg_46, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_46 := -1574336124;
  {
    print "(params-for lift_38_2 arg_42 ", arg_42, ")\n";
    print "(params-for lift_38_2 arg_43 ", arg_43, ")\n";
    print "(params-for lift_38_2 arg_44 ", arg_44, ")\n";
    print "(meth-for lift_38_2)\n";
    {
      var lift_47 := 499574795;
      print "(section 15 ", -1027710036, "\n", ")\n";
      lift_47 := arg_44;
      print "(section 16 ", arg_46, "\n", ")\n";
    }
    print "(rets-for lift_38_2 arg_45 ", arg_45, ")\n";
    print "(rets-for lift_38_2 arg_46 ", arg_46, ")\n";
  }
}
...
method Main () {
  ...
  var methoddefvar_3 := lift_1_0(lift_14, lift_14);
  {
    ...
    {
      print "(section 0 ", methoddefvar_17, "\n", ")\n";
    }
    ...
    if (("nDyu-cLp^_wq~$w$_*itCDfIlELPapV", true).1) {
      ...
      if (lift_50) {
        ...
        print "(section 3 ", -1030188571, "\n", ")\n";
        lift_92 := lift_93;
        print "(section 4 ", 324875015, "\n", ")\n";
      }
