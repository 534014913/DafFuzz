...
method lift_123_0 (arg_127 : int, arg_128 : int, arg_129 : int)
  ...
  requires (((arg_129 == 706520741) && ((arg_128 == -942049731) && ((arg_127 == 706520741) && true))))
  ensures (((arg_131 == -1663788436) && ((arg_130 == 234525163) && true)))
{
  arg_130 := 234525163;
  arg_131 := -1663788436;
  {
    assert (arg_130 == ((234525162 - 234525163) + (234525164 + 0)));
    assert (((-1885548022 == -1885548022) || (-1885548022 == -1885548022)) || ((-1885548022 + -1885548022) == -1885548022));
    assert (((-942049733 - -942049731) == (arg_128 - -942049729)) && ((-942049733 == arg_128) || (arg_128 == -942049731)));
    assert ((arg_130 == 234525163) || ((arg_130 < arg_130) && (arg_130 < arg_130)));
  }
}

method lift_123_1 (arg_127 : int, arg_128 : int, arg_129 : int)
  returns (arg_130 : int, arg_131 : int)
  requires (((arg_129 == 706520741) && ((arg_128 == 1) && ((arg_127 == -483598772) && true))))
  ensures (((arg_131 == -1663788436) && ((arg_130 == 234525163) && true)))
{
  arg_130 := 234525163;
  arg_131 := -1663788436;
  {
    assert ((arg_130 == 234525163) || ((arg_130 < arg_130) && (arg_130 < arg_130)));
    assert (((-1885548022 == -1885548022) || (-1885548022 == -1885548022)) || ((-1885548022 + -1885548022) == -1885548022));
    assert (((-2 - arg_128) - (0 - arg_128)) == ((0 - arg_128) + (0 - arg_128)));
    assert (((-234525163 - 234525163) == (arg_130 - 703575489)) && (-469050327 < (-234525163 - 234525163)));
  }
}
...
method lift_107_0 (arg_110 : int)
  returns (arg_111 : int)
  requires (((arg_110 == -2110510616) && true))
  ensures (((arg_111 == 404768565) && true))
{
  arg_111 := 404768565;
  {
    ...
    lift_117 := arg_110;
    assert (((-2 - arg_111) == (-1 - arg_111)) || ((-1 - arg_111) == (-1 - 404768565)));
    assert (((arg_110 == arg_110) || (arg_110 < arg_110)) && ((-2110510617 - arg_110) < (2110510619 + arg_110)));
  }
}

method lift_107_1 (arg_110 : int)
  returns (arg_111 : int)
  requires (((arg_110 == 347110577) && true))
  ensures (((arg_111 == 404768565) && true))
{
  arg_111 := 404768565;
  {
    ...
    lift_112 := (arg_110, lift_116);
    lift_117 := arg_110;
    assert (((arg_111 + arg_111) - 809537131) < ((-404768567 + 0) - (-1 - arg_111)));
    assert (0 == (-347110577 - (0 - arg_110)));
  }
}
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    {
      assert ((-1 - (906225239 + lift_98)) == ((906225238 - lift_98) + (-906225240 - lift_98)));
      {
        assert (((1880393811 + 5641181438) - (5641181440 + 1880393812)) == -3);
        lift_122 := lift_122;
        assert ((-1800306089 - (1800306089 + -1800306089)) == -1800306089);
        assert ((-49095982 - (147287946 + -49095982)) < -49095982);
      }
      ...
      {
        assert (((109294759 - 327884279) - (-109294760 + 109294759)) == ((0 - 109294759) + (-1 - 109294759)));
      }
      lift_132 := lift_56;
      assert (lift_18 == ((360954624 - 360954625) - (360954624 - 721909249)));
    }
  }
  ...
  );
  {
    ...
    lift_193 := lift_197.0;
    assert (((|lift_97| - 5) - (|lift_97| - |lift_97|)) == -1);
    lift_201 := (multiset{
      -1967973140,
      lift_149,
      lift_187,
