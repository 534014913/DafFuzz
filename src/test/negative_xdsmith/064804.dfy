  ...
  ensures (true)
{
  ...
  arg_378 := 277567852;
  {
    ...
    print "(meth-for lift_370_0)\n";
    {
      ...
      lift_379 := lift_379;
      print "(section 42 ", arg_374, "\n", ")\n";
      print "(section 43 ", arg_374, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_364 := 551362668;
  {
    print "(params-for lift_357_0 arg_361 ", arg_361, ")\n";
    print "(params-for lift_357_0 arg_362 ", arg_362, ")\n";
    print "(meth-for lift_357_0)\n";
    {
      print "(section 40 ", arg_363, "\n", ")\n";
      print "(section 41 ", arg_362, "\n", ")\n";
    }
    print "(rets-for lift_357_0 arg_363 ", arg_363, ")\n";
    print "(rets-for lift_357_0 arg_364 ", arg_364, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_354 := -1097808975;
  {
    ...
    {
      print "(section 37 ", arg_351, "\n", ")\n";
      print "(section 38 ", 165230528, "\n", ")\n";
      print "(section 39 ", arg_351, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_26 := -700092229;
  {
    ...
    {
      print "(section 34 ", arg_26, "\n", ")\n";
    }
    print "(rets-for lift_23_0 arg_26 ", arg_26, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_26 := -700092229;
  {
    ...
    {
      print "(section 33 ", arg_26, "\n", ")\n";
    }
    print "(rets-for lift_23_1 arg_26 ", arg_26, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_26 := -700092229;
  {
    print "(meth-for lift_23_2)\n";
    {
      print "(section 32 ", arg_26, "\n", ")\n";
    }
    print "(rets-for lift_23_2 arg_26 ", arg_26, ")\n";
  }
}
...
method Main () {
  ...
  if ((lift_1.2.0 >= (lift_15.1[lift_17 := lengthNormalize(|lift_21|)]))) {
    ...
    var methoddefvar_25 := lift_23_0();
    {
      ...
      var lift_28 := [lift_29, lift_39, lift_46];
      {
        ...
        lift_27 := lift_5;
        print "(section 2 ", methoddefvar_25, "\n", ")\n";
      }
      {
      ...
      if (lift_27) {
        ...
        print "(section 4 ", 942993453, "\n", ")\n";
        lift_57 := lift_57;
        print "(section 5 ", lift_66, "\n", ")\n";
      } else {
        lift_67 := '&';
        print "(section 6 ", -1106847985, "\n", ")\n";
      }
    }
    print "(section 7 ", lift_48.2, "\n", ")\n";
    ...
    }
    {
      ...
      print "(section 10 ", safeSeqRef(lift_109, lift_8, lift_8), "\n", ")\n";
      if ((lift_4 in lift_110)) {
        ...
        {
          print "(section 14 ", methoddefvar_151, "\n", ")\n";
          lift_152 := lift_152;
          print "(section 15 ", -841701623, "\n", ")\n";
        }
      }
    }
    ...
    {
      var lift_226 := '<';
      print "(section 18 ", -1387609080, "\n", ")\n";
      lift_205 := lift_92;
      if (lift_120) {
        print "(section 19 ", lift_79, "\n", ")\n";
        lift_206 := lift_206;
        print "(section 20 ", lift_49, "\n", ")\n";
        print "(section 21 ", 1675317844, "\n", ")\n";
        print "(section 22 ", lift_54, "\n", ")\n";
      } else {
        lift_218 := lift_66;
        print "(section 23 ", lift_77, "\n", ")\n";
      }
    ...
    lift_231 := lift_35;
    print "(section 24 ", lift_247(lift_254).2, "\n", ")\n";
  }
  print 
    "(section 25 ",
    safeSeqRef(lift_256, lift_239, lift_268).0(
      (|lift_53| >= |lift_40|),
  ...
  );
  {
    ...
    var methoddefvar_359, methoddefvar_360 := lift_357_0(-1457132164, lift_266);
    {
      var lift_365 := '?';
      lift_365 := lift_89;
      print "(section 26 ", lift_54, "\n", ")\n";
    }
    print "(section 27 ", |lift_285|, "\n", ")\n";
    lift_366 := |lift_367|;
  }
  ...
  );
  {
    ...
    {
      print "(section 28 ", lift_9, "\n", ")\n";
      lift_423 := lift_424;
      print "(section 29 ", 1860914174, "\n", ")\n";
      print "(section 30 ", 646171895, "\n", ")\n";
