  ...
  ensures (true)
{
  ...
  arg_282 := 856455772;
  {
    ...
    print "(meth-for lift_275_0)\n";
    {
      ...
      print "(section 40 ", arg_280, "\n", ")\n";
      lift_283 := lift_284;
      lift_286 := '!';
      print "(section 41 ", arg_280, "\n", ")\n";
      print "(section 42 ", arg_280, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_250 := -1262344377;
  {
    ...
    {
      print "(section 36 ", arg_249, "\n", ")\n";
      print "(section 37 ", 48602362, "\n", ")\n";
      print "(section 38 ", arg_247, "\n", ")\n";
      print "(section 39 ", arg_248, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_173 := -88743026;
  {
    print "(params-for lift_169_0 arg_172 ", arg_172, ")\n";
  ...
  ensures (true)
{
  arg_124 := -287805775;
  {
    ...
    {
      print "(section 34 ", 1762165477, "\n", ")\n";
      print "(section 35 ", arg_122, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_124 := -287805775;
  {
    ...
    {
      print "(section 32 ", 1762165477, "\n", ")\n";
      print "(section 33 ", arg_122, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_49 := -1309535626;
  {
    ...
    print "(rets-for lift_44_0 arg_48 ", arg_48, ")\n";
  ...
  ensures (true)
{
  ...
  arg_25 := 156133583;
  {
    print "(params-for lift_19_2 arg_23 ", arg_23, ")\n";
    print "(meth-for lift_19_2)\n";
    {
      var lift_39 := 'x';
      var lift_38 := lift_39;
      var lift_37 := lift_38;
    ...
    print "(rets-for lift_19_2 arg_24 ", arg_24, ")\n";
    print "(rets-for lift_19_2 arg_25 ", arg_25, ")\n";
  }
}
  ...
  var methoddefvar_3 := lift_1_0();
  {
    ...
    var lift_43 := ();
    {
      ...
      var methoddefvar_21, methoddefvar_22 := lift_19_0(lift_40);
      {
        ...
        print "(section 1 ", methoddefvar_21, "\n", ")\n";
    ...
    print 
      "(section 4 ",
      ("aVl|qz=SMhrdSEK<ys_KXH>Wu_tIgJ$JT", lift_58, (true, 'r')).1,
      "\n",
      ")\n";
    var methoddefvar_62 := lift_60_0();
    {
      print "(section 5 ", lift_58, "\n", ")\n";
      print "(section 6 ", lift_59, "\n", ")\n";
  ...
  if ((lift_68.2.0 !! lift_77.0.0 !! lift_93(
    ...
    );
    {
      ...
      var methoddefvar_171 := lift_169_0(lift_150);
      {
        ...
        lift_188 := ();
        lift_189 := lift_168;
        print "(section 8 ", methoddefvar_171, "\n", ")\n";
        lift_190 := lift_162;
        print "(section 9 ", 861715675, "\n", ")\n";
      }
    }
    print "(section 10 ", lift_191(lift_196.0, lift_202.0), "\n", ")\n";
    lift_211 := (lift_73.1 == lift_160.0);
    print "(section 11 ", lift_212(lift_211, lift_220, lift_86).1, "\n", ")\n";
  } else {
    var lift_289 := true;
    ...
    if ((lift_92, -1916557966).0) {
      ...
      {
        lift_289 := lift_205;
        print "(section 21 ", lift_137, "\n", ")\n";
        print "(section 22 ", lift_82, "\n", ")\n";
        print "(section 23 ", lift_132, "\n", ")\n";
      }
      {
        {
          print "(section 24 ", lift_133, "\n", ")\n";
          print "(section 25 ", -1517412148, "\n", ")\n";
        ...
        {
          print "(section 28 ", lift_82, "\n", ")\n";
        }
        {
          print "(section 29 ", lift_151, "\n", ")\n";
        }
      }
    }
  }
