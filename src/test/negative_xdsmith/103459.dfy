  ...
  ensures (true)
{
  arg_185 := -1528180649;
  {
    ...
    print "(meth-for lift_181_0)\n";
    {
      ...
      print "(section 25 ", arg_185, "\n", ")\n";
      lift_186 := lift_186;
      print "(section 26 ", arg_184, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_112 := 1575912174;
  {
    print "(meth-for lift_109_0)\n";
    {
      ...
      print "(section 18 ", arg_112, "\n", ")\n";
      lift_113 := lift_115;
      print "(section 19 ", lift_118, "\n", ")\n";
...
method Main () {
  ...
  );
  {
    ...
    print "(section 1 ", (lift_95[lift_108] as int), "\n", ")\n";
    var methoddefvar_111 := lift_109_0();
    {
      lift_119 := (lift_64, lift_107, lift_31);
      print "(section 2 ", methoddefvar_71, "\n", ")\n";
      lift_120 := lift_25;
    ...
    var methoddefvar_216 := lift_121_1(lift_67, lift_93, lift_145);
    {
      ...
      lift_217 := lift_224;
      print "(section 14 ", lift_68, "\n", ")\n";
      print "(section 15 ", methoddefvar_216, "\n", ")\n";
    }
  }
}
