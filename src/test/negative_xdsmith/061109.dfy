...
method lift_53_0 (arg_56 : int, arg_57 : int, arg_58 : int)
  returns (arg_59 : int)
  requires (((arg_58 == 782471971) && ((arg_57 == -967199511) && ((arg_56 == 294800770) && true))))
  ensures (((arg_59 == 1469434442) && true))
{
  arg_59 := 1469434442;
  {
...
method lift_1_0 (arg_5 : int, arg_6 : int, arg_7 : int)
  ...
  requires (((arg_7 == 294800770) && ((arg_6 == 5) && ((arg_5 == 3) && true))))
  ensures (((arg_9 == 906299508) && ((arg_8 == -904027603) && true)))
{
  arg_8 := -904027603;
  arg_9 := 906299508;
  {
    ...
    var lift_10 := lift_11;
    lift_10 := lift_12;
    assert (((arg_6 < arg_6) && (-1 == arg_6)) || ((-6 - 0) == (-1 - arg_6)));
    assert (((-2 - 294800770) == (arg_7 + arg_7)) || ((294800770 == arg_7) || (arg_7 < arg_7)));
    lift_16 := ();
    lift_17 := lift_18;
  }
}
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_55 := lift_53_0(lift_50, lift_25, lift_44);
    {
      ...
      assert (((lift_50 < lift_50) && (294800773 == lift_50)) || ((294800769 - 294800770) == (294800769 - lift_50)));
      assert (lift_50 < (-1 - (-2 - 0)));
      lift_64 := lift_25;
    }
  }
}
