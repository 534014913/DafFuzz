  ...
  ensures (true)
{
  arg_309 := -1290665547;
  {
    ...
    print "(meth-for lift_303_0)\n";
    {
      ...
      var lift_310 := 'M';
      lift_310 := lift_311;
      print "(section 53 ", arg_308, "\n", ")\n";
      lift_312 := lift_312;
      lift_319 := lift_319;
      print "(section 54 ", arg_306, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_187 := -899667939;
  {
    ...
    print "(meth-for lift_181_0)\n";
    {
      ...
      lift_188 := lift_188;
      print "(section 49 ", lift_189, "\n", ")\n";
      print "(section 50 ", arg_187, "\n", ")\n";
      print "(section 51 ", arg_186, "\n", ")\n";
      print "(section 52 ", arg_184, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_79 := 119758398;
  {
    ...
    print "(meth-for lift_75_0)\n";
    {
      ...
      var lift_81 := lift_82;
      var lift_80 := lift_81;
      print "(section 41 ", arg_79, "\n", ")\n";
      lift_80 := lift_82;
      print "(section 42 ", arg_78, "\n", ")\n";
      print "(section 43 ", arg_79, "\n", ")\n";
      print "(section 44 ", arg_79, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_79 := 119758398;
  {
    ...
    print "(meth-for lift_75_1)\n";
    {
      ...
      var lift_81 := lift_82;
      var lift_80 := lift_81;
      print "(section 37 ", arg_79, "\n", ")\n";
      lift_80 := lift_82;
      print "(section 38 ", arg_78, "\n", ")\n";
      print "(section 39 ", arg_79, "\n", ")\n";
      print "(section 40 ", arg_79, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_74 := -1826448594;
  {
    ...
    {
      print "(section 35 ", arg_72, "\n", ")\n";
      print "(section 36 ", arg_74, "\n", ")\n";
    }
  ...
  if ((lift_17.0 > safeSeqRef(
    ...
    if ((lift_20 || (multiset{
      ...
      );
      {
        ...
        lift_174 := lift_174;
        lift_175 := lift_176;
        print "(section 14 ", 202806802, "\n", ")\n";
        lift_177 := lift_178;
      }
      {
        {
          lift_179 := lift_96;
          print "(section 15 ", lift_127, "\n", ")\n";
          lift_180 := lift_142;
          print "(section 16 ", lift_48, "\n", ")\n";
        }
      }
      if ((lift_164 ==> lift_163 ==> lift_20)) {
        ...
        var methoddefvar_183 := lift_181_0(lift_10, lift_152, -2079022465);
        {
          ...
          lift_190 := lift_153;
          print "(section 18 ", methoddefvar_183, "\n", ")\n";
        }
        if (false) {
        ...
        if (lift_21) {
          ...
          var lift_212 := true;
          lift_211 := lift_20;
          print "(section 21 ", lift_7, "\n", ")\n";
          lift_212 := lift_163;
        }
        if (lift_163) {
          var lift_213 := lift_210;
          print "(section 22 ", lift_155, "\n", ")\n";
          lift_213 := lift_92;
          print "(section 23 ", 268925407, "\n", ")\n";
          lift_214 := lift_97;
        } else {
    ...
    );
    {
      if (false) {
        ...
        print "(section 30 ", -898299975, "\n", ")\n";
        lift_375 := lift_249;
        print "(section 31 ", lift_220, "\n", ")\n";
      }
      if (false) {
        var lift_377 := ["JBpbpbic", "*Oi\"g%&?u:CWyuhJ", lift_378];
        print "(section 32 ", lift_198, "\n", ")\n";
        lift_376 := lift_377;
        print "(section 33 ", lift_131, "\n", ")\n";
        lift_379 := [multiset{lift_236}];
      } else {
        var lift_380 := lift_292;
        print "(section 34 ", lift_135, "\n", ")\n";
        lift_380 := lift_145;
      }
    }
  }
