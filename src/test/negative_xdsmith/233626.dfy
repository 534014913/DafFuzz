  ...
  ensures (true)
{
  arg_64 := -1945296762;
  {
    ...
    print "(meth-for lift_58_0)\n";
    {
      ...
      print "(section 4 ", arg_61, "\n", ")\n";
      print "(section 5 ", -1883295989, "\n", ")\n";
      print "(section 6 ", arg_62, "\n", ")\n";
      lift_65 := lift_65;
      print "(section 7 ", arg_63, "\n", ")\n";
    }
...
method Main () {
  ...
  var lift_1 := lift_2;
  print "(section 0 ", (lift_1.2.2[lift_15.0.0] as int), "\n", ")\n";
  ...
  );
  {
    ...
    var methoddefvar_95, methoddefvar_96 := lift_93_0(lift_21, 415257920);
    {
      ...
      lift_143 := lift_143;
      print "(section 2 ", lift_150, "\n", ")\n";
    }
    print 
      "(section 3 ",
      safeSeqRef([lift_7, lift_21, lift_7, lift_11], lift_23, lift_21),
      "\n",
      ")\n";
    lift_151 := lift_151;
  }
