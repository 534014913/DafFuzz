  ...
  ensures (true)
{
  arg_799 := 1193048397;
  {
    print "(params-for lift_793_0 arg_796 ", arg_796, ")\n";
    print "(params-for lift_793_0 arg_797 ", arg_797, ")\n";
    print "(params-for lift_793_0 arg_798 ", arg_798, ")\n";
    print "(meth-for lift_793_0)\n";
    {
      ...
      lift_800 := lift_800;
      print "(section 135 ", arg_799, "\n", ")\n";
      lift_807 := lift_807;
    }
    print "(rets-for lift_793_0 arg_799 ", arg_799, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_780 := 1123268119;
  {
    ...
    {
      print "(section 134 ", arg_779, "\n", ")\n";
    }
    print "(rets-for lift_774_0 arg_779 ", arg_779, ")\n";
    print "(rets-for lift_774_0 arg_780 ", arg_780, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_747 := -600389312;
  {
    print "(params-for lift_740_0 arg_744 ", arg_744, ")\n";
    print "(params-for lift_740_0 arg_745 ", arg_745, ")\n";
    print "(meth-for lift_740_0)\n";
    {
      ...
      print "(section 133 ", arg_744, "\n", ")\n";
      lift_748 := lift_760;
      lift_764 := lift_753;
    }
    print "(rets-for lift_740_0 arg_746 ", arg_746, ")\n";
    print "(rets-for lift_740_0 arg_747 ", arg_747, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_747 := -600389312;
  {
    print "(params-for lift_740_1 arg_744 ", arg_744, ")\n";
    print "(params-for lift_740_1 arg_745 ", arg_745, ")\n";
    print "(meth-for lift_740_1)\n";
    {
      var lift_764 := false;
      var lift_763 := arg_746;
      var lift_762 := multiset{lift_763, -1476929814, -1176958146};
      ...
      var lift_749 := lift_750;
      var lift_748 := (lift_749, lift_756);
      print "(section 132 ", arg_744, "\n", ")\n";
      lift_748 := lift_760;
      lift_764 := lift_753;
    }
    print "(rets-for lift_740_1 arg_746 ", arg_746, ")\n";
    print "(rets-for lift_740_1 arg_747 ", arg_747, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_682 := -598562118;
  {
    ...
    {
      var lift_683 := ();
      print "(section 130 ", arg_681, "\n", ")\n";
      print "(section 131 ", arg_681, "\n", ")\n";
      lift_683 := ();
    }
    print "(rets-for lift_677_0 arg_681 ", arg_681, ")\n";
  ...
  ensures (true)
{
  ...
  arg_622 := 835165808;
  {
    print "(params-for lift_614_0 arg_618 ", arg_618, ")\n";
    print "(params-for lift_614_0 arg_619 ", arg_619, ")\n";
    print "(params-for lift_614_0 arg_620 ", arg_620, ")\n";
    print "(meth-for lift_614_0)\n";
    {
      print "(section 128 ", arg_618, "\n", ")\n";
      print "(section 129 ", arg_620, "\n", ")\n";
    }
    print "(rets-for lift_614_0 arg_621 ", arg_621, ")\n";
    print "(rets-for lift_614_0 arg_622 ", arg_622, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_561 := 657878931;
  {
    print "(meth-for lift_558_0)\n";
    {
      var lift_562 := ();
      lift_562 := ();
      print "(section 127 ", arg_561, "\n", ")\n";
    }
    print "(rets-for lift_558_0 arg_561 ", arg_561, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_536 := 1192226398;
  {
    print "(params-for lift_531_0 arg_534 ", arg_534, ")\n";
    ...
    print "(meth-for lift_531_0)\n";
    {
      ...
      lift_537 := lift_540;
      lift_547 := lift_548;
      print "(section 125 ", -883440277, "\n", ")\n";
      print "(section 126 ", arg_536, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_536 := 1192226398;
  {
    print "(params-for lift_531_1 arg_534 ", arg_534, ")\n";
    ...
    print "(meth-for lift_531_1)\n";
    {
      ...
      lift_537 := lift_540;
      lift_547 := lift_548;
      print "(section 123 ", -883440277, "\n", ")\n";
      print "(section 124 ", arg_536, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_463 := -986469671;
  {
    print "(params-for lift_459_0 arg_462 ", arg_462, ")\n";
    print "(meth-for lift_459_0)\n";
    {
      var lift_466 := ();
      var lift_465 := lift_466;
      var lift_464 := lift_465;
      print "(section 119 ", arg_463, "\n", ")\n";
      print "(section 120 ", -45333123, "\n", ")\n";
      print "(section 121 ", arg_463, "\n", ")\n";
      lift_464 := lift_466;
      print "(section 122 ", arg_462, "\n", ")\n";
    }
    print "(rets-for lift_459_0 arg_463 ", arg_463, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_463 := -986469671;
  {
    print "(params-for lift_459_1 arg_462 ", arg_462, ")\n";
    print "(meth-for lift_459_1)\n";
    {
      var lift_466 := ();
      var lift_465 := lift_466;
      var lift_464 := lift_465;
      print "(section 115 ", arg_463, "\n", ")\n";
      print "(section 116 ", -45333123, "\n", ")\n";
      print "(section 117 ", arg_463, "\n", ")\n";
      lift_464 := lift_466;
      print "(section 118 ", arg_462, "\n", ")\n";
    }
    print "(rets-for lift_459_1 arg_463 ", arg_463, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_257 := 850945644;
  {
    print "(params-for lift_251_1 arg_254 ", arg_254, ")\n";
    print "(params-for lift_251_1 arg_255 ", arg_255, ")\n";
    print "(params-for lift_251_1 arg_256 ", arg_256, ")\n";
    print "(meth-for lift_251_1)\n";
    {
      var lift_259 := 'L';
      var lift_258 := {'e', lift_259, '?', lift_259};
      lift_258 := lift_258;
    }
    print "(rets-for lift_251_1 arg_257 ", arg_257, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_186 := -1513934520;
  {
    ...
    print "(meth-for lift_180_1)\n";
    {
      ...
      var lift_188 := [arg_185, arg_185, arg_184];
      var lift_187 := lift_188;
      print "(section 111 ", -1771260401, "\n", ")\n";
      lift_187 := [-1608166010, arg_186];
      lift_189 := (arg_184, (lift_193, lift_194), lift_195);
    }
    print "(rets-for lift_180_1 arg_185 ", arg_185, ")\n";
    print "(rets-for lift_180_1 arg_186 ", arg_186, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_147 := 587241472;
  {
    ...
    {
      print "(section 108 ", -227759771, "\n", ")\n";
      print "(section 109 ", arg_145, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_147 := 587241472;
  {
    ...
    {
      print "(section 106 ", -227759771, "\n", ")\n";
      print "(section 107 ", arg_145, "\n", ")\n";
    }
    print "(rets-for lift_142_1 arg_147 ", arg_147, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_147 := 587241472;
  {
    ...
    {
      print "(section 104 ", -227759771, "\n", ")\n";
      print "(section 105 ", arg_145, "\n", ")\n";
    }
    print "(rets-for lift_142_2 arg_147 ", arg_147, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_80 := -107812213;
  {
    ...
    {
      var lift_81 := ();
      print "(section 99 ", 1155140456, "\n", ")\n";
      lift_81 := lift_81;
    }
    print "(rets-for lift_75_1 arg_79 ", arg_79, ")\n";
    print "(rets-for lift_75_1 arg_80 ", arg_80, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_52 := -1743842274;
  {
    print "(params-for lift_48_1 arg_51 ", arg_51, ")\n";
    print "(meth-for lift_48_1)\n";
    {
      print "(section 97 ", 127726383, "\n", ")\n";
    }
    print "(rets-for lift_48_1 arg_52 ", arg_52, ")\n";
  }
}
...
method Main () {
  ...
  var lift_26 := lift_27;
  {
    ...
    );
    {
      ...
      var methoddefvar_77, methoddefvar_78 := lift_75_0();
      {
        ...
        lift_82 := -945382908;
        print "(section 9 ", methoddefvar_78, "\n", ")\n";
        print "(section 10 ", lift_39, "\n", ")\n";
      }
    }
    if ((lift_83.0 !! lift_88)) {
      ...
      var methoddefvar_93 := lift_91_0();
      {
        ...
        print "(section 11 ", lift_97, "\n", ")\n";
        print "(section 12 ", lift_98, "\n", ")\n";
        lift_99 := ();
      }
      {
        var lift_134 := true;
        ...
        var methoddefvar_103 := lift_101_0(lift_87, 1915644533, lift_128);
        {
          ...
          lift_129 := lift_129;
          print "(section 13 ", methoddefvar_103, "\n", ")\n";
          lift_130 := {(), ()};
        }
        {
      ...
      }
      {
        ...
        {
          print "(section 21 ", lift_150, "\n", ")\n";
          print "(section 22 ", lift_98, "\n", ")\n";
          lift_179 := lift_61;
          print "(section 23 ", lift_175, "\n", ")\n";
          print "(section 24 ", lift_150, "\n", ")\n";
        }
      }
    } else {
      ...
      var methoddefvar_182, methoddefvar_183 := lift_180_0(lift_150);
      {
        ...
        print "(section 26 ", methoddefvar_182, "\n", ")\n";
        lift_198 := lift_198;
      }
    }
    if (((lift_98 - 611577775) > |lift_55|)) {
      var lift_201 := [lift_197, lift_98];
      print "(section 27 ", safeSeqRef(lift_200, lift_98, lift_98), "\n", ")\n";
      print 
        "(section 28 ",
        safeSeqRef(lift_201, lift_87, lift_197),
        "\n",
        ")\n";
    } else {
      ...
      if ((1026554536 < lift_211 < lift_87)) {
        ...
        var methoddefvar_244 := lift_142_1(lift_210, lift_211);
        {
          ...
          print "(section 31 ", lift_140, "\n", ")\n";
          print "(section 32 ", lift_98, "\n", ")\n";
        }
        if (lift_151) {
          print "(section 33 ", lift_176, "\n", ")\n";
          lift_245 := lift_72;
        } else {
        ...
        lift_249 := lift_209;
        print "(section 34 ", lift_175, "\n", ")\n";
      } else {
        lift_250 := lift_250;
        print "(section 35 ", lift_176, "\n", ")\n";
      }
    ...
    var methoddefvar_295, methoddefvar_296 := lift_293_0(lift_266, lift_138.1);
    {
      ...
      print "(section 38 ", 1397480730, "\n", ")\n";
      print "(section 39 ", lift_87, "\n", ")\n";
      lift_313 := lift_73;
    }
  }
  print "(section 40 ", lift_314.1.1.1, "\n", ")\n";
  if ((safeSeqRef(
    ...
    print 
      "(section 41 ",
      safeSeqRef(lift_374, lift_87, lift_387)(
        safeSeqRef([lift_44, lift_310, lift_45], lift_322, lift_309),
        lift_59.0,
        (false && lift_343)
      ),
      "\n",
    ...
    {
      {
        ...
        lift_396 := lift_215;
        lift_397 := lift_397;
        print "(section 42 ", methoddefvar_394, "\n", ")\n";
      }
      print "(section 43 ", lift_197, "\n", ")\n";
    }
    ...
    );
    {
      ...
      print "(section 44 ", lift_197, "\n", ")\n";
      if (lift_309) {
        var lift_406 := -1680415617;
        var lift_405 := multiset{lift_210};
        lift_405 := lift_215;
        print "(section 45 ", lift_175, "\n", ")\n";
        lift_406 := 545811598;
        print "(section 46 ", lift_402, "\n", ")\n";
      } else {
        lift_407 := lift_402;
        print "(section 47 ", 761221631, "\n", ")\n";
        lift_408 := lift_372;
        lift_409 := lift_409;
        print "(section 48 ", lift_216, "\n", ")\n";
      }
      if (lift_408) {
        lift_410 := (lift_69, lift_413, lift_340);
        lift_424 := lift_401;
        print "(section 49 ", methoddefvar_403, "\n", ")\n";
        lift_425 := lift_425;
        print "(section 50 ", methoddefvar_403, "\n", ")\n";
      } else {
      ...
      }
      {
        ...
        lift_454 := lift_455;
        print "(section 54 ", lift_427, "\n", ")\n";
      }
    }
    print 
      "(section 55 ",
      |safeSeqSlice3Colon(lift_137, 153497546, lift_197, lift_400)|,
      "\n",
      ")\n";
  } else {
    ...
    }
    {
      ...
      if (lift_30) {
        ...
        print "(section 59 ", 1874903005, "\n", ")\n";
        if (lift_408) {
          print "(section 60 ", lift_402, "\n", ")\n";
          print "(section 61 ", -146311333, "\n", ")\n";
          lift_471 := lift_480;
        } else {
      ...
      var methoddefvar_520 := lift_251_1(lift_421, 484337133, lift_176);
      {
        ...
        print "(section 62 ", -838846397, "\n", ")\n";
        print "(section 63 ", lift_402, "\n", ")\n";
        lift_521 := lift_523;
    ...
    var methoddefvar_533 := lift_531_0(lift_400, |{{(), ()}, lift_428}|);
    {
      var methoddefvar_560 := lift_558_0();
      {
        ...
        lift_563 := lift_569;
        print "(section 64 ", lift_421, "\n", ")\n";
        lift_577 := lift_578;
        print "(section 65 ", lift_473, "\n", ")\n";
      }
    }
    lift_579 := lift_589;
  }
  lift_594 := lift_141;
  {
    ...
    );
    {
      ...
      var lift_647 := 'z';
      print "(section 66 ", lift_87, "\n", ")\n";
      {
        lift_636 := lift_132;
        lift_637 := lift_637;
        print "(section 67 ", lift_216, "\n", ")\n";
        lift_647 := 'U';
        lift_648 := 2105528513;
      }
      print "(section 68 ", lift_87, "\n", ")\n";
      print "(section 69 ", lift_451, "\n", ")\n";
    ...
    if (((lift_585 <= lift_584 == lift_211) ==> lift_408 ==> lift_414.2)) {
      ...
      if (((var tmpData : set<char> := {}; tmpData) == lift_281)) {
        ...
        if (lift_364) {
          ...
          print "(section 70 ", lift_197, "\n", ")\n";
          print "(section 71 ", lift_402, "\n", ")\n";
          lift_650 := lift_652;
          lift_655 := lift_285;
        } else {
          var lift_658 := "s-Yus~jpOxN_?n'|%k$uXS&gvZO-oiGOD;KMLm";
          lift_656 := lift_197;
          print "(section 72 ", -704509506, "\n", ")\n";
          lift_657 := lift_488;
          print "(section 73 ", lift_321, "\n", ")\n";
        ...
        }
        {
          ...
          print "(section 74 ", lift_656, "\n", ")\n";
          print "(section 75 ", lift_586, "\n", ")\n";
          lift_659 := lift_659;
          lift_669 := lift_669;
          lift_673 := lift_674;
        }
        print "(section 76 ", lift_584, "\n", ")\n";
        var methoddefvar_679, methoddefvar_680 := lift_677_0();
        {
          print "(section 77 ", 1444085439, "\n", ")\n";
        ...
        if (lift_429) {
          print "(section 78 ", lift_427, "\n", ")\n";
          lift_704 := lift_638;
          print "(section 79 ", lift_321, "\n", ")\n";
          print "(section 80 ", lift_400, "\n", ")\n";
        } else {
          lift_705 := lift_676;
          lift_706 := lift_707;
        }
    ...
    } else {
      {
        ...
        {
          print "(section 82 ", lift_424, "\n", ")\n";
          lift_765 := lift_765;
        }
        var methoddefvar_776, methoddefvar_777 := lift_774_0(lift_402);
        {
          print "(section 83 ", lift_424, "\n", ")\n";
        }
        lift_781 := lift_782;
        {
          var lift_783 := ();
          print "(section 84 ", lift_656, "\n", ")\n";
          lift_783 := lift_704;
          lift_784 := lift_784;
          print "(section 85 ", lift_407, "\n", ")\n";
        }
      }
    }
    var methoddefvar_787 := lift_142_2((lift_633 as int), |lift_41|);
    {
      if (lift_151) {
        ...
        lift_788 := lift_582;
        print "(section 86 ", lift_789, "\n", ")\n";
      } else {
        print "(section 87 ", lift_710, "\n", ")\n";
        lift_790 := lift_613;
        print "(section 88 ", 215493978, "\n", ")\n";
        print "(section 89 ", lift_407, "\n", ")\n";
        print "(section 90 ", 636417527, "\n", ")\n";
      }
    ...
    );
    {
      ...
      {
        lift_810 := lift_732;
        print "(section 92 ", lift_402, "\n", ")\n";
        lift_811 := lift_714;
        print "(section 93 ", lift_693, "\n", ")\n";
      }
    }
    lift_813 := lift_863.0;
  }
