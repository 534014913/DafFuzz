  ...
  ensures (true)
{
  arg_284 := -2115682779;
  {
    print "(meth-for lift_281_0)\n";
    {
      ...
      var lift_286 := ();
      var lift_285 := ();
      print "(section 42 ", arg_284, "\n", ")\n";
      lift_285 := lift_286;
      print "(section 43 ", lift_287, "\n", ")\n";
      print "(section 44 ", 945885524, "\n", ")\n";
      print "(section 45 ", lift_288, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_193 := 1197532261;
  {
    ...
    print "(meth-for lift_188_0)\n";
    {
      ...
      print "(section 39 ", arg_191, "\n", ")\n";
      print "(section 40 ", arg_191, "\n", ")\n";
      lift_194 := arg_192;
      lift_195 := arg_192;
    }
    print "(rets-for lift_188_0 arg_193 ", arg_193, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_193 := 1197532261;
  {
    print "(params-for lift_188_1 arg_191 ", arg_191, ")\n";
    print "(params-for lift_188_1 arg_192 ", arg_192, ")\n";
    ...
    print "(rets-for lift_188_1 arg_193 ", arg_193, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_58 := -906159529;
  {
    ...
    print "(params-for lift_52_0 arg_57 ", arg_57, ")\n";
    print "(meth-for lift_52_0)\n";
    {
      ...
      var lift_59 := lift_60;
      lift_59 := lift_59;
      print "(section 32 ", arg_57, "\n", ")\n";
      lift_61 := lift_61;
      print "(section 33 ", arg_56, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_58 := -906159529;
  {
    ...
    print "(params-for lift_52_1 arg_57 ", arg_57, ")\n";
    print "(meth-for lift_52_1)\n";
    {
      ...
      var lift_59 := lift_60;
      lift_59 := lift_59;
      print "(section 30 ", arg_57, "\n", ")\n";
      lift_61 := lift_61;
      print "(section 31 ", arg_56, "\n", ")\n";
    }
    print "(rets-for lift_52_1 arg_58 ", arg_58, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_33 := -1114059069;
  {
    ...
    print "(rets-for lift_30_0 arg_33 ", arg_33, ")\n";
  }
}
  ...
  if (safeSeqRef(
    ...
    if (lift_25) {
      ...
      if ((lift_102 == lift_102)) {
        ...
        {
          lift_103 := lift_103;
          print "(section 9 ", 1993023437, "\n", ")\n";
          print "(section 10 ", 1578369902, "\n", ")\n";
        }
      } else {
    ...
    print "(section 22 ", ((lift_67 + lift_67)[lift_17] as int), "\n", ")\n";
    ...
    {
      if (lift_251) {
        print "(section 23 ", lift_140, "\n", ")\n";
        print "(section 24 ", lift_205, "\n", ")\n";
        print "(section 25 ", lift_91, "\n", ")\n";
      } else {
