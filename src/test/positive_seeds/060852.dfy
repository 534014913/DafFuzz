...
method lift_103_0 ()
  ...
  requires (true)
  ensures (((arg_108 == -2025312628) && ((arg_107 == -41158617) && true)))
{
  arg_107 := -41158617;
  arg_108 := -2025312628;
  {
...
method lift_7_0 (arg_10 : int, arg_11 : int, arg_12 : int)
  returns (arg_13 : int)
  requires (((arg_12 == -442275344) && ((arg_11 == 0) && ((arg_10 == -774108924) && true))))
  ensures (((arg_13 == 979793971) && true))
{
  arg_13 := 979793971;
  {
    var lift_14 := true;
    assert ((-401328313 == -401328313) || ((-401328313 - -401328312) == -1));
    lift_14 := lift_14;
    assert ((arg_10 + (-3096435700 - arg_10)) == ((-2322326774 - arg_10) + (-2322326774 - arg_10)));
  }
}
...
method Main () {
  ...
  assert (((-2 - |(lift_57.2 * safeSeqRef(
    lift_73,
    -1193682162,
    lift_70
  ) * (lift_70 + {lift_56}))|) - (0 - |(lift_57.2 * safeSeqRef(
    lift_73,
    -1193682162,
    lift_70
  ) * (lift_70 + {lift_56}))|)) == ((0 - |(lift_57.2 * safeSeqRef(
  ...
  {
    {
      ...
      {
        assert (((lift_84 < lift_84) && (240056720 == 240056721)) || ((-240056720 - 0) == (-1 - lift_84)));
        assert (((lift_34 - -442275336) - (-442275345 - lift_34)) < -6);
      }
      {
        assert (((lift_18 == lift_18) && (lift_18 == 345054935)) || ((-1 - 345054935) == (-1 - lift_18)));
      }
    }
  }
}
