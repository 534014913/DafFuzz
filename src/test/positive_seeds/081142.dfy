...
method lift_6_0 (arg_9 : int, arg_10 : int, arg_11 : int)
  returns (arg_12 : int)
  requires (((arg_11 == -1967653813) && ((arg_10 == -1376594083) && ((arg_9 == -1376594083) && true))))
  ensures (((arg_12 == 1655191160) && true))
{
  arg_12 := 1655191160;
  {
    var lift_15 := false;
    var lift_14 := lift_15;
    var lift_13 := lift_14;
    assert (((arg_9 < arg_9) || (arg_9 < arg_9)) || ((arg_9 < arg_9) || (-1376594083 == arg_9)));
    lift_13 := lift_14;
    assert (((-2753188166 - -1376594082) - (-1376594083 - arg_10)) < -1376594083);
    assert (arg_12 == 1655191160);
  }
}
...
method lift_1_0 ()
  returns (arg_4 : int)
  requires (true)
  ensures (((arg_4 == 594076243) && true))
{
  arg_4 := 594076243;
  {
    var lift_5 := 1876268108;
    assert (((lift_5 == lift_5) || (lift_5 == lift_5)) && ((lift_5 == lift_5) && (lift_5 == 1876268108)));
  }
}
...
method Main () {
  ...
  var methoddefvar_3 := lift_1_0();
  {
    ...
    {
      assert (((lift_17 == lift_17) && (lift_17 < lift_17)) || ((-1967653813 == lift_17) && (lift_17 == lift_17)));
      assert ((lift_17 - (lift_17 - 2)) == ((lift_17 + 1967653814) + (lift_17 + 1967653814)));
    }
  }
  assert (((safeSeqRef(
    lift_18,
    1123802940,
    lift_21
  ).1.0 + -1261942554) + (2523885106 + -1261942554)) < ((safeSeqRef(
    lift_18,
    1123802940,
    lift_21
  ).1.0 - -1261942551) + safeSeqRef(lift_18, 1123802940, lift_21).1.0));
