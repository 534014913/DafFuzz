...
method lift_253_0 ()
  ...
  requires (true)
  ensures (((arg_258 == -606412342) && ((arg_257 == -1299745238) && true)))
{
  arg_257 := -1299745238;
  arg_258 := -606412342;
  {
...
method lift_205_0 (arg_208 : int)
  returns (arg_209 : int)
  requires (((arg_208 == 1411016996) && true))
  ensures (((arg_209 == -495405043) && true))
{
  arg_209 := -495405043;
  {
    var lift_219 := ();
    ...
    assert (((1411016994 - arg_208) < (1411016995 - arg_208)) && ((-2 + 1411016998) == arg_208));
    lift_210 := lift_211;
    lift_218 := lift_218;
    assert (((1411016994 - arg_208) < (1411016995 - arg_208)) && ((-2 + 1411016998) == arg_208));
  }
...
method lift_164_0 ()
  ...
  requires (true)
  ensures (((arg_169 == -672279346) && ((arg_168 == 516433827) && true)))
{
  arg_168 := 516433827;
  arg_169 := -672279346;
  {
    ...
    assert (((-672279345 - arg_169) == (1 - 0)) || ((-672279348 - arg_169) == (-672279347 - arg_169)));
    assert (((-1291881271 < -1291881271) && (-1291881271 < -1291881271)) || ((-1291881272 - -1291881271) == (-1291881272 - -1291881271)));
    lift_170 := lift_175;
    assert (((lift_178 < -36772138) && (lift_178 == lift_178)) || ((lift_178 + lift_178) == 1));
...
method lift_150_0 (arg_153 : int)
  returns (arg_154 : int)
  requires (((arg_153 == 481314125) && true))
  ensures (((arg_154 == 1454445251) && true))
{
  arg_154 := 1454445251;
  {
    var lift_160 := '-';
    ...
    assert (((-1211728998 + lift_155) - (-1211728996 + lift_155)) == ((1211728992 - lift_155) + (1211728992 - lift_155)));
    assert (((-1546600309 + 1546600304) - (1546600306 - 1546600306)) < ((-1546600310 + 1546600306) - (1546600303 - 1546600306)));
...
method lift_56_1 (arg_59 : int, arg_60 : int, arg_61 : int)
  returns (arg_62 : int)
  requires (((arg_61 == 1411016996) && ((arg_60 == 717404996) && ((arg_59 == 717404996) && true))))
  ensures (((arg_62 == 1986695398) && true))
{
  arg_62 := 1986695398;
  {
    var lift_66 := true;
...
method Main () {
  ...
  if (!((safeSeqRef(lift_1, -1777745284, lift_2) > ((), lift_3).1))) {
    ...
    var methoddefvar_152 := lift_150_0(lift_141);
    {
      ...
      var methoddefvar_166, methoddefvar_167 := lift_164_0();
      {
        ...
        assert ((886701411 + (886701411 - 886701412)) < 886701411);
        assert (((-516433832 + methoddefvar_166) - (-516433830 + methoddefvar_166)) == ((516433826 - methoddefvar_166) + (516433826 - methoddefvar_166)));
      }
      assert ((methoddefvar_152 + (-2908890503 - -1454445252)) == ((-1454445253 + 2908890504) - methoddefvar_152));
    }
    var methoddefvar_207 := lift_205_0(lift_197.0);
    {
      ...
      if (lift_195) {
        assert (((-478203738 - -159401248) + (159401244 - lift_191)) < lift_191);
        assert (((methoddefvar_207 + methoddefvar_207) - methoddefvar_207) < 0);
        lift_221 := lift_149;
        assert (((-597403434 - lift_69) < (-597403433 - lift_69)) && ((-597403434 - -597403432) < (-597403433 - lift_69)));
        assert (((-1173384448 < -1173384448) || (-1173384448 < -1173384446)) || ((-1173384450 - -1173384448) == (-1173384449 - -1173384448)));
      } else {
        var lift_222 := true;
        lift_222 := lift_143;
        assert false;
      ...
      }
      {
        ...
        assert (((1411016994 - lift_198) < (1411016995 - lift_198)) && ((-2 + 1411016998) == lift_198));
        lift_228 := lift_228;
        lift_237 := lift_238;
      }
      {
      ...
      assert (((159401243 - lift_191) == (159401245 - 159401247)) && ((159401243 - lift_191) < (159401244 - lift_191)));
    }
  }
  var methoddefvar_255, methoddefvar_256 := lift_253_0();
  {
    ...
    {
      assert (((lift_142 < lift_142) || (lift_142 < lift_142)) || ((-1045417990 == lift_142) && (lift_142 == lift_142)));
    }
  }
}
