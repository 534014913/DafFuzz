...
method lift_137_0 (arg_140 : int, arg_141 : int)
  returns (arg_142 : int)
  requires (((arg_141 == 714510474) && ((arg_140 == -913815545) && true)))
  ensures (((arg_142 == -1870119017) && true))
{
  arg_142 := -1870119017;
  {
    ...
    var lift_143 := false;
    lift_143 := lift_144;
    assert (((-714510479 + arg_141) - (-714510477 + arg_141)) == ((714510473 - arg_141) + (714510473 - arg_141)));
    lift_145 := (
      lift_148,
...
method lift_50_0 (arg_54 : int)
  ...
  requires (((arg_54 == 588818472) && true))
  ensures (((arg_56 == -404627575) && ((arg_55 == -83400305) && true)))
{
  arg_55 := -83400305;
  arg_56 := -404627575;
  {
    ...
    assert ((arg_55 - (-1 - arg_55)) < arg_55);
    lift_57 := [lift_58, ('H', lift_62, lift_63), lift_64];
    assert (((588818471 - arg_54) < (-588818471 + arg_54)) || ((588818473 == arg_54) || (arg_54 == -588818471)));
    assert (((-404627577 - arg_56) == (-404627576 - arg_56)) || (arg_56 == (-809255150 - arg_56)));
  }
}

method lift_30_0 (arg_33 : int)
  returns (arg_34 : int)
  requires (((arg_33 == 588818472) && true))
  ensures (((arg_34 == 1041502453) && true))
{
  arg_34 := 1041502453;
  {
    var lift_41 := 'K';
...
method lift_17_0 (arg_20 : int)
  returns (arg_21 : int)
  requires (((arg_20 == 909934943) && true))
  ensures (((arg_21 == 714510474) && true))
{
  arg_21 := 714510474;
  {
    ...
    var lift_22 := true;
    lift_22 := lift_23;
    assert ((lift_24 < 425628923) && (lift_24 == (lift_24 - 0)));
  }
}
...
method Main () {
  ...
  var lift_15 := lift_16;
  var lift_14 := 'V';
  assert ((lift_1(lift_14, lift_14, lift_15).2.1 + (-77550434 - lift_1(
    lift_14,
    lift_14,
    lift_15
  ).2.1)) == ((-58162825 - lift_1(
    ...
    lift_14,
    lift_15
  ).2.1) + (-58162825 - lift_1(lift_14, lift_14, lift_15).2.1)));
  var methoddefvar_19 := lift_17_0(lift_25.2);
  {
    ...
    var methoddefvar_32 := lift_30_0(lift_15);
    {
      ...
      lift_42 := lift_48;
      assert (((methoddefvar_32 + methoddefvar_32) + (-3124507359 - methoddefvar_32)) < ((methoddefvar_32 - 2083004906) + methoddefvar_32));
    }
    ...
    assert (((safeSeqRef(lift_72, methoddefvar_19, lift_16) + safeSeqRef(
      lift_72,
      methoddefvar_19,
      lift_16
    )) + (-588818473 - safeSeqRef(
      lift_72,
      methoddefvar_19,
      lift_16
    ))) < ((safeSeqRef(
      ...
      methoddefvar_19,
      lift_16
    ) - 1177636944) + safeSeqRef(lift_72, methoddefvar_19, lift_16)));
    if ((lift_49 in lift_78)) {
      ...
      if (lift_82) {
        lift_83 := lift_95;
        assert (((lift_44 == lift_44) && (lift_44 == lift_44)) && (lift_44 == (-1827631090 - lift_44)));
        assert (((588818471 - lift_15) < (-588818471 + lift_15)) || ((588818473 == lift_15) || (lift_15 == -588818471)));
      } else {
    ...
    var methoddefvar_139 := lift_137_0(lift_44, methoddefvar_19);
    {
      ...
      lift_151 := lift_14;
      lift_152 := false;
      assert (((lift_44 + lift_44) + (-913815545 - -913815543)) < ((lift_44 - -913815542) + (-2741446633 - lift_44)));
      assert (((588818471 - lift_16) < (-588818471 + lift_16)) || ((588818473 == lift_16) || (lift_16 == -588818471)));
      lift_153 := lift_159;
    }
  }
  assert (lift_162.0.2.2 == ((lift_162.0.2.2 - 1) + (-1693475579 - lift_162.0.2.2)));
}
