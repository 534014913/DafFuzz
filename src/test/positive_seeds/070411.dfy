...
method lift_424_0 (arg_427 : int, arg_428 : int)
  returns (arg_429 : int)
  requires (((arg_428 == 1371310021) && ((arg_427 == 811560581) && true)))
  ensures (((arg_429 == 1548287335) && true))
{
  arg_429 := 1548287335;
  {
    var lift_437 := 'A';
    ...
    var lift_432 := '>';
    var lift_431 := 'M';
    var lift_430 := multiset{lift_431, lift_431, lift_431, lift_431, lift_432};
...
method lift_378_0 (arg_382 : int, arg_383 : int, arg_384 : int)
  ...
  requires (((arg_384 == -1375076335) && ((arg_383 == -1532536848) && ((arg_382 == 66070154) && true))))
  ensures (((arg_386 == 200329726) && ((arg_385 == 1144166853) && true)))
{
  arg_385 := 1144166853;
  arg_386 := 200329726;
  {
    ...
    var lift_387 := ();
    assert (((-1814499201 - -1814499199) == (-1814499199 - -1814499197)) && ((-1814499199 == -1814499199) || (-1814499199 == -1814499199)));
    lift_387 := lift_387;
    lift_388 := lift_388;
    lift_406 := lift_406;
  }
...
method lift_347_0 ()
  returns (arg_350 : int)
  requires (true)
  ensures (((arg_350 == -501471287) && true))
{
  arg_350 := -501471287;
  {
    var lift_366 := 'x';
    ...
    var lift_359 := multiset{lift_360, lift_363, lift_363, lift_361, lift_363};
    var lift_358 := 'Y';
    var lift_357 := true;
...
method lift_342_0 (arg_345 : int)
  returns (arg_346 : int)
  requires (((arg_345 == 3) && true))
  ensures (((arg_346 == 66070154) && true))
{
  arg_346 := 66070154;
  {
    assert ((-1 == (arg_345 - 4)) && ((-4 - arg_345) == (-10 + arg_345)));
  }
}

method lift_342_1 (arg_345 : int)
  returns (arg_346 : int)
  requires (((arg_345 == 1676891490) && true))
  ensures (((arg_346 == 66070154) && true))
{
  arg_346 := 66070154;
  {
    assert (arg_345 == ((1 - 2) + 1676891491));
  }
}

method lift_265_0 (arg_268 : int, arg_269 : int)
  returns (arg_270 : int)
  requires (((arg_269 == 1) && ((arg_268 == 2) && true)))
  ensures (((arg_270 == 664652816) && true))
{
  arg_270 := 664652816;
  {
    var lift_315 := true;
    ...
    var lift_281 := multiset{lift_282, lift_282, lift_283, lift_283, lift_288};
    ...
    lift_271 := lift_275;
    assert (((377096964 == lift_279) || (lift_279 < lift_279)) || ((377096966 - lift_279) == 1));
    lift_280 := lift_296;
    assert (((-2 - arg_269) - (0 - arg_269)) == ((0 - arg_269) + (0 - arg_269)));
  }
}

method lift_242_0 (arg_246 : int)
  returns (arg_247 : int, arg_248 : int)
  requires (((arg_246 == -152999345) && true))
  ensures (((arg_248 == 549207600) && ((arg_247 == 118770884) && true)))
{
  arg_247 := 118770884;
  arg_248 := 549207600;
  {
    ...
    var lift_249 := '*';
    assert (((-118770885 - 118770884) + 1) == ((arg_247 - 118770884) - (arg_247 + arg_247)));
    lift_249 := lift_249;
    lift_250 := (var tmpData : set<((int, int), char)> := {}; tmpData);
    lift_254 := lift_255;
    assert (((arg_247 < 118770885) || (arg_247 < 118770886)) && (-4 < (arg_247 + -118770887)));
  }
}
...
method lift_188_0 ()
  returns (arg_191 : int)
  requires (true)
  ensures (((arg_191 == 1424243227) && true))
{
  arg_191 := 1424243227;
  {
    ...
    lift_197 := lift_202;
    lift_208 := lift_213;
    assert (((-1 - lift_199) < (0 - 4683321)) || ((-1 - lift_199) == (-1 - 4683321)));
  }
}
...
method lift_133_0 (arg_137 : int, arg_138 : int)
  ...
  requires (((arg_138 == -99287170) && ((arg_137 == 421107811) && true)))
  ensures (((arg_140 == 1986032157) && ((arg_139 == -462443245) && true)))
{
  arg_139 := -462443245;
  arg_140 := 1986032157;
  {
    ...
    lift_141 := ();
    lift_142 := lift_142;
    assert (((arg_140 + arg_140) + (-1986032158 - arg_140)) < ((arg_140 - 3972064314) + arg_140));
    assert (((421107810 - arg_137) == (421107810 - 421107811)) || ((arg_137 < arg_137) && (arg_137 < arg_137)));
    assert (((421107810 - arg_137) == (421107810 - 421107811)) || ((arg_137 < arg_137) && (arg_137 < arg_137)));
  }
}
...
method lift_133_1 (arg_137 : int, arg_138 : int)
  returns (arg_139 : int, arg_140 : int)
  requires (((arg_138 == -1633272074) && ((arg_137 == -1736629627) && true)))
  ensures (((arg_140 == 1986032157) && ((arg_139 == -462443245) && true)))
{
  arg_139 := -462443245;
  arg_140 := 1986032157;
  {
    ...
    lift_141 := ();
    lift_142 := lift_142;
    assert (((-1986032162 + arg_140) - (-1986032160 + arg_140)) == ((1986032156 - arg_140) + (1986032156 - arg_140)));
    assert (((arg_137 - 4) - arg_137) == ((arg_137 - -1736629624) + (-1736629628 - -1736629627)));
    assert ((arg_137 == (arg_137 - 0)) && ((-1736629627 == arg_137) && (arg_137 == arg_137)));
  }
}

method lift_133_2 (arg_137 : int, arg_138 : int)
  returns (arg_139 : int, arg_140 : int)
  requires (((arg_138 == -520203241) && ((arg_137 == 114) && true)))
  ensures (((arg_140 == 1986032157) && ((arg_139 == -462443245) && true)))
{
  arg_139 := -462443245;
  arg_140 := 1986032157;
  {
    ...
    lift_142 := lift_142;
    assert (((-1986032162 + arg_140) - (-1986032160 + arg_140)) == ((1986032156 - arg_140) + (1986032156 - arg_140)));
    assert (((113 - arg_137) == (113 - 114)) || ((112 - arg_137) == (113 - arg_137)));
    assert (((113 - arg_137) == (113 - 114)) || ((112 - arg_137) == (113 - arg_137)));
  }
}
...
method lift_111_0 ()
  ...
  requires (true)
  ensures (((arg_116 == -703945096) && ((arg_115 == 1511526677) && true)))
{
  arg_115 := 1511526677;
  arg_116 := -703945096;
  {
    ...
    lift_120 := lift_120;
    lift_121 := lift_127;
    assert (((1511526677 - 1511526677) == (1511526677 - 1511526677)) && ((1511526676 - arg_115) == (-1511526678 + 1511526677)));
    assert (((1482503322 + 1482503322) + (-1482503323 - 1482503322)) < ((1482503322 - 2965006644) + 1482503322));
  }
}
  ...
  ensures (((arg_116 == -703945096) && ((arg_115 == 1511526677) && true)))
{
  ...
  arg_116 := -703945096;
  {
    ...
    lift_120 := lift_120;
    lift_121 := lift_127;
    assert (((1511526676 - arg_115) == (arg_115 - 1511526677)) || ((arg_115 == 1511526677) || (arg_115 < arg_115)));
    assert (((1482503321 - 1482503322) == (1482503321 - 1482503322)) || ((1482503320 - 1482503322) == (1482503321 - 1482503322)));
  }
}
...
method Main () {
  ...
  assert (((-5 - |(lift_1 - lift_1 - (lift_18 - lift_37 - lift_18))|) - (-3 - |(lift_1 - lift_1 - (lift_18 - lift_37 - lift_18))|)) < (|(lift_1 - lift_1 - (lift_18 - lift_37 - lift_18))| + (-3 - -2)));
  if (((safeSeqTake(lift_46, lift_7) + (
    ...
    var methoddefvar_190 := lift_188_0();
    {
      ...
      if (lift_152) {
        ...
        assert (((lift_157 == 1872292624) || (1872292624 == lift_157)) || ((1872292622 - lift_157) == (1872292623 - lift_157)));
        lift_229 := true;
        assert (((-1241243022 - -1241243021) < (-1241243018 + lift_107)) || ((lift_107 + lift_107) == (-1241243020 + lift_107)));
        assert (((0 - 1449645407) + 1449645406) == ((lift_150 - 2899290815) - (0 - 1449645407)));
        assert (((lift_150 + lift_150) + (-1449645408 - lift_150)) < ((lift_150 - 2899290814) + lift_150));
      }
      assert (((lift_150 + lift_150) + (-1449645408 - lift_150)) < ((lift_150 - 2899290814) + lift_150));
      if (lift_13) {
        lift_231 := lift_31;
      ...
      assert (((649224271 + -649224270) < (-649224267 + 649224269)) || ((-649224272 - -649224267) == (-649224271 - -649224267)));
    }
  }
  {
    ...
    );
    {
      ...
      if (lift_94) {
        ...
        assert (((lift_235 + lift_235) + (-1532536849 - -1532536846)) < ((lift_235 - -1532536845) + (-4597610543 - lift_235)));
      }
    }
    ...
    );
    {
      var methoddefvar_258, methoddefvar_259 := lift_111_1();
      {
        ...
        assert (((lift_29 - 4) - lift_29) == ((lift_29 - -1736629624) + (-1736629628 - -1736629627)));
        assert (((lift_149 + -593836457) - (lift_149 - lift_149)) == (lift_149 + (1 - lift_149)));
        lift_260 := lift_12;
        lift_263 := lift_264;
      }
    }
    var methoddefvar_267 := lift_265_0(|lift_172|, |lift_80|);
    {
      var lift_316 := '\'';
      {
        assert (((-1 - lift_158) < (0 - 1371310021)) || ((-1 - lift_158) == (-1 - 1371310021)));
        assert (((1 < lift_170) && (lift_170 == lift_170)) || (lift_170 == (768285638 - lift_170)));
        assert (((-1918319430 + -1918319430) + (-1918319431 - -1918319430)) < ((0 - 3836638862) - (-1918319430 - 1)));
        assert (((1449645405 - lift_150) == (1449645407 - 1449645409)) && ((1449645404 - lift_150) == (-1449645410 + lift_150)));
        assert (((-1736629628 - lift_29) < (-1736629628 - lift_29)) || (lift_29 == (-1736629627 + 0)));
      }
      lift_316 := '!';
    }
    lift_317 := ((
    ...
    var methoddefvar_344 := lift_342_0((lift_90[lift_92] as int));
    {
      ...
      var methoddefvar_349 := lift_347_0();
      {
        ...
        assert (((1421794277 < 1421794277) && (1421794278 == 1421794277)) || ((1421794276 - 1421794277) == (1421794276 - 1421794277)));
        assert (((0 - 1) == (-501471288 - methoddefvar_349)) && ((-501471287 < methoddefvar_349) || (-501471288 < methoddefvar_349)));
        lift_368 := lift_368;
        assert (((-1449645410 + lift_150) < (-1449645409 + 1449645408)) || ((1449645405 - lift_150) == (1449645406 - lift_150)));
      }
      {
        assert (0 == (lift_45 - (-2750152670 - lift_45)));
        assert (((lift_321 + lift_321) < 1) || ((-1992645297 + lift_321) == (lift_321 - lift_321)));
      }
      assert (((-1 - lift_158) < (0 - 1371310021)) || ((-1 - lift_158) == (-1 - 1371310021)));
      ...
      );
      {
        lift_411 := lift_412;
        lift_413 := lift_413;
        assert (((lift_168 + lift_168) + (-5030674470 - lift_168)) < ((lift_168 - 3353782980) + lift_168));
      }
    }
  }
  lift_414 := lift_416;
  ...
  );
  {
    ...
    {
      var lift_483 := false;
      assert (((lift_104 + lift_104) + (-152999346 - lift_104)) < ((lift_104 - -152999346) + lift_104));
      lift_476 := lift_476;
      lift_478 := lift_479;
      lift_483 := lift_146;
    }
    {
      ...
      if (lift_162) {
        ...
        lift_490 := lift_493;
        assert (((1 - lift_36) < (-2798473440 + lift_36)) && (-1 < lift_36));
        lift_502 := lift_421;
        assert ((lift_371 == (-1809390904 - lift_371)) || ((lift_371 < lift_371) || (lift_371 < lift_371)));
      }
      assert (((1 - lift_36) < (-2798473440 + lift_36)) && (-1 < lift_36));
      if (lift_152) {
        ...
        lift_510 := lift_510;
        lift_511 := lift_3;
        assert (((-594587999 + lift_421) < (594587996 - lift_421)) && ((594587995 - lift_421) < (594587996 - lift_421)));
        lift_512 := lift_513;
        assert (((-152999346 - lift_104) == (-152999346 - lift_104)) && ((-152999346 - -152999345) == (-152999346 - lift_104)));
      }
    }
    if ((lift_422 > lift_29)) {
      assert (((-1633272075 - lift_166) - (lift_166 + 1633272075)) == -2);
    } else {
      {
