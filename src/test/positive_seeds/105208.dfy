...
method lift_55_0 (arg_58 : int, arg_59 : int)
  returns (arg_60 : int)
  requires (((arg_59 == 5) && ((arg_58 == 4) && true)))
  ensures (((arg_60 == -83834280) && true))
{
  arg_60 := -83834280;
  {
    var lift_63 := 'w';
    var lift_62 := lift_63;
    var lift_61 := lift_62;
    assert (((-419171403 - arg_60) - arg_60) == (arg_60 + (-251502842 - -83834279)));
    assert (((arg_58 - 5) - (arg_58 - arg_58)) == -1);
    lift_61 := lift_62;
    assert (((-419171403 - arg_60) - arg_60) == (arg_60 + (-251502842 - -83834279)));
  }
}
  ...
  ).2;
  {
    var methoddefvar_57 := lift_55_0((lift_64[lift_72] as int), |lift_64|);
    {
      ...
      if (lift_41) {
        ...
        assert (0 == (-799304297 - lift_69));
        assert (0 == (-799304297 - lift_68));
        assert ((-1900028343 + (-7600113376 - -1900028343)) == ((-5700085031 - -1900028343) + (-5700085031 - -1900028343)));
        assert (0 == (lift_33 - (-2533106512 - lift_33)));
      }
      if (false) {
        var lift_77 := lift_78;
        ...
        assert (((-1261122342 - 1261122343) == (lift_45 + lift_45)) || ((lift_45 < lift_45) || (-1261122342 < lift_45)));
        assert (((0 + -988408637) - (-494204318 + lift_51)) == ((lift_51 - 2) - (lift_51 - 1)));
        assert (lift_45 == 1261122343);
        assert (((1261122342 - lift_45) == (1261122342 - 1261122343)) || ((1261122341 - lift_45) == (1261122342 - lift_45)));
      }
    }
  }
}
