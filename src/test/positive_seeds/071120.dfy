...
method lift_237_0 (arg_240 : int)
  returns (arg_241 : int)
  requires (((arg_240 == -369435602) && true))
  ensures (((arg_241 == 646342896) && true))
{
  arg_241 := 646342896;
  {
    ...
    lift_242 := lift_243;
    lift_244 := ';';
    assert (((-691334157 - -691334155) < (-691334156 - lift_242)) || ((-691334157 - lift_242) == (-691334156 - lift_242)));
    assert (((-1365158113 == lift_245) && (lift_245 == lift_245)) || (-1 == (-1365158113 - lift_245)));
  }
}
