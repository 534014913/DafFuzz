...
method lift_138_0 (arg_141 : int)
  returns (arg_142 : int)
  requires (((arg_141 == 1985089016) && true))
  ensures (((arg_142 == 515649514) && true))
{
  arg_142 := 515649514;
  {
    var lift_166 := '<';
    ...
    lift_143 := arg_141;
    lift_144 := lift_147;
    assert (((0 - 515649514) == (-515649513 + arg_142)) || ((0 < arg_142) || (arg_142 < arg_142)));
    lift_150 := lift_152;
    lift_158 := lift_163;
  }
}
...
method lift_46_0 (arg_50 : int, arg_51 : int)
  ...
  requires (((arg_51 == -1581060478) && ((arg_50 == 1495235931) && true)))
  ensures (((arg_53 == 180778868) && ((arg_52 == 267356650) && true)))
{
  arg_52 := 267356650;
  arg_53 := 180778868;
  {
    assert (((-645058200 + 645058195) - (-645058198 + 645058195)) == ((645058194 - 645058195) + (645058194 - 645058195)));
    assert (((-1605896374 - 401474093) + (401474093 + 401474093)) == ((-2 - 401474093) - (401474093 + 401474093)));
  }
}
...
method lift_1_0 (arg_4 : int, arg_5 : int)
  returns (arg_6 : int)
  requires (((arg_5 == 5) && ((arg_4 == 2026785371) && true)))
  ensures (((arg_6 == -655005474) && true))
{
  arg_6 := -655005474;
  {
...
method Main () {
  ...
  );
  {
    ...
    {
      assert (((1580583605 + -1580583603) == (-1580583603 - -1580583603)) || ((-1580583606 == -1580583603) || (-1580583603 == -1580583603)));
      assert (((lift_33 < lift_33) && (lift_33 == -1)) || ((-1495235930 + 1495235930) == (1495235931 - lift_33)));
      assert (((lift_39 + -2026785372) + (-1 - lift_39)) < ((lift_39 - 4053570744) - (0 - 2026785371)));
      assert (((1907547636 < 1907547636) || (1907547636 == 1907547636)) && ((-1907547637 - 1907547636) == (-1907547637 - 1907547636)));
      assert (((0 < lift_33) && (lift_33 == lift_33)) || ((1 == lift_33) || (lift_33 < lift_33)));
    }
  }
  if ((lift_35 == safeSeqRef(lift_54, -1023930296, lift_56).1)) {
    ...
    );
    {
      ...
      var lift_136 := '\'';
      {
        assert (lift_39 == ((3040178057 - -3040178056) - (lift_39 + lift_39)));
        lift_122 := lift_126;
        lift_136 := '=';
        assert ((lift_137 + (-4159968707 - -2079984353)) == ((-2079984354 - lift_137) + (-6239953059 - lift_137)));
      }
      var methoddefvar_140 := lift_138_0(1985089016);
      {
        var lift_171 := (lift_172, lift_177, lift_179);
        lift_167 := lift_167;
        assert (((-6947221198 - 1736805299) + (1736805299 + 1736805299)) == ((-2 - 1736805299) - (1736805299 + 1736805299)));
        lift_171 := lift_180;
        assert (((-2 < lift_57) && (lift_57 == lift_57)) || ((lift_57 < lift_57) && (lift_57 < lift_57)));
      }
      lift_184 := lift_195.1;
      assert (((lift_174 == lift_174) && (lift_174 < lift_174)) || ((lift_174 < -1048393407) && (lift_174 == lift_174)));
    ...
    if (((lift_274 == lift_40) || (lift_293 && lift_204))) {
      ...
      assert (((1781115444 - lift_351(
        ['s', lift_219, lift_273, lift_285],
        lift_286,
        lift_358,
        lift_223,
        lift_363
      )) == (1781115444 - 1781115445)) || ((1781115443 - lift_351(
        ['s', lift_219, lift_273, lift_285],
        lift_286,
        lift_358,
        lift_223,
