...
method lift_402_0 ()
  returns (arg_405 : int)
  requires (true)
  ensures (((arg_405 == 754051999) && true))
{
  arg_405 := 754051999;
  {
    ...
    lift_409 := lift_410;
    assert (((arg_405 + -754051999) + -1508103998) < ((arg_405 - 1508103998) + arg_405));
    assert (((-949699632 - lift_411) < (-949699632 - lift_411)) || ((-949699632 - -949699631) == (-949699632 - lift_411)));
    assert (((lift_412 < 1575085689) && (lift_412 == lift_412)) || ((-1575085690 - lift_412) == (-1575085689 - lift_412)));
  }
}
...
method lift_327_0 ()
  returns (arg_330 : int)
  requires (true)
  ensures (((arg_330 == 1649403687) && true))
{
  arg_330 := 1649403687;
  {
    var lift_347 := 'v';
    ...
    assert (((-11765369629 - lift_331) - (-5042301269 - lift_331)) == ((-5042301269 - lift_331) + (-5042301269 - lift_331)));
    assert (((-2 - lift_332) == (-1 - lift_332)) || ((-1 - 156562880) == (-1 - lift_332)));
    lift_333 := lift_341;
    assert (((-11765369629 - lift_331) - (-5042301269 - lift_331)) == ((-5042301269 - lift_331) + (-5042301269 - lift_331)));
  }
}
...
method lift_179_0 ()
  ...
  requires (true)
  ensures (((arg_184 == -1242437466) && ((arg_183 == -1978266230) && true)))
{
  arg_183 := -1978266230;
  arg_184 := -1242437466;
  {
...
method lift_167_0 ()
  ...
  requires (true)
  ensures (((arg_172 == -1113543624) && ((arg_171 == 919056057) && true)))
{
  arg_171 := 919056057;
  arg_172 := -1113543624;
  {
    ...
    assert (((arg_171 == arg_171) || (arg_171 == arg_171)) && ((-1 - arg_171) < (-1 - 0)));
    lift_173 := lift_173;
  }
}
  ...
  ensures (((arg_172 == -1113543624) && ((arg_171 == 919056057) && true)))
{
  ...
  arg_172 := -1113543624;
  {
    ...
    var lift_174 := (lift_175, '+');
    var lift_173 := (lift_174, lift_177);
    assert (arg_171 == ((1838112113 - arg_171) + (-919056056 + arg_171)));
    lift_173 := lift_173;
  }
}
...
method lift_143_0 (arg_146 : int)
  returns (arg_147 : int)
  requires (((arg_146 == 1128713421) && true))
  ensures (((arg_147 == 1951114315) && true))
{
  arg_147 := 1951114315;
  {
    ...
    lift_151 := arg_146;
    assert (((-1951114320 + arg_147) - (-1951114318 + arg_147)) == ((1951114314 - arg_147) + (1951114314 - arg_147)));
  }
}

method lift_103_0 (arg_107 : int, arg_108 : int, arg_109 : int)
  returns (arg_110 : int, arg_111 : int)
  requires (((arg_109 == -64897423) && ((arg_108 == -1099256752) && ((arg_107 == -64897423) && true))))
  ensures (((arg_111 == -1457627506) && ((arg_110 == -1794029175) && true)))
{
  arg_110 := -1794029175;
  arg_111 := -1457627506;
  {
...
method lift_85_0 ()
  ...
  requires (true)
  ensures (((arg_90 == 768816065) && ((arg_89 == -677820182) && true)))
{
  arg_89 := -677820182;
  arg_90 := 768816065;
  {
    ...
    assert (((-1968020354 + 1968020349) - (-1968020352 + 1968020349)) == ((1968020348 - 1968020349) + (1968020348 - 1968020349)));
    assert (((-677820183 - arg_89) == (-677820183 - -677820182)) || ((-677820184 - arg_89) == (-677820183 - arg_89)));
    lift_91 := lift_91;
    lift_93 := lift_93;
    assert (((lift_97 + -768816066) + (-1 - lift_97)) < ((lift_97 - 1537632132) - (0 - 768816065)));
  }
}

method lift_56_0 (arg_59 : int, arg_60 : int, arg_61 : int)
  returns (arg_62 : int)
  requires (((arg_61 == -1099256752) && ((arg_60 == -64897423) && ((arg_59 == -64897423) && true))))
  ensures (((arg_62 == -131807993) && true))
{
  arg_62 := -131807993;
  {
    ...
    var lift_63 := ();
    lift_63 := lift_63;
    assert (((arg_61 < arg_61) || (arg_61 < arg_61)) || ((-1099256755 - arg_61) == (arg_61 - -1099256749)));
    lift_64 := lift_64;
    lift_65 := lift_65;
  }
}
...
method lift_1_0 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == -64897423) && ((arg_5 == 2) && ((arg_4 == -1524295535) && true))))
  ensures (((arg_7 == 953342230) && true))
{
  arg_7 := 953342230;
  {
    var lift_28 := 'j';
...
method lift_1_1 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == 1993485095) && ((arg_5 == 108) && ((arg_4 == 1993485095) && true))))
  ensures (((arg_7 == 953342230) && true))
{
  arg_7 := 953342230;
  {
...
method Main () {
  ...
  };
  {
    ...
    );
    {
      ...
      {
        assert (((687550544 == 687550544) && (687550544 < 687550544)) || ((-687550545 - 687550544) == (-687550544 - 687550545)));
        lift_68 := lift_68;
        lift_69 := true;
        assert (((methoddefvar_3 == methoddefvar_3) && (methoddefvar_3 == methoddefvar_3)) && ((-953342231 - methoddefvar_3) == (-2860026691 + methoddefvar_3)));
        lift_70 := lift_70;
      }
    }
    var methoddefvar_77 := lift_1_1(lift_78.1, ('l' as int), lift_80.1);
    {
      ...
      );
      {
        ...
        assert (((-7894289862 - lift_52) + (lift_52 + lift_52)) == ((-2 - lift_52) - (lift_52 + lift_52)));
        lift_125 := lift_129;
      }
      lift_135 := lift_139;
    ...
    var methoddefvar_169, methoddefvar_170 := lift_167_0();
    {
      ...
      {
        lift_187 := lift_189;
        assert (methoddefvar_169 == ((1838112113 - methoddefvar_169) + (-919056056 + methoddefvar_169)));
        lift_197 := false;
        assert (((lift_128 - 844744864) - (lift_128 + -844744864)) == ((-2 + lift_128) - 844744863));
      }
      if (true) {
        lift_198 := lift_200;
        lift_204 := lift_204;
        assert (((-937311436 - lift_196) + -1) < 0);
        assert (((-1705279899 + lift_158) - (-1705279897 + lift_158)) == ((1705279893 - lift_158) + (1705279893 - lift_158)));
        assert (((-146037072 - lift_84) - (-146037070 - lift_84)) == ((-146037070 - lift_84) + (-146037070 - lift_84)));
      } else {
        assert false;
        assert false;
        lift_217 := lift_217;
  ...
  var methoddefvar_329 := lift_327_0();
  {
    ...
    {
      assert ((lift_218 + (5 - lift_218)) == ((lift_218 - -900798275) - (-900798276 - lift_218)));
    }
    if (('V' <= lift_257 == lift_367)) {
      ...
      {
        lift_413 := lift_413;
        assert ((4 + (1993485094 - lift_81)) == ((3 - lift_81) + lift_81));
        lift_417 := lift_191;
        assert (((-1973572470 + lift_152) - (-1973572468 + lift_152)) == ((1973572464 - lift_152) + (1973572464 - lift_152)));
        assert (((lift_417 + lift_417) - (lift_417 - 1758833177)) < ((1758833176 - 1758833175) + (lift_417 + lift_417)));
      }
    }
  }
}
