...
method lift_182_1 (arg_186 : int, arg_187 : int)
  returns (arg_188 : int, arg_189 : int)
  requires (((arg_187 == 2067781986) && ((arg_186 == -75087120) && true)))
  ensures (((arg_189 == -730095285) && ((arg_188 == 420402494) && true)))
{
  arg_188 := 420402494;
  arg_189 := -730095285;
  {
    ...
    lift_190 := 687365637;
    lift_191 := lift_192;
    assert ((arg_186 - (-75087121 - -75087120)) == ((arg_186 + arg_186) + (1 - -75087120)));
    assert (((-2190285856 == arg_189) && (-2190285857 == arg_189)) || ((arg_189 == arg_189) && (-2190285856 < arg_189)));
    assert (((-687365639 - lift_190) < (-687365639 - lift_190)) || ((-687365639 - 687365637) == (-687365639 - lift_190)));
  }
}
  ...
  if (((true, lift_1, (1696378840, 'n')).1(
    ...
    if (((lift_148 && lift_105) <==> (lift_32 > lift_99))) {
      ...
      }
      {
        ...
        {
          assert ((lift_99 == (1017069854 - lift_99)) || ((508534923 - lift_99) == (508534924 - lift_99)));
          lift_233 := lift_234;
        }
      }
      {
        ...
        {
          lift_239 := lift_229;
          assert (((lift_10 < lift_10) || (lift_10 == lift_10)) && ((lift_10 + lift_10) == (-691189917 - -230396639)));
          assert (((lift_10 < lift_10) || (lift_10 == lift_10)) && ((lift_10 + lift_10) == (-691189917 - -230396639)));
        }
        if (lift_42) {
          var lift_240 := ();
          lift_240 := lift_240;
          assert (0 == (-999690955 - lift_61));
          assert (((1686676261 - lift_46) - -2) == ((lift_46 - 1686676264) + (1686676265 - lift_46)));
          assert (((lift_63 < lift_63) && (-1 == lift_63)) || ((-494109158 - lift_63) == (-494109158 - -494109157)));
        } else {
          var lift_243 := true;
        ...
        if (lift_177) {
          var lift_244 := 'N';
          lift_244 := 'v';
          assert (((-1523471975 + lift_9) - (-1523471973 + lift_9)) == ((1523471969 - lift_9) + (1523471969 - lift_9)));
          lift_245 := lift_248;
        } else {
          assert false;
          assert false;
