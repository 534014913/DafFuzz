...
method lift_214_0 (arg_217 : int, arg_218 : int, arg_219 : int)
  returns (arg_220 : int)
  requires (((arg_219 == 18047149) && ((arg_218 == -165514207) && ((arg_217 == 253782208) && true))))
  ensures (((arg_220 == 1872541248) && true))
{
  arg_220 := 1872541248;
  {
    var lift_238 := 'N';
    ...
    assert (0 == (arg_218 - (-331028414 - arg_218)));
    assert (((-2 - arg_217) - (arg_217 + arg_217)) == ((-761346628 - arg_217) - (-2 - arg_217)));
    lift_221 := lift_229;
    assert (((-76272505 - -1) < -76272503) || ((-76272502 - -76272503) == (-76272503 - -76272502)));
  }
}

method lift_180_0 (arg_183 : int)
  returns (arg_184 : int)
  requires (((arg_183 == 5) && true))
  ensures (((arg_184 == -377893744) && true))
{
  arg_184 := -377893744;
  {
    var lift_205 := true;
    ...
    var lift_185 := false;
    assert (((-789579533 + 789579528) - (-789579531 + 789579528)) == ((789579527 - 789579528) + (789579527 - 789579528)));
    lift_185 := lift_185;
    lift_186 := lift_186;
    lift_193 := lift_194;
    lift_203 := lift_203;
...
method lift_91_0 (arg_95 : int, arg_96 : int)
  ...
  requires (((arg_96 == 107) && ((arg_95 == -1897740728) && true)))
  ensures (((arg_98 == -360523944) && ((arg_97 == -1048909534) && true)))
{
  arg_97 := -1048909534;
  arg_98 := -360523944;
  {
    ...
    lift_99 := arg_96;
    assert (((arg_95 + arg_95) + (-1897740729 + 3795481456)) < arg_95);
    assert ((368553788 - (3 + 368553788)) == (368553788 + (0 - 368553791)));
    assert (((arg_96 + -108) + (-1 - arg_96)) < ((arg_96 - 216) - (0 - 107)));
  }
}
...
method lift_16_0 (arg_20 : int)
  ...
  requires (((arg_20 == -777862311) && true))
  ensures (((arg_22 == -1537440792) && ((arg_21 == -1224396011) && true)))
{
  arg_21 := -1224396011;
  arg_22 := -1537440792;
  {
    assert ((arg_20 + (-777862312 - arg_20)) == ((-1555724622 - arg_20) + (-777862312 - arg_20)));
  }
}

method lift_16_1 (arg_20 : int)
  returns (arg_21 : int, arg_22 : int)
  requires (((arg_20 == -1453586802) && true))
  ensures (((arg_22 == -1537440792) && ((arg_21 == -1224396011) && true)))
{
  arg_21 := -1224396011;
  arg_22 := -1537440792;
  {
    assert (((arg_20 + arg_20) + (-1453586803 - arg_20)) < ((arg_20 - -1453586803) + arg_20));
  }
}

method lift_16_2 (arg_20 : int)
  returns (arg_21 : int, arg_22 : int)
  requires (((arg_20 == 248050927) && true))
  ensures (((arg_22 == -1537440792) && ((arg_21 == -1224396011) && true)))
{
  arg_21 := -1224396011;
  arg_22 := -1537440792;
  {
    assert (-1 == ((arg_20 - 496101855) - (0 - 248050927)));
  }
}
...
method Main () {
  ...
  var lift_2 := 'O';
  var lift_1 := lift_2;
  assert ((((lift_1 as int) < (lift_1 as int)) && ((lift_1 as int) < (lift_1 as int))) || ((-1 - (lift_1 as int)) == (-159 + (lift_1 as int))));
  assert (((-2 - |safeSeqSlice3(
    lift_3,
    (
      ((
  ...
  );
  {
    ...
    var lift_27 := lift_28;
    if (true) {
      assert (0 == (-1453586802 - lift_24));
      lift_27 := lift_28;
      {
        assert (((methoddefvar_18 + -1224396011) + (-1224396010 - 0)) < ((methoddefvar_18 - 1) + (-2448792020 - methoddefvar_18)));
        assert (((-1537440792 == methoddefvar_19) && (methoddefvar_19 == methoddefvar_19)) || ((methoddefvar_19 == methoddefvar_19) && (-1537440795 == methoddefvar_19)));
        lift_34 := lift_41;
      }
      if (lift_6) {
        assert false;
        ...
        var lift_57 := 'Z';
        assert (((-1224396010 + methoddefvar_18) == (1224396011 - methoddefvar_18)) || ((methoddefvar_18 + methoddefvar_18) == (methoddefvar_18 + -1224396011)));
        assert (((lift_56 - 255319202) - (lift_56 + lift_56)) == ((255319202 - lift_56) + (255319202 - lift_56)));
        lift_57 := lift_31;
      }
    } else {
      var lift_76 := lift_31;
    ...
    var methoddefvar_85, methoddefvar_86 := lift_16_1(lift_24);
    {
      ...
      var lift_87 := lift_88;
      lift_87 := lift_87;
      assert (((lift_45 + lift_45) + (-1897740729 + 3795481456)) < lift_45);
    }
  }
  {
    ...
    var methoddefvar_93, methoddefvar_94 := lift_91_0(lift_34.2, ('k' as int));
    {
      ...
      if (lift_9) {
        ...
        lift_139 := lift_139;
        assert (((lift_105 == lift_105) && (18047149 == lift_105)) && ((lift_105 == lift_105) || (lift_105 == lift_105)));
        lift_144 := lift_149;
        lift_151 := lift_151;
        assert (0 == (-1453586802 - lift_24));
      }
      assert (((lift_179 + lift_179) < lift_179) || ((-1249938675 - lift_179) == (-1249938674 - lift_179)));
    }
    var methoddefvar_182 := lift_180_0(|lift_206|);
    {
      ...
      {
        assert (((-802294769 + -802294769) + (-802294769 - -802294770)) < ((-802294769 - -2) + -802294769));
        assert (lift_147 < (911525781 - 0));
        assert (((lift_160 == lift_160) || (lift_160 < lift_160)) && ((-1650472172 - lift_160) == (-4951416514 + lift_160)));
        assert ((-1312850067 + (-2625700135 - -1312850067)) == ((-3938550201 - -1312850067) + (-1312850068 - -1312850067)));
        assert (((-578341423 == -578341424) && (lift_146 == lift_146)) || ((-1156682850 < lift_146) && (lift_146 < -578341423)));
      }
      if (false) {
        lift_239 := lift_141;
        assert false;
        ...
        assert (((lift_14 < 2091898646) && (lift_14 < lift_14)) || ((lift_14 < 2091898646) && (lift_14 < -2091898646)));
        lift_241 := lift_242;
        assert ((lift_145 < (lift_145 - -1)) && ((lift_145 == lift_145) && (-1094826787 == lift_145)));
      }
