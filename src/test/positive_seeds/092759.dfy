...
method lift_504_0 (arg_508 : int)
  ...
  requires (((arg_508 == 1374135525) && true))
  ensures (((arg_510 == 2078037396) && ((arg_509 == -1035704588) && true)))
{
  arg_509 := -1035704588;
  arg_510 := 2078037396;
  {
    ...
    lift_511 := lift_520;
    assert (((-1374135530 + arg_508) - (-1374135528 + arg_508)) == ((1374135524 - arg_508) + (1374135524 - arg_508)));
    assert (((arg_509 == 1) && (arg_509 < arg_509)) || ((arg_509 < -1035704587) && (arg_509 == arg_509)));
    assert (((1666122461 - 1666122462) == (1666122461 - lift_523)) || ((1666122461 - lift_523) == (1666122461 - 1666122462)));
    assert (((1666122461 - 1666122462) == (1666122461 - lift_523)) || ((1666122461 - lift_523) == (1666122461 - 1666122462)));
  }
}
...
method lift_490_0 ()
  ...
  requires (true)
  ensures (((arg_495 == -128376345) && ((arg_494 == -880912239) && true)))
{
  arg_494 := -880912239;
  arg_495 := -128376345;
  {
...
method lift_474_0 ()
  returns (arg_477 : int)
  requires (true)
  ensures (((arg_477 == 113373586) && true))
{
  arg_477 := 113373586;
  {
    var lift_478 := 499056597;
    assert (((-499056601 + lift_478) - (-499056601 + 499056598)) == ((499056598 - lift_478) + (lift_478 - 499056599)));
  }
}

method lift_448_0 (arg_451 : int, arg_452 : int, arg_453 : int)
  returns (arg_454 : int)
  requires (((arg_453 == 428429652) && ((arg_452 == 1) && ((arg_451 == -292870699) && true))))
  ensures (((arg_454 == -418740107) && true))
{
  arg_454 := -418740107;
  {
    ...
    assert ((-1 - (arg_453 - 856859305)) == arg_453);
    assert (((arg_452 - 2) + (-1 - arg_452)) == ((-3 - 1) + arg_452));
    assert (((arg_452 + arg_452) + (-3 - arg_452)) < ((arg_452 + arg_452) - 1));
    lift_455 := arg_452;
    lift_457 := lift_461;
  }
}
...
method lift_269_1 ()
  returns (arg_273 : int, arg_274 : int)
  requires (true)
  ensures (((arg_274 == -1766942507) && ((arg_273 == 1073092831) && true)))
{
  arg_273 := 1073092831;
  arg_274 := -1766942507;
  {
    ...
    var lift_276 := lift_277;
    var lift_275 := lift_276;
    assert (((arg_274 < arg_274) && (arg_274 == arg_274)) || ((arg_274 + arg_274) < (1 - 2)));
    lift_275 := lift_277;
    assert (arg_274 == ((arg_274 - 3533885014) - (arg_274 + arg_274)));
    lift_280 := lift_280;
  }
}
...
method lift_197_0 (arg_200 : int, arg_201 : int)
  returns (arg_202 : int)
  requires (((arg_201 == 2006578673) && ((arg_200 == -1442688361) && true)))
  ensures (((arg_202 == 2132199988) && true))
{
  arg_202 := 2132199988;
  {
    var lift_214 := ();
    ...
    var lift_203 := false;
    lift_203 := lift_204;
    assert (((-1442688364 - -1442688362) - (arg_200 + arg_200)) == ((-1442688363 - arg_200) - (arg_200 + arg_200)));
    lift_206 := lift_210;
    lift_214 := lift_213;
  }
}
...
method lift_154_0 (arg_158 : int, arg_159 : int)
  ...
  requires (((arg_159 == 1374135525) && ((arg_158 == -1545804811) && true)))
  ensures (((arg_161 == -1442688361) && ((arg_160 == 1466385410) && true)))
{
  arg_160 := 1466385410;
  arg_161 := -1442688361;
  {
    ...
    lift_162 := lift_165;
    assert (((0 - 1545804812) + (-1545804812 - arg_158)) == ((arg_158 - 1) + (-1545804812 - arg_158)));
    assert (((-1374135530 + arg_159) - (-1374135528 + arg_159)) == ((1374135524 - arg_159) + (1374135524 - arg_159)));
    assert (((arg_161 < 2) && (arg_161 == arg_161)) || ((arg_161 < arg_161) || (arg_161 == -1442688362)));
    lift_167 := arg_158;
  }
}
...
method Main () {
  ...
  if (!(((lift_34 in lift_111) && (() !in lift_122)))) {
    ...
    var lift_126 := [lift_18, lift_70];
    {
      ...
      assert (((safeSeqRef(
        ...
        lift_41,
        1756739696
      ) - 1756739699) < (1756739697 + -1756739698)) || ((1756739694 - safeSeqRef(
        (var tmpData : seq<int> := []; tmpData),
        lift_41,
        1756739696
      )) == (1756739695 - safeSeqRef(
        (var tmpData : seq<int> := []; tmpData),
        lift_41,
        1756739696
      ))));
    ...
    );
    {
      ...
      var lift_184 := (lift_143, lift_172);
      {
        ...
        lift_169 := lift_169;
        lift_178 := lift_178;
        assert (((lift_41 == lift_41) && (lift_41 < lift_41)) || ((lift_41 == 1296399744) || (lift_41 < lift_41)));
        lift_182 := ((var tmpData : string := []; tmpData), lift_196);
      }
      var methoddefvar_199 := lift_197_0(methoddefvar_157, lift_18);
      {
        assert (((-522309861 - lift_195) + 2) == (lift_195 + (lift_195 + 1044619721)));
        assert (((-1125440878 - 1125440875) == (-1125440878 - lift_177)) || ((lift_177 < lift_177) && (lift_177 < lift_177)));
        lift_215 := lift_215;
        assert (((-1168260610 - lift_143) - (-1168260609 - lift_143)) == ((-1168260612 - lift_143) + (lift_143 - lift_143)));
      }
    }
  ...
  );
  {
    ...
    {
      lift_479 := lift_480;
      assert (((lift_18 == lift_18) || (lift_18 == lift_18)) && ((2006578671 < lift_18) || (lift_18 < lift_18)));
    }
    var methoddefvar_487, methoddefvar_488 := lift_269_1();
    {
      assert (((-2 - 1279721467) < (-1 - 1279721467)) && ((-1 - 1279721467) == (-1 - 1279721467)));
      lift_489 := lift_350;
      assert (((-1202487147 + 1202487148) < (lift_148 - -1202487148)) || ((-1202487151 - lift_148) == (-1202487150 - lift_148)));
    }
  }
  var methoddefvar_492, methoddefvar_493 := lift_490_0();
  {
    ...
    var methoddefvar_506, methoddefvar_507 := lift_504_0(lift_109);
    {
      ...
      lift_524 := lift_524;
      lift_525 := lift_55;
      assert (((lift_424 < lift_424) || (lift_424 < lift_424)) || ((lift_424 == lift_424) && (-295822424 < lift_424)));
      assert (((0 + lift_366) == (-1 - lift_366)) || ((431022993 - 431022995) < (lift_366 - 431022994)));
      assert (((428429650 - lift_370) == (428429652 - 428429654)) && ((428429650 - lift_370) < (428429651 - lift_370)));
    }
  }
}
