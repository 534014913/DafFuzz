...
method lift_133_0 (arg_136 : int, arg_137 : int, arg_138 : int)
  returns (arg_139 : int)
  requires (((arg_138 == 2113560680) && ((arg_137 == 28) && ((arg_136 == -1882779021) && true))))
  ensures (((arg_139 == 660428865) && true))
{
  arg_139 := 660428865;
  {
    var lift_142 := ();
    ...
    var lift_140 := ();
    lift_140 := lift_141;
    assert (((arg_139 == arg_139) || (arg_139 < arg_139)) && ((660428862 - arg_139) == (-660428868 + arg_139)));
  }
}
...
method lift_67_0 ()
  ...
  requires (true)
  ensures (((arg_72 == -1038437011) && ((arg_71 == 2073895089) && true)))
{
  arg_71 := 2073895089;
  arg_72 := -1038437011;
  {
...
method lift_45_0 (arg_49 : int, arg_50 : int, arg_51 : int)
  ...
  requires (((arg_51 == 2141029827) && ((arg_50 == 2141029827) && ((arg_49 == 2141029827) && true))))
  ensures (((arg_53 == 491952352) && ((arg_52 == 1480229202) && true)))
{
  arg_52 := 1480229202;
  arg_53 := 491952352;
  {
    assert (((arg_50 < arg_50) && (2141029828 == arg_50)) || ((2141029826 - 2141029827) == (2141029826 - arg_50)));
  }
}
...
method lift_38_0 ()
  ...
  requires (true)
  ensures (((arg_43 == -1264644820) && ((arg_42 == 2141029827) && true)))
{
  arg_42 := 2141029827;
  arg_43 := -1264644820;
  {
...
method Main () {
  ...
  assert (((|((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)| == |((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)|) && (2 == |((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)|)) || ((|((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)| < |((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)|) || (|((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)| < |((lift_1 * lift_3 * lift_1) + (lift_1 * lift_3) + lift_3)|)));
  assert (((-2 - |((
    lift_3,
  ...
  var methoddefvar_40, methoddefvar_41 := lift_38_0();
  {
    ...
    );
    {
      ...
      lift_54 := lift_54;
      assert (((-370997449 - -370997448) == (-2 - -1)) || ((1 == -370997448) || (-370997447 == -370997448)));
      assert (((methoddefvar_41 == methoddefvar_41) || (methoddefvar_41 == methoddefvar_41)) && ((methoddefvar_41 + methoddefvar_41) < (-3793934454 - methoddefvar_41)));
      assert (((methoddefvar_40 < methoddefvar_40) && (2141029828 == methoddefvar_40)) || ((2141029826 - 2141029827) == (2141029826 - methoddefvar_40)));
      lift_62 := lift_62;
    }
    lift_63 := lift_64.0;
    assert (((-44 + (lift_24 as int)) - (-42 + (lift_24 as int))) == ((38 - (lift_24 as int)) + (38 - (lift_24 as int))));
  ...
  {
    assert (((lift_59.0 < 676658884) && (lift_59.0 == lift_59.0)) && ((676658882 - 676658885) == (lift_59.0 - 676658885)));
  }
}
