...
method lift_110_0 (arg_114 : int, arg_115 : int, arg_116 : int)
  ...
  requires (((arg_116 == 645254769) && ((arg_115 == -576873096) && ((arg_114 == -1561459794) && true))))
  ensures (((arg_118 == 1068167452) && ((arg_117 == -215702548) && true)))
{
  arg_117 := -215702548;
  arg_118 := 1068167452;
  {
    ...
    assert (((arg_117 < arg_117) && (2 == arg_117)) || ((arg_117 + arg_117) < (1 - 2)));
    lift_119 := lift_119;
    assert (((-5340837268 + arg_118) - (-1068167454 + arg_118)) == ((-1068167455 - arg_118) + (-1068167455 - arg_118)));
  }
}
...
method lift_79_0 (arg_82 : int, arg_83 : int)
  returns (arg_84 : int)
  requires (((arg_83 == -1561459794) && ((arg_82 == -201296412) && true)))
  ensures (((arg_84 == 771968242) && true))
{
  arg_84 := 771968242;
  {
    assert (((-201296413 - -201296412) == (-201296413 - arg_82)) && ((arg_82 == arg_82) || (arg_82 < arg_82)));
  }
}
...
method lift_15_0 ()
  ...
  requires (true)
  ensures (((arg_20 == -1080532188) && ((arg_19 == 1524882479) && true)))
{
  arg_19 := 1524882479;
  arg_20 := -1080532188;
  {
    ...
    lift_23 := lift_23;
    lift_30 := arg_19;
    assert (lift_30 == ((1524882479 - lift_30) + 1524882479));
    assert ((lift_31 == (1931330321 - lift_31)) || ((lift_31 < lift_31) || (lift_31 < 1931330322)));
  }
}

method lift_1_0 (arg_5 : int, arg_6 : int)
  returns (arg_7 : int, arg_8 : int)
  requires (((arg_6 == -348667692) && ((arg_5 == 24) && true)))
  ensures (((arg_8 == -1241069302) && ((arg_7 == 1798479341) && true)))
{
  arg_7 := 1798479341;
  arg_8 := -1241069302;
  {
    assert (((2119561095 - 2119561097) == (2119561096 - 2119561097)) || ((2119561096 - 2119561097) == (2119561096 - 2119561097)));
    assert (((1798479341 - 1798479343) < (arg_7 - 1798479342)) || ((arg_7 < arg_7) || (arg_7 < arg_7)));
  }
}

method lift_1_1 (arg_5 : int, arg_6 : int)
  returns (arg_7 : int, arg_8 : int)
  requires (((arg_6 == -201296412) && ((arg_5 == 1178096370) && true)))
  ensures (((arg_8 == -1241069302) && ((arg_7 == 1798479341) && true)))
{
  arg_7 := 1798479341;
  arg_8 := -1241069302;
  {
    assert (((2119561095 - 2119561097) == (2119561096 - 2119561097)) || ((2119561096 - 2119561097) == (2119561096 - 2119561097)));
    assert (((-2 - 1798479341) == (arg_7 + arg_7)) || ((arg_7 < arg_7) || (-2 < arg_7)));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    {
      lift_32 := lift_32;
      assert (((1798479341 - 1798479343) < (methoddefvar_3 - 1798479342)) || ((methoddefvar_3 < methoddefvar_3) || (methoddefvar_3 < methoddefvar_3)));
      assert (lift_9 == ((-1561459793 - lift_9) - (1 - lift_9)));
    }
  }
  if (safeSeqRef(lift_47, lift_46, lift_58).1(
    ...
    var lift_86 := (lift_66, lift_87);
    {
      ...
      if ((lift_9 !in lift_74)) {
        ...
        var methoddefvar_81 := lift_79_0(lift_59, lift_9);
        {
          ...
          lift_93 := lift_93;
          lift_95 := lift_65;
          assert (((lift_9 == lift_9) || (lift_9 < lift_9)) && ((lift_9 + lift_9) == (-4684379382 - -1561459794)));
          assert (((lift_37 == -1669084660) && (lift_37 == lift_37)) || ((lift_37 < lift_37) || (lift_37 < lift_37)));
        }
      } else {
    ...
    }
    {
      ...
      assert (-1287714505 == ((-1287714505 - 1287714506) - (-1287714505 - 1)));
    }
  }
  assert (((-333 + (lift_123.1(
  ...
  ) as int)) - (-67 + (lift_123.1(
    lift_128(lift_35, lift_12, lift_35, lift_125, lift_68),
    lift_128(lift_13, lift_45, lift_45, lift_127, lift_69),
    ("~^+dzdkE:DLwp'qTyLcA>g", 'b', "dTKJOe&hLPJ").1,
    lift_37,
    (lift_135 >= {lift_36, lift_59} > lift_135)
  ) as int))) == ((-68 - (lift_123.1(
    lift_128(lift_35, lift_12, lift_35, lift_125, lift_68),
    lift_128(lift_13, lift_45, lift_45, lift_127, lift_69),
    ("~^+dzdkE:DLwp'qTyLcA>g", 'b', "dTKJOe&hLPJ").1,
    lift_37,
