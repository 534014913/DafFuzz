...
method lift_318_0 (arg_322 : int, arg_323 : int)
  ...
  requires (((arg_323 == -199177084) && ((arg_322 == 660272006) && true)))
  ensures (((arg_325 == -1323427958) && ((arg_324 == 928581817) && true)))
{
  arg_324 := 928581817;
  arg_325 := -1323427958;
  {
    ...
    var lift_326 := ();
    assert (((arg_324 == arg_324) || (arg_324 < arg_324)) && ((-2785745451 - arg_324) < (-928581817 - 928581817)));
    lift_326 := ();
    assert (0 == (-199177084 - arg_323));
    assert (((-3970283875 < arg_325) && (-3970283875 < arg_325)) && ((arg_325 == arg_325) || (arg_325 < arg_325)));
    lift_327 := arg_323;
  }
}
...
method lift_302_0 (arg_305 : int, arg_306 : int)
  returns (arg_307 : int)
  requires (((arg_306 == 3) && ((arg_305 == 80) && true)))
  ensures (((arg_307 == 1740984185) && true))
{
  arg_307 := 1740984185;
  {
    var lift_309 := false;
    var lift_308 := true;
    lift_308 := lift_309;
    assert (((arg_305 - 321) - arg_305) == ((-80 - 80) + (-81 - arg_305)));
    assert (((arg_305 + 83) - (84 + arg_305)) == (-1 + (80 - arg_305)));
  }
}
...
method lift_286_0 ()
  ...
  requires (true)
  ensures (((arg_291 == -1536245166) && ((arg_290 == 1400006389) && true)))
{
  arg_290 := 1400006389;
  arg_291 := -1536245166;
  {
    ...
    lift_292 := lift_292;
    assert (((-757036926 == -757036926) || (-757036926 < -757036926)) || ((-757036926 == -757036926) && (-757036927 == -757036926)));
    assert ((arg_291 == (arg_291 - 0)) && ((-1536245166 == arg_291) && (arg_291 == arg_291)));
  }
}
...
method lift_179_1 (arg_182 : int, arg_183 : int, arg_184 : int)
  returns (arg_185 : int)
  requires (((arg_184 == 317243748) && ((arg_183 == -487023430) && ((arg_182 == 922379048) && true))))
  ensures (((arg_185 == 197797085) && true))
{
  arg_185 := 197797085;
  {
    var lift_189 := arg_182;
    ...
    var lift_186 := false;
    lift_186 := lift_187;
    assert (((lift_189 < lift_189) && (lift_189 < lift_189)) || ((-2 - lift_189) == (-2 - 922379048)));
    assert (((arg_185 == arg_185) || (arg_185 < arg_185)) && ((197797082 - arg_185) == (-197797088 + arg_185)));
  }
}
...
method lift_141_0 (arg_145 : int)
  ...
  requires (((arg_145 == -1737580681) && true))
  ensures (((arg_147 == 543266540) && ((arg_146 == 1775489662) && true)))
{
  arg_146 := 1775489662;
  arg_147 := 543266540;
  {
...
method lift_31_0 (arg_35 : int)
  ...
  requires (((arg_35 == 2) && true))
  ensures (((arg_37 == 15454783) && ((arg_36 == 873651749) && true)))
{
  arg_36 := 873651749;
  arg_37 := 15454783;
  {
    ...
    var lift_39 := lift_40;
    var lift_38 := lift_39;
    assert (((arg_35 == arg_35) && (2 == arg_35)) || ((arg_35 < arg_35) || (arg_35 < arg_35)));
    assert ((arg_35 - (-1 + arg_35)) == ((5 - arg_35) - arg_35));
    lift_38 := 'P';
    lift_41 := arg_36;
    assert (((-873651754 + arg_36) - (-873651752 + arg_36)) == ((873651748 - arg_36) + (873651748 - arg_36)));
  }
}
...
method Main () {
  ...
  assert (((901603066 + lift_30) == (-901603065 + lift_30)) || ((1 == 1) && (lift_30 < 0)));
  ...
  );
  {
    ...
    assert (((|lift_47| - 5) - (|lift_47| - |lift_47|)) == -1);
    assert (((|lift_66| == |lift_66|) || (|lift_66| == |lift_66|)) && ((2 - |lift_66|) < (-1 - 0)));
    if (lift_105()) {
      var lift_113 := ();
      var lift_112 := lift_113;
      var lift_110 := methoddefvar_34;
      {
        assert (((methoddefvar_34 < methoddefvar_34) || (methoddefvar_34 < methoddefvar_34)) || ((15454781 < methoddefvar_34) && (methoddefvar_34 == methoddefvar_34)));
        lift_109 := ();
      }
      if (lift_98) {
        lift_110 := lift_30;
        assert (lift_61 == ((473389908 - lift_61) + lift_61));
        lift_111 := lift_112;
        lift_114 := lift_100;
      } else {
        assert false;
  ...
  }
  {
    ...
    }
    {
      ...
      if (lift_221.2) {
        ...
        if (lift_8) {
          ...
          assert ((-1473215740 + (-2946431479 - -1473215740)) == ((-1473215740 + -1473215740) - (-1473215741 - -1473215740)));
          assert (((-1789658898 - lift_206) - (-1789658898 - lift_206)) == (-1789658899 - lift_206));
          lift_237 := lift_177;
        }
        lift_238 := lift_243;
        lift_258 := lift_17;
        if (lift_195) {
          assert (((187963900 - lift_177) + (-187963903 - -1)) < -187963900);
          lift_259 := lift_164;
        } else {
      ...
      var methoddefvar_284 := lift_179_1(922379048, lift_205, 317243748);
      {
        ...
        assert (((187963899 - lift_177) + (187963900 + -187963899)) == 1);
        lift_285 := lift_285;
        assert (lift_267 == (lift_267 - (lift_267 - -199177084)));
        assert (((methoddefvar_284 < 197797086) && (197797083 < methoddefvar_284)) || ((methoddefvar_284 - 197797084) == (197797085 - methoddefvar_284)));
      }
    }
    var methoddefvar_288, methoddefvar_289 := lift_286_0();
    {
      {
        assert (((lift_65 < lift_65) && (0 == 1)) || ((-660272007 - 0) == (-1 - lift_65)));
        assert ((-2800012780 - (-1400006392 + methoddefvar_288)) == ((1400006390 - methoddefvar_288) - (methoddefvar_288 + methoddefvar_288)));
      }
      assert (lift_5 == (1 - (1 - 1677602675)));
    }
    var methoddefvar_304 := lift_302_0(('P' as int), |lift_9|);
    {
      ...
      var methoddefvar_320, methoddefvar_321 := lift_318_0(lift_65, lift_267);
      {
        ...
        assert (((-1789658898 - lift_206) - (-1789658898 - lift_206)) == (-1789658899 - lift_206));
        assert (((-5888233783 + lift_172) == (5888233784 - lift_172)) || ((lift_172 < 5888233783) || (1962744593 == lift_172)));
        lift_328 := lift_334;
        assert ((lift_264 + (-2117701500 - -1058850750)) == ((-3176552249 - lift_264) + (-1058850751 - lift_264)));
        assert (((-1789658898 - lift_206) - (-1789658898 - lift_206)) == (-1789658899 - lift_206));
      }
    }
  }
