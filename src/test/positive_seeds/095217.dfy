...
method lift_430_1 ()
  returns (arg_433 : int)
  requires (true)
  ensures (((arg_433 == -1011182337) && true))
{
  arg_433 := -1011182337;
  {
    var lift_465 := ();
...
method lift_382_0 (arg_386 : int, arg_387 : int, arg_388 : int)
  ...
  requires (((arg_388 == 856069398) && ((arg_387 == 156228251) && ((arg_386 == -2111316302) && true))))
  ensures (((arg_390 == -139692514) && ((arg_389 == -1417665917) && true)))
{
  arg_389 := -1417665917;
  arg_390 := -139692514;
  {
    ...
    assert (((-4252997752 < arg_389) && (-4252997752 < arg_389)) && ((-4252997754 - arg_389) < (-4252997753 - arg_389)));
    lift_391 := lift_394;
    assert ((156228250 - -1) == ((arg_387 + arg_387) - arg_387));
    assert ((-1 == (lift_398 - 1625666076)) && ((-4876998226 - lift_398) < (-1625666075 - 1625666075)));
    assert (((arg_388 < arg_388) && (856069399 == arg_388)) || ((856069397 - 856069398) == (856069397 - arg_388)));
  }
}
...
method lift_374_1 (arg_377 : int, arg_378 : int)
  returns (arg_379 : int)
  requires (((arg_378 == 156228251) && ((arg_377 == -1335740548) && true)))
  ensures (((arg_379 == -1824839950) && true))
{
  arg_379 := -1824839950;
  {
    var lift_381 := arg_379;
    var lift_380 := 'o';
    lift_380 := 'p';
    assert (((734543834 - 734543833) - (-734543835 + 734543836)) == ((734543835 + -734543835) + (734543833 - 734543833)));
    lift_381 := arg_377;
  }
}
...
method lift_23_1 (arg_27 : int, arg_28 : int)
  returns (arg_29 : int, arg_30 : int)
  requires (((arg_28 == -680779301) && ((arg_27 == -1040799572) && true)))
  ensures (((arg_30 == -718159303) && ((arg_29 == 1883340057) && true)))
{
  arg_29 := 1883340057;
  arg_30 := -718159303;
  {
  ...
  if ((safeSeqSet(
    ...
    if ((lift_300.0 >= lift_316.0 == lift_328.2)) {
      ...
      );
      {
        ...
        lift_400 := lift_400;
        assert (((-1648363122 - 1648363123) == (lift_238 + lift_238)) || ((lift_238 < lift_238) || (1648363123 == lift_238)));
        lift_409 := lift_340;
        lift_410 := lift_324;
        assert (((1 - lift_203) < lift_203) || ((lift_203 == lift_203) && (-1040799572 == lift_203)));
      }
    }
    assert (((-5 - (lift_81[(lift_411 + lift_411)] as int)) - (-3 - (lift_81[(lift_411 + lift_411)] as int))) < ((lift_81[(lift_411 + lift_411)] as int) + (-3 - -2)));
    if ((lift_407 && (lift_199 <== false))) {
      ...
      {
        assert (((lift_269 - lift_269) - (-1847353937 + lift_269)) == (lift_269 + (lift_269 - 3694707871)));
        lift_468 := lift_469;
        lift_480 := lift_481;
        assert ((156228250 - -1) == ((lift_244 + lift_244) - lift_244));
        lift_482 := lift_214;
      }
      {
        var lift_483 := '"';
        ...
        {
          lift_486 := [lift_351];
          assert (((-8309649098 + lift_68) - (-1661929820 + lift_68)) == ((-1661929821 - lift_68) + (-1661929821 - lift_68)));
          assert (((1272464079 == lift_275) && (lift_275 == -1272464081)) || (lift_275 < 1));
        }
      }
      assert (((-1211790137 - -1211790135) < (-1211790136 - -1211790135)) || ((-1211790136 - -1211790135) == (-1211790136 - -1211790135)));
    }
    if (((lift_494 * {
      lift_481,
      ()
      ...
      {
        assert ((156228250 - -1) == ((lift_245 + lift_245) - lift_245));
        assert (((lift_98 < lift_98) && (1014228799 == lift_98)) || ((-1014228799 - -1014228798) == (-1014228799 - lift_98)));
      }
      assert (((safeSeqRef(
        ...
        lift_7,
        lift_106
      )) + (2111316301 + safeSeqRef(
        (var tmpData : seq<int> := []; tmpData),
        lift_7,
        lift_106
      ))) < ((-2111316300 - -1) + safeSeqRef(
        (var tmpData : seq<int> := []; tmpData),
        lift_7,
        lift_106
      )));
