  ...
  ensures (false)
{
  ...
  arg_267 := -580278279;
  {
    ...
    var lift_271 := multiset{arg_266, lift_272, lift_272, 1457521347, lift_272};
...
method lift_171_0 (arg_174 : int)
  returns (arg_175 : int)
  requires (((arg_174 == -251288953) && true))
  ensures (((arg_175 == -1294618724) && true))
{
  arg_175 := -1294618724;
  {
    assert ((arg_174 + (-251288954 - arg_174)) == ((-502577906 - arg_174) + (-251288954 - arg_174)));
  }
}
...
method lift_93_0 (arg_97 : int)
  ...
  requires (((arg_97 == 535504584) && true))
  ensures (((arg_99 == -1253521204) && ((arg_98 == -1072362461) && true)))
{
  arg_98 := -1072362461;
  arg_99 := -1253521204;
  {
    ...
    lift_100 := lift_101;
    assert (-1072362464 == ((arg_98 - 1) + (-1072362462 - -1072362460)));
    assert (((720917806 - 720917807) == (720917806 - 720917807)) || ((720917805 - 720917807) == (720917806 - 720917807)));
    lift_102 := [
      lift_106,
...
method lift_78_0 ()
  ...
  requires (true)
  ensures (((arg_83 == 743535331) && ((arg_82 == 535504584) && true)))
{
  arg_82 := 535504584;
  arg_83 := 743535331;
  {
...
method lift_25_0 (arg_28 : int, arg_29 : int)
  returns (arg_30 : int)
  requires (((arg_29 == 1903434514) && ((arg_28 == 1427520975) && true)))
  ensures (((arg_30 == -122682496) && true))
{
  arg_30 := -122682496;
  {
    var lift_45 := 'G';
...
method lift_25_1 (arg_28 : int, arg_29 : int)
  returns (arg_30 : int)
  requires (((arg_29 == 88050655) && ((arg_28 == -309189841) && true)))
  ensures (((arg_30 == -122682496) && true))
{
  arg_30 := -122682496;
  {
...
method lift_1_0 (arg_5 : int)
  ...
  requires (((arg_5 == 4) && true))
  ensures (((arg_7 == 1427520975) && ((arg_6 == 1903434514) && true)))
{
  arg_6 := 1903434514;
  arg_7 := 1427520975;
  {
    ...
    lift_8 := lift_16;
    lift_20 := lift_21;
    assert (((arg_6 + arg_6) - 3806869029) < arg_6);
  }
}

method lift_1_1 (arg_5 : int)
  returns (arg_6 : int, arg_7 : int)
  requires (((arg_5 == 743535331) && true))
  ensures (((arg_7 == 1427520975) && ((arg_6 == 1903434514) && true)))
{
  arg_6 := 1903434514;
  arg_7 := 1427520975;
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_27 := lift_25_0(methoddefvar_4, methoddefvar_3);
    {
      ...
      lift_46 := lift_46;
      assert (0 == (lift_47 - (-3041947982 - lift_47)));
      lift_48 := lift_48;
      lift_71 := lift_71;
    }
  }
  assert ((-1 < (-680797456 - safeSeqRef(
    [lift_73],
    lift_76,
    lift_73
  ).0.1)) || ((-680797457 + safeSeqRef(
    [lift_73],
    lift_76,
    lift_73
  ).0.1) == (safeSeqRef([lift_73], lift_76, lift_73).0.1 - -680797458)));
  {
    ...
    var methoddefvar_80, methoddefvar_81 := lift_78_0();
    {
      ...
      {
        assert (((-1072362462 - methoddefvar_95) == (-1072362462 - -1072362461)) || ((methoddefvar_95 < methoddefvar_95) || (methoddefvar_95 < methoddefvar_95)));
      }
      var methoddefvar_117, methoddefvar_118 := lift_1_1(methoddefvar_81);
      {
        var lift_120 := multiset{lift_50, lift_56, lift_50};
        assert ((methoddefvar_80 < 535504585) || ((535504585 - methoddefvar_80) == -1));
        lift_119 := 'a';
        assert ((methoddefvar_80 < 535504585) || ((535504585 - methoddefvar_80) == -1));
        lift_120 := lift_120;
        assert ((methoddefvar_80 < 535504585) || ((535504585 - methoddefvar_80) == -1));
    ...
    if ((1926210751 > lift_121(lift_90))) {
      ...
      var methoddefvar_173 := lift_171_0(-251288953);
      {
        ...
        assert (((-2 - lift_131) == (-1 - lift_131)) || ((-1 - 88050655) == (-1 - lift_131)));
        lift_176 := lift_160;
        lift_177 := lift_178;
        lift_179 := lift_202;
        lift_217 := lift_221;
  ...
  assert ((safeSeqRef(
    lift_314.1.0,
    (multiset(lift_149)[lift_181.0] as int),
    lift_322
  ) + 1055347738) == (safeSeqRef(
    lift_314.1.0,
    (multiset(lift_149)[lift_181.0] as int),
    lift_322
  ) - (-2110695476 - safeSeqRef(
    lift_314.1.0,
    (multiset(lift_149)[lift_181.0] as int),
    lift_322
  ))));
