  ...
  ensures (false)
{
  ...
  arg_197 := -1351250551;
  {
    ...
    var lift_199 := (lift_200, true, (var tmpData : seq<bool> := []; tmpData));
    var lift_198 := ();
    lift_198 := ();
    assert false;
    lift_199 := lift_199;
...
method lift_128_0 (arg_131 : int, arg_132 : int, arg_133 : int)
  returns (arg_134 : int)
  requires (((arg_133 == 0) && ((arg_132 == 2080818963) && ((arg_131 == 381971632) && true))))
  ensures (((arg_134 == -963156081) && true))
{
  arg_134 := -963156081;
  {
    var lift_135 := -257086933;
    assert (((arg_134 < arg_134) && (-1 == arg_134)) || ((-963156082 - arg_134) == (-963156082 - -963156081)));
    lift_135 := arg_131;
  }
}
...
method Main () {
  ...
  if (((() !in safeSeqDrop(
    ...
    assert (((-2 - |lift_113.0|) - (0 - |lift_113.0|)) == ((0 - |lift_113.0|) + (0 - |lift_113.0|)));
