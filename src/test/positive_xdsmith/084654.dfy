  ...
  ensures (true)
{
  arg_159 := -1782372745;
  {
    ...
    print "(meth-for lift_154_0)\n";
    {
      var lift_161 := ();
      var lift_160 := ();
      print "(section 23 ", arg_157, "\n", ")\n";
      print "(section 24 ", arg_157, "\n", ")\n";
      lift_160 := lift_160;
      lift_161 := lift_160;
    }
  ...
  ensures (true)
{
  ...
  arg_132 := 1062914619;
  {
    ...
    print "(params-for lift_124_0 arg_130 ", arg_130, ")\n";
    print "(meth-for lift_124_0)\n";
    {
      ...
      var lift_135 := [
        lift_136,
        multiset{lift_137, lift_137, arg_129},
        lift_138
      ];
      ...
      lift_133 := arg_129;
      lift_134 := lift_139;
      print "(section 22 ", 1390621039, "\n", ")\n";
    }
    print "(rets-for lift_124_0 arg_131 ", arg_131, ")\n";
    print "(rets-for lift_124_0 arg_132 ", arg_132, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_132 := 1062914619;
  {
    ...
    print "(params-for lift_124_1 arg_129 ", arg_129, ")\n";
    print "(params-for lift_124_1 arg_130 ", arg_130, ")\n";
    print "(meth-for lift_124_1)\n";
    {
      ...
      lift_133 := arg_129;
      lift_134 := lift_139;
      print "(section 21 ", 1390621039, "\n", ")\n";
    }
    print "(rets-for lift_124_1 arg_131 ", arg_131, ")\n";
    print "(rets-for lift_124_1 arg_132 ", arg_132, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_69 := 1003800063;
  {
    ...
    {
      print "(section 18 ", 1250121784, "\n", ")\n";
      print "(section 19 ", arg_69, "\n", ")\n";
    }
