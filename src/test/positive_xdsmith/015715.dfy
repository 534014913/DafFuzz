...
method lift_158_0 (arg_162 : int, arg_163 : int, arg_164 : int)
  ...
  requires (((arg_164 == 400294327) && ((arg_163 == -1229988148) && ((arg_162 == 1073128756) && true))))
  ensures (((arg_166 == -1727720522) && ((arg_165 == -1704544486) && true)))
{
  arg_165 := -1704544486;
  arg_166 := -1727720522;
  {
    ...
    assert (0 == (-1704544486 - arg_165));
    lift_167 := lift_167;
    lift_171 := lift_171;
    assert (((-2 - lift_176) == (-1 - lift_176)) || ((2087601949 == lift_176) || (-1 == lift_176)));
  }
}
...
method lift_144_0 ()
  returns (arg_147 : int)
  requires (true)
  ensures (((arg_147 == -482585590) && true))
{
  arg_147 := -482585590;
  {
    var lift_155 := false;
    ...
    lift_148 := lift_149;
    assert (((-1850940590 - lift_150) == (-1850940589 - lift_150)) || ((-1850940589 - lift_150) == (-1850940589 - -1850940588)));
    assert (((-1850940590 - lift_150) == (-1850940589 - lift_150)) || ((-1850940589 - lift_150) == (-1850940589 - -1850940588)));
    lift_151 := lift_152;
  }
}
...
method lift_123_0 ()
  ...
  requires (true)
  ensures (((arg_128 == -117498838) && ((arg_127 == -1850981778) && true)))
{
  arg_127 := -1850981778;
  arg_128 := -117498838;
  {
    ...
    lift_129 := lift_129;
    lift_131 := lift_133;
    assert (((-1850981780 - arg_127) == (-1850981779 - arg_127)) || ((-1850981779 - arg_127) == (-1850981779 - -1850981778)));
    assert (((arg_128 < -117498837) || (arg_128 < arg_128)) || ((-117498840 - arg_128) == (-117498839 - arg_128)));
  }
}
...
method lift_97_0 (arg_100 : int, arg_101 : int)
  returns (arg_102 : int)
  requires (((arg_101 == -813547507) && ((arg_100 == 400294327) && true)))
  ensures (((arg_102 == 1007401148) && true))
{
  arg_102 := 1007401148;
  {
    var lift_107 := true;
...
method lift_62_0 (arg_66 : int, arg_67 : int)
  ...
  requires (((arg_67 == 400294327) && ((arg_66 == 400294327) && true)))
  ensures (((arg_69 == 1958241395) && ((arg_68 == 1736710030) && true)))
{
  arg_68 := 1736710030;
  arg_69 := 1958241395;
  {
    ...
    assert ((-3473420061 + (arg_68 + arg_68)) < arg_68);
    lift_70 := lift_70;
    lift_74 := lift_74;
  }
}
...
method lift_5_1 (arg_8 : int, arg_9 : int, arg_10 : int)
  returns (arg_11 : int)
  requires (((arg_10 == 2015235005) && ((arg_9 == 1) && ((arg_8 == -1086189808) && true))))
  ensures (((arg_11 == -2085225149) && true))
{
  arg_11 := -2085225149;
  {
    var lift_25 := ();
    ...
    var lift_13 := [lift_14, lift_16, lift_14, lift_14, lift_17];
    var lift_12 := 'B';
    assert ((-1559612991 < (-1 - -1559612991)) || ((1 == -1559612991) || (-1559612991 < -1559612991)));
    assert (0 < ((-2 - arg_10) + (arg_10 + arg_10)));
    lift_12 := lift_12;
    lift_13 := lift_13;
    lift_18 := lift_22;
  }
...
method lift_5_2 (arg_8 : int, arg_9 : int, arg_10 : int)
  returns (arg_11 : int)
  requires (((arg_10 == 400294327) && ((arg_9 == 400294327) && ((arg_8 == 2015235005) && true))))
  ensures (((arg_11 == -2085225149) && true))
{
  arg_11 := -2085225149;
  {
    ...
    var lift_12 := 'B';
    assert ((-1559612991 < (-1 - -1559612991)) || ((1 == -1559612991) || (-1559612991 < -1559612991)));
    assert (((-400294332 + arg_10) - (-400294330 + arg_10)) == ((400294326 - arg_10) + (400294326 - arg_10)));
    lift_12 := lift_12;
    lift_13 := lift_13;
    lift_18 := lift_22;
  }
...
method Main () {
  ...
  var lift_1 := lift_2;
  {
    ...
    if ((!(lift_1) ==> !(false) ==> lift_4)) {
      ...
      {
        assert (((-1 - methoddefvar_64) < -1) || ((-1 - methoddefvar_64) < (-1 - methoddefvar_64)));
        lift_75 := lift_51;
        assert (((methoddefvar_65 + methoddefvar_65) + (-1958241397 - methoddefvar_65)) < (methoddefvar_65 - (1958241394 - methoddefvar_65)));
        assert ((lift_42 + (0 - lift_42)) == (lift_42 - (-2172379616 - lift_42)));
      }
    }
    ...
    );
    {
      ...
      var methoddefvar_125, methoddefvar_126 := lift_123_0();
      {
        ...
        assert ((lift_42 + (0 - lift_42)) == (lift_42 - (-2172379616 - lift_42)));
        assert (((lift_40 < lift_40) && (-1229988149 == lift_40)) || (lift_40 == (-2459976296 - lift_40)));
        lift_141 := lift_141;
        lift_143 := lift_1;
      }
      ...
      {
        lift_156 := lift_4;
        assert (((lift_45 + -1073128757) + (-1 - lift_45)) < ((lift_45 - 2146257514) - (0 - 1073128756)));
        lift_157 := lift_51;
        assert (((lift_40 < lift_40) && (-1229988149 == lift_40)) || (lift_40 == (-2459976296 - lift_40)));
      }
      ...
      if (true) {
        ...
        assert (((-400294332 + lift_30) - (-400294330 + lift_30)) == ((400294326 - lift_30) + (400294326 - lift_30)));
        lift_183 := multiset{lift_191, lift_184};
        assert (((2015235003 - 2015235005) < (2015235004 - lift_179)) || ((2015235003 - lift_179) == (2015235004 - lift_179)));
        assert (((-2 - 1007401148) == (methoddefvar_99 + methoddefvar_99)) || ((-2 < methoddefvar_99) || (methoddefvar_99 < methoddefvar_99)));
      } else {
        assert false;
        assert false;
      }
    ...
    );
    {
      ...
      {
        assert (((-400294332 + lift_28) - (-400294330 + lift_28)) == ((400294326 - lift_28) + (400294326 - lift_28)));
        lift_203 := lift_34;
        assert (((-2085225150 - methoddefvar_195) == (-2085225150 - methoddefvar_195)) && (methoddefvar_195 == (-4170450298 - methoddefvar_195)));
      }
      if (lift_51) {
        assert (((-400294332 + lift_27) - (-400294330 + lift_27)) == ((400294326 - lift_27) + (400294326 - lift_27)));
        assert (1578009170 == ((1578009170 + 1578009170) - 1578009170));
      } else {
        assert false;
        assert false;
        lift_204 := true;
      ...
      assert (((400294327 == lift_26) && (lift_26 == lift_26)) || ((lift_26 < lift_26) || (lift_26 < lift_26)));
    }
  }
  assert (((|safeSeqRef(
    lift_206(lift_215),
  ...
  lift_241 := lift_281.2;
  assert (-283304516 < lift_260.0);
  assert (((lift_180 - 4030470011) - lift_180) == ((0 - 2015235005) + (-1 - lift_180)));
}
