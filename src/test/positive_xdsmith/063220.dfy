  ...
  ensures (true)
{
  arg_71 := -204310916;
  {
    print "(meth-for lift_68_0)\n";
    {
      ...
      lift_72 := lift_75;
      lift_76 := lift_91;
      print "(section 9 ", arg_71, "\n", ")\n";
      print "(section 10 ", -556138989, "\n", ")\n";
  ...
  ensures (true)
{
  arg_52 := 1017759574;
  {
    print "(params-for lift_46_0 arg_49 ", arg_49, ")\n";
...
method Main () {
  ...
  var methoddefvar_70 := lift_68_0();
  {
    ...
    );
    {
      var lift_111 := 't';
      lift_111 := 'E';
      print "(section 4 ", methoddefvar_105, "\n", ")\n";
    }
  }
  print "(section 5 ", |(lift_112.2 + lift_131.1)|, "\n", ")\n";
}
