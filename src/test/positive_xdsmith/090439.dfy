  ...
  ensures (true)
{
  ...
  arg_214 := -1098634406;
  {
    ...
    print "(meth-for lift_207_0)\n";
    {
      ...
      print "(section 22 ", 1435261474, "\n", ")\n";
      lift_215 := lift_216;
      print "(section 23 ", lift_217, "\n", ")\n";
      lift_218 := ();
    }
  ...
  ensures (true)
{
  arg_66 := 404480872;
  {
    ...
    {
      print "(section 18 ", 1238598325, "\n", ")\n";
      print "(section 19 ", arg_64, "\n", ")\n";
      print "(section 20 ", arg_65, "\n", ")\n";
    }
