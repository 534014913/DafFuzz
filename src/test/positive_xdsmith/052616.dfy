  ...
  ensures (true)
{
  ...
  arg_170 := 1404636962;
  {
    ...
    print "(meth-for lift_163_0)\n";
    {
      ...
      lift_171 := lift_172;
      print "(section 30 ", -1975021961, "\n", ")\n";
      print "(section 31 ", arg_169, "\n", ")\n";
      lift_173 := arg_167;
  ...
  ensures (true)
{
  ...
  arg_135 := 1762771475;
  {
    ...
    print "(meth-for lift_128_0)\n";
    {
      ...
      print "(section 29 ", 1254824326, "\n", ")\n";
      lift_136 := (lift_137, true);
      lift_139 := lift_140;
    }
    print "(rets-for lift_128_0 arg_134 ", arg_134, ")\n";
    print "(rets-for lift_128_0 arg_135 ", arg_135, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_16 := 2086684542;
  {
    ...
    print "(meth-for lift_10_0)\n";
    {
      var lift_18 := ();
      var lift_17 := lift_18;
      print "(section 24 ", arg_15, "\n", ")\n";
      print "(section 25 ", arg_16, "\n", ")\n";
      lift_17 := lift_17;
    }
  ...
  ensures (true)
{
  ...
  arg_16 := 2086684542;
  {
    ...
    print "(meth-for lift_10_1)\n";
    {
      var lift_18 := ();
      var lift_17 := lift_18;
      print "(section 22 ", arg_15, "\n", ")\n";
      print "(section 23 ", arg_16, "\n", ")\n";
      lift_17 := lift_17;
    }
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_38 := lift_36_0(1671809578, lift_32);
    {
      ...
      var lift_57 := lift_58;
      lift_56 := -246599169;
      print "(section 1 ", -832542491, "\n", ")\n";
      lift_57 := lift_58;
      print "(section 2 ", lift_32, "\n", ")\n";
      lift_60 := true;
    }
    if (safeSeqRef(lift_61, lift_56, true)) {
      {
        print "(section 3 ", 18940199, "\n", ")\n";
        lift_62 := lift_62;
      }
      ...
      {
        print "(section 7 ", lift_62, "\n", ")\n";
        print "(section 8 ", methoddefvar_13, "\n", ")\n";
      ...
      lift_94 := lift_94;
      {
        ...
        lift_102 := lift_102;
        print "(section 13 ", lift_86, "\n", ")\n";
      }
    }
    print "(section 14 ", |multiset{lift_6, lift_23, '+'}|, "\n", ")\n";
  ...
  if (lift_110(
    ...
    );
    {
      ...
      var methoddefvar_176 := lift_174_0(lift_7);
      {
        ...
        lift_183 := lift_185;
        print "(section 19 ", lift_149, "\n", ")\n";
        print "(section 20 ", lift_85, "\n", ")\n";
