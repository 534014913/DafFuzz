...
method lift_560_0 ()
  returns (arg_563 : int)
  requires (true)
  ensures (((arg_563 == 1939481703) && true))
{
  arg_563 := 1939481703;
  {
    var lift_564 := 755954543;
    assert (((755954540 - 755954543) == (755954540 - lift_564)) || ((lift_564 == 755954543) && (lift_564 == lift_564)));
    assert (755954542 < lift_564);
  }
}
...
method lift_477_0 (arg_480 : int, arg_481 : int)
  returns (arg_482 : int)
  requires (((arg_481 == 479509984) && ((arg_480 == 1312590211) && true)))
  ensures (((arg_482 == -1716059127) && true))
{
  arg_482 := -1716059127;
  {
    var lift_490 := '_';
    ...
    assert ((-36143721 + (-72287442 - -36143721)) == ((-108431162 - -36143721) + (-36143722 - -36143721)));
    assert (((0 - 1312590211) == (arg_480 - 2625180422)) && ((-1 - arg_480) == (-2625180423 + arg_480)));
...
method lift_469_0 (arg_473 : int)
  ...
  requires (((arg_473 == 1312590211) && true))
  ensures (((arg_475 == 218778897) && ((arg_474 == 2009454622) && true)))
{
  arg_474 := 2009454622;
  arg_475 := 218778897;
  {
    assert (-4018909246 == ((-1 - arg_474) + (-1 - arg_474)));
    assert (((1 - arg_473) < arg_473) || ((-2 - arg_473) == (-1 - arg_473)));
  }
}

method lift_456_0 (arg_460 : int, arg_461 : int)
  returns (arg_462 : int, arg_463 : int)
  requires (((arg_461 == 493947876) && ((arg_460 == 1452191098) && true)))
  ensures (((arg_463 == 1209021863) && ((arg_462 == -8081334) && true)))
{
  arg_462 := -8081334;
  arg_463 := 1209021863;
  {
    ...
    lift_464 := arg_461;
    assert (((arg_461 + arg_461) + (-1481843628 - arg_461)) < ((arg_461 - 987895752) + arg_461));
    assert (((arg_463 - 1209021865) + 2) == ((1209021864 - arg_463) + (1209021862 - arg_463)));
  }
}

method lift_428_0 (arg_431 : int)
  returns (arg_432 : int)
  requires (((arg_431 == 689435139) && true))
  ensures (((arg_432 == 1369758759) && true))
{
  arg_432 := 1369758759;
  {
    ...
    lift_442 := lift_442;
    assert (((1369758758 - arg_432) + (-1369758760 - arg_432)) == ((arg_432 - arg_432) + (-1369758761 - arg_432)));
    assert ((lift_443 == (lift_443 - 0)) && ((-710697550 == lift_443) || (-710697550 == lift_443)));
  }
}
...
method lift_406_0 (arg_409 : int, arg_410 : int)
  returns (arg_411 : int)
  requires (((arg_410 == 1935049128) && ((arg_409 == 108) && true)))
  ensures (((arg_411 == 9772722) && true))
{
  arg_411 := 9772722;
  {
    var lift_412 := 348844354;
    assert (((arg_409 == 108) || (111 == arg_409)) || ((arg_409 < 110) || (arg_409 < arg_409)));
    assert (((-9772726 + arg_411) - (arg_411 - arg_411)) < ((9772720 - arg_411) - (9772721 - arg_411)));
    assert (((lift_412 + -348844355) + (-1 - lift_412)) < ((lift_412 - 697688710) - (0 - 348844354)));
  }
}
...
method lift_325_0 (arg_329 : int, arg_330 : int, arg_331 : int)
  ...
  requires (((arg_331 == 1612813774) && ((arg_330 == 1947809857) && ((arg_329 == -1125237528) && true))))
  ensures (((arg_333 == 1747695376) && ((arg_332 == -1143232274) && true)))
{
  arg_332 := -1143232274;
  arg_333 := 1747695376;
  {
    var lift_334 := -1019860766;
    assert ((lift_334 + (-4079443068 - lift_334)) == ((-3059582300 - lift_334) + (-3059582300 - lift_334)));
    assert ((arg_329 < (2250475058 + arg_329)) && ((-1125237527 == arg_329) || (-1125237528 == arg_329)));
    assert (-1143232274 == arg_332);
  }
}
...
method lift_276_1 (arg_280 : int)
  returns (arg_281 : int, arg_282 : int)
  requires (((arg_280 == -262622889) && true))
  ensures (((arg_282 == 582462625) && ((arg_281 == 545300333) && true)))
{
  arg_281 := 545300333;
  arg_282 := 582462625;
  {
    ...
    lift_283 := lift_283;
    lift_284 := lift_284;
    assert (((arg_280 == arg_280) || (arg_280 < arg_280)) && ((-262622889 == arg_280) && (arg_280 < -262622887)));
    assert (((-545300337 + arg_281) - (arg_281 - arg_281)) < ((545300331 - arg_281) - (545300332 - arg_281)));
  }
}
...
method lift_229_0 (arg_232 : int)
  returns (arg_233 : int)
  requires (((arg_232 == 1997650055) && true))
  ensures (((arg_233 == -333002854) && true))
{
  arg_233 := -333002854;
  {
    assert (((-2 - 1997650055) == (arg_232 + arg_232)) || ((-2 < arg_232) || (arg_232 < arg_232)));
  }
}

method lift_229_1 (arg_232 : int)
  returns (arg_233 : int)
  requires (((arg_232 == 2144807204) && true))
  ensures (((arg_233 == -333002854) && true))
{
  arg_233 := -333002854;
  {
    assert (((arg_232 == arg_232) && (arg_232 == arg_232)) && ((-2144807205 - arg_232) < (-2144807204 - 2144807204)));
  }
}
  ...
  if ((lift_59.2.1 < lift_76.0.2 <= safeSeqRef(
    ...
    if ((lift_21.0 == lift_61.0 >= (
      ...
      var lift_245 := (var tmpData : seq<(int, char)> := []; tmpData);
      {
        ...
        {
          var lift_234 := 'W';
          assert (((1 - lift_72) < lift_72) || ((-2 - lift_72) == (-1 - lift_72)));
          lift_234 := 'Z';
          lift_235 := lift_235;
        }
      }
      if ((lift_227 !! lift_227 !! lift_227)) {
        ...
        if (lift_24) {
          assert (((1 - lift_71) < lift_71) || ((-2 - lift_71) == (-1 - lift_71)));
          lift_236 := lift_236;
          assert (((lift_163 == lift_163) || (lift_163 < lift_163)) && ((-1681618731 - lift_163) == (-5044856191 + lift_163)));
          lift_238 := lift_245;
        } else {
          assert false;
          assert false;
      ...
      {
        assert (((lift_243 + -1864444535) - -1864444533) == ((lift_243 - 1) + (-1864444535 - lift_243)));
      }
      if ((lift_85 <==> lift_262 <==> lift_237)) {
        ...
        assert (((-1452191103 + lift_322) - (-1452191101 + lift_322)) == ((1452191097 - lift_322) + (1452191097 - lift_322)));
        ...
        {
          assert (((lift_254 == lift_254) || (lift_254 < lift_254)) && ((lift_254 + lift_254) == (-3375712584 - -1125237528)));
          lift_335 := lift_335;
        }
        {
          ...
          lift_340 := lift_341;
          lift_351 := lift_262;
          assert (((lift_258 == lift_258) || (lift_258 < lift_258)) && ((-262622889 == lift_258) && (lift_258 < -262622887)));
          assert (((lift_313 + lift_313) + (-2099199217 - lift_313)) < ((lift_313 - 2099199215) - (2099199216 - lift_313)));
          lift_352 := lift_362;
        }
        assert (((lift_243 + lift_243) + lift_243) < ((lift_243 - 1864444533) + lift_243));
      } else {
  ...
  );
  {
    ...
    if (('|' in lift_417)) {
      ...
      var methoddefvar_420, methoddefvar_421 := lift_276_1(lift_259);
      {
        ...
        assert (((lift_320 + lift_320) + -378141016) == (0 - (lift_320 - lift_320)));
        lift_422 := lift_98;
        lift_423 := lift_424;
        assert (((lift_388 - 4079557397) - lift_388) == ((-1019889349 - 1019889349) + (-1019889350 - lift_388)));
        lift_426 := (lift_67, lift_73);
      }
      lift_427 := lift_295;
      var methoddefvar_430 := lift_428_0(lift_361);
      {
        assert (((-1 - lift_47) < (-1 - 0)) && ((lift_47 < lift_47) || (lift_47 == lift_47)));
    ...
    var methoddefvar_458, methoddefvar_459 := lift_456_0(lift_322, lift_338);
    {
      ...
      assert ((methoddefvar_458 - (-8081335 - methoddefvar_458)) < ((-8081335 + methoddefvar_458) - (methoddefvar_458 + methoddefvar_458)));
      lift_465 := lift_465;
      assert (((methoddefvar_459 - 1209021865) + 2) == ((1209021864 - methoddefvar_459) + (1209021862 - methoddefvar_459)));
      assert ((lift_338 + (lift_338 + -987895755)) == ((493947875 - lift_338) + (-493947878 + lift_338)));
    }
    if ((lift_98 <== lift_14 <== lift_98)) {
      ...
      {
        assert (((-2 - 624055583) == (lift_225 + lift_225)) || ((-2 < lift_225) || (lift_225 < lift_225)));
        lift_466 := lift_71;
        lift_467 := {lift_221, ()};
      ...
      {
        assert ((-524611627 < -524611626) && ((2 == -524611626) || (-524611626 == -524611626)));
        lift_476 := lift_62;
        assert (((0 + -2) - (lift_313 - lift_313)) == (-1 + (2099199215 - lift_313)));
      }
      assert (((1 - lift_466) < lift_466) || ((-2 - lift_466) == (-1 - lift_466)));
