  ...
  ensures (true)
{
  arg_23 := 2102700199;
  {
    ...
    print "(rets-for lift_20_0 arg_23 ", arg_23, ")\n";
  }
}
...
method Main () {
  ...
  }
  {
    ...
    var lift_94 := (var tmpData : multiset<((), int, (bool, bool, bool))> := multiset{}; tmpData);
    {
      ...
      var lift_83 := ();
      print "(section 3 ", lift_13.1, "\n", ")\n";
      print "(section 4 ", ('P' as int), "\n", ")\n";
      {
        ...
        {
          print "(section 5 ", -34571688, "\n", ")\n";
          print "(section 6 ", lift_75, "\n", ")\n";
          print "(section 7 ", methoddefvar_87, "\n", ")\n";
          lift_94 := lift_95;
          lift_104 := lift_82;
        }
      }
      {
        ...
        if (false) {
          ...
          lift_138 := lift_147;
          print "(section 11 ", lift_129, "\n", ")\n";
          print "(section 12 ", lift_75, "\n", ")\n";
        }
        {
          print "(section 13 ", lift_128, "\n", ")\n";
          print "(section 14 ", 329604843, "\n", ")\n";
        }
        lift_149 := lift_156;
        {
          lift_157 := lift_157;
    ...
    print 
      "(section 15 ",
      lift_164.0(|lift_145|, lift_172(lift_11, lift_176), lift_161, lift_13.0),
      "\n",
      ")\n";
  }
}
