  ...
  ensures (true)
{
  arg_466 := 1023191384;
  {
    print "(params-for lift_462_0 arg_465 ", arg_465, ")\n";
    print "(meth-for lift_462_0)\n";
    {
      ...
      print "(section 73 ", arg_466, "\n", ")\n";
      print "(section 74 ", lift_467, "\n", ")\n";
      lift_468 := lift_468;
      lift_472 := (lift_473, lift_470);
    }
    print "(rets-for lift_462_0 arg_466 ", arg_466, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_466 := 1023191384;
  {
    print "(params-for lift_462_1 arg_465 ", arg_465, ")\n";
    print "(meth-for lift_462_1)\n";
    {
      ...
      var lift_468 := (805731997, lift_469);
      var lift_467 := arg_465;
      print "(section 71 ", arg_466, "\n", ")\n";
      print "(section 72 ", lift_467, "\n", ")\n";
      lift_468 := lift_468;
      lift_472 := (lift_473, lift_470);
    }
    print "(rets-for lift_462_1 arg_466 ", arg_466, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_419 := 984996336;
  {
    ...
    print "(meth-for lift_413_0)\n";
    {
      ...
      print "(section 69 ", arg_418, "\n", ")\n";
      print "(section 70 ", arg_418, "\n", ")\n";
      lift_420 := lift_422;
      lift_430 := 1606828248;
    }
  ...
  ensures (true)
{
  ...
  arg_419 := 984996336;
  {
    ...
    print "(meth-for lift_413_1)\n";
    {
      ...
      var lift_421 := ();
      var lift_420 := multiset{lift_421, lift_421, ()};
      print "(section 67 ", arg_418, "\n", ")\n";
      print "(section 68 ", arg_418, "\n", ")\n";
      lift_420 := lift_422;
      lift_430 := 1606828248;
    }
    print "(rets-for lift_413_1 arg_418 ", arg_418, ")\n";
    print "(rets-for lift_413_1 arg_419 ", arg_419, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_419 := 984996336;
  {
    print "(params-for lift_413_2 arg_417 ", arg_417, ")\n";
    print "(meth-for lift_413_2)\n";
    {
      var lift_430 := 346166112;
      var lift_429 := ();
      var lift_428 := lift_429;
      ...
      var lift_421 := ();
      var lift_420 := multiset{lift_421, lift_421, ()};
      print "(section 65 ", arg_418, "\n", ")\n";
      print "(section 66 ", arg_418, "\n", ")\n";
      lift_420 := lift_422;
      lift_430 := 1606828248;
    }
    print "(rets-for lift_413_2 arg_418 ", arg_418, ")\n";
    print "(rets-for lift_413_2 arg_419 ", arg_419, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_368 := 338010799;
  {
    ...
    print "(meth-for lift_362_0)\n";
    {
      var lift_369 := 'k';
      lift_369 := 'h';
      print "(section 64 ", arg_368, "\n", ")\n";
    }
    print "(rets-for lift_362_0 arg_367 ", arg_367, ")\n";
    print "(rets-for lift_362_0 arg_368 ", arg_368, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_368 := 338010799;
  {
    print "(params-for lift_362_1 arg_366 ", arg_366, ")\n";
    print "(meth-for lift_362_1)\n";
    {
      var lift_369 := 'k';
      lift_369 := 'h';
      print "(section 63 ", arg_368, "\n", ")\n";
    }
    print "(rets-for lift_362_1 arg_367 ", arg_367, ")\n";
    print "(rets-for lift_362_1 arg_368 ", arg_368, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_368 := 338010799;
  {
    print "(params-for lift_362_2 arg_366 ", arg_366, ")\n";
    print "(meth-for lift_362_2)\n";
    {
      var lift_369 := 'k';
      lift_369 := 'h';
      print "(section 62 ", arg_368, "\n", ")\n";
    }
    print "(rets-for lift_362_2 arg_367 ", arg_367, ")\n";
    print "(rets-for lift_362_2 arg_368 ", arg_368, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_338 := -512772182;
  {
    ...
    print "(rets-for lift_332_1 arg_338 ", arg_338, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_307 := -2094111306;
  {
    print "(params-for lift_303_0 arg_306 ", arg_306, ")\n";
  ...
  ensures (true)
{
  arg_307 := -2094111306;
  {
    print "(params-for lift_303_1 arg_306 ", arg_306, ")\n";
    print "(meth-for lift_303_1)\n";
    {
      ...
      lift_317 := lift_317;
      lift_319 := arg_306;
      print "(section 60 ", arg_307, "\n", ")\n";
    }
    print "(rets-for lift_303_1 arg_307 ", arg_307, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_273 := -2136365123;
  {
    ...
    print "(rets-for lift_270_0 arg_273 ", arg_273, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_273 := -2136365123;
  {
    ...
    print "(rets-for lift_270_1 arg_273 ", arg_273, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_75 := -1631662274;
  {
    ...
    {
      print "(section 54 ", arg_73, "\n", ")\n";
      print "(section 55 ", arg_74, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_75 := -1631662274;
  {
    ...
    {
      print "(section 52 ", arg_73, "\n", ")\n";
      print "(section 53 ", arg_74, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_75 := -1631662274;
  {
    print "(params-for lift_68_2 arg_72 ", arg_72, ")\n";
    print "(params-for lift_68_2 arg_73 ", arg_73, ")\n";
    print "(meth-for lift_68_2)\n";
    {
      print "(section 50 ", arg_73, "\n", ")\n";
      print "(section 51 ", arg_74, "\n", ")\n";
    }
    print "(rets-for lift_68_2 arg_74 ", arg_74, ")\n";
    print "(rets-for lift_68_2 arg_75 ", arg_75, ")\n";
  }
}
...
method Main () {
  ...
  if ((((lift_17 <== lift_17) <==> (false && lift_19) <==> (lift_6 == lift_8)) <== (safeSeqSlice2(
    ...
    if ((|"p;~=MPViqO>Q'"| in lift_94())) {
      ...
      if ((lift_62 !in lift_213)) {
        ...
        {
          print "(section 12 ", lift_174, "\n", ")\n";
          lift_260 := lift_261;
          print "(section 13 ", lift_44, "\n", ")\n";
          lift_269 := lift_267;
        }
        var methoddefvar_272 := lift_270_0();
        {
          ...
          lift_289 := lift_289;
          print "(section 14 ", lift_177, "\n", ")\n";
          print "(section 15 ", 281748574, "\n", ")\n";
          lift_290 := lift_291;
        }
      }
      print "(section 16 ", lift_292.1, "\n", ")\n";
    ...
    }
    {
      ...
      {
        print "(section 18 ", -335492683, "\n", ")\n";
        print "(section 19 ", 1359436552, "\n", ")\n";
        lift_320 := lift_321;
  ...
  );
  {
    ...
    if (safeSeqRef(lift_359, lift_86, lift_20)) {
      ...
      {
        print "(section 24 ", lift_111, "\n", ")\n";
        lift_370 := lift_372;
      }
      print "(section 25 ", lift_12, "\n", ")\n";
      lift_377 := lift_384;
      {
        print "(section 26 ", lift_43, "\n", ")\n";
        print "(section 27 ", -1916401002, "\n", ")\n";
      }
    ...
    }
    {
      ...
      {
        print "(section 32 ", lift_499, "\n", ")\n";
        print "(section 33 ", lift_500, "\n", ")\n";
        lift_503 := (lift_514, multiset{lift_488, lift_448, lift_382, lift_17});
        print "(section 34 ", 1604713884, "\n", ")\n";
      }
      lift_518 := lift_518;
      lift_519 := lift_23;
    }
  ...
  var methoddefvar_522 := lift_520_0(lift_217, lift_12);
  {
    ...
    print 
      "(section 35 ",
      safeSeqRef(lift_324, 753243576, lift_296),
      "\n",
      ")\n";
  ...
  var methoddefvar_563, methoddefvar_564 := lift_413_1(lift_12);
  {
    ...
    if (lift_381) {
      ...
      var methoddefvar_566, methoddefvar_567 := lift_68_2(lift_500, lift_65);
      {
        ...
        lift_568 := lift_569;
        lift_573 := lift_453;
        print "(section 39 ", lift_356, "\n", ")\n";
        print "(section 40 ", lift_44, "\n", ")\n";
      }
      lift_574 := lift_530;
    }
    ...
    if ((lift_497 ==> lift_375)) {
      ...
      {
        lift_582 := lift_584;
        print "(section 46 ", lift_296, "\n", ")\n";
        lift_585 := lift_89;
        print "(section 47 ", 1066637747, "\n", ")\n";
        lift_586 := (lift_592, lift_587, (lift_12, lift_325));
      }
      {
        lift_593 := lift_593;
        lift_597 := lift_519;
        print "(section 48 ", lift_16, "\n", ")\n";
        lift_601 := lift_601;
      }
    }
    print "(section 49 ", (lift_48 as int), "\n", ")\n";
  }
}
