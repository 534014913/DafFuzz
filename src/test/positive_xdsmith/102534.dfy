  ...
  ensures (true)
{
  arg_60 := 84405321;
  {
    ...
    print "(params-for lift_54_1 arg_59 ", arg_59, ")\n";
  ...
  ensures (true)
{
  ...
  arg_52 := -1436770473;
  {
    ...
    print "(params-for lift_44_0 arg_50 ", arg_50, ")\n";
    print "(meth-for lift_44_0)\n";
    {
      print "(section 25 ", 1919189209, "\n", ")\n";
      print "(section 26 ", arg_51, "\n", ")\n";
    }
    print "(rets-for lift_44_0 arg_51 ", arg_51, ")\n";
    print "(rets-for lift_44_0 arg_52 ", arg_52, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_32 := 100342225;
  {
    print "(params-for lift_26_1 arg_30 ", arg_30, ")\n";
    print "(meth-for lift_26_1)\n";
    {
      ...
      var lift_34 := lift_35;
      var lift_33 := ();
      print "(section 23 ", -1361884949, "\n", ")\n";
      lift_33 := lift_33;
      lift_34 := lift_34;
      lift_38 := {'P', lift_34, lift_34, lift_40, lift_35};
      lift_41 := arg_30;
    }
    print "(rets-for lift_26_1 arg_31 ", arg_31, ")\n";
    print "(rets-for lift_26_1 arg_32 ", arg_32, ")\n";
  }
}
...
method Main () {
  ...
  if (!(lift_1.0)) {
    ...
    var methoddefvar_79, methoddefvar_80 := lift_26_1(lift_22);
    {
      ...
      if (lift_43) {
        print "(section 9 ", -637709498, "\n", ")\n";
        print "(section 10 ", lift_5, "\n", ")\n";
        print "(section 11 ", lift_5, "\n", ")\n";
        print "(section 12 ", 306878354, "\n", ")\n";
      } else {
    ...
    print 
      ...
      lift_149(
        lift_157,
        safeSeqRef(lift_158, lift_5, lift_159),
        safeSeqRef(
          "w=lM\"aABcRMpXmy=XaHpY'U$nPH|D@y?!\":G?",
          lift_131,
          lift_134
        ),
        lift_162.2
