  ...
  ensures (true)
{
  arg_346 := 1958975724;
  {
    print "(meth-for lift_343_0)\n";
    {
      ...
      print "(section 97 ", arg_346, "\n", ")\n";
      print "(section 98 ", arg_346, "\n", ")\n";
      print "(section 99 ", lift_347, "\n", ")\n";
    }
    print "(rets-for lift_343_0 arg_346 ", arg_346, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_306 := -714655942;
  {
    ...
    print "(meth-for lift_300_0)\n";
    {
      ...
      print "(section 95 ", arg_304, "\n", ")\n";
      print "(section 96 ", lift_307, "\n", ")\n";
      lift_308 := multiset{lift_309, lift_309};
    }
    print "(rets-for lift_300_0 arg_305 ", arg_305, ")\n";
    print "(rets-for lift_300_0 arg_306 ", arg_306, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_251 := 736250778;
  {
    print "(meth-for lift_246_0)\n";
    {
      ...
      print "(section 89 ", arg_251, "\n", ")\n";
      lift_252 := lift_253;
      print "(section 90 ", arg_251, "\n", ")\n";
      print "(section 91 ", lift_259, "\n", ")\n";
    }
    print "(rets-for lift_246_0 arg_250 ", arg_250, ")\n";
  ...
  ensures (true)
{
  ...
  arg_242 := 1599381954;
  {
    ...
    {
      print "(section 86 ", arg_241, "\n", ")\n";
      print "(section 87 ", arg_242, "\n", ")\n";
      print "(section 88 ", arg_240, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_214 := -1964363353;
  {
    print "(meth-for lift_211_2)\n";
    {
      ...
      var lift_216 := [lift_217, lift_217, lift_217, lift_217, lift_217];
      var lift_215 := lift_216;
      print "(section 83 ", arg_214, "\n", ")\n";
      lift_215 := lift_215;
      lift_218 := lift_218;
    }
    print "(rets-for lift_211_2 arg_214 ", arg_214, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_90 := -1109179227;
  {
    print "(meth-for lift_85_1)\n";
    {
      ...
      lift_91 := lift_91;
      lift_108 := lift_110;
      print "(section 77 ", lift_113, "\n", ")\n";
      lift_114 := lift_115;
    }
    print "(rets-for lift_85_1 arg_89 ", arg_89, ")\n";
  ...
  ensures (true)
{
  ...
  arg_90 := -1109179227;
  {
    print "(meth-for lift_85_2)\n";
    {
      ...
      lift_91 := lift_91;
      lift_108 := lift_110;
      print "(section 76 ", lift_113, "\n", ")\n";
      lift_114 := lift_115;
    }
    print "(rets-for lift_85_2 arg_89 ", arg_89, ")\n";
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0(lift_13.0.2);
  {
    ...
    var lift_36 := {lift_27, lift_37, lift_31, lift_31};
    {
      ...
      var methoddefvar_80, methoddefvar_81 := lift_1_1(methoddefvar_4);
      {
        ...
        print "(section 14 ", methoddefvar_80, "\n", ")\n";
        print "(section 15 ", lift_17, "\n", ")\n";
      }
    }
  ...
  if ((lift_127.1.1 !! ((lift_138 + lift_141 + lift_147) - lift_149()))) {
    ...
    if ((lift_149() !! (lift_140 * lift_138))) {
      ...
      var lift_163 := lift_128;
      {
        ...
        if (true) {
          ...
          print "(section 22 ", lift_18, "\n", ")\n";
          lift_166 := lift_167;
          print "(section 23 ", 746551705, "\n", ")\n";
        } else {
          print "(section 24 ", lift_50, "\n", ")\n";
          lift_168 := lift_169;
        }
      }
      {
        print "(section 25 ", lift_53, "\n", ")\n";
        {
          print "(section 26 ", lift_50, "\n", ")\n";
          print "(section 27 ", lift_53, "\n", ")\n";
          print "(section 28 ", lift_77, "\n", ")\n";
          lift_170 := lift_26;
      ...
      {
        lift_222 := lift_222;
        print "(section 33 ", 636797437, "\n", ")\n";
        print "(section 34 ", lift_206, "\n", ")\n";
      }
    ...
    );
    {
      ...
      if (true) {
        var lift_245 := 'x';
        print "(section 35 ", lift_137, "\n", ")\n";
        lift_243 := lift_51;
        lift_244 := lift_16;
        print "(section 36 ", lift_77, "\n", ")\n";
        lift_245 := lift_119;
      } else {
        print "(section 37 ", lift_51, "\n", ")\n";
        print "(section 38 ", -1648835558, "\n", ")\n";
        print "(section 39 ", lift_206, "\n", ")\n";
        print "(section 40 ", lift_51, "\n", ")\n";
      }
      {
        print "(section 41 ", 470399427, "\n", ")\n";
      }
      print "(section 42 ", -805440009, "\n", ")\n";
      var methoddefvar_248, methoddefvar_249 := lift_246_0();
      {
        print "(section 43 ", -1346894288, "\n", ")\n";
        print "(section 44 ", lift_206, "\n", ")\n";
        lift_260 := lift_16;
        print "(section 45 ", -72374457, "\n", ")\n";
      }
      lift_261 := ();
    }
    if ((safeSeqRef(
      ...
      print "(section 46 ", (lift_179[lift_144] as int), "\n", ")\n";
      ...
      if ((lift_271 in lift_169)) {
        var lift_289 := ();
        print "(section 47 ", lift_123, "\n", ")\n";
        var methoddefvar_274, methoddefvar_275 := lift_85_1();
        {
          print "(section 48 ", lift_137, "\n", ")\n";
          print "(section 49 ", lift_135, "\n", ")\n";
          lift_276 := lift_124;
          print "(section 50 ", methoddefvar_274, "\n", ")\n";
        }
        var methoddefvar_279 := lift_277_0(lift_19, -319732123);
        {
          print "(section 51 ", lift_207, "\n", ")\n";
        }
        ...
        );
        {
          ...
          lift_288 := lift_288;
          lift_289 := ();
          print "(section 52 ", lift_271, "\n", ")\n";
          print "(section 53 ", 1889414682, "\n", ")\n";
        }
        {
          var lift_290 := false;
          lift_290 := lift_84;
        ...
        {
          print "(section 54 ", 1171761285, "\n", ")\n";
          print "(section 55 ", 1109840614, "\n", ")\n";
        }
      }
      {
        print "(section 56 ", lift_51, "\n", ")\n";
        var methoddefvar_302, methoddefvar_303 := lift_300_0(lift_206);
        {
          print "(section 57 ", -750793568, "\n", ")\n";
        }
      }
    } else {
      ...
      {
        var lift_321 := ();
        print "(section 60 ", -1033407239, "\n", ")\n";
        print "(section 61 ", lift_53, "\n", ")\n";
        print "(section 62 ", -85798486, "\n", ")\n";
        lift_316 := lift_320;
        lift_321 := lift_43;
      }
      print "(section 63 ", lift_206, "\n", ")\n";
    }
  } else {
    print "(section 64 ", lift_322(), "\n", ")\n";
  }
  var methoddefvar_328, methoddefvar_329 := lift_85_2();
  {
    var lift_350 := true;
    print "(section 65 ", |lift_330|, "\n", ")\n";
    {
      var lift_333 := lift_334;
      {
        lift_333 := lift_333;
        print "(section 66 ", 2095742929, "\n", ")\n";
        print "(section 67 ", lift_226, "\n", ")\n";
      ...
      {
        print "(section 69 ", -1881054829, "\n", ")\n";
      }
      {
        print "(section 70 ", lift_349, "\n", ")\n";
      }
    }
    ...
    {
      print "(section 71 ", methoddefvar_329, "\n", ")\n";
      print "(section 72 ", lift_319, "\n", ")\n";
    }
  }
}
