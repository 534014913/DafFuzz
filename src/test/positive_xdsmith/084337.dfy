  ...
  ensures (true)
{
  ...
  arg_265 := -535691561;
  {
    ...
    print "(meth-for lift_258_0)\n";
    {
      ...
      print "(section 49 ", -642774905, "\n", ")\n";
      lift_266 := lift_270;
      lift_275 := lift_276;
      lift_277 := (lift_278, lift_269);
      print "(section 50 ", lift_280, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_253 := -811470099;
  {
    print "(meth-for lift_248_0)\n";
    {
      ...
      var lift_254 := 'S';
      lift_254 := lift_255;
      print "(section 47 ", arg_253, "\n", ")\n";
      print "(section 48 ", lift_256, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_253 := -811470099;
  {
    print "(meth-for lift_248_1)\n";
    {
      ...
      var lift_254 := 'S';
      lift_254 := lift_255;
      print "(section 45 ", arg_253, "\n", ")\n";
      print "(section 46 ", lift_256, "\n", ")\n";
    }
    print "(rets-for lift_248_1 arg_252 ", arg_252, ")\n";
  ...
  ensures (true)
{
  ...
  arg_253 := -811470099;
  {
    print "(meth-for lift_248_2)\n";
    {
      ...
      var lift_254 := 'S';
      lift_254 := lift_255;
      print "(section 43 ", arg_253, "\n", ")\n";
      print "(section 44 ", lift_256, "\n", ")\n";
    }
    print "(rets-for lift_248_2 arg_252 ", arg_252, ")\n";
  ...
  ensures (true)
{
  ...
  arg_228 := 837943524;
  {
    ...
    print "(params-for lift_220_0 arg_226 ", arg_226, ")\n";
    ...
    print "(rets-for lift_220_0 arg_228 ", arg_228, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_121 := -961844296;
  {
    ...
    print "(meth-for lift_115_0)\n";
    {
      ...
      var lift_122 := true;
      print "(section 39 ", arg_119, "\n", ")\n";
      lift_122 := lift_123;
      lift_125 := lift_127;
    }
    print "(rets-for lift_115_0 arg_120 ", arg_120, ")\n";
  ...
  ensures (true)
{
  ...
  arg_121 := -961844296;
  {
    ...
    print "(meth-for lift_115_1)\n";
    {
      ...
      var lift_123 := lift_124;
      var lift_122 := true;
      print "(section 38 ", arg_119, "\n", ")\n";
      lift_122 := lift_123;
      lift_125 := lift_127;
    }
    print "(rets-for lift_115_1 arg_120 ", arg_120, ")\n";
  ...
  ensures (true)
{
  arg_67 := 1388764910;
  {
    print "(meth-for lift_64_0)\n";
    {
      ...
      lift_68 := lift_68;
      print "(section 37 ", -2075679026, "\n", ")\n";
      lift_72 := lift_91;
    }
    print "(rets-for lift_64_0 arg_67 ", arg_67, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_67 := 1388764910;
  {
    print "(meth-for lift_64_1)\n";
    {
      ...
      var lift_68 := multiset{lift_69, lift_69, lift_70, lift_71, lift_70};
      lift_68 := lift_68;
      print "(section 36 ", -2075679026, "\n", ")\n";
      lift_72 := lift_91;
    }
    print "(rets-for lift_64_1 arg_67 ", arg_67, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_51 := -1152746195;
  {
    ...
    print "(meth-for lift_44_0)\n";
    {
      ...
      var lift_52 := false;
      print "(section 34 ", arg_50, "\n", ")\n";
      lift_52 := lift_52;
      print "(section 35 ", lift_53, "\n", ")\n";
      lift_54 := (lift_58, (lift_58, arg_50));
    }
    print "(rets-for lift_44_0 arg_50 ", arg_50, ")\n";
    print "(rets-for lift_44_0 arg_51 ", arg_51, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_9 := 68681727;
  {
    ...
    print "(meth-for lift_1_0)\n";
    {
      ...
      print "(section 32 ", arg_7, "\n", ")\n";
      print "(section 33 ", -2081484093, "\n", ")\n";
      lift_10 := lift_10;
      lift_19 := lift_24;
      lift_26 := lift_26;
    }
...
method Main () {
  ...
  );
  {
    ...
    {
      lift_59 := lift_62;
      print "(section 0 ", -1554215639, "\n", ")\n";
      lift_63 := '$';
      print "(section 1 ", methoddefvar_47, "\n", ")\n";
    }
    ...
    if ((lift_109 !! lift_113 !! lift_113)) {
      ...
      if (lift_103) {
        ...
        print "(section 6 ", 1310588076, "\n", ")\n";
        print "(section 7 ", 106960645, "\n", ")\n";
        print "(section 8 ", methoddefvar_4, "\n", ")\n";
      } else {
        print "(section 9 ", -1382612258, "\n", ")\n";
      }
      if (lift_151) {
        ...
        lift_165 := lift_165;
        lift_166 := lift_106;
        print "(section 12 ", methoddefvar_3, "\n", ")\n";
        lift_167 := lift_144;
      }
    ...
    {
      print "(section 14 ", methoddefvar_4, "\n", ")\n";
      lift_198 := lift_198;
    }
  ...
  if (lift_151) {
    ...
    );
    {
      ...
      if (lift_61) {
        ...
        print "(section 19 ", 990901143, "\n", ")\n";
        print "(section 20 ", lift_111, "\n", ")\n";
        lift_242 := lift_245;
        print "(section 21 ", lift_217, "\n", ")\n";
      }
      print "(section 22 ", methoddefvar_223, "\n", ")\n";
    ...
    }
    {
      ...
      {
        print "(section 23 ", lift_114, "\n", ")\n";
        lift_281 := lift_111;
      }
      {
        var lift_302 := true;
        print "(section 24 ", -385289488, "\n", ")\n";
        ...
        if (true) {
          print "(section 25 ", lift_281, "\n", ")\n";
        } else {
          print "(section 26 ", lift_110, "\n", ")\n";
          print "(section 27 ", lift_281, "\n", ")\n";
          lift_303 := lift_133;
        }
      }
    }
    var methoddefvar_306 := lift_304_0(lift_215.0);
    {
      ...
      {
        print "(section 28 ", methoddefvar_306, "\n", ")\n";
        print "(section 29 ", methoddefvar_322, "\n", ")\n";
      }
      ...
      if (lift_156) {
        ...
        print "(section 30 ", lift_114, "\n", ")\n";
        lift_327 := lift_112;
      } else {
        lift_328 := lift_218;
      }
      print "(section 31 ", -2044004612, "\n", ")\n";
    }
  } else {
