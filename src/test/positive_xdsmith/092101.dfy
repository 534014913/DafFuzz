...
method lift_159_0 (arg_162 : int, arg_163 : int, arg_164 : int)
  returns (arg_165 : int)
  requires (((arg_164 == 788503034) && ((arg_163 == -656422782) && ((arg_162 == -1930011681) && true))))
  ensures (((arg_165 == 1476804754) && true))
{
  arg_165 := 1476804754;
  {
    var lift_178 := true;
    ...
    lift_177 := false;
    lift_178 := lift_177;
    assert (((-2 - arg_165) == (-1 - arg_165)) || ((-1 - arg_165) == (-1 - 1476804754)));
  }
}
...
method lift_137_0 ()
  returns (arg_140 : int)
  requires (true)
  ensures (((arg_140 == -439242669) && true))
{
  arg_140 := -439242669;
  {
    assert (((988265926 + 988265926) + (-988265927 - 988265926)) < ((988265926 - 1976531852) + 988265926));
  }
}

method lift_117_0 (arg_121 : int)
  returns (arg_122 : int, arg_123 : int)
  requires (((arg_121 == -743014009) && true))
  ensures (((arg_123 == 1361504880) && ((arg_122 == 788503034) && true)))
{
  arg_122 := 788503034;
  arg_123 := 1361504880;
  {
    ...
    lift_124 := 371120015;
    assert (((-788503034 + 788503035) - (-788503030 + 788503033)) == ((788503027 + -788503028) + (788503033 - arg_122)));
    lift_125 := lift_127;
...
method Main () {
  ...
  assert ((((lift_1[("hmJ", lift_2).1] as int) - 2) + (-1 - (lift_1[(
    "hmJ",
    lift_2
  ).1] as int))) == ((-3 - 1) + (lift_1[("hmJ", lift_2).1] as int)));
  lift_4 := safeSeqTake(
    safeSeqRef(
  ...
  );
  {
    ...
    {
      lift_141 := lift_80;
      assert (((-5790035043 - lift_43) == (-1930011681 - 1930011681)) && ((lift_43 == lift_43) || (lift_43 == lift_43)));
      assert (((-788503034 + 788503035) - (-788503030 + 788503033)) == ((788503027 + -788503028) + (788503033 - methoddefvar_119)));
      lift_142 := lift_142;
      lift_145 := lift_146;
    }
    {
      ...
      {
        assert (((lift_31 < 1) && (lift_31 == lift_31)) || ((lift_31 == lift_31) && (lift_31 == -521158117)));
      }
    }
    if (safeSeqRef(lift_179, lift_155, lift_57)) {
      ...
      var lift_212 := false;
      var lift_203 := ();
      assert (0 == (-1930011681 - lift_42));
      if (lift_56) {
        lift_203 := lift_29;
        assert (((2109667276 + 2109667276) - (-1 + 2109667276)) == (2109667276 + (2109667277 - 2109667276)));
      ...
      {
        assert (((580091549 - lift_155) == (580091550 - lift_155)) || ((lift_155 == 580091552) || (lift_155 < 580091553)));
        assert (lift_88 == ((-1 - lift_88) + (lift_88 + 1436130161)));
      }
    }
  }
}
