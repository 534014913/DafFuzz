  ...
  ensures (true)
{
  arg_336 := -623699296;
  {
    ...
    print "(meth-for lift_332_0)\n";
    {
      ...
      lift_337 := arg_335;
      print "(section 47 ", lift_337, "\n", ")\n";
      lift_338 := lift_339;
      print "(section 48 ", arg_336, "\n", ")\n";
      print "(section 49 ", arg_335, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_300 := -375884855;
  {
    ...
    print "(meth-for lift_293_0)\n";
    {
      ...
      print "(section 45 ", -550191087, "\n", ")\n";
      lift_301 := lift_301;
      print "(section 46 ", arg_297, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_249 := -2015346207;
  {
    ...
    print "(meth-for lift_243_0)\n";
    {
      ...
      print "(section 44 ", lift_250, "\n", ")\n";
    }
    print "(rets-for lift_243_0 arg_248 ", arg_248, ")\n";
  ...
  ensures (true)
{
  arg_213 := -485587538;
  {
    ...
    print "(meth-for lift_208_0)\n";
    {
      ...
      var lift_215 := '&';
      var lift_214 := 'm';
      print "(section 42 ", arg_212, "\n", ")\n";
      print "(section 43 ", arg_212, "\n", ")\n";
      lift_214 := lift_215;
      lift_216 := lift_222;
    }
  ...
  ensures (true)
{
  arg_142 := 647619724;
  {
    ...
    print "(rets-for lift_139_1 arg_142 ", arg_142, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_96 := -245767653;
  {
    ...
    print "(meth-for lift_89_0)\n";
    {
      ...
      var lift_98 := 'Q';
      var lift_97 := lift_98;
      print "(section 40 ", arg_95, "\n", ")\n";
      lift_97 := lift_99;
      print "(section 41 ", -430502906, "\n", ")\n";
    }
    print "(rets-for lift_89_0 arg_95 ", arg_95, ")\n";
    print "(rets-for lift_89_0 arg_96 ", arg_96, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_96 := -245767653;
  {
    ...
    print "(meth-for lift_89_1)\n";
    {
      ...
      var lift_98 := 'Q';
      var lift_97 := lift_98;
      print "(section 38 ", arg_95, "\n", ")\n";
      lift_97 := lift_99;
      print "(section 39 ", -430502906, "\n", ")\n";
    }
    print "(rets-for lift_89_1 arg_95 ", arg_95, ")\n";
    print "(rets-for lift_89_1 arg_96 ", arg_96, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_62 := 1363024406;
  {
    ...
    print "(meth-for lift_56_0)\n";
    {
      ...
      lift_63 := lift_64;
      print "(section 36 ", arg_62, "\n", ")\n";
      print "(section 37 ", arg_59, "\n", ")\n";
      lift_65 := lift_66;
    }
  ...
  ensures (true)
{
  ...
  arg_41 := -2116560807;
  {
    print "(meth-for lift_36_0)\n";
    {
      ...
      var lift_42 := lift_43;
      print "(section 33 ", arg_41, "\n", ")\n";
      lift_42 := lift_43;
      lift_46 := (lift_52, lift_49);
      print "(section 34 ", lift_55, "\n", ")\n";
    }
...
method Main () {
  ...
  if ((|safeSeqSet([1922677266], lift_1, lift_1)| == ((multiset{
    ...
    print 
      "(section 0 ",
      |safeSeqSlice3(lift_28, lift_3, lift_19, lift_19)|,
      "\n",
      ")\n";
    var methoddefvar_38, methoddefvar_39 := lift_36_0();
    {
      ...
      if (lift_32) {
        ...
        lift_83 := lift_83;
        lift_84 := lift_84;
        print "(section 4 ", methoddefvar_38, "\n", ")\n";
        print "(section 5 ", methoddefvar_38, "\n", ")\n";
    ...
    if ((((arg_103 : (bool, bool)) => lift_11)(
      ...
      if ((lift_166 !! lift_167 !! lift_177)) {
        ...
        {
          print "(section 24 ", lift_123, "\n", ")\n";
          lift_251 := lift_252;
          print "(section 25 ", lift_130, "\n", ")\n";
        }
        lift_253 := lift_206;
        {
          var lift_259 := {false};
