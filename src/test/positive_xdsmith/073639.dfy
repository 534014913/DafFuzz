...
method lift_142_0 ()
  ...
  requires (true)
  ensures (((arg_147 == -956918409) && ((arg_146 == 1391417512) && true)))
{
  arg_146 := 1391417512;
  arg_147 := -956918409;
  {
...
method lift_98_0 (arg_101 : int, arg_102 : int)
  returns (arg_103 : int)
  requires (((arg_102 == 841483727) && ((arg_101 == -928090065) && true)))
  ensures (((arg_103 == -446892137) && true))
{
  arg_103 := -446892137;
  {
    var lift_116 := ();
    ...
    lift_104 := lift_104;
    lift_106 := lift_107;
    assert ((751598389 + (751598389 + -1503196781)) == ((751598389 - 751598389) - (751598392 - 751598389)));
    lift_109 := lift_115;
    lift_116 := lift_116;
  }
}
...
method lift_1_0 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == -1514502209) && ((arg_5 == 0) && ((arg_4 == 1223830594) && true))))
  ensures (((arg_7 == 100691963) && true))
{
  arg_7 := 100691963;
  {
    var lift_8 := 823688400;
    assert ((-1 == lift_8) || ((-823688401 - lift_8) == (-823688400 - 823688401)));
    assert (((-359990775 < -359990775) && (-1079972327 == -359990775)) || ((-1079972327 - -359990775) == (-1079972327 - -359990775)));
  }
}
  ...
  );
  {
    ...
    if ((lift_33 ==> lift_33 ==> true)) {
      ...
      if (lift_36) {
        ...
        lift_74 := lift_77;
        assert (((-815178158 + 815178153) - (-815178156 + 815178153)) == ((815178152 - 815178153) + (815178152 - 815178153)));
        lift_80 := lift_81;
        lift_97 := lift_29;
      }
      ...
      if (lift_51) {
        ...
        assert ((lift_131 < lift_131) || ((lift_131 == 1611867767) || (lift_131 < 1611867767)));
      ...
      var methoddefvar_144, methoddefvar_145 := lift_142_0();
      {
        ...
        lift_156 := lift_127;
        assert (((-219964589 == -219964589) || (-219964589 == -219964589)) && ((-219964589 + -219964589) < (-659893761 - -219964589)));
      }
    } else {
