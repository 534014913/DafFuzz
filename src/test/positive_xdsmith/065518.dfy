...
method lift_285_0 (arg_289 : int, arg_290 : int)
  ...
  requires (((arg_290 == -1328871987) && ((arg_289 == -1649040191) && true)))
  ensures (((arg_292 == -612695896) && ((arg_291 == 1818304566) && true)))
{
  arg_291 := 1818304566;
  arg_292 := -612695896;
  {
    ...
    lift_293 := lift_299;
    lift_307 := lift_308;
    assert (((arg_291 - 1818304569) - (arg_291 + arg_291)) == ((-1 - 2) - (arg_291 + arg_291)));
    lift_309 := lift_309;
    assert ((arg_292 + (arg_292 - arg_292)) < ((-612695895 - arg_292) + 1));
  }
}

method lift_271_0 (arg_275 : int, arg_276 : int, arg_277 : int)
  returns (arg_278 : int, arg_279 : int)
  requires (((arg_277 == -1674036734) && ((arg_276 == -249630109) && ((arg_275 == 1391504996) && true))))
  ensures (((arg_279 == -1383749725) && ((arg_278 == 667116029) && true)))
{
  arg_278 := 667116029;
  arg_279 := -1383749725;
  {
    assert (((0 - 1) + (-1383749726 - arg_279)) == ((arg_279 - 3) - (arg_279 - 1)));
  }
}

method lift_208_0 (arg_211 : int)
  returns (arg_212 : int)
  requires (((arg_211 == -735937054) && true))
  ensures (((arg_212 == -1154663182) && true))
{
  arg_212 := -1154663182;
  {
    ...
    lift_213 := lift_226;
    assert (0 == (-735937054 - arg_211));
    assert (0 < ((0 - arg_212) + (0 - arg_212)));
    assert ((-1817754752 + (-3635509505 - -1817754752)) == ((-5453264256 - -1817754752) + (-1817754753 - -1817754752)));
    lift_232 := lift_233;
  }
}
...
method lift_166_0 ()
  ...
  requires (true)
  ensures (((arg_171 == -1758468543) && ((arg_170 == 208787483) && true)))
{
  arg_170 := 208787483;
  arg_171 := -1758468543;
  {
    ...
    var lift_172 := true;
    lift_172 := lift_173;
    assert (((-1580309197 + -1580309197) + (-1580309196 - -1580309197)) < ((-1580309197 - 4740927589) - (-1580309197 + -1580309197)));
    assert (((-208787485 - arg_170) + 417574966) == ((-208787484 - -208787483) + (-208787485 - -208787484)));
  }
}
...
method lift_146_0 ()
  returns (arg_149 : int)
  requires (true)
  ensures (((arg_149 == 1384935994) && true))
{
  arg_149 := 1384935994;
  {
    var lift_150 := 698976209;
    assert (lift_150 == 698976209);
    assert (((-954483734 + -954483734) + (954483735 - -954483733)) == ((954483735 - 954483737) + (954483736 + -954483734)));
    assert (((lift_150 + lift_150) + (-698976210 - lift_150)) < ((lift_150 - 1397952418) + lift_150));
  }
}
  ...
  ensures (((arg_149 == 1384935994) && true))
{
  ...
  {
    var lift_150 := 698976209;
    assert (lift_150 == (-1 - (lift_150 + -1397952419)));
    assert (((-954483734 + -954483734) + (954483735 - -954483733)) == ((954483735 - 954483737) + (954483736 + -954483734)));
    assert (((lift_150 - 2096928629) - (-1 + 0)) == ((0 - 698976209) + (-1 - lift_150)));
  }
}

method lift_138_0 (arg_141 : int, arg_142 : int, arg_143 : int)
  returns (arg_144 : int)
  requires (((arg_143 == -921420820) && ((arg_142 == 3) && ((arg_141 == 95) && true))))
  ensures (((arg_144 == -662560660) && true))
{
  arg_144 := -662560660;
  {
    assert (((0 - 95) + (-1 - arg_141)) == ((arg_141 - 381) + arg_141));
    assert ((arg_143 + (-921420821 - arg_143)) == ((-1842841640 - arg_143) + (-921420821 - arg_143)));
    assert (((arg_142 < arg_142) && (-1 == arg_142)) || ((-4 - 0) == (-1 - arg_142)));
  }
}
...
method Main () {
  ...
  if (lift_1.2.2.0) {
    ...
    );
    {
      ...
      assert (((lift_66 + -509209233) - (-509209236 + lift_66)) == ((lift_66 - 509209231) + 2));
    }
    assert ((-1 == (safeSeqRef(
      safeSeqTake(lift_51, lift_6),
      lift_53,
      |lift_85|
    ) - 4)) && ((-4 - safeSeqRef(
      safeSeqTake(lift_51, lift_6),
    ...
    if (((lift_154 * lift_154 * lift_155) in lift_156.0)) {
      ...
      var methoddefvar_168, methoddefvar_169 := lift_166_0();
      {
        ...
        assert (((lift_69 < lift_69) || (-19986085 < lift_69)) || ((lift_69 - 19986086) == (-59958256 - lift_69)));
        assert (((lift_66 + -509209233) - (-509209236 + lift_66)) == ((lift_66 - 509209231) + 2));
        lift_176 := lift_176;
        lift_178 := lift_151;
      }
  ...
  var methoddefvar_210 := lift_208_0(safeSeqRef(lift_237, lift_6, lift_241).2);
  {
    ...
    var lift_252 := (var tmpData : multiset<seq<(int, char, bool)>> := multiset{}; tmpData);
    {
      ...
      assert (((1637735861 == 1637735861) || (1637735861 < 1637735861)) && ((1637735858 - 1637735861) == (-1637735864 + 1637735861)));
      if (lift_12) {
        ...
        assert ((lift_6 + (-921420821 - lift_6)) == ((-1842841640 - lift_6) + (-921420821 - lift_6)));
        lift_247 := lift_248;
        assert (((1 - methoddefvar_210) + (-2309326366 - methoddefvar_210)) == ((methoddefvar_210 - 2) - (methoddefvar_210 - 1)));
      }
      if (false) {
        lift_252 := lift_253;
        lift_268 := lift_243;
      ...
      );
      {
        ...
        assert (((-1469759250 + 1469759248) - -1) < lift_259);
        assert (((-2 - methoddefvar_273) < (-1 - methoddefvar_273)) && ((-1 - methoddefvar_273) == (-1 - 667116029)));
        lift_280 := lift_284;
      }
    }
    ...
    );
    {
      ...
      assert (((-4181491214 - lift_268) < (-4181491213 - -1393830404)) || (lift_268 == (-4181491214 - lift_268)));
      lift_314 := lift_314;
      assert (((-794736634 - lift_341) < (-794736633 - lift_341)) && ((-794736634 - -794736632) < (-794736633 - lift_341)));
    }
    assert (((-2 - |lift_52|) - (0 - |lift_52|)) == ((0 - |lift_52|) + (0 - |lift_52|)));
    {
      var lift_354 := lift_9;
      var lift_348 := lift_349;
      {
        lift_342 := lift_342;
        assert (((lift_48 < lift_48) || (lift_48 < lift_48)) || ((lift_48 + 751794974) == 3));
      }
      lift_348 := lift_349;
      var methoddefvar_353 := lift_146_1();
      {
        lift_354 := lift_205;
        lift_355 := lift_355;
        assert ((lift_5 + (-921420821 - lift_5)) == ((-1842841640 - lift_5) + (-921420821 - lift_5)));
      }
      assert (0 == (-735937054 - lift_243));
    }
  }
}
