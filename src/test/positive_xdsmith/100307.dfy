...
method lift_370_0 (arg_373 : int)
  returns (arg_374 : int)
  requires (((arg_373 == -1158437820) && true))
  ensures (((arg_374 == 1488615672) && true))
{
  arg_374 := 1488615672;
  {
    var lift_375 := -2008215724;
    assert (((lift_375 == lift_375) && (lift_375 < lift_375)) || ((lift_375 < -2008215722) && (lift_375 == lift_375)));
  }
}
...
method lift_321_0 (arg_324 : int)
  returns (arg_325 : int)
  requires (((arg_324 == 582335595) && true))
  ensures (((arg_325 == -306735729) && true))
{
  arg_325 := -306735729;
  {
    ...
    assert ((arg_325 + (-613471459 - -306735729)) == ((-920207187 - arg_325) + (-306735730 - arg_325)));
    lift_326 := lift_328;
    lift_330 := lift_330;
    lift_343 := arg_325;
    lift_344 := arg_324;
...
method lift_159_0 ()
  ...
  requires (true)
  ensures (((arg_164 == 1622842945) && ((arg_163 == -1640498493) && true)))
{
  arg_163 := -1640498493;
  arg_164 := 1622842945;
  {
    ...
    lift_165 := lift_173;
    assert (((-1640498494 - arg_163) == (-1640498494 - arg_163)) && ((-1640498494 - arg_163) == (-1640498494 - -1640498493)));
    lift_180 := lift_180;
    assert (((-1640498494 - arg_163) == (-1640498494 - arg_163)) && ((-1640498494 - arg_163) == (-1640498494 - -1640498493)));
    lift_189 := lift_189;
  }
...
method lift_116_1 (arg_120 : int, arg_121 : int)
  returns (arg_122 : int, arg_123 : int)
  requires (((arg_121 == -1193081487) && ((arg_120 == -1875769068) && true)))
  ensures (((arg_123 == -2029784966) && ((arg_122 == 568937191) && true)))
{
  arg_122 := 568937191;
  arg_123 := -2029784966;
  {
    var lift_124 := 2040161205;
    assert (((2040161204 - 2040161208) == -4) && ((lift_124 == lift_124) && (lift_124 == 2040161205)));
  }
}

method lift_116_2 (arg_120 : int, arg_121 : int)
  returns (arg_122 : int, arg_123 : int)
  requires (((arg_121 == -752207130) && ((arg_120 == -1875769068) && true)))
  ensures (((arg_123 == -2029784966) && ((arg_122 == 568937191) && true)))
{
  arg_122 := 568937191;
  arg_123 := -2029784966;
...
method lift_116_3 (arg_120 : int, arg_121 : int)
  returns (arg_122 : int, arg_123 : int)
  requires (((arg_121 == -1818639073) && ((arg_120 == -1441203949) && true)))
  ensures (((arg_123 == -2029784966) && ((arg_122 == 568937191) && true)))
{
  arg_122 := 568937191;
  arg_123 := -2029784966;
  {
    var lift_124 := 2040161205;
    assert (((lift_124 < lift_124) && (lift_124 == lift_124)) || ((lift_124 < lift_124) || (1 < lift_124)));
  }
}

method lift_116_4 (arg_120 : int, arg_121 : int)
  returns (arg_122 : int, arg_123 : int)
  requires (((arg_121 == -631322741) && ((arg_120 == 1091603033) && true)))
  ensures (((arg_123 == -2029784966) && ((arg_122 == 568937191) && true)))
{
  arg_122 := 568937191;
  arg_123 := -2029784966;
...
method lift_97_0 (arg_100 : int, arg_101 : int)
  returns (arg_102 : int)
  requires (((arg_101 == -1875769068) && ((arg_100 == 1091603033) && true)))
  ensures (((arg_102 == -1755991006) && true))
{
  arg_102 := -1755991006;
  {
...
method lift_1_0 (arg_5 : int)
  ...
  requires (((arg_5 == -1158437820) && true))
  ensures (((arg_7 == 513625609) && ((arg_6 == -314383192) && true)))
{
  arg_6 := -314383192;
  arg_7 := 513625609;
  {
    ...
    var lift_8 := arg_6;
    assert (((arg_7 < arg_7) && (513625610 == 513625611)) || ((-513625610 - 0) == (-1 - arg_7)));
    lift_8 := lift_9;
    assert (((arg_7 - 1) + (-1 - arg_7)) == ((-2 - 513625609) + arg_7));
    assert (((237913645 - lift_9) - (lift_9 - -237913643)) == (475827289 + (-237913644 - lift_9)));
    assert (((arg_6 - 1) + 314383193) == ((0 - 1) + (-314383191 - arg_6)));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    if (!(lift_21)) {
      {
        assert (-596569993 == ((-596569993 - 596569994) - (-596569993 - 1)));
      }
      lift_22 := lift_23;
    } else {
    ...
    assert (((|lift_80| - 5) - (|lift_80| - |lift_80|)) == -1);
    if ((lift_44 == lift_108 >= lift_27)) {
      ...
      if (lift_46) {
        ...
        lift_140 := lift_140;
        lift_141 := lift_145;
        assert (((lift_66 + -1891968668) + (-1 - lift_66)) < ((lift_66 - 3783937336) - (0 - 1891968667)));
        assert (((534029734 < lift_72) && (lift_72 == lift_72)) || (1 == (534029739 - lift_72)));
        lift_146 := lift_147;
      } else {
        assert false;
        assert false;
      ...
      {
        assert (((-1454104353 + lift_155) - (-1454104351 + lift_155)) == ((1454104347 - lift_155) + (1454104347 - lift_155)));
        lift_158 := 'q';
        assert (((-1454104353 + lift_155) - (-1454104351 + lift_155)) == ((1454104347 - lift_155) + (1454104347 - lift_155)));
      }
      var methoddefvar_161, methoddefvar_162 := lift_159_0();
      {
        assert (((-628766385 - methoddefvar_3) < methoddefvar_3) || ((-628766387 - methoddefvar_3) == (-628766388 - methoddefvar_3)));
        assert (((methoddefvar_3 - 1) + 314383193) == ((0 - 1) + (-314383191 - methoddefvar_3)));
      }
    }
    var methoddefvar_198, methoddefvar_199 := lift_116_2(lift_19, lift_17);
    {
      var lift_206 := (lift_107, false, lift_85);
      assert (2 == ((-1441203948 + 1) - lift_153));
      lift_200 := lift_205;
      assert (2 == ((-1441203948 + 1) - lift_153));
      assert ((lift_204 - (-582335596 + lift_204)) == ((873503393 - lift_204) + (873503393 - lift_204)));
      lift_206 := lift_206;
    }
  }
  if ((((lift_24[lift_42 := lengthNormalize(lift_18)]) == multiset(
    ...
    if (((lift_46 ==> lift_111 ==> lift_57) !in lift_229(
      ...
      assert (((lift_221 == lift_221) || (lift_221 < lift_221)) && ((lift_221 + lift_221) < (-5040028883 - lift_221)));
      assert (((('m', lift_254).1 + ('m', lift_254).1) + (-1564351738 - (
        'm',
        lift_254
      ).1)) < ((('m', lift_254).1 - 3128703474) + ('m', lift_254).1));
      var methoddefvar_323 := lift_321_0(lift_204);
      {
        assert ((methoddefvar_323 + (-613471459 - -306735729)) == ((-920207187 - methoddefvar_323) + (-306735730 - methoddefvar_323)));
      }
    } else {
    ...
    var methoddefvar_372 := lift_370_0(lift_11(lift_137, lift_147));
    {
      var lift_376 := '|';
      {
        assert (((-2204479033 - lift_201) + (-1102239518 - lift_201)) == lift_201);
        assert (((534029734 < lift_72) && (lift_72 == lift_72)) || (1 == (534029739 - lift_72)));
        lift_376 := lift_303;
        lift_377 := lift_262;
      }
      assert (2 == ((-1441203948 + 1) - lift_152));
      var methoddefvar_378, methoddefvar_379 := lift_116_4(lift_90, -631322741);
      {
        var lift_382 := (lift_86, lift_202, lift_64);
        lift_380 := lift_382;
        assert (((-2 - 1180668081) == (lift_138 + lift_138)) || ((lift_138 < lift_138) || (-2 < lift_138)));
        assert ((lift_73 - (534029738 - lift_73)) == lift_73);
      }
    }
  ...
  assert (2 == ((304888274 - safeSeqRef(lift_416, lift_201, lift_425)(
    (lift_23 <= lift_431)
  )(lift_148)) - (safeSeqRef(lift_416, lift_201, lift_425)(
    (lift_23 <= lift_431)
  )(lift_148) - 304888276)));
}
