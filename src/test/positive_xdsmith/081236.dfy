  ...
  ensures (true)
{
  arg_360 := -1635354660;
  {
    ...
    print "(meth-for lift_356_0)\n";
    {
      ...
      var lift_361 := ();
      lift_361 := lift_361;
      print "(section 56 ", arg_359, "\n", ")\n";
      lift_362 := lift_363;
      lift_373 := lift_373;
      print "(section 57 ", arg_359, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_262 := 1808547844;
  {
    print "(params-for lift_258_1 arg_261 ", arg_261, ")\n";
    print "(meth-for lift_258_1)\n";
    {
      ...
      var lift_263 := (lift_264, lift_268, lift_269);
      lift_263 := lift_271;
      print "(section 54 ", 1144038013, "\n", ")\n";
      lift_276 := lift_280;
      lift_283 := lift_283;
    }
    print "(rets-for lift_258_1 arg_262 ", arg_262, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_117 := -876010657;
  {
    ...
    print "(meth-for lift_109_0)\n";
    {
      ...
      print "(section 51 ", arg_116, "\n", ")\n";
      print "(section 52 ", arg_113, "\n", ")\n";
      print "(section 53 ", arg_113, "\n", ")\n";
      lift_118 := lift_118;
    }
  ...
  ensures (true)
{
  ...
  arg_117 := -876010657;
  {
    ...
    print "(meth-for lift_109_1)\n";
    {
      ...
      print "(section 48 ", arg_116, "\n", ")\n";
      print "(section 49 ", arg_113, "\n", ")\n";
      print "(section 50 ", arg_113, "\n", ")\n";
      lift_118 := lift_118;
    }
  ...
  ensures (true)
{
  arg_14 := 156881558;
  {
    print "(meth-for lift_11_0)\n";
    {
      ...
      print "(section 45 ", arg_14, "\n", ")\n";
      print "(section 46 ", arg_14, "\n", ")\n";
      lift_15 := lift_22;
      print "(section 47 ", arg_14, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_14 := 156881558;
  {
    print "(meth-for lift_11_1)\n";
    {
      ...
      var lift_16 := (lift_17, lift_17);
      var lift_15 := (lift_16, lift_20);
      print "(section 42 ", arg_14, "\n", ")\n";
      print "(section 43 ", arg_14, "\n", ")\n";
      lift_15 := lift_22;
      print "(section 44 ", arg_14, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_14 := 156881558;
  {
    print "(meth-for lift_11_3)\n";
    {
      ...
      var lift_16 := (lift_17, lift_17);
      var lift_15 := (lift_16, lift_20);
      print "(section 36 ", arg_14, "\n", ")\n";
      print "(section 37 ", arg_14, "\n", ")\n";
      lift_15 := lift_22;
      print "(section 38 ", arg_14, "\n", ")\n";
    }
    print "(rets-for lift_11_3 arg_14 ", arg_14, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_14 := 156881558;
  {
    print "(meth-for lift_11_4)\n";
    {
      ...
      var lift_16 := (lift_17, lift_17);
      var lift_15 := (lift_16, lift_20);
      print "(section 33 ", arg_14, "\n", ")\n";
      print "(section 34 ", arg_14, "\n", ")\n";
      lift_15 := lift_22;
      print "(section 35 ", arg_14, "\n", ")\n";
    }
    print "(rets-for lift_11_4 arg_14 ", arg_14, ")\n";
  }
}
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0();
  {
    ...
    print "(section 2 ", lift_41.1, "\n", ")\n";
    var methoddefvar_48, methoddefvar_49 := lift_1_1();
    {
      print "(section 3 ", methoddefvar_48, "\n", ")\n";
    }
  }
  print "(section 4 ", lift_50.0(lift_61.0, lift_62)(), "\n", ")\n";
  {
    ...
    var lift_66 := lift_45;
    {
      ...
      if ((lift_66 && lift_69)) {
        ...
        );
        {
          ...
          lift_129 := lift_133;
          lift_163 := lift_164;
          print "(section 10 ", methoddefvar_111, "\n", ")\n";
          lift_165 := lift_58;
        }
        if (lift_103) {
          ...
          lift_169 := lift_172;
          print "(section 12 ", lift_29, "\n", ")\n";
        }
        print "(section 13 ", lift_29, "\n", ")\n";
        lift_173 := lift_176;
      }
    }
    print "(section 14 ", (lift_42.2 as int), "\n", ")\n";
  }
  if (lift_157.0) {
    ...
    var methoddefvar_256, methoddefvar_257 := lift_1_3();
    {
      ...
      if (lift_45) {
        ...
        print "(section 16 ", methoddefvar_256, "\n", ")\n";
        lift_296 := lift_203;
        print "(section 17 ", lift_254, "\n", ")\n";
      } else {
        print "(section 18 ", lift_254, "\n", ")\n";
        print "(section 19 ", lift_60, "\n", ")\n";
        lift_297 := lift_294;
        lift_298 := lift_298;
    ...
    var lift_309 := (lift_103, lift_310);
    {
      ...
      {
        lift_374 := lift_374;
        print "(section 27 ", lift_179, "\n", ")\n";
        print "(section 28 ", 941465540, "\n", ")\n";
      }
