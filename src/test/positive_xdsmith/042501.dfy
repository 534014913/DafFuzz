...
method lift_547_0 (arg_550 : int, arg_551 : int)
  returns (arg_552 : int)
  requires (((arg_551 == -1803654881) && ((arg_550 == -1803654881) && true)))
  ensures (((arg_552 == 1365752114) && true))
{
  arg_552 := 1365752114;
  {
    var lift_575 := false;
    ...
    assert (((-144229396 < -144229396) && (-144229396 == -144229396)) || ((-144229396 == -144229396) || (-432688190 == -144229396)));
    lift_553 := (
      lift_560,
      false,
      multiset{
    ...
    assert (((2731504229 - arg_552) + (1365752115 + -1365752116)) == arg_552);
    lift_574 := lift_556;
    lift_575 := lift_556;
  }
}
...
method lift_528_0 (arg_532 : int)
  ...
  requires (((arg_532 == 1946635137) && true))
  ensures (((arg_534 == 1676718604) && ((arg_533 == 1924334914) && true)))
{
  arg_533 := 1924334914;
  arg_534 := 1676718604;
  {
    ...
    lift_535 := '!';
    lift_536 := lift_536;
    assert (((lift_544 + lift_544) == (-2 - lift_544)) || ((lift_544 < lift_544) || (1924334914 == lift_544)));
  }
}
...
method lift_464_1 (arg_468 : int, arg_469 : int)
  returns (arg_470 : int, arg_471 : int)
  requires (((arg_469 == -1803654881) && ((arg_468 == 1761223372) && true)))
  ensures (((arg_471 == 1318239587) && ((arg_470 == -2116604126) && true)))
{
  arg_470 := -2116604126;
  arg_471 := 1318239587;
  {
  ...
  ensures (false)
{
  arg_220 := 1870738081;
  {
    ...
    var lift_228 := (lift_229, (var tmpData : string := []; tmpData), lift_233);
    ...
    var lift_221 := multiset{lift_222, lift_222, lift_223, lift_224, lift_222};
    lift_221 := lift_221;
    assert false;
    lift_226 := lift_227;
    assert false;
...
method lift_189_1 (arg_192 : int, arg_193 : int, arg_194 : int)
  returns (arg_195 : int)
  requires (((arg_194 == -248486700) && ((arg_193 == -2083915561) && ((arg_192 == -1541268731) && true))))
  ensures (((arg_195 == -599591393) && true))
{
  arg_195 := -599591393;
  {
    assert (((-496973401 < arg_194) && (arg_194 == arg_194)) || ((arg_194 < arg_194) && (arg_194 < arg_194)));
    assert ((arg_195 == (-1199182786 - arg_195)) || ((-1199182788 == arg_195) || (arg_195 < arg_195)));
    assert (((-496973401 < arg_194) && (arg_194 == arg_194)) || ((arg_194 < arg_194) && (arg_194 < arg_194)));
    assert (((-496973401 < arg_194) && (arg_194 == arg_194)) || ((arg_194 < arg_194) && (arg_194 < arg_194)));
  }
}
...
method lift_114_1 ()
  returns (arg_118 : int, arg_119 : int)
  requires (true)
  ensures (((arg_119 == -248486700) && ((arg_118 == 140878302) && true)))
{
  arg_118 := 140878302;
  arg_119 := -248486700;
  {
    ...
    var lift_120 := lift_121;
    lift_120 := arg_118;
    assert (((-140878307 + lift_120) - (-140878305 + lift_120)) == ((140878301 - lift_120) + (140878301 - lift_120)));
  }
}
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    assert (1049174133 == ((-524587068 - safeSeqRef(
    ...
    if (((lift_105 < 1257860088) !in lift_379.0)) {
      ...
      var lift_586 := 'o';
      var lift_527 := 'z';
      assert ((((lift_33[lift_44] as int) - 2) + (-1 - (lift_33[lift_44] as int))) == ((-3 - 1) + (lift_33[lift_44] as int)));
      if ((lift_241 == lift_416)) {
        ...
        {
          assert (((-2707807958 - lift_25) < (lift_25 - -2707807958)) || ((-1353903979 == lift_25) && (lift_25 < -1353903978)));
          lift_545 := lift_49;
        }
        lift_546 := lift_366;
      }
  ...
  var methoddefvar_609, methoddefvar_610 := lift_114_2();
  {
    ...
    {
      assert (((-2083915566 - lift_523) < (-2083915565 - lift_523)) && ((-2083915564 < lift_523) || (lift_523 < lift_523)));
      if (false) {
        var lift_611 := lift_612;
        assert false;
        lift_611 := lift_615;
      } else {
        assert (((lift_523 == lift_523) || (lift_523 < lift_523)) && ((lift_523 + lift_523) == (-6251746683 - lift_523)));
        lift_616 := lift_16;
        assert (((-1900036453 + lift_103) - (-1900036451 + lift_103)) == ((1900036447 - lift_103) + (1900036447 - lift_103)));
      }
    }
    lift_617 := lift_624.2;
    var methoddefvar_636, methoddefvar_637 := lift_464_1(lift_101, lift_416);
    {
      assert (((lift_261 < lift_261) && (-1573761203 == lift_261)) || ((-1573761203 - -524587067) == (-1573761203 - lift_261)));
    }
    var methoddefvar_638 := lift_189_1(lift_112, lift_523, methoddefvar_610);
    {
      lift_639 := lift_421;
      assert (((263881744 + lift_350) == (-263881744 + lift_350)) || ((-263881744 == lift_350) || (lift_350 < lift_350)));
    }
    if (([lift_6, lift_593] !in lift_641)) {
      if (false) {
        ...
        lift_645 := lift_646;
        assert ((lift_241 + (-854321155 - -427160577)) == ((-1281481731 - lift_241) + (-427160578 - lift_241)));
        assert (((lift_255 + -1839455395) + (-1 - lift_255)) < ((lift_255 - 3678910790) - (0 - 1839455394)));
      }
    } else {
      var lift_659 := false;
      {
  ...
  assert ((lift_617.0 - (-4 + lift_617.0)) == ((445421318 - lift_617.0) + 1));
}
