  ...
  ensures (true)
{
  arg_549 := 265533892;
  {
    print "(meth-for lift_546_0)\n";
    {
      ...
      lift_550 := lift_553;
      lift_554 := lift_557;
      print "(section 86 ", lift_559, "\n", ")\n";
      print "(section 87 ", -1201574013, "\n", ")\n";
    }
    print "(rets-for lift_546_0 arg_549 ", arg_549, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_503 := -1723833190;
  {
    ...
    print "(meth-for lift_499_0)\n";
    {
      ...
      lift_505 := lift_505;
      lift_518 := lift_517;
      print "(section 84 ", 1348076860, "\n", ")\n";
      print "(section 85 ", arg_503, "\n", ")\n";
    }
    print "(rets-for lift_499_0 arg_503 ", arg_503, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_466 := -2145969505;
  {
    ...
    print "(rets-for lift_460_0 arg_465 ", arg_465, ")\n";
  ...
  ensures (true)
{
  ...
  arg_466 := -2145969505;
  {
    print "(params-for lift_460_1 arg_464 ", arg_464, ")\n";
    print "(meth-for lift_460_1)\n";
    {
      var lift_470 := ();
      var lift_469 := lift_470;
      var lift_468 := 1820157361;
      var lift_467 := lift_468;
      print "(section 82 ", lift_467, "\n", ")\n";
      lift_469 := lift_470;
    }
    print "(rets-for lift_460_1 arg_465 ", arg_465, ")\n";
    print "(rets-for lift_460_1 arg_466 ", arg_466, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_381 := 544494348;
  {
    ...
    print "(params-for lift_374_1 arg_379 ", arg_379, ")\n";
    ...
    print "(rets-for lift_374_1 arg_380 ", arg_380, ")\n";
    print "(rets-for lift_374_1 arg_381 ", arg_381, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_381 := 544494348;
  {
    ...
    print "(params-for lift_374_2 arg_379 ", arg_379, ")\n";
    ...
    print "(rets-for lift_374_2 arg_380 ", arg_380, ")\n";
    print "(rets-for lift_374_2 arg_381 ", arg_381, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_243 := 286704004;
  {
    print "(params-for lift_235_2 arg_239 ", arg_239, ")\n";
    print "(params-for lift_235_2 arg_240 ", arg_240, ")\n";
    print "(params-for lift_235_2 arg_241 ", arg_241, ")\n";
    print "(meth-for lift_235_2)\n";
    {
      ...
      var lift_244 := multiset{lift_245, lift_245, lift_245, lift_249};
      lift_244 := lift_254;
      print "(section 79 ", 2039964912, "\n", ")\n";
      lift_261 := 516746548;
    }
    print "(rets-for lift_235_2 arg_242 ", arg_242, ")\n";
    print "(rets-for lift_235_2 arg_243 ", arg_243, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_180 := 595203098;
  {
    ...
    print "(meth-for lift_174_0)\n";
    {
      ...
      var lift_182 := true;
      var lift_181 := false;
      print "(section 76 ", -1983740509, "\n", ")\n";
      lift_181 := lift_182;
      print "(section 77 ", arg_178, "\n", ")\n";
      lift_183 := [lift_184, lift_186, lift_187, lift_186];
      print "(section 78 ", arg_178, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_180 := 595203098;
  {
    print "(params-for lift_174_1 arg_177 ", arg_177, ")\n";
    print "(params-for lift_174_1 arg_178 ", arg_178, ")\n";
    print "(params-for lift_174_1 arg_179 ", arg_179, ")\n";
    print "(meth-for lift_174_1)\n";
    {
      ...
      var lift_182 := true;
      var lift_181 := false;
      print "(section 73 ", -1983740509, "\n", ")\n";
      lift_181 := lift_182;
      print "(section 74 ", arg_178, "\n", ")\n";
      lift_183 := [lift_184, lift_186, lift_187, lift_186];
      print "(section 75 ", arg_178, "\n", ")\n";
    }
    print "(rets-for lift_174_1 arg_180 ", arg_180, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_180 := 595203098;
  {
    print "(params-for lift_174_2 arg_177 ", arg_177, ")\n";
    print "(params-for lift_174_2 arg_178 ", arg_178, ")\n";
    print "(params-for lift_174_2 arg_179 ", arg_179, ")\n";
    print "(meth-for lift_174_2)\n";
    {
      var lift_187 := ();
      var lift_186 := lift_187;
      var lift_185 := ();
      ...
      var lift_182 := true;
      var lift_181 := false;
      print "(section 70 ", -1983740509, "\n", ")\n";
      lift_181 := lift_182;
      print "(section 71 ", arg_178, "\n", ")\n";
      lift_183 := [lift_184, lift_186, lift_187, lift_186];
      print "(section 72 ", arg_178, "\n", ")\n";
    }
    print "(rets-for lift_174_2 arg_180 ", arg_180, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_168 := 521328132;
  {
    ...
    print "(meth-for lift_162_0)\n";
    {
      ...
      print "(section 68 ", arg_167, "\n", ")\n";
      lift_169 := lift_169;
      print "(section 69 ", arg_168, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_168 := 521328132;
  {
    print "(params-for lift_162_2 arg_166 ", arg_166, ")\n";
    print "(meth-for lift_162_2)\n";
    {
      var lift_170 := true;
      var lift_169 := lift_170;
      print "(section 64 ", arg_167, "\n", ")\n";
      lift_169 := lift_169;
      print "(section 65 ", arg_168, "\n", ")\n";
    }
    print "(rets-for lift_162_2 arg_167 ", arg_167, ")\n";
    print "(rets-for lift_162_2 arg_168 ", arg_168, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_168 := 521328132;
  {
    print "(params-for lift_162_3 arg_166 ", arg_166, ")\n";
    print "(meth-for lift_162_3)\n";
    {
      var lift_170 := true;
      var lift_169 := lift_170;
      print "(section 62 ", arg_167, "\n", ")\n";
      lift_169 := lift_169;
      print "(section 63 ", arg_168, "\n", ")\n";
    }
    print "(rets-for lift_162_3 arg_167 ", arg_167, ")\n";
    print "(rets-for lift_162_3 arg_168 ", arg_168, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_130 := 1590622326;
  {
    ...
    print "(rets-for lift_127_0 arg_130 ", arg_130, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_130 := 1590622326;
  {
    ...
    print "(rets-for lift_127_1 arg_130 ", arg_130, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_130 := 1590622326;
  {
    ...
    print "(rets-for lift_127_2 arg_130 ", arg_130, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_101 := 1838579586;
  {
    ...
    print "(meth-for lift_95_0)\n";
    {
      ...
      lift_102 := lift_109;
      print "(section 59 ", arg_98, "\n", ")\n";
      print "(section 60 ", arg_98, "\n", ")\n";
      print "(section 61 ", lift_113, "\n", ")\n";
      lift_114 := lift_114;
    }
  ...
  ensures (true)
{
  arg_78 := 1904688802;
  {
    ...
    print "(params-for lift_73_1 arg_77 ", arg_77, ")\n";
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    if (((lift_8 < lift_10 == lift_8) in (
      ...
      }
      {
        ...
        {
          print "(section 11 ", 262784672, "\n", ")\n";
          print "(section 12 ", -618357844, "\n", ")\n";
          lift_262 := lift_121;
        }
        print "(section 13 ", 320540702, "\n", ")\n";
      }
      print "(section 14 ", lift_145.1, "\n", ")\n";
    }
    lift_265 := lift_283;
  } else {
    ...
    );
    {
      ...
      if (false) {
        ...
        print "(section 16 ", lift_277, "\n", ")\n";
      } else {
        var lift_308 := lift_309;
        var lift_305 := lift_221;
        lift_305 := lift_88;
        lift_306 := lift_220;
        print "(section 17 ", 254131018, "\n", ")\n";
        lift_308 := lift_309;
        print "(section 18 ", lift_142, "\n", ")\n";
      }
      {
        lift_315 := lift_205;
    ...
    print "(section 21 ", |(lift_81 + lift_318 + lift_318)|, "\n", ")\n";
  }
  {
    ...
    ));
    {
      ...
      };
      {
        ...
        {
          print "(section 22 ", lift_304, "\n", ")\n";
          lift_336 := lift_337;
          lift_338 := lift_147;
          print "(section 23 ", -1960403417, "\n", ")\n";
          lift_339 := lift_324;
        }
        ...
        {
          lift_342 := lift_342;
          print "(section 24 ", 2086064974, "\n", ")\n";
          print "(section 25 ", 750333513, "\n", ")\n";
          lift_345 := lift_17;
        }
        {
          lift_346 := lift_199;
          lift_347 := multiset{(lift_331, lift_220)};
          print "(section 26 ", lift_279, "\n", ")\n";
          lift_358 := lift_358;
          print "(section 27 ", lift_144, "\n", ")\n";
        }
        {
          print "(section 28 ", lift_279, "\n", ")\n";
          print "(section 29 ", lift_11, "\n", ")\n";
          print "(section 30 ", lift_144, "\n", ")\n";
          print "(section 31 ", lift_277, "\n", ")\n";
        }
      }
  ...
  if (((safeSeqSubseq(lift_333, -1354601358, -2005711955) + safeSeqRef(
    ...
    var methoddefvar_462, methoddefvar_463 := lift_460_0(lift_14.1);
    {
      ...
      {
        print "(section 34 ", lift_217, "\n", ")\n";
        lift_472 := lift_476;
        print "(section 35 ", lift_148, "\n", ")\n";
      }
      var methoddefvar_478, methoddefvar_479 := lift_374_1(lift_204, lift_120);
      {
        var lift_480 := true;
        lift_480 := lift_262;
        print "(section 36 ", lift_151, "\n", ")\n";
      }
      ...
      {
        lift_485 := ();
        print "(section 37 ", lift_418, "\n", ")\n";
        print "(section 38 ", 233706633, "\n", ")\n";
        print "(section 39 ", lift_9, "\n", ")\n";
      }
      if (true) {
        print "(section 40 ", lift_226, "\n", ")\n";
        print "(section 41 ", lift_15, "\n", ")\n";
        print "(section 42 ", lift_205, "\n", ")\n";
      } else {
        var lift_487 := true;
        var lift_486 := 'M';
    ...
    if ((lift_139.0 == lift_147 > (lift_141 * lift_146))) {
      ...
      var methoddefvar_495, methoddefvar_496 := lift_460_1(lift_493);
      {
        ...
        lift_497 := lift_219;
        lift_498 := lift_10;
        print "(section 44 ", lift_420, "\n", ")\n";
        print "(section 45 ", lift_202, "\n", ")\n";
      }
      {
        var methoddefvar_501 := lift_499_0(lift_171);
        {
          ...
          lift_521 := lift_521;
          print "(section 47 ", -778657, "\n", ")\n";
        }
      }
      print "(section 48 ", ('r', -1130401090, lift_15).2, "\n", ")\n";
      if (('r' !in [lift_281, lift_84, lift_312])) {
        ...
        print "(section 53 ", lift_217, "\n", ")\n";
        {
          ...
          print "(section 54 ", -1132009575, "\n", ")\n";
          print "(section 55 ", 55449368, "\n", ")\n";
          lift_565 := {
