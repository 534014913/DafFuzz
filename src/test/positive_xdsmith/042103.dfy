  ...
  ensures (true)
{
  ...
  arg_190 := -448997688;
  {
    ...
    print "(params-for lift_182_0 arg_188 ", arg_188, ")\n";
    print "(meth-for lift_182_0)\n";
    {
      ...
      print "(section 19 ", arg_190, "\n", ")\n";
    }
    print "(rets-for lift_182_0 arg_189 ", arg_189, ")\n";
    print "(rets-for lift_182_0 arg_190 ", arg_190, ")\n";
  }
}
...
method Main () {
  ...
  );
  {
    ...
    var lift_158 := -1397926888;
    {
      ...
      {
        print "(section 0 ", lift_88, "\n", ")\n";
      }
    }
    {
      var lift_141 := lift_80;
      print "(section 1 ", lift_77, "\n", ")\n";
      print "(section 2 ", lift_88, "\n", ")\n";
      {
        print "(section 3 ", lift_69, "\n", ")\n";
        lift_141 := lift_141;
        lift_142 := lift_76;
      }
    }
