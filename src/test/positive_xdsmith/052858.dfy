  ...
  ensures (true)
{
  arg_317 := 956032176;
  {
    print "(params-for lift_312_0 arg_315 ", arg_315, ")\n";
    print "(params-for lift_312_0 arg_316 ", arg_316, ")\n";
    print "(meth-for lift_312_0)\n";
    {
      print "(section 56 ", arg_317, "\n", ")\n";
    }
    print "(rets-for lift_312_0 arg_317 ", arg_317, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_317 := 956032176;
  {
    print "(params-for lift_312_1 arg_315 ", arg_315, ")\n";
    print "(params-for lift_312_1 arg_316 ", arg_316, ")\n";
    print "(meth-for lift_312_1)\n";
    {
      print "(section 55 ", arg_317, "\n", ")\n";
    }
    print "(rets-for lift_312_1 arg_317 ", arg_317, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_177 := 588586923;
  {
    ...
    print "(meth-for lift_171_0)\n";
    {
      ...
      var lift_178 := ();
      print "(section 50 ", arg_175, "\n", ")\n";
      print "(section 51 ", arg_175, "\n", ")\n";
      print "(section 52 ", arg_176, "\n", ")\n";
      lift_178 := lift_179;
      print "(section 53 ", lift_184, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_146 := -843930374;
  {
    print "(meth-for lift_143_0)\n";
    {
      ...
      print "(section 47 ", lift_151, "\n", ")\n";
      print "(section 48 ", lift_150, "\n", ")\n";
  ...
  ensures (true)
{
  arg_119 := 1303318515;
  {
    ...
    print "(params-for lift_113_1 arg_117 ", arg_117, ")\n";
    print "(params-for lift_113_1 arg_118 ", arg_118, ")\n";
    print "(meth-for lift_113_1)\n";
    {
      var lift_121 := ();
      var lift_120 := ();
      print "(section 45 ", arg_118, "\n", ")\n";
      lift_120 := lift_121;
    }
    print "(rets-for lift_113_1 arg_119 ", arg_119, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_119 := 1303318515;
  {
    print "(params-for lift_113_2 arg_116 ", arg_116, ")\n";
    print "(params-for lift_113_2 arg_117 ", arg_117, ")\n";
    print "(params-for lift_113_2 arg_118 ", arg_118, ")\n";
    print "(meth-for lift_113_2)\n";
    {
      var lift_121 := ();
      var lift_120 := ();
      print "(section 44 ", arg_118, "\n", ")\n";
      lift_120 := lift_121;
    }
    print "(rets-for lift_113_2 arg_119 ", arg_119, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_41 := 430253116;
  {
    ...
    print "(meth-for lift_35_0)\n";
    {
      ...
      print "(section 42 ", 22482305, "\n", ")\n";
      print "(section 43 ", arg_41, "\n", ")\n";
      lift_42 := lift_42;
  ...
  ensures (true)
{
  ...
  arg_14 := -579002198;
  {
    ...
    print "(meth-for lift_8_0)\n";
    {
      ...
      print "(section 39 ", -710455805, "\n", ")\n";
      print "(section 40 ", 2019873478, "\n", ")\n";
  ...
  ensures (true)
{
  ...
  arg_14 := -579002198;
  {
    ...
    {
      var lift_15 := -1478594955;
      print "(section 36 ", -710455805, "\n", ")\n";
      print "(section 37 ", 2019873478, "\n", ")\n";
      print "(section 38 ", arg_13, "\n", ")\n";
      lift_15 := arg_14;
    }
    ...
    if (!((lift_66 < lift_130))) {
      ...
      var lift_169 := true;
      {
        ...
        if (lift_125) {
          ...
          print "(section 9 ", lift_152, "\n", ")\n";
          lift_153 := lift_161;
          lift_167 := 'R';
          lift_168 := lift_169;
        }
        {
          print "(section 10 ", 2097791277, "\n", ")\n";
          print "(section 11 ", lift_152, "\n", ")\n";
          lift_170 := lift_155;
          print "(section 12 ", lift_63, "\n", ")\n";
        }
        var methoddefvar_173, methoddefvar_174 := lift_171_0(lift_141);
        {
          ...
          lift_185 := lift_197;
          print "(section 13 ", lift_94, "\n", ")\n";
          print "(section 14 ", 1575885183, "\n", ")\n";
          lift_198 := lift_159;
        }
        if (lift_199) {
          print "(section 15 ", lift_92, "\n", ")\n";
          print "(section 16 ", 1952443361, "\n", ")\n";
          print "(section 17 ", lift_63, "\n", ")\n";
        } else {
          lift_200 := lift_102;
          lift_201 := lift_214;
          print "(section 18 ", lift_141, "\n", ")\n";
      ...
      }
      {
        ...
        lift_276 := lift_158;
        {
          lift_277 := lift_290;
          lift_291 := lift_291;
          print "(section 20 ", -1270817732, "\n", ")\n";
          print "(section 21 ", lift_264, "\n", ")\n";
          print "(section 22 ", lift_285, "\n", ")\n";
        }
      }
      var methoddefvar_294, methoddefvar_295 := lift_292_0();
      {
        ...
        lift_298 := lift_67;
        print "(section 23 ", lift_130, "\n", ")\n";
        lift_299 := lift_138;
        lift_300 := lift_300;
      }
      {
        if (lift_213) {
          print "(section 24 ", lift_285, "\n", ")\n";
          lift_307 := lift_311;
        } else {
          print "(section 25 ", lift_200, "\n", ")\n";
          print "(section 26 ", lift_141, "\n", ")\n";
        }
        ...
        var methoddefvar_319 := lift_312_1(-1875272290, lift_130);
        {
          ...
          lift_320 := lift_206;
          lift_321 := lift_321;
          print "(section 30 ", lift_92, "\n", ")\n";
        }
      }
      print "(section 31 ", (lift_131[lift_140] as int), "\n", ")\n";
    } else {
