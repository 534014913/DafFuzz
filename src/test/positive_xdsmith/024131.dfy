  ...
  ensures (true)
{
  arg_91 := 1670207753;
  {
    ...
    {
      print "(section 9 ", arg_90, "\n", ")\n";
      print "(section 10 ", arg_90, "\n", ")\n";
    }
    print "(rets-for lift_86_0 arg_91 ", arg_91, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_78 := 1606300382;
  {
    ...
    {
      print "(section 7 ", arg_78, "\n", ")\n";
      print "(section 8 ", arg_78, "\n", ")\n";
    }
