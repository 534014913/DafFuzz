...
method lift_109_0 (arg_113 : int)
  ...
  requires (((arg_113 == -958560163) && true))
  ensures (((arg_115 == -463239109) && ((arg_114 == 1964458115) && true)))
{
  arg_114 := 1964458115;
  arg_115 := -463239109;
  {
...
method lift_95_0 (arg_99 : int, arg_100 : int)
  ...
  requires (((arg_100 == 33) && ((arg_99 == -62760159) && true)))
  ensures (((arg_102 == -264401428) && ((arg_101 == -1103100279) && true)))
{
  arg_101 := -1103100279;
  arg_102 := -264401428;
  {
    assert (((arg_101 < arg_101) && (arg_101 < arg_101)) || ((arg_101 == arg_101) && (arg_101 < 2)));
  }
}
...
method lift_15_0 (arg_18 : int, arg_19 : int)
  returns (arg_20 : int)
  requires (((arg_19 == 1445604025) && ((arg_18 == -1483918077) && true)))
  ensures (((arg_20 == 651362207) && true))
{
  arg_20 := 651362207;
  {
    var lift_23 := 'z';
...
method lift_1_0 ()
  ...
  requires (true)
  ensures (((arg_6 == 553676139) && ((arg_5 == -1483918077) && true)))
{
  arg_5 := -1483918077;
  arg_6 := 553676139;
  {
    ...
    assert (((-553676144 + arg_6) - (-553676142 + arg_6)) == ((553676138 - arg_6) + (553676138 - arg_6)));
    assert (((arg_6 == 1) && (553676139 == arg_6)) || (-2 < (arg_6 - 553676140)));
    lift_7 := lift_11;
    lift_14 := lift_14;
    assert (((arg_5 - arg_5) < -1) || (1 < (arg_5 + 1483918079)));
  }
}
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0();
  {
    ...
    var methoddefvar_17 := lift_15_0(methoddefvar_3, 1445604025);
    {
      ...
      assert (((-2066604642 - lift_50) < (-2066604641 - lift_50)) && ((-2066604642 - lift_50) < (-2066604641 - -688868213)));
      lift_66 := lift_60;
    }
  }
  assert (((|(lift_67.0 + lift_79(lift_46, lift_90) + (multiset{
    lift_75
  } + multiset{
    lift_70,
    (lift_71, -281383062, [lift_35, lift_94, false, lift_53, lift_54]),
    lift_75
  } + lift_69))| + |(lift_67.0 + lift_79(lift_46, lift_90) + (multiset{
    lift_75
  } + multiset{
    lift_70,
    (lift_71, -281383062, [lift_35, lift_94, false, lift_53, lift_54]),
    lift_75
  } + lift_69))|) + (-13 - |(lift_67.0 + lift_79(lift_46, lift_90) + (multiset{
    lift_75
  } + multiset{
    lift_70,
    (lift_71, -281383062, [lift_35, lift_94, false, lift_53, lift_54]),
    ...
    (lift_71, -281383062, [lift_35, lift_94, false, lift_53, lift_54]),
    lift_75
  } + lift_69))| - 24) + |(lift_67.0 + lift_79(lift_46, lift_90) + (multiset{
    lift_75
  } + multiset{
    lift_70,
    (lift_71, -281383062, [lift_35, lift_94, false, lift_53, lift_54]),
