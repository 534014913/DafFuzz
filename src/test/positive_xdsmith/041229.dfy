  ...
  ensures (true)
{
  arg_192 := 1835713394;
  {
    ...
    print "(params-for lift_186_1 arg_190 ", arg_190, ")\n";
    print "(params-for lift_186_1 arg_191 ", arg_191, ")\n";
    ...
    print "(rets-for lift_186_1 arg_192 ", arg_192, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_121 := -1514388346;
  {
    print "(meth-for lift_118_0)\n";
    {
      ...
      print "(section 39 ", lift_122, "\n", ")\n";
      lift_123 := lift_123;
      print "(section 40 ", lift_123, "\n", ")\n";
      lift_124 := (lift_132, lift_129, lift_133);
      print "(section 41 ", arg_121, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_121 := -1514388346;
  {
    print "(meth-for lift_118_1)\n";
    {
      ...
      var lift_123 := 488893346;
      var lift_122 := 1051971218;
      print "(section 36 ", lift_122, "\n", ")\n";
      lift_123 := lift_123;
      print "(section 37 ", lift_123, "\n", ")\n";
      lift_124 := (lift_132, lift_129, lift_133);
      print "(section 38 ", arg_121, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_102 := -1670298051;
  {
    print "(params-for lift_98_1 arg_101 ", arg_101, ")\n";
    print "(meth-for lift_98_1)\n";
    {
      var lift_104 := arg_102;
      var lift_103 := -2051527926;
      lift_103 := lift_104;
      print "(section 34 ", arg_102, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_81 := 176110800;
  {
    ...
    print "(params-for lift_73_0 arg_79 ", arg_79, ")\n";
    print "(meth-for lift_73_0)\n";
    {
      ...
      var lift_82 := lift_83;
      print "(section 31 ", -153668856, "\n", ")\n";
      print "(section 32 ", arg_80, "\n", ")\n";
      lift_82 := lift_83;
      print "(section 33 ", arg_77, "\n", ")\n";
    }
    print "(rets-for lift_73_0 arg_80 ", arg_80, ")\n";
    print "(rets-for lift_73_0 arg_81 ", arg_81, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_60 := -138400772;
  {
    print "(meth-for lift_57_0)\n";
    {
      ...
      var lift_62 := false;
      var lift_61 := lift_62;
      print "(section 29 ", 1025372941, "\n", ")\n";
      lift_61 := lift_61;
      lift_63 := lift_63;
      print "(section 30 ", lift_64, "\n", ")\n";
    }
    print "(rets-for lift_57_0 arg_60 ", arg_60, ")\n";
  }
}
  ...
  )|;
  {
    ...
    if (lift_28) {
      ...
      if (lift_51.1) {
        ...
        if (lift_107) {
          print "(section 8 ", 621003577, "\n", ")\n";
          print "(section 9 ", lift_50, "\n", ")\n";
          print "(section 10 ", lift_93, "\n", ")\n";
          print "(section 11 ", 856223162, "\n", ")\n";
        } else {
          print "(section 12 ", -155946982, "\n", ")\n";
        }
      }
      ...
      if (lift_213.2) {
        ...
        {
          print "(section 20 ", lift_201, "\n", ")\n";
          print "(section 21 ", lift_114, "\n", ")\n";
