...
method lift_407_0 ()
  ...
  requires (true)
  ensures (((arg_412 == -1583614063) && ((arg_411 == 106661735) && true)))
{
  arg_411 := 106661735;
  arg_412 := -1583614063;
  {
...
method lift_343_2 (arg_346 : int, arg_347 : int, arg_348 : int)
  returns (arg_349 : int)
  requires (((arg_348 == 2102607271) && ((arg_347 == -1302082932) && ((arg_346 == 1471295241) && true))))
  ensures (((arg_349 == 580517393) && true))
{
  arg_349 := 580517393;
  {
    var lift_352 := 'R';
    var lift_351 := lift_352;
    var lift_350 := lift_351;
    assert ((arg_346 + -1471295238) == ((1471295244 - arg_346) + (1471295241 - arg_346)));
    lift_350 := lift_352;
    assert (((-580517398 + arg_349) - (-580517396 + arg_349)) == ((580517392 - arg_349) + (580517392 - arg_349)));
    assert (((arg_346 == arg_346) || (arg_346 == arg_346)) && ((-1 - arg_346) == (-2942590483 + arg_346)));
  }
}
...
method lift_258_2 (arg_262 : int, arg_263 : int, arg_264 : int)
  returns (arg_265 : int, arg_266 : int)
  requires (((arg_264 == -620293761) && ((arg_263 == -1731188840) && ((arg_262 == 2043583675) && true))))
  ensures (((arg_266 == 1802216007) && ((arg_265 == -120024057) && true)))
{
  arg_265 := -120024057;
  arg_266 := 1802216007;
  {
    ...
    var lift_268 := '|';
    var lift_267 := (lift_268, lift_269, lift_273);
    assert (((arg_264 < arg_264) && (-1 == arg_264)) || ((-620293762 - arg_264) == (-620293762 - -620293761)));
    assert (((-120024057 == arg_265) || (arg_265 < arg_265)) || ((-360072172 + 360072172) == (-120024058 - arg_265)));
    assert (((arg_264 < arg_264) && (-1 == arg_264)) || ((-620293762 - arg_264) == (-620293762 - -620293761)));
    lift_267 := lift_267;
    assert (((-1546269597 - 1546269598) + -1) < -3092539195);
  }
}
...
method lift_17_0 ()
  returns (arg_20 : int)
  requires (true)
  ensures (((arg_20 == 2050702044) && true))
{
  arg_20 := 2050702044;
  {
    var lift_21 := -393863582;
    assert (((0 - 1) + (393863581 + lift_21)) == ((lift_21 - 3) - (lift_21 - 1)));
  }
}
  ...
  ensures (((arg_20 == 2050702044) && true))
{
  ...
  {
    var lift_21 := -393863582;
    assert (((-787727167 - lift_21) - lift_21) < -1);
  }
}
  ...
  ensures (((arg_20 == 2050702044) && true))
{
  ...
  {
    var lift_21 := -393863582;
    assert (((lift_21 - 393863581) == (-393863582 + lift_21)) || ((-393863582 == lift_21) && (lift_21 == lift_21)));
  }
}
...
method lift_1_0 (arg_5 : int, arg_6 : int)
  ...
  requires (((arg_6 == 2043583675) && ((arg_5 == -723426348) && true)))
  ensures (((arg_8 == -1897423963) && ((arg_7 == -472285424) && true)))
{
  arg_7 := -472285424;
  arg_8 := -1897423963;
  {
...
method lift_1_2 (arg_5 : int, arg_6 : int)
  returns (arg_7 : int, arg_8 : int)
  requires (((arg_6 == -363410764) && ((arg_5 == -1731188840) && true)))
  ensures (((arg_8 == -1897423963) && ((arg_7 == -472285424) && true)))
{
  arg_7 := -472285424;
  arg_8 := -1897423963;
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_19 := lift_17_0();
    {
      ...
      assert (((lift_13 < lift_13) && (lift_13 == lift_13)) || ((1 < lift_13) || (lift_13 < lift_13)));
      lift_26 := lift_26;
      lift_31 := lift_32;
    }
    lift_33 := (lift_33, {'/', lift_34, lift_34}, "RNadtChrDd=sI").0;
    assert (((828578146 - 828578147) == (828578146 - lift_35(
      lift_39
    ))) || ((828578145 - lift_35(lift_39)) == (828578146 - lift_35(lift_39))));
    assert (((lift_40.2 + lift_40.2) + lift_40.2) < ((-1507097372 - 1507097372) + lift_40.2));
  ...
  );
  {
    ...
    var methoddefvar_120 := lift_17_2();
    {
      ...
      if (lift_91) {
        assert (((lift_82 + lift_82) + (-353135359 - lift_82)) < ((lift_82 - 706270716) + lift_82));
        lift_121 := ('P', lift_124);
      } else {
        var lift_130 := ();
  ...
  }
  {
    ...
    assert ((lift_173.2.2 + (lift_173.2.2 + 1316372715)) < lift_173.2.2);
    if ((safeSeqRef(lift_187, lift_201, lift_188) > lift_202.2 >= lift_224())) {
      ...
      var methoddefvar_403 := lift_17_3();
      {
        ...
        assert (((542474553 - lift_212) == (542474553 - 542474554)) || ((lift_212 < lift_212) && (lift_212 < lift_212)));
        lift_405 := lift_145;
        lift_406 := lift_356;
      }
      ...
      }
      {
        ...
        {
          assert ((lift_250 + (-1455827007 - lift_250)) == ((-2911654012 - lift_250) + (-1455827007 - lift_250)));
          lift_459 := lift_313;
          assert (71887184 == (215661552 - (71887184 + 71887184)));
          assert (-2 == ((-2033151370 - lift_58) + (-2033151370 - lift_58)));
        }
        assert (((-6662207348 + lift_223) - (-1332441470 + lift_223)) == ((-1332441471 - lift_223) + (-1332441471 - lift_223)));
      }
      assert (((("<|%U~kokp=?kqf!WCdpnjFqq", lift_315).1 < (
        "<|%U~kokp=?kqf!WCdpnjFqq",
        lift_315
      ).1) && (2102607272 == (
        "<|%U~kokp=?kqf!WCdpnjFqq",
        lift_315
      ).1)) || ((2102607270 - 2102607271) == (2102607270 - (
        "<|%U~kokp=?kqf!WCdpnjFqq",
        lift_315
      ).1)));
    }
    ...
    {
      {
        assert (((-2 - 1874596094) == (-3 - 1874596094)) || ((1874596093 - 1874596094) == (1874596094 - 1874596095)));
        lift_468 := lift_468;
      }
    }
  }
  assert (((331 - ((
    lift_90,
    ((var tmpData : set<int> := {}; tmpData), '_', 'v')
  ).0.2 as int)) - (110 + ((
    lift_90,
    ((var tmpData : set<int> := {}; tmpData), '_', 'v')
  ).0.2 as int))) == (-222 + (333 - ((
