...
method lift_110_0 (arg_114 : int, arg_115 : int)
  ...
  requires (((arg_115 == -2144377351) && ((arg_114 == 1705279894) && true)))
  ensures (((arg_117 == -1454454288) && ((arg_116 == -1846734611) && true)))
{
  arg_116 := -1846734611;
  arg_117 := -1454454288;
  {
    ...
    lift_118 := lift_118;
    lift_123 := lift_123;
    assert (((-2 - 1705279894) == (arg_114 + arg_114)) || ((arg_114 == -3) || (-2 < arg_114)));
    assert (((-1416233756 - 1416233756) == (1416233756 - 4248701268)) && ((-1416233757 - 1416233756) == (-4248701269 + 1416233756)));
    assert (((arg_116 == arg_116) && (arg_116 == -1846734611)) || ((-1846734611 - -1846734610) == (-1846734611 - arg_116)));
  }
}

method lift_110_1 (arg_114 : int, arg_115 : int)
  returns (arg_116 : int, arg_117 : int)
  requires (((arg_115 == 957497387) && ((arg_114 == 2018093396) && true)))
  ensures (((arg_117 == -1454454288) && ((arg_116 == -1846734611) && true)))
{
  arg_116 := -1846734611;
  arg_117 := -1454454288;
  {
    ...
    lift_118 := lift_118;
    lift_123 := lift_123;
    assert (((arg_114 == arg_114) && (0 < arg_114)) && ((2 + arg_114) < (arg_114 + arg_114)));
    assert (((1416233754 - 1416233756) == (1416233755 - 1416233756)) || ((1416233755 - 1416233756) == (1416233755 - 1416233756)));
    assert (((arg_116 + -1846734611) + (-1846734612 - arg_116)) < ((0 - 5540203834) - (arg_116 - 1)));
  }
}
  ...
  lift_1 := (lift_46, ("zMdeqZVYEgD", "NUoSDfJLE", (() => -650317795))).0.1;
  {
    ...
    var methoddefvar_112, methoddefvar_113 := lift_110_0(lift_46.2, lift_45);
    {
      ...
      var methoddefvar_130, methoddefvar_131 := lift_110_1(2018093396, lift_89);
      {
        ...
        assert ((lift_106 + (-1372732244 - lift_106)) == ((-1029549182 - lift_106) + (-1029549182 - lift_106)));
        assert (((lift_44 == lift_44) || (lift_44 < lift_44)) && ((1641076681 == lift_44) || (1641076682 == lift_44)));
        lift_132 := lift_133;
        lift_134 := lift_89;
        assert (((-2 - 1101167187) - (1101167187 + 1101167187)) < 1101167187);
      }
      assert (((-1911798258 - lift_15) == (-1911798258 - -1911798257)) || ((-1911798258 - lift_15) == (-1911798258 - -1911798257)));
    }
  }
