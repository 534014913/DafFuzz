  ...
  ensures (true)
{
  ...
  arg_394 := -1009257888;
  {
    ...
    {
      print "(section 67 ", 444390061, "\n", ")\n";
    }
    print "(rets-for lift_387_0 arg_393 ", arg_393, ")\n";
    print "(rets-for lift_387_0 arg_394 ", arg_394, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_246 := 1668276353;
  {
    ...
    print "(meth-for lift_240_0)\n";
    {
      ...
      print "(section 62 ", -803340496, "\n", ")\n";
      lift_247 := lift_247;
      print "(section 63 ", arg_243, "\n", ")\n";
      print "(section 64 ", arg_246, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_246 := 1668276353;
  {
    ...
    print "(meth-for lift_240_1)\n";
    {
      ...
      var lift_248 := lift_249;
      var lift_247 := lift_248;
      print "(section 59 ", -803340496, "\n", ")\n";
      lift_247 := lift_247;
      print "(section 60 ", arg_243, "\n", ")\n";
      print "(section 61 ", arg_246, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_126 := 1239890997;
  {
    print "(meth-for lift_123_0)\n";
    {
      ...
      lift_127 := lift_128;
      print "(section 56 ", arg_126, "\n", ")\n";
      print "(section 57 ", arg_126, "\n", ")\n";
      lift_130 := lift_130;
    }
  ...
  ensures (true)
{
  arg_126 := 1239890997;
  {
    print "(meth-for lift_123_1)\n";
    {
      ...
      var lift_127 := (var tmpData : seq<multiset<int>> := []; tmpData);
      lift_127 := lift_128;
      print "(section 54 ", arg_126, "\n", ")\n";
      print "(section 55 ", arg_126, "\n", ")\n";
      lift_130 := lift_130;
    }
    print "(rets-for lift_123_1 arg_126 ", arg_126, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_126 := 1239890997;
  {
    print "(meth-for lift_123_2)\n";
    {
      ...
      var lift_127 := (var tmpData : seq<multiset<int>> := []; tmpData);
      lift_127 := lift_128;
      print "(section 52 ", arg_126, "\n", ")\n";
      print "(section 53 ", arg_126, "\n", ")\n";
      lift_130 := lift_130;
    }
    print "(rets-for lift_123_2 arg_126 ", arg_126, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_106 := -1620577778;
  {
    ...
    print "(meth-for lift_100_0)\n";
    {
      ...
      lift_107 := lift_110;
      lift_111 := lift_111;
      print "(section 50 ", 760726223, "\n", ")\n";
      print "(section 51 ", 1200972181, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_106 := -1620577778;
  {
    print "(params-for lift_100_1 arg_104 ", arg_104, ")\n";
    print "(meth-for lift_100_1)\n";
    {
      var lift_111 := arg_105;
      var lift_110 := 'F';
      var lift_109 := '/';
      ...
      lift_107 := lift_110;
      lift_111 := lift_111;
      print "(section 48 ", 760726223, "\n", ")\n";
      print "(section 49 ", 1200972181, "\n", ")\n";
    }
    print "(rets-for lift_100_1 arg_105 ", arg_105, ")\n";
    print "(rets-for lift_100_1 arg_106 ", arg_106, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_23 := 1161969246;
  {
    ...
    print "(meth-for lift_17_0)\n";
    {
      ...
      var lift_25 := true;
      var lift_24 := lift_25;
      print "(section 44 ", arg_23, "\n", ")\n";
      print "(section 45 ", arg_21, "\n", ")\n";
      lift_24 := lift_24;
      print "(section 46 ", lift_26, "\n", ")\n";
  ...
  ensures (true)
{
  ...
  arg_16 := 1143861771;
  {
    ...
    {
      print "(section 41 ", arg_16, "\n", ")\n";
      print "(section 42 ", arg_15, "\n", ")\n";
      print "(section 43 ", arg_16, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_16 := 1143861771;
  {
    ...
    {
      print "(section 38 ", arg_16, "\n", ")\n";
      print "(section 39 ", arg_15, "\n", ")\n";
      print "(section 40 ", arg_16, "\n", ")\n";
    }
    print "(rets-for lift_11_1 arg_15 ", arg_15, ")\n";
...
method Main () {
  ...
  var methoddefvar_125 := lift_123_0();
  {
    ...
    print "(section 6 ", (lift_34, multiset{true, lift_115}).0, "\n", ")\n";
    {
      if (true) {
        print "(section 7 ", lift_112, "\n", ")\n";
        print "(section 8 ", lift_113, "\n", ")\n";
        print "(section 9 ", lift_34, "\n", ")\n";
        lift_147 := lift_148;
        print "(section 10 ", 1365713814, "\n", ")\n";
      } else {
        lift_157 := lift_157;
        lift_161 := lift_161;
    ...
    }
    {
      ...
      var methoddefvar_242 := lift_240_0(lift_228, 907885523, lift_237);
      {
        ...
        print "(section 13 ", 388481793, "\n", ")\n";
        print "(section 14 ", 1395726726, "\n", ")\n";
        print "(section 15 ", methoddefvar_242, "\n", ")\n";
      }
      lift_254 := lift_254;
    }
  }
  ...
  }
  {
    ...
    var methoddefvar_272 := lift_270_0();
    {
      var methoddefvar_315 := lift_123_1();
      {
        var lift_316 := ();
        lift_316 := lift_116;
        print "(section 16 ", methoddefvar_315, "\n", ")\n";
      }
    }
    print 
      "(section 17 ",
    ...
    if ((safeSeqSlice2(lift_93, lift_51, 1495369663) !in (
      ...
      if ((lift_113 < lift_206)) {
        ...
        if (lift_181) {
          print "(section 24 ", lift_220, "\n", ")\n";
          print "(section 25 ", lift_347, "\n", ")\n";
          print "(section 26 ", lift_366, "\n", ")\n";
        } else {
          var lift_417 := (lift_341, lift_418, ());
          lift_417 := lift_419;
          print "(section 27 ", lift_159, "\n", ")\n";
          print "(section 28 ", 637985165, "\n", ")\n";
          lift_420 := lift_413;
        }
        lift_421 := lift_431;
      ...
      {
        print "(section 32 ", lift_346, "\n", ")\n";
        print "(section 33 ", 1335096018, "\n", ")\n";
      }
