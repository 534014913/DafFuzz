  ...
  ensures (true)
{
  ...
  arg_423 := -1323130276;
  {
    ...
    print "(rets-for lift_418_0 arg_422 ", arg_422, ")\n";
  ...
  ensures (true)
{
  arg_378 := -1688255321;
  {
    ...
    print "(meth-for lift_372_0)\n";
    {
      ...
      lift_379 := lift_379;
      lift_382 := lift_382;
      print "(section 69 ", 29399136, "\n", ")\n";
      lift_383 := 1771915448;
      print "(section 70 ", 1407261900, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_354 := 1034755976;
  {
    ...
    print "(meth-for lift_347_0)\n";
    {
      ...
      lift_355 := false;
      lift_356 := lift_362;
      print "(section 68 ", arg_351, "\n", ")\n";
    }
    print "(rets-for lift_347_0 arg_353 ", arg_353, ")\n";
    print "(rets-for lift_347_0 arg_354 ", arg_354, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_343 := 300647181;
  {
    ...
    print "(params-for lift_335_0 arg_341 ", arg_341, ")\n";
    print "(meth-for lift_335_0)\n";
    {
      var lift_344 := true;
      print "(section 67 ", arg_341, "\n", ")\n";
      lift_344 := lift_344;
    }
    print "(rets-for lift_335_0 arg_342 ", arg_342, ")\n";
    print "(rets-for lift_335_0 arg_343 ", arg_343, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_343 := 300647181;
  {
    ...
    print "(params-for lift_335_1 arg_341 ", arg_341, ")\n";
    print "(meth-for lift_335_1)\n";
    {
      var lift_344 := true;
      print "(section 66 ", arg_341, "\n", ")\n";
      lift_344 := lift_344;
    }
    print "(rets-for lift_335_1 arg_342 ", arg_342, ")\n";
    print "(rets-for lift_335_1 arg_343 ", arg_343, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_325 := -1439813792;
  {
    ...
    {
      print "(section 61 ", arg_325, "\n", ")\n";
      print "(section 62 ", arg_323, "\n", ")\n";
      print "(section 63 ", arg_324, "\n", ")\n";
      print "(section 64 ", arg_324, "\n", ")\n";
      print "(section 65 ", arg_323, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_325 := -1439813792;
  {
    ...
    {
      print "(section 56 ", arg_325, "\n", ")\n";
      print "(section 57 ", arg_323, "\n", ")\n";
      print "(section 58 ", arg_324, "\n", ")\n";
      print "(section 59 ", arg_324, "\n", ")\n";
      print "(section 60 ", arg_323, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_280 := 1223365376;
  {
    print "(params-for lift_276_0 arg_279 ", arg_279, ")\n";
    print "(meth-for lift_276_0)\n";
    {
      var lift_281 := true;
      print "(section 54 ", arg_279, "\n", ")\n";
      lift_281 := lift_281;
      print "(section 55 ", arg_279, "\n", ")\n";
    }
    print "(rets-for lift_276_0 arg_280 ", arg_280, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_267 := 416771275;
  {
    print "(params-for lift_262_0 arg_265 ", arg_265, ")\n";
  ...
  ensures (true)
{
  arg_227 := -965699564;
  {
    ...
    print "(meth-for lift_222_0)\n";
    {
      ...
      lift_228 := lift_228;
      print "(section 49 ", arg_227, "\n", ")\n";
      print "(section 50 ", arg_226, "\n", ")\n";
      print "(section 51 ", arg_225, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_204 := -136364127;
  {
    print "(meth-for lift_201_0)\n";
    {
      ...
      print "(section 45 ", arg_204, "\n", ")\n";
      print "(section 46 ", lift_205, "\n", ")\n";
      print "(section 47 ", 1261365502, "\n", ")\n";
    }
    print "(rets-for lift_201_0 arg_204 ", arg_204, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_164 := -1147456185;
  {
    ...
    print "(meth-for lift_160_1)\n";
    {
      ...
      lift_174 := true;
      lift_175 := arg_163;
      print "(section 42 ", arg_163, "\n", ")\n";
    }
    print "(rets-for lift_160_1 arg_164 ", arg_164, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_98 := 2006526570;
  {
    print "(meth-for lift_95_0)\n";
    {
      ...
      var lift_99 := false;
      lift_99 := lift_100;
      print "(section 37 ", arg_98, "\n", ")\n";
      print "(section 38 ", lift_101, "\n", ")\n";
      print "(section 39 ", lift_102, "\n", ")\n";
  ...
  ensures (true)
{
  arg_84 := -505896359;
  {
    ...
    print "(params-for lift_79_1 arg_83 ", arg_83, ")\n";
    print "(meth-for lift_79_1)\n";
    {
      var lift_86 := 'y';
      var lift_85 := '*';
      lift_85 := lift_85;
      print "(section 35 ", arg_83, "\n", ")\n";
      lift_86 := lift_85;
    }
...
method Main () {
  ...
  if ((lift_1 !! (lift_5[lift_12.0 := lengthNormalize(
    ...
    if (((lift_24 * lift_25 * (var tmpData : set<((char, char, int), (bool, int, bool))> := {}; tmpData)) > lift_59(
      ...
      {
        print "(section 0 ", lift_49, "\n", ")\n";
        lift_87 := lift_87;
        lift_94 := lift_11;
        print "(section 1 ", -1483732023, "\n", ")\n";
      }
    ...
    var lift_142 := (lift_143, 1268727545, lift_148);
    {
      ...
      if (lift_129.1) {
        ...
        {
          print "(section 5 ", lift_211, "\n", ")\n";
          lift_219 := lift_197;
          print "(section 6 ", lift_199, "\n", ")\n";
        }
        lift_220 := lift_13;
        lift_221 := lift_221;
      }
      {
        print "(section 7 ", 356634945, "\n", ")\n";
        var methoddefvar_224 := lift_222_0(lift_54, lift_58);
        {
          print "(section 8 ", lift_145, "\n", ")\n";
          print "(section 9 ", 746694100, "\n", ")\n";
          print "(section 10 ", lift_208, "\n", ")\n";
      ...
      var methoddefvar_236, methoddefvar_237 := lift_234_0();
      {
        ...
        print "(section 13 ", lift_208, "\n", ")\n";
        lift_252 := lift_159;
        print "(section 14 ", lift_208, "\n", ")\n";
      }
      var methoddefvar_255 := lift_253_0(-1970456503, lift_23, 789050769);
      {
        print "(section 15 ", -261327768, "\n", ")\n";
        print "(section 16 ", -1119643516, "\n", ")\n";
    ...
    );
    {
      ...
      {
        lift_288 := lift_288;
        print "(section 20 ", lift_19, "\n", ")\n";
      }
      if (lift_119) {
        print "(section 21 ", lift_135, "\n", ")\n";
      } else {
    ...
    }
    {
      ...
      }
      {
        ...
        var methoddefvar_321, methoddefvar_322 := lift_319_0(lift_32);
        {
          ...
          lift_326 := lift_326;
          lift_332 := lift_333;
          print "(section 25 ", lift_198, "\n", ")\n";
          print "(section 26 ", lift_146, "\n", ")\n";
        }
      }
      print "(section 27 ", (true, lift_137).1, "\n", ")\n";
    }
    {
