...
method Main () {
  ...
  var methoddefvar_54 := lift_52_0(lift_59.2.2);
  {
    ...
    print "(section 0 ", lift_9, "\n", ")\n";
    {
      ...
      {
        print "(section 1 ", methoddefvar_73, "\n", ")\n";
        lift_84 := lift_84;
    ...
    }
    {
      ...
      if (lift_131) {
        print "(section 6 ", 1179327086, "\n", ")\n";
      } else {
        print "(section 7 ", 1110422287, "\n", ")\n";
      }
  ...
  print 
    "(section 12 ",
    ((lift_4, multiset{{lift_38}, lift_153, lift_153, lift_153}).0.1 as int),
    "\n",
    ")\n";
}
