  ...
  ensures (true)
{
  arg_697 := 967287936;
  {
    print "(meth-for lift_694_0)\n";
    {
      ...
      lift_698 := lift_701;
      print "(section 112 ", lift_705, "\n", ")\n";
      lift_706 := lift_706;
    }
    print "(rets-for lift_694_0 arg_697 ", arg_697, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_632 := -232343171;
  {
    print "(params-for lift_626_0 arg_630 ", arg_630, ")\n";
    print "(meth-for lift_626_0)\n";
    {
      ...
      lift_633 := -1825623544;
      lift_634 := lift_634;
      print "(section 111 ", 62167091, "\n", ")\n";
      lift_645 := lift_645;
    }
    print "(rets-for lift_626_0 arg_631 ", arg_631, ")\n";
    print "(rets-for lift_626_0 arg_632 ", arg_632, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_508 := 1580494376;
  {
    ...
    print "(meth-for lift_502_0)\n";
    {
      ...
      print "(section 109 ", arg_506, "\n", ")\n";
      lift_509 := lift_509;
      lift_522 := lift_522;
      print "(section 110 ", arg_506, "\n", ")\n";
    }
    print "(rets-for lift_502_0 arg_507 ", arg_507, ")\n";
    print "(rets-for lift_502_0 arg_508 ", arg_508, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_498 := -1753875563;
  {
    print "(params-for lift_493_0 arg_496 ", arg_496, ")\n";
    print "(params-for lift_493_0 arg_497 ", arg_497, ")\n";
    print "(meth-for lift_493_0)\n";
    {
      var lift_500 := 'M';
      var lift_499 := '$';
      lift_499 := lift_500;
      print "(section 108 ", arg_498, "\n", ")\n";
    }
    print "(rets-for lift_493_0 arg_498 ", arg_498, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_498 := -1753875563;
  {
    print "(params-for lift_493_1 arg_496 ", arg_496, ")\n";
    print "(params-for lift_493_1 arg_497 ", arg_497, ")\n";
    print "(meth-for lift_493_1)\n";
    {
      var lift_500 := 'M';
      var lift_499 := '$';
      lift_499 := lift_500;
      print "(section 107 ", arg_498, "\n", ")\n";
    }
    print "(rets-for lift_493_1 arg_498 ", arg_498, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_498 := -1753875563;
  {
    print "(params-for lift_493_2 arg_496 ", arg_496, ")\n";
    print "(params-for lift_493_2 arg_497 ", arg_497, ")\n";
    print "(meth-for lift_493_2)\n";
    {
      var lift_500 := 'M';
      var lift_499 := '$';
      lift_499 := lift_500;
      print "(section 106 ", arg_498, "\n", ")\n";
    }
    print "(rets-for lift_493_2 arg_498 ", arg_498, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_424 := -1730081800;
  {
    print "(params-for lift_418_0 arg_422 ", arg_422, ")\n";
    print "(meth-for lift_418_0)\n";
    {
      ...
      lift_425 := lift_425;
      print "(section 102 ", arg_423, "\n", ")\n";
      print "(section 103 ", arg_423, "\n", ")\n";
      lift_435 := lift_434;
      lift_437 := lift_438;
    }
    print "(rets-for lift_418_0 arg_423 ", arg_423, ")\n";
    print "(rets-for lift_418_0 arg_424 ", arg_424, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_406 := -1962317133;
  {
    ...
    print "(params-for lift_398_0 arg_404 ", arg_404, ")\n";
    print "(meth-for lift_398_0)\n";
    {
      print "(section 100 ", arg_402, "\n", ")\n";
      print "(section 101 ", 1684723959, "\n", ")\n";
    }
    print "(rets-for lift_398_0 arg_405 ", arg_405, ")\n";
    print "(rets-for lift_398_0 arg_406 ", arg_406, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_381 := 795789737;
  {
    ...
    print "(meth-for lift_374_0)\n";
    {
      ...
      print "(section 98 ", arg_381, "\n", ")\n";
      lift_382 := lift_382;
      lift_394 := arg_378;
      print "(section 99 ", arg_381, "\n", ")\n";
    }
    print "(rets-for lift_374_0 arg_380 ", arg_380, ")\n";
    print "(rets-for lift_374_0 arg_381 ", arg_381, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_371 := 620084204;
  {
    print "(params-for lift_367_2 arg_370 ", arg_370, ")\n";
    print "(meth-for lift_367_2)\n";
    {
      var lift_372 := 2025900980;
      print "(section 95 ", lift_372, "\n", ")\n";
    }
    print "(rets-for lift_367_2 arg_371 ", arg_371, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_356 := 1421103866;
  {
    print "(params-for lift_352_0 arg_355 ", arg_355, ")\n";
  ...
  ensures (true)
{
  arg_324 := -1047812581;
  {
    print "(meth-for lift_321_0)\n";
    {
      ...
      print "(section 92 ", lift_325, "\n", ")\n";
      lift_326 := multiset{
        (lift_329, lift_330),
        lift_336,
        (lift_338, lift_331)
      };
      print "(section 93 ", lift_342, "\n", ")\n";
      lift_343 := 326217788;
    }
    print "(rets-for lift_321_0 arg_324 ", arg_324, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_157 := -650335768;
  {
    ...
    print "(meth-for lift_151_0)\n";
    {
      ...
      print "(section 88 ", arg_156, "\n", ")\n";
      lift_158 := lift_158;
      print "(section 89 ", arg_156, "\n", ")\n";
      lift_162 := lift_160;
    }
  ...
  ensures (true)
{
  ...
  arg_125 := 1129329998;
  {
    ...
    print "(rets-for lift_118_1 arg_125 ", arg_125, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_125 := 1129329998;
  {
    ...
    print "(params-for lift_118_2 arg_123 ", arg_123, ")\n";
    ...
    print "(rets-for lift_118_2 arg_125 ", arg_125, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_125 := 1129329998;
  {
    ...
    print "(params-for lift_118_3 arg_123 ", arg_123, ")\n";
    ...
    print "(rets-for lift_118_3 arg_124 ", arg_124, ")\n";
    print "(rets-for lift_118_3 arg_125 ", arg_125, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_125 := 1129329998;
  {
    print "(params-for lift_118_4 arg_122 ", arg_122, ")\n";
    print "(params-for lift_118_4 arg_123 ", arg_123, ")\n";
    print "(meth-for lift_118_4)\n";
    {
      var lift_127 := true;
      var lift_126 := true;
      lift_126 := lift_127;
    }
    print "(rets-for lift_118_4 arg_124 ", arg_124, ")\n";
    print "(rets-for lift_118_4 arg_125 ", arg_125, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_125 := 1129329998;
  {
    print "(params-for lift_118_5 arg_122 ", arg_122, ")\n";
    print "(params-for lift_118_5 arg_123 ", arg_123, ")\n";
    print "(meth-for lift_118_5)\n";
    {
      var lift_127 := true;
      var lift_126 := true;
      lift_126 := lift_127;
    }
    print "(rets-for lift_118_5 arg_124 ", arg_124, ")\n";
    print "(rets-for lift_118_5 arg_125 ", arg_125, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_125 := 1129329998;
  {
    print "(params-for lift_118_6 arg_122 ", arg_122, ")\n";
    print "(params-for lift_118_6 arg_123 ", arg_123, ")\n";
    print "(meth-for lift_118_6)\n";
    {
      var lift_127 := true;
      var lift_126 := true;
      lift_126 := lift_127;
    }
    print "(rets-for lift_118_6 arg_124 ", arg_124, ")\n";
    print "(rets-for lift_118_6 arg_125 ", arg_125, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_113 := -449373506;
  {
    print "(meth-for lift_110_0)\n";
    {
      ...
      lift_114 := lift_114;
      print "(section 87 ", lift_116, "\n", ")\n";
    }
    print "(rets-for lift_110_0 arg_113 ", arg_113, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_61 := 1603851755;
  {
    print "(meth-for lift_56_0)\n";
    {
      ...
      lift_62 := lift_69;
      print "(section 85 ", 2053490020, "\n", ")\n";
      lift_80 := lift_81;
      print "(section 86 ", arg_60, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_61 := 1603851755;
  {
    print "(meth-for lift_56_1)\n";
    {
      ...
      var lift_62 := (lift_63, lift_66, lift_67);
      lift_62 := lift_69;
      print "(section 83 ", 2053490020, "\n", ")\n";
      lift_80 := lift_81;
      print "(section 84 ", arg_60, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_61 := 1603851755;
  {
    print "(meth-for lift_56_2)\n";
    {
      ...
      var lift_62 := (lift_63, lift_66, lift_67);
      lift_62 := lift_69;
      print "(section 81 ", 2053490020, "\n", ")\n";
      lift_80 := lift_81;
      print "(section 82 ", arg_60, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_61 := 1603851755;
  {
    print "(meth-for lift_56_3)\n";
    {
      ...
      var lift_62 := (lift_63, lift_66, lift_67);
      lift_62 := lift_69;
      print "(section 79 ", 2053490020, "\n", ")\n";
      lift_80 := lift_81;
      print "(section 80 ", arg_60, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_7 := -1802885818;
  {
    ...
    print "(meth-for lift_1_0)\n";
    {
      ...
      print "(section 77 ", arg_4, "\n", ")\n";
      print "(section 78 ", arg_7, "\n", ")\n";
      lift_8 := lift_17;
    }
  ...
  ensures (true)
{
  arg_7 := -1802885818;
  {
    ...
    print "(meth-for lift_1_1)\n";
    {
      ...
      var lift_9 := lift_10;
      var lift_8 := (lift_9, (arg_7, lift_14, arg_6), lift_15);
      print "(section 75 ", arg_4, "\n", ")\n";
      print "(section 76 ", arg_7, "\n", ")\n";
      lift_8 := lift_17;
    }
  ...
  ensures (true)
{
  arg_7 := -1802885818;
  {
    ...
    print "(meth-for lift_1_2)\n";
    {
      ...
      var lift_9 := lift_10;
      var lift_8 := (lift_9, (arg_7, lift_14, arg_6), lift_15);
      print "(section 73 ", arg_4, "\n", ")\n";
      print "(section 74 ", arg_7, "\n", ")\n";
      lift_8 := lift_17;
    }
...
method Main () {
  ...
  );
  {
    ...
    if ((lift_55 ==> false)) {
      ...
      if (false) {
        ...
        lift_85 := lift_91;
        print "(section 2 ", lift_92, "\n", ")\n";
        print "(section 3 ", lift_38, "\n", ")\n";
        lift_93 := lift_93;
        lift_94 := lift_95;
      } else {
        print "(section 4 ", lift_43, "\n", ")\n";
        print "(section 5 ", lift_92, "\n", ")\n";
      ...
      {
        var lift_133 := 'Y';
        print "(section 14 ", lift_117, "\n", ")\n";
        print "(section 15 ", lift_101, "\n", ")\n";
        print "(section 16 ", lift_101, "\n", ")\n";
        lift_128 := lift_131;
        lift_133 := lift_54;
      }
    }
    if (safeSeqRef(lift_134, lift_132, lift_109)) {
      ...
      {
        print "(section 17 ", methoddefvar_139, "\n", ")\n";
        print "(section 18 ", -1945537818, "\n", ")\n";
        print "(section 19 ", 1279644879, "\n", ")\n";
        print "(section 20 ", methoddefvar_139, "\n", ")\n";
      }
    } else {
      lift_141 := lift_145;
      {
    ...
    }
    {
      var methoddefvar_153, methoddefvar_154 := lift_151_0(lift_43);
      {
        ...
        lift_164 := lift_165;
        print "(section 22 ", methoddefvar_154, "\n", ")\n";
      }
    }
  }
  lift_166 := lift_166;
  if (('z' in safeSeqRef(
    ...
    {
      {
        var methoddefvar_185, methoddefvar_186 := lift_56_1();
        {
          ...
          print "(section 24 ", -2002896162, "\n", ")\n";
          lift_189 := lift_189;
          lift_191 := lift_176;
        }
        print "(section 25 ", lift_169, "\n", ")\n";
      }
    }
    var methoddefvar_192, methoddefvar_193 := lift_118_2(lift_86.1, lift_194.1);
    {
      {
        print "(section 26 ", 1881793112, "\n", ")\n";
        print "(section 27 ", 131849673, "\n", ")\n";
        print "(section 28 ", lift_38, "\n", ")\n";
        print "(section 29 ", methoddefvar_192, "\n", ")\n";
        print "(section 30 ", methoddefvar_192, "\n", ")\n";
      }
      var methoddefvar_206 := lift_204_0(lift_132, lift_43, lift_132);
      {
        print "(section 31 ", -919187083, "\n", ")\n";
        print "(section 32 ", lift_38, "\n", ")\n";
        print "(section 33 ", methoddefvar_192, "\n", ")\n";
        print "(section 34 ", methoddefvar_192, "\n", ")\n";
      }
      var methoddefvar_217, methoddefvar_218 := lift_118_3(lift_219, lift_101);
      {
        print "(section 35 ", lift_170, "\n", ")\n";
        lift_220 := lift_222;
        print "(section 36 ", lift_132, "\n", ")\n";
      }
    ...
    if (!((lift_38 < lift_101 <= lift_132))) {
      var lift_251 := {lift_202};
      {
        ...
        if (lift_87) {
          lift_239 := lift_241;
          lift_250 := lift_137;
          print "(section 38 ", -878977556, "\n", ")\n";
          print "(section 39 ", lift_230, "\n", ")\n";
          print "(section 40 ", lift_38, "\n", ")\n";
        } else {
          lift_251 := lift_252;
          print "(section 41 ", 648580939, "\n", ")\n";
          print "(section 42 ", lift_230, "\n", ")\n";
          print "(section 43 ", lift_171, "\n", ")\n";
        }
    ...
    if ((lift_171 <= (lift_148 as int))) {
      ...
      {
        print "(section 49 ", lift_132, "\n", ")\n";
        print "(section 50 ", lift_101, "\n", ")\n";
        print "(section 51 ", lift_299, "\n", ")\n";
      }
      if ((lift_294 !! lift_243 !! {
        ...
        );
        {
          ...
          print "(section 53 ", lift_248, "\n", ")\n";
          lift_411 := lift_183;
        }
        if (lift_178) {
          print "(section 54 ", -2111139515, "\n", ")\n";
          print "(section 55 ", -811722704, "\n", ")\n";
        } else {
        ...
        var methoddefvar_420, methoddefvar_421 := lift_418_0(lift_244);
        {
          ...
          lift_460 := lift_319;
          lift_461 := lift_461;
          print "(section 56 ", -1264703734, "\n", ")\n";
        }
        print "(section 57 ", lift_396, "\n", ")\n";
        lift_463 := lift_260;
      } else {
        ...
        {
          lift_501 := lift_143;
          print "(section 58 ", lift_414, "\n", ")\n";
          print "(section 59 ", lift_132, "\n", ")\n";
        }
    ...
    if (((lift_363 <==> lift_178) && (multiset{
      ...
      var methoddefvar_561 := lift_493_1(lift_528, lift_451);
      {
        ...
        lift_562 := lift_562;
        lift_563 := lift_572;
        print "(section 60 ", lift_245, "\n", ")\n";
        lift_573 := lift_109;
        lift_574 := multiset{lift_242};
      }
      lift_575 := lift_588.0;
      lift_620 := lift_623;
      print "(section 61 ", (lift_51 as int), "\n", ")\n";
      print "(section 62 ", |lift_200|, "\n", ")\n";
    } else {
      ...
      var methoddefvar_628, methoddefvar_629 := lift_626_0(lift_301);
      {
        ...
        print "(section 64 ", lift_568, "\n", ")\n";
        print "(section 65 ", methoddefvar_628, "\n", ")\n";
        lift_646 := lift_646;
        print "(section 66 ", lift_171, "\n", ")\n";
      }
      {
        var lift_650 := lift_556;
        print "(section 67 ", lift_319, "\n", ")\n";
        print "(section 68 ", lift_567, "\n", ")\n";
  ...
  print "(section 72 ", (lift_799 as int), "\n", ")\n";
}
