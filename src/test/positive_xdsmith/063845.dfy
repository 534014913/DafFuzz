  ...
  ensures (true)
{
  ...
  arg_60 := -1283924960;
  {
    ...
    print "(meth-for lift_53_0)\n";
    {
      ...
      var lift_62 := false;
      var lift_61 := true;
      print "(section 11 ", arg_59, "\n", ")\n";
      lift_61 := lift_62;
      print "(section 12 ", arg_59, "\n", ")\n";
      print "(section 13 ", lift_63, "\n", ")\n";
    }
...
method Main () {
  ...
  print 
    "(section 10 ",
    (((-44691546, ()), lift_38, ["c/aYu~ekLSp"]).1 as int),
    "\n",
    ")\n";
}
