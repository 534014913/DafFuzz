  ...
  ensures (true)
{
  ...
  arg_126 := 1234301823;
  {
    print "(meth-for lift_121_0)\n";
    {
      ...
      print "(section 8 ", arg_125, "\n", ")\n";
      lift_128 := lift_129;
      print "(section 9 ", arg_126, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_85 := -1628207221;
  {
    ...
    print "(params-for lift_79_0 arg_84 ", arg_84, ")\n";
    print "(meth-for lift_79_0)\n";
    {
      ...
      lift_90 := -1151340751;
      lift_91 := lift_91;
      print "(section 5 ", arg_85, "\n", ")\n";
      print "(section 6 ", arg_83, "\n", ")\n";
    }
    print "(rets-for lift_79_0 arg_85 ", arg_85, ")\n";
  }
}
...
method Main () {
  ...
  print 
    "(section 0 ",
    |safeSeqSubseq(lift_1, (lift_3 as int), (lift_4[lift_9] as int))|,
    "\n",
    ")\n";
  ...
  );
  {
    ...
    var methoddefvar_134, methoddefvar_135 := lift_132_0(lift_2, 154658096);
    {
      ...
      lift_150 := lift_151;
      lift_164 := lift_108;
      print "(section 2 ", lift_117, "\n", ")\n";
      print "(section 3 ", lift_101, "\n", ")\n";
    }
  }
}
