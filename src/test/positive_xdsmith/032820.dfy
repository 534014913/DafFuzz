  ...
  ensures (true)
{
  ...
  arg_102 := 1732409786;
  {
    print "(meth-for lift_97_0)\n";
    {
      ...
      lift_103 := lift_103;
      print "(section 19 ", 265068493, "\n", ")\n";
      lift_113 := lift_113;
    }
    print "(rets-for lift_97_0 arg_101 ", arg_101, ")\n";
  ...
  ensures (true)
{
  arg_78 := -2064210838;
  {
    print "(params-for lift_74_0 arg_77 ", arg_77, ")\n";
...
method Main () {
    ...
    ")\n";
  {
    ...
    var lift_28 := lift_29;
    print "(section 1 ", lift_28.0.0, "\n", ")\n";
  }
  print 
    "(section 2 ",
    (((lift_12[lift_13 := lengthNormalize(lift_9)]) + multiset(lift_35))[(
  ...
  );
  {
    ...
    if ((-296082383 > lift_26)) {
      ...
      if (lift_121) {
        ...
        print "(section 9 ", methoddefvar_65, "\n", ")\n";
        lift_129 := lift_129;
        lift_135 := lift_135;
        lift_136 := lift_53;
        lift_137 := lift_46;
      ...
      if (lift_134) {
        ...
        print "(section 14 ", 494804043, "\n", ")\n";
        print "(section 15 ", lift_148, "\n", ")\n";
      } else {
        var lift_217 := true;
        lift_204 := lift_204;
        lift_211 := lift_211;
