  ...
  ensures (true)
{
  arg_321 := -1106054274;
  {
    print "(params-for lift_317_0 arg_320 ", arg_320, ")\n";
    print "(meth-for lift_317_0)\n";
    {
      ...
      var lift_322 := false;
      print "(section 47 ", arg_320, "\n", ")\n";
      lift_322 := lift_322;
      print "(section 48 ", lift_323, "\n", ")\n";
      lift_325 := lift_328;
    }
  ...
  ensures (true)
{
  arg_263 := 188434806;
  {
    print "(meth-for lift_260_0)\n";
    {
      ...
      print "(section 41 ", lift_264, "\n", ")\n";
      print "(section 42 ", arg_263, "\n", ")\n";
      print "(section 43 ", arg_263, "\n", ")\n";
      print "(section 44 ", lift_264, "\n", ")\n";
      lift_265 := lift_266;
    }
  ...
  ensures (true)
{
  arg_240 := -1266194545;
  {
    ...
    {
      var lift_241 := [arg_240, -1468417108];
      print "(section 37 ", arg_238, "\n", ")\n";
      lift_241 := lift_241;
      print "(section 38 ", arg_239, "\n", ")\n";
    }
    print "(rets-for lift_235_1 arg_240 ", arg_240, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_226 := -1357738056;
  {
    print "(params-for lift_220_0 arg_223 ", arg_223, ")\n";
    ...
    print "(meth-for lift_220_0)\n";
    {
      ...
      print "(section 34 ", lift_227, "\n", ")\n";
      print "(section 35 ", arg_226, "\n", ")\n";
      lift_228 := lift_228;
      print "(section 36 ", arg_226, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_144 := -227586164;
  {
    ...
    print "(meth-for lift_138_0)\n";
    {
      ...
      var lift_145 := true;
      print "(section 31 ", arg_144, "\n", ")\n";
      lift_145 := true;
      print "(section 32 ", -1141971320, "\n", ")\n";
      print "(section 33 ", -516196517, "\n", ")\n";
      lift_146 := lift_148;
    }
  ...
  ensures (true)
{
  arg_144 := -227586164;
  {
    ...
    print "(meth-for lift_138_1)\n";
    {
      ...
      var lift_146 := (lift_147, ());
      var lift_145 := true;
      print "(section 28 ", arg_144, "\n", ")\n";
      lift_145 := true;
      print "(section 29 ", -1141971320, "\n", ")\n";
      print "(section 30 ", -516196517, "\n", ")\n";
      lift_146 := lift_148;
    }
  ...
  ensures (true)
{
  arg_72 := -1799358119;
  {
    ...
    print "(meth-for lift_67_0)\n";
    {
      ...
      var lift_73 := [lift_74];
      lift_73 := lift_75;
      print "(section 26 ", arg_70, "\n", ")\n";
      lift_79 := lift_107;
      print "(section 27 ", arg_70, "\n", ")\n";
    }
...
method Main () {
  ...
  var lift_3 := lift_4;
  {
    ...
    if ((safeSeqTake(lift_1, lift_2) in safeSeqRef(
      ...
      var lift_58 := lift_59;
      print "(section 0 ", (lift_16 as int), "\n", ")\n";
  ...
  if ((((lift_5 - lift_152 - multiset{
    ...
    );
    {
      ...
      print "(section 13 ", lift_217, "\n", ")\n";
      var methoddefvar_237 := lift_235_0(lift_30, lift_15);
      {
        print "(section 14 ", lift_48, "\n", ")\n";
        lift_242 := lift_248;
      }
      lift_249 := lift_231;
    }
    ...
    var methoddefvar_262 := lift_260_0();
    {
      ...
      if (false) {
        ...
        lift_275 := false;
        print "(section 17 ", methoddefvar_262, "\n", ")\n";
        lift_277 := lift_278;
      } else {
        var lift_282 := true;
        ...
        lift_282 := lift_276;
        lift_283 := lift_231;
        print "(section 18 ", lift_215, "\n", ")\n";
      }
      print "(section 19 ", lift_217, "\n", ")\n";
    }
    {
