  ...
  ensures (true)
{
  ...
  arg_376 := 288138659;
  {
    ...
    print "(meth-for lift_368_0)\n";
    {
      ...
      print "(section 41 ", arg_375, "\n", ")\n";
      print "(section 42 ", arg_373, "\n", ")\n";
      lift_377 := lift_377;
      print "(section 43 ", -234313084, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_321 := -1484965689;
  {
    ...
    print "(rets-for lift_316_0 arg_320 ", arg_320, ")\n";
  ...
  ensures (true)
{
  arg_300 := 379530749;
  {
    print "(meth-for lift_297_0)\n";
    {
      ...
      lift_301 := lift_301;
      print "(section 39 ", lift_302, "\n", ")\n";
      lift_303 := ();
      lift_305 := lift_306;
    }
    print "(rets-for lift_297_0 arg_300 ", arg_300, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_196 := 1535568261;
  {
    print "(params-for lift_192_1 arg_195 ", arg_195, ")\n";
    print "(meth-for lift_192_1)\n";
    {
      ...
      var lift_198 := (lift_199, lift_200, lift_203);
      var lift_197 := lift_198;
      print "(section 34 ", 1863623127, "\n", ")\n";
      lift_197 := lift_197;
    }
    print "(rets-for lift_192_1 arg_196 ", arg_196, ")\n";
  }
}
...
method Main () {
  ...
  if ((lift_56.0 !! ((lift_58 + {lift_19}) - lift_67(
    ...
    lift_123 := lift_123;
    {
      ...
      print 
        "(section 1 ",
        safeSeqRef(lift_64, lift_65, 1930441468),
        "\n",
        ")\n";
  ...
  );
  {
    ...
    if ((lift_116 == lift_117 <= lift_85)) {
      ...
      if (lift_137) {
        ...
        lift_281 := lift_283;
        lift_289 := lift_290;
        print "(section 15 ", 76883085, "\n", ")\n";
        print "(section 16 ", lift_160, "\n", ")\n";
      } else {
        var lift_295 := true;
        lift_291 := lift_293;
        print "(section 17 ", 1892268970, "\n", ")\n";
        lift_294 := lift_82;
    ...
    }
    {
      ...
      {
        lift_307 := lift_307;
        print "(section 19 ", lift_190, "\n", ")\n";
        print "(section 20 ", lift_12, "\n", ")\n";
      }
      var methoddefvar_318, methoddefvar_319 := lift_316_0();
      {
        lift_324 := lift_324;
        print "(section 21 ", lift_171, "\n", ")\n";
