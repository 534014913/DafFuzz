...
method lift_202_0 (arg_205 : int, arg_206 : int)
  returns (arg_207 : int)
  requires (((arg_206 == -1925643104) && ((arg_205 == -1966556394) && true)))
  ensures (((arg_207 == -49863763) && true))
{
  arg_207 := -49863763;
  {
    var lift_218 := 'm';
    ...
    lift_208 := 279533391;
    assert (((0 - 279533391) + (-1 - lift_208)) == ((lift_208 - 1118133565) - (0 - 279533391)));
    lift_210 := lift_210;
    assert (((-829539412 - lift_209) == (-829539412 - lift_209)) && ((-829539408 == -829539408) && (lift_209 < -829539409)));
    lift_213 := lift_213;
  }
}
...
method lift_164_0 (arg_168 : int)
  ...
  requires (((arg_168 == 1247505195) && true))
  ensures (((arg_170 == 1378281098) && ((arg_169 == -2123849713) && true)))
{
  arg_169 := -2123849713;
  arg_170 := 1378281098;
  {
    ...
    var lift_176 := 'g';
    var lift_175 := 'D';
    var lift_174 := multiset{lift_175, lift_176, lift_175, lift_176, lift_177};
    var lift_173 := ();
    var lift_172 := ();
    var lift_171 := multiset{lift_172, (), lift_172};
    assert (((1560589747 - 1560589748) == (1560589747 - 1560589748)) || ((1560589746 - 1560589748) == (1560589747 - 1560589748)));
    lift_171 := lift_171;
    lift_173 := lift_172;
    lift_174 := lift_174;
  }
...
method lift_164_1 (arg_168 : int)
  returns (arg_169 : int, arg_170 : int)
  requires (((arg_168 == -1966556394) && true))
  ensures (((arg_170 == 1378281098) && ((arg_169 == -2123849713) && true)))
{
  arg_169 := -2123849713;
  arg_170 := 1378281098;
  {
    ...
    var lift_172 := ();
    var lift_171 := multiset{lift_172, (), lift_172};
    assert (((1560589748 == 1560589748) || (1560589748 < 1560589748)) && ((1560589748 == 1560589748) && (1560589748 == 1560589748)));
    lift_171 := lift_171;
    lift_173 := lift_172;
    lift_174 := lift_174;
  }
...
method lift_151_0 (arg_154 : int)
  returns (arg_155 : int)
  requires (((arg_154 == 1843608693) && true))
  ensures (((arg_155 == 1658655499) && true))
{
  arg_155 := 1658655499;
  {
    var lift_159 := ();
  ...
  ensures (((arg_99 == 388690428) && true))
{
  arg_99 := 388690428;
  {
    ...
    lift_100 := lift_101;
    lift_102 := lift_102;
    assert (((-4468651724 - -1489550574) == (-4468651724 - lift_114)) || ((-4468651725 - lift_114) == (-4468651724 - lift_114)));
    lift_115 := lift_115;
    assert (((-4468651724 - -1489550574) == (-4468651724 - lift_114)) || ((-4468651725 - lift_114) == (-4468651724 - lift_114)));
  }
}
...
method lift_62_0 ()
  ...
  requires (true)
  ensures (((arg_67 == 472046661) && ((arg_66 == 1525190052) && true)))
{
  arg_66 := 1525190052;
  arg_67 := 472046661;
  {
...
method lift_46_0 ()
  returns (arg_49 : int)
  requires (true)
  ensures (((arg_49 == 2073311344) && true))
{
  arg_49 := 2073311344;
  {
    var lift_61 := 'e';
    ...
    assert (((arg_49 < arg_49) && (arg_49 == arg_49)) || ((arg_49 < arg_49) || (1 < arg_49)));
    lift_50 := (
      (var tmpData : multiset<(bool, bool, bool)> := multiset{}; tmpData),
      lift_57
    );
    lift_58 := lift_59;
    assert (((lift_57 - -382249469) < (-382249469 - lift_57)) || ((lift_57 == -382249469) || (lift_57 < lift_57)));
    lift_60 := lift_61;
  }
}
...
method lift_17_0 ()
  ...
  requires (true)
  ensures (((arg_22 == -1242358958) && ((arg_21 == -1204137693) && true)))
{
  arg_21 := -1204137693;
  arg_22 := -1242358958;
  {
    ...
    assert (((-1761540754 - lift_41) < (-1761540754 - lift_41)) || ((-1761540754 - -1761540753) == (-1761540754 - lift_41)));
    assert (((-1204137695 - -1204137693) < (-1204137694 - lift_42)) && ((lift_42 < lift_42) || (lift_42 == lift_42)));
    assert (((lift_41 + lift_41) + (-1761540754 - lift_41)) < ((lift_41 - -1761540754) + lift_41));
  }
}
  ...
  var methoddefvar_48 := lift_46_0();
  {
    ...
    var lift_86 := lift_87;
    {
      ...
      var methoddefvar_98 := lift_96_0();
      {
        ...
        lift_117 := lift_129;
        assert (((-954744485 - 954744484) + (954744484 + 954744484)) < 954744484);
      }
      var methoddefvar_144 := lift_96_1();
      {
        assert (((2073311342 - methoddefvar_48) == (2073311343 - methoddefvar_48)) || ((2073311343 - 2073311344) == (2073311343 - methoddefvar_48)));
        lift_145 := lift_142;
        assert (((lift_95 == lift_95) || (lift_95 == lift_95)) && ((-5899669183 - lift_95) == (-5899669183 - -1966556394)));
      }
    }
    {
      if (lift_90) {
        ...
        lift_148 := lift_149;
        assert ((275452580 - (137726289 - 137726289)) == ((137726290 + 137726290) + (137726289 - 137726289)));
      }
      ...
      {
        assert (((-1966556394 == lift_5) && (lift_5 == lift_5)) || ((lift_5 < lift_5) || (lift_5 < lift_5)));
        assert (((methoddefvar_166 == methoddefvar_166) || (methoddefvar_166 < methoddefvar_166)) && ((methoddefvar_166 + methoddefvar_166) == (-6371549139 - methoddefvar_166)));
        assert ((methoddefvar_166 + (-4247699427 - -2123849713)) == ((-6371549139 - methoddefvar_166) + (-2123849714 - methoddefvar_166)));
        lift_178 := lift_124;
        lift_179 := 'C';
      }
    }
    ...
    var methoddefvar_204 := lift_202_0(lift_95, lift_199);
    {
      ...
      assert ((methoddefvar_48 == 2073311344) || (methoddefvar_48 < (2073311343 - methoddefvar_48)));
      assert ((lift_227 == (-3796622889 - lift_227)) || ((lift_227 == -5694934334) || (-5694934332 < lift_227)));
      assert (((-1925643106 - lift_199) == (-1925643105 - lift_199)) || (lift_199 == (-3851286208 - lift_199)));
    }
    lift_230 := lift_231();
  }
  assert (((safeSeqRef(
