  ...
  ensures (true)
{
  arg_367 := -25514035;
  {
    ...
    print "(meth-for lift_362_0)\n";
    {
      ...
      lift_371 := lift_376;
      lift_384 := ();
      print "(section 59 ", arg_365, "\n", ")\n";
      print "(section 60 ", -1095096032, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_352 := -1105014447;
  {
    print "(params-for lift_348_0 arg_351 ", arg_351, ")\n";
    print "(meth-for lift_348_0)\n";
    {
      ...
      var lift_353 := '@';
      print "(section 58 ", arg_352, "\n", ")\n";
      lift_353 := lift_354;
      lift_357 := arg_351;
    }
    print "(rets-for lift_348_0 arg_352 ", arg_352, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_332 := 525039382;
  {
    ...
    print "(rets-for lift_329_0 arg_332 ", arg_332, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_273 := -1299091768;
  {
    ...
    print "(meth-for lift_269_0)\n";
    {
      ...
      lift_274 := lift_275;
      lift_280 := lift_281;
      print "(section 54 ", arg_273, "\n", ")\n";
      print "(section 55 ", lift_283, "\n", ")\n";
      lift_284 := lift_311;
    }
  ...
  ensures (true)
{
  ...
  arg_201 := 402628655;
  {
    ...
    print "(meth-for lift_194_0)\n";
    {
      ...
      var lift_202 := "!Q+Juuc";
      lift_202 := lift_202;
      print "(section 51 ", arg_201, "\n", ")\n";
      lift_203 := lift_211;
      print "(section 52 ", 1327005959, "\n", ")\n";
      print "(section 53 ", arg_201, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_167 := 737472797;
  {
    ...
    print "(rets-for lift_161_0 arg_166 ", arg_166, ")\n";
  ...
  ensures (true)
{
  arg_58 := 507424854;
  {
    ...
    print "(meth-for lift_54_0)\n";
    {
      ...
      lift_59 := arg_57;
      print "(section 49 ", arg_58, "\n", ")\n";
      print "(section 50 ", arg_58, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_58 := 507424854;
  {
    ...
    {
      var lift_59 := 922377028;
      print "(section 45 ", arg_57, "\n", ")\n";
      lift_59 := arg_57;
      print "(section 46 ", arg_58, "\n", ")\n";
      print "(section 47 ", arg_58, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_26 := -1307364048;
  {
    ...
    print "(meth-for lift_20_0)\n";
    {
      ...
      var lift_27 := ();
      lift_27 := lift_27;
      print "(section 43 ", lift_28, "\n", ")\n";
      print "(section 44 ", 2136225335, "\n", ")\n";
      lift_29 := lift_29;
    }
  ...
  ensures (true)
{
  ...
  arg_26 := -1307364048;
  {
    ...
    print "(meth-for lift_20_1)\n";
    {
      ...
      var lift_27 := ();
      lift_27 := lift_27;
      print "(section 41 ", lift_28, "\n", ")\n";
      print "(section 42 ", 2136225335, "\n", ")\n";
      lift_29 := lift_29;
    }
  ...
  ensures (true)
{
  ...
  arg_26 := -1307364048;
  {
    ...
    print "(meth-for lift_20_2)\n";
    {
      ...
      var lift_27 := ();
      lift_27 := lift_27;
      print "(section 39 ", lift_28, "\n", ")\n";
      print "(section 40 ", 2136225335, "\n", ")\n";
      lift_29 := lift_29;
    }
    print "(rets-for lift_20_2 arg_25 ", arg_25, ")\n";
  ...
  ensures (true)
{
  ...
  arg_15 := -765138310;
  {
    ...
    print "(params-for lift_7_0 arg_13 ", arg_13, ")\n";
    print "(meth-for lift_7_0)\n";
    {
      var lift_16 := true;
      lift_16 := false;
    }
    print "(rets-for lift_7_0 arg_14 ", arg_14, ")\n";
    print "(rets-for lift_7_0 arg_15 ", arg_15, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_6 := -800138064;
  {
    ...
    {
      print "(section 35 ", arg_5, "\n", ")\n";
      print "(section 36 ", 1886321578, "\n", ")\n";
      print "(section 37 ", arg_5, "\n", ")\n";
  ...
  if ((lift_48 > ({lift_31, lift_31, lift_50} + lift_49) == lift_51.0)) {
    ...
    }
    {
      ...
      if (!(lift_60)) {
        ...
        print "(section 15 ", lift_32, "\n", ")\n";
        var methoddefvar_119, methoddefvar_120 := lift_20_1(573119615);
        {
          lift_121 := lift_103;
          print "(section 16 ", methoddefvar_120, "\n", ")\n";
        }
        if (lift_60) {
          var lift_137 := ();
          lift_123 := lift_136;
          print "(section 17 ", lift_110, "\n", ")\n";
          print "(section 18 ", lift_111, "\n", ")\n";
          lift_137 := lift_31;
        } else {
          print "(section 19 ", lift_19, "\n", ")\n";
          print "(section 20 ", lift_36, "\n", ")\n";
          print "(section 21 ", 579899357, "\n", ")\n";
          lift_138 := lift_138;
        }
      ...
      if ((lift_114 < lift_116)) {
        ...
        var methoddefvar_163, methoddefvar_164 := lift_161_0(lift_19);
        {
          ...
          print "(section 23 ", lift_42, "\n", ")\n";
          print "(section 24 ", methoddefvar_164, "\n", ")\n";
          lift_171 := lift_172;
        }
        print "(section 25 ", lift_42, "\n", ")\n";
      }
    }
    var methoddefvar_173 := lift_54_1(|lift_152|);
    {
      print "(section 26 ", lift_134, "\n", ")\n";
    }
    lift_174 := safeSeqRef(
      lift_175.1,
      lift_107.1,
    ...
    );
    {
      ...
      {
        print "(section 27 ", lift_182, "\n", ")\n";
        lift_260 := lift_260;
        print "(section 28 ", lift_33, "\n", ")\n";
      }
      lift_265 := lift_135;
      lift_266 := lift_266;
      lift_268 := lift_31;
    ...
    var methoddefvar_331 := lift_329_0();
    {
      ...
      {
        lift_361 := lift_142;
        print "(section 31 ", 1490749159, "\n", ")\n";
      }
      {
        print "(section 32 ", lift_127, "\n", ")\n";
        print "(section 33 ", lift_36, "\n", ")\n";
      }
      var methoddefvar_364 := lift_362_0(1708560071, lift_110);
      {
        print "(section 34 ", methoddefvar_331, "\n", ")\n";
      }
    }
    lift_387 := safeSeqSet(
      lift_388.1,
