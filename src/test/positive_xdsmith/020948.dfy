  ...
  ensures (true)
{
  arg_139 := -414228627;
  {
    ...
    print "(meth-for lift_134_0)\n";
    {
      var lift_141 := false;
      var lift_140 := false;
      print "(section 14 ", arg_138, "\n", ")\n";
      lift_140 := lift_141;
      print "(section 15 ", arg_138, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_113 := 825889058;
  {
    ...
    print "(meth-for lift_107_0)\n";
    {
      ...
      print "(section 12 ", -1135003480, "\n", ")\n";
      lift_114 := lift_114;
      print "(section 13 ", arg_112, "\n", ")\n";
    }
...
method Main () {
  ...
  );
  {
    ...
    if ((lift_40 > lift_40)) {
      ...
      {
        print "(section 3 ", lift_118, "\n", ")\n";
        print "(section 4 ", lift_105, "\n", ")\n";
        print "(section 5 ", lift_99, "\n", ")\n";
        lift_142 := lift_143;
      }
      {
    ...
    var methoddefvar_149, methoddefvar_150 := lift_147_0(lift_66);
    {
      ...
      print "(section 9 ", methoddefvar_149, "\n", ")\n";
    }
  }
}
