  ...
  ensures (true)
{
  ...
  arg_110 := 228189261;
  {
    ...
    print "(params-for lift_102_0 arg_108 ", arg_108, ")\n";
    print "(meth-for lift_102_0)\n";
    {
      ...
      print "(section 12 ", arg_110, "\n", ")\n";
      lift_111 := arg_107;
      lift_112 := lift_112;
    }
    print "(rets-for lift_102_0 arg_109 ", arg_109, ")\n";
    print "(rets-for lift_102_0 arg_110 ", arg_110, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_110 := 228189261;
  {
    print "(params-for lift_102_1 arg_106 ", arg_106, ")\n";
    print "(params-for lift_102_1 arg_107 ", arg_107, ")\n";
    print "(params-for lift_102_1 arg_108 ", arg_108, ")\n";
    print "(meth-for lift_102_1)\n";
    {
      ...
      var lift_112 := (lift_113, lift_114, lift_119);
      var lift_111 := -1287546344;
      print "(section 11 ", arg_110, "\n", ")\n";
      lift_111 := arg_107;
      lift_112 := lift_112;
    }
    print "(rets-for lift_102_1 arg_109 ", arg_109, ")\n";
    print "(rets-for lift_102_1 arg_110 ", arg_110, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_21 := -667649127;
  {
    ...
    print "(rets-for lift_18_0 arg_21 ", arg_21, ")\n";
  }
}
...
method Main () {
  ...
  );
  {
    ...
    print "(section 0 ", lift_43.0, "\n", ")\n";
    print "(section 1 ", lift_43.0, "\n", ")\n";
    lift_52 := lift_53;
    {
      if (lift_13) {
        var lift_54 := 'w';
