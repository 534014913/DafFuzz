...
method lift_141_0 ()
  ...
  requires (true)
  ensures (((arg_146 == 1232114444) && ((arg_145 == 1475542771) && true)))
{
  arg_145 := 1475542771;
  arg_146 := 1232114444;
  {
    assert (((1232114446 - arg_146) + -2) == 0);
  }
}

method lift_55_0 (arg_58 : int, arg_59 : int)
  returns (arg_60 : int)
  requires (((arg_59 == 1230381592) && ((arg_58 == 1230381592) && true)))
  ensures (((arg_60 == -1262488556) && true))
{
  arg_60 := -1262488556;
  {
    var lift_105 := '@';
    ...
    lift_64 := lift_64;
    lift_65 := lift_65;
    assert (((arg_60 < -1262488554) && (arg_60 == arg_60)) || ((-1262488558 - arg_60) == (-1262488557 - arg_60)));
    lift_66 := lift_82;
  }
}
...
method lift_55_1 (arg_58 : int, arg_59 : int)
  returns (arg_60 : int)
  requires (((arg_59 == -1067161810) && ((arg_58 == -521620356) && true)))
  ensures (((arg_60 == -1262488556) && true))
{
  arg_60 := -1262488556;
  {
...
method lift_45_0 ()
  returns (arg_48 : int)
  requires (true)
  ensures (((arg_48 == -1826775186) && true))
{
  arg_48 := -1826775186;
  {
    var lift_52 := ();
    ...
    var lift_49 := arg_48;
    assert (((-3653550372 - lift_49) == lift_49) && ((lift_49 == lift_49) || (lift_49 == lift_49)));
    assert (((arg_48 + arg_48) + (-1826775187 - arg_48)) < ((arg_48 - -1826775187) + arg_48));
    lift_50 := [(), lift_51, (), (), lift_52];
    assert (-1826775189 == ((arg_48 - 1) + (-1826775187 - -1826775185)));
  }
}

method lift_1_0 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == 1230381592) && ((arg_5 == 2) && ((arg_4 == 3) && true))))
  ensures (((arg_7 == -375413342) && true))
{
  arg_7 := -375413342;
  {
    var lift_14 := false;
...
method Main () {
  ...
  {
    assert (((-1 - (lift_37 as int)) < (-1 - 0)) && ((-2 - (lift_37 as int)) < (-1 - (lift_37 as int))));
    var methoddefvar_47 := lift_45_0();
    {
      assert (((methoddefvar_3 < methoddefvar_3) && (methoddefvar_3 == methoddefvar_3)) || ((-375413342 == -375413344) || (-375413344 < methoddefvar_3)));
      lift_53 := (var tmpData : seq<bool> := []; tmpData);
      assert (lift_44 == 1230381592);
    }
  ...
  assert ((|lift_42| - (-1 + |lift_42|)) == ((5 - |lift_42|) - |lift_42|));
  lift_107 := safeSeqRef(
    [lift_122],
    lift_114,
  ...
  ).2|));
  {
    ...
    var methoddefvar_143, methoddefvar_144 := lift_141_0();
    {
      var lift_149 := ();
      if (lift_43) {
        assert (((-1265478232 + lift_121) - (-1265478230 + lift_121)) == ((1265478226 - lift_121) + (1265478226 - lift_121)));
      } else {
        lift_147 := lift_114;
        assert false;
      }
      {
        assert (((-1501745471 - 1501745470) - -1501745471) == ((-1501745471 + 1501745472) - 1501745471));
        assert (((lift_112 + -1306127786) - (lift_112 - lift_112)) == ((-1306127786 + 1306127785) + (1306127785 - lift_112)));
        lift_148 := lift_42;
        assert (((-2102997601 < -2102997601) && (-1 == -2102997601)) || ((-2102997602 - -2102997601) == (-2102997602 - -2102997601)));
      }
      if (lift_33) {
        assert (((lift_129 == lift_129) || (lift_129 == lift_129)) && ((lift_129 + lift_129) < (-3201485424 - lift_129)));
        lift_149 := lift_107;
        assert (((methoddefvar_144 == methoddefvar_144) || (methoddefvar_144 < methoddefvar_144)) && ((-3696343332 - methoddefvar_144) < (-1232114444 - 1232114444)));
        assert (((-521620359 - lift_131) < (521620355 + lift_131)) && ((-521620358 < lift_131) || (lift_131 < lift_131)));
      } else {
        lift_150 := lift_150;
      }
