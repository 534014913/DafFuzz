  ...
  ensures (true)
{
  arg_433 := 2038404259;
  {
    print "(meth-for lift_430_0)\n";
    {
      ...
      lift_434 := lift_434;
      print "(section 62 ", lift_440, "\n", ")\n";
      print "(section 63 ", lift_441, "\n", ")\n";
      lift_442 := lift_443;
      lift_444 := lift_441;
    }
  ...
  ensures (true)
{
  ...
  arg_320 := -1135280492;
  {
    ...
    print "(rets-for lift_315_0 arg_319 ", arg_319, ")\n";
    print "(rets-for lift_315_0 arg_320 ", arg_320, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_237 := -413974481;
  {
    print "(meth-for lift_234_0)\n";
    {
      ...
      lift_238 := lift_238;
      lift_243 := lift_243;
      print "(section 59 ", lift_246, "\n", ")\n";
      lift_247 := lift_241;
      print "(section 60 ", lift_249, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_237 := -413974481;
  {
    print "(meth-for lift_234_1)\n";
    {
      ...
      lift_238 := lift_238;
      lift_243 := lift_243;
      print "(section 57 ", lift_246, "\n", ")\n";
      lift_247 := lift_241;
      print "(section 58 ", lift_249, "\n", ")\n";
    }
    print "(rets-for lift_234_1 arg_237 ", arg_237, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_214 := 669125050;
  {
    print "(meth-for lift_211_0)\n";
    {
      ...
      lift_215 := lift_221;
      print "(section 55 ", lift_226, "\n", ")\n";
      lift_231 := lift_229;
      print "(section 56 ", lift_226, "\n", ")\n";
      lift_232 := ();
    }
  ...
  ensures (true)
{
  arg_195 := -1401136063;
  {
    print "(params-for lift_191_1 arg_194 ", arg_194, ")\n";
    print "(meth-for lift_191_1)\n";
    {
      var lift_202 := false;
      var lift_201 := lift_202;
      var lift_200 := lift_201;
    ...
    print "(rets-for lift_191_1 arg_195 ", arg_195, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_104 := 1580216960;
  {
    ...
    print "(meth-for lift_100_0)\n";
    {
      ...
      lift_105 := lift_105;
      print "(section 53 ", arg_104, "\n", ")\n";
      print "(section 54 ", lift_110, "\n", ")\n";
      lift_113 := arg_104;
    }
  ...
  ensures (true)
{
  arg_70 := 1215321434;
  {
    ...
    {
      var lift_71 := 'U';
      print "(section 49 ", arg_68, "\n", ")\n";
      lift_71 := lift_71;
      print "(section 50 ", arg_67, "\n", ")\n";
      print "(section 51 ", arg_69, "\n", ")\n";
      print "(section 52 ", -1251687616, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_70 := 1215321434;
  {
    ...
    {
      var lift_71 := 'U';
      print "(section 45 ", arg_68, "\n", ")\n";
      lift_71 := lift_71;
      print "(section 46 ", arg_67, "\n", ")\n";
      print "(section 47 ", arg_69, "\n", ")\n";
      print "(section 48 ", -1251687616, "\n", ")\n";
    }
...
method Main () {
  ...
  print 
    "(section 0 ",
    (((lift_1 - lift_1 - lift_1)[safeSeqRef(
      lift_4,
      -1765319003,
      lift_5
    ) := lengthNormalize(|lift_6|)])[lift_9.0.2] as int),
    "\n",
    ")\n";
  if ((safeSeqRef(lift_20, lift_25.2, lift_22) ==> (lift_41.0 < (
    ...
    print 
      "(section 5 ",
      safeSeqRef(
        safeSeqTake(lift_114, 1213645314),
        safeSeqRef(lift_114, lift_80, lift_117),
        |lift_72|
      ),
      "\n",
      ")\n";
    ...
    print 
      "(section 6 ",
      safeSeqRef((62623725, 'u', lift_114).2, lift_36, (lift_99 as int)),
      "\n",
      ")\n";
    {
      print "(section 7 ", |{lift_98, lift_58}|, "\n", ")\n";
    }
    if ((lift_134(
      lift_1,
      lift_142,
      ...
      if ((lift_42 < 1087339774)) {
        ...
        if (lift_118) {
          ...
          lift_158 := lift_159;
          print "(section 13 ", lift_129, "\n", ")\n";
          print "(section 14 ", -286003577, "\n", ")\n";
        }
        {
          var lift_170 := lift_171;
          var lift_165 := lift_166;
          var lift_161 := (lift_162, lift_79, lift_165);
          print "(section 15 ", lift_115, "\n", ")\n";
          lift_161 := lift_170;
          lift_183 := lift_186;
        }
        ...
        if (lift_8) {
          ...
          print "(section 18 ", lift_32, "\n", ")\n";
          lift_204 := lift_204;
        } else {
          lift_205 := lift_205;
          print "(section 19 ", lift_128, "\n", ")\n";
        }
      }
      ...
      var methoddefvar_236 := lift_234_0();
      {
        ...
        print "(section 20 ", lift_32, "\n", ")\n";
        lift_251 := 2141246107;
        lift_252 := lift_255;
      }
      {
        print "(section 21 ", 2031140938, "\n", ")\n";
      }
    }
  }
  if (((safeSeqRef(lift_259, lift_32, lift_269) !! ({
    ...
    {
      print "(section 22 ", lift_295(lift_17), "\n", ")\n";
      var methoddefvar_300, methoddefvar_301 := lift_298_0(lift_117);
      {
        print "(section 23 ", methoddefvar_300, "\n", ")\n";
        print "(section 24 ", lift_293, "\n", ")\n";
        print "(section 25 ", lift_76, "\n", ")\n";
        print "(section 26 ", lift_282, "\n", ")\n";
      }
      {
        lift_313 := lift_294;
      }
      ...
      {
        print "(section 27 ", lift_291, "\n", ")\n";
        lift_327 := lift_261;
        lift_328 := lift_268;
        lift_329 := "jbdUD";
        print "(section 28 ", -1269744826, "\n", ")\n";
      }
      print "(section 29 ", safeSeqRef(lift_31, lift_42, lift_129), "\n", ")\n";
    }
  } else {
    ...
    var methoddefvar_341 := lift_191_1(|lift_89|);
    {
      ...
      {
        var lift_343 := false;
        print "(section 30 ", lift_278, "\n", ")\n";
        print "(section 31 ", lift_294, "\n", ")\n";
        lift_343 := lift_98;
        print "(section 32 ", -1389402376, "\n", ")\n";
        lift_344 := lift_293;
      }
    }
    print 
      "(section 33 ",
      safeSeqRef(lift_345.2, |lift_54|, lift_78.2),
      "\n",
      ")\n";
    {
      ...
      lift_356 := lift_357(lift_55, lift_80, [-1149887447, lift_293, lift_80]);
      {
        ...
        print "(section 34 ", lift_278, "\n", ")\n";
        var methoddefvar_378 := lift_234_1();
        {
          print "(section 35 ", lift_288, "\n", ")\n";
        }
      }
      print "(section 36 ", lift_40.1, "\n", ")\n";
      print 
        "(section 37 ",
        (
          multiset{
    ...
    var methoddefvar_432 := lift_430_0();
    {
      ...
      if (lift_57) {
        print "(section 38 ", lift_37, "\n", ")\n";
        print "(section 39 ", lift_313, "\n", ")\n";
        lift_445 := lift_11;
        lift_446 := lift_427;
        print "(section 40 ", lift_278, "\n", ")\n";
      } else {
        lift_447 := lift_47;
        print "(section 41 ", lift_257, "\n", ")\n";
      }
      lift_448 := lift_448;
      lift_456 := lift_44;
      if (lift_209) {
        ...
        print "(section 43 ", lift_459, "\n", ")\n";
        print "(section 44 ", lift_190, "\n", ")\n";
      }
    }
  }
}
