...
method lift_212_0 ()
  ...
  requires (true)
  ensures (((arg_217 == -518656893) && ((arg_216 == 772640097) && true)))
{
  arg_216 := 772640097;
  arg_217 := -518656893;
  {
    ...
    assert (0 == (arg_217 - (-1037313786 - arg_217)));
    assert (((2 + lift_218) - (-411507557 - lift_218)) < ((-411507557 + lift_218) - (lift_218 + lift_218)));
...
method lift_145_0 (arg_148 : int, arg_149 : int)
  returns (arg_150 : int)
  requires (((arg_149 == 347620834) && ((arg_148 == 1249178745) && true)))
  ensures (((arg_150 == -1435522600) && true))
{
  arg_150 := -1435522600;
  {
    ...
    var lift_151 := 'L';
    assert (((393401668 == 393401668) || (393401668 == 393401668)) || (393401668 == (-3 - 393401668)));
    lift_151 := lift_151;
...
method lift_125_0 (arg_129 : int, arg_130 : int, arg_131 : int)
  ...
  requires (((arg_131 == -530274401) && ((arg_130 == 347620834) && ((arg_129 == 347620834) && true))))
  ensures (((arg_133 == -452477685) && ((arg_132 == 1936054694) && true)))
{
  arg_132 := 1936054694;
  arg_133 := -452477685;
  {
    var lift_134 := ();
    lift_134 := lift_134;
    assert (((-1060548803 - arg_131) < arg_131) || ((-1060548805 - arg_131) == (-1060548806 - arg_131)));
    assert (((-948846359 - -948846358) == (-948846359 - -948846358)) && ((-948846359 - -948846358) == (-948846359 - -948846358)));
  }
}
...
method lift_64_0 (arg_67 : int, arg_68 : int)
  returns (arg_69 : int)
  requires (((arg_68 == 347620834) && ((arg_67 == -530274401) && true)))
  ensures (((arg_69 == 1230547591) && true))
{
  arg_69 := 1230547591;
  {
    var lift_83 := false;
    ...
    lift_70 := lift_79;
    assert (((arg_68 == arg_68) && (arg_68 == arg_68)) && ((347620831 - arg_68) == (-347620837 + arg_68)));
    assert (((-1060548803 - arg_67) < arg_67) || ((-1060548805 - arg_67) == (-1060548806 - arg_67)));
  }
}
...
method lift_31_0 (arg_35 : int)
  ...
  requires (((arg_35 == 347620834) && true))
  ensures (((arg_37 == 1882179417) && ((arg_36 == -1168696513) && true)))
{
  arg_36 := -1168696513;
  arg_37 := 1882179417;
  {
    ...
    lift_38 := lift_38;
    lift_43 := lift_44;
    assert (((lift_43 + lift_43) + lift_43) < (-552206314 + lift_43));
  }
}
...
method lift_2_0 (arg_6 : int, arg_7 : int)
  ...
  requires (((arg_7 == 1582769259) && ((arg_6 == 1806127731) && true)))
  ensures (((arg_9 == 94507548) && ((arg_8 == -530274401) && true)))
{
  arg_8 := -530274401;
  arg_9 := 94507548;
  {
    ...
    var lift_11 := lift_12;
    var lift_10 := lift_11;
    assert (((-1060548803 - arg_8) < arg_8) || ((-1060548805 - arg_8) == (-1060548806 - arg_8)));
    lift_10 := ();
    assert (((94507547 - arg_9) == (94507547 - 94507548)) || (arg_9 == (94507547 - arg_9)));
    lift_13 := arg_7;
    lift_14 := lift_16;
  }
}
...
method Main () {
  ...
  assert (((lift_1 - 3713683710) - 1) == ((0 - 1237894570) + (-1 - lift_1)));
  ...
  );
  {
    ...
    var methoddefvar_33, methoddefvar_34 := lift_31_0(lift_21);
    {
      ...
      assert (((1388030329 - 1388030331) == (1388030331 - 1388030333)) && ((1388030329 - 1388030331) < (1388030330 - 1388030331)));
      assert (((94507547 - methoddefvar_5) == (94507547 - 94507548)) || (methoddefvar_5 == (94507547 - methoddefvar_5)));
      lift_45 := lift_46;
      lift_52 := lift_52;
    }
    lift_53 := lift_54();
    if ((lift_62 <==> lift_63)) {
      ...
      {
        assert (((-1060548803 - methoddefvar_4) < methoddefvar_4) || ((-1060548805 - methoddefvar_4) == (-1060548806 - methoddefvar_4)));
        lift_84 := lift_84;
      }
    } else {
      var lift_124 := true;
    ...
    {
      assert (((lift_22 == lift_22) || (lift_22 < lift_22)) && ((lift_22 == lift_22) && (lift_22 == 347620834)));
      lift_135 := [lift_136, lift_63, false, false, lift_62];
      lift_137 := lift_137;
      assert (((-1060548803 - methoddefvar_4) < methoddefvar_4) || ((-1060548805 - methoddefvar_4) == (-1060548806 - methoddefvar_4)));
      lift_140 := lift_140;
    }
    assert (((1862356774 - 1862356776) < ((
      'y',
      1862356774,
      ["S?E$cR\"-W_w-YU:J_bJlD", lift_144, lift_144]
    ).1 - 1862356775)) && ((1862356774 - 1862356775) == ((
      'y',
      1862356774,
      ["S?E$cR\"-W_w-YU:J_bJlD", lift_144, lift_144]
    ).1 + -1862356775)));
  ...
  var methoddefvar_147 := lift_145_0(lift_25, lift_21);
  {
    ...
    var methoddefvar_214, methoddefvar_215 := lift_212_0();
    {
      ...
      assert (2 == ((-1359351969 + 1) - lift_101));
      assert (((lift_228 + lift_228) + lift_228) < ((-928784859 - 928784859) + lift_228));
      lift_229 := lift_235;
      lift_242 := lift_243;
      lift_245 := lift_253;
    }
