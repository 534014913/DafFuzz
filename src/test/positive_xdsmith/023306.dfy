...
method lift_80_0 ()
  ...
  requires (true)
  ensures (((arg_85 == 909394310) && ((arg_84 == -815437053) && true)))
{
  arg_84 := -815437053;
  arg_85 := 909394310;
  {
...
method lift_1_0 (arg_4 : int, arg_5 : int)
  returns (arg_6 : int)
  requires (((arg_5 == -1277487042) && ((arg_4 == 0) && true)))
  ensures (((arg_6 == -1301457624) && true))
{
  arg_6 := -1301457624;
  {
    var lift_9 := 't';
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_29 := lift_27_0();
    {
      var lift_70 := lift_71;
      lift_58 := lift_58;
      assert (((lift_25 < lift_25) || (lift_25 < lift_25)) || ((-1277487045 - lift_25) == (lift_25 - -1277487039)));
      lift_63 := lift_66;
      lift_70 := lift_72;
    }
    lift_74 := lift_74;
    assert (((lift_78.1 < lift_78.1) || (1185719548 < lift_78.1)) || ((lift_78.1 - 1185719549) == (lift_78.1 + lift_78.1)));
  ...
  }
  {
    ...
    if ((safeSeqRef(
      ...
      assert (((safeSeqRef(lift_79, 336958901, 1457167182) < safeSeqRef(
        lift_79,
        336958901,
        1457167182
      )) && (1457167183 == safeSeqRef(
        lift_79,
        336958901,
        1457167182
      ))) || ((1457167181 - 1457167182) == (1457167181 - safeSeqRef(
        lift_79,
        336958901,
        1457167182
      ))));
      assert (((91 - 94) == (91 - ('^' as int))) || ((('^' as int) < ('^' as int)) && (('^' as int) < ('^' as int))));
    } else {
      var lift_147 := ();
