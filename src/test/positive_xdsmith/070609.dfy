...
method lift_147_0 ()
  returns (arg_150 : int)
  requires (true)
  ensures (((arg_150 == 383613109) && true))
{
  arg_150 := 383613109;
  {
    assert (((-1 - 1686384779) - (-5059154336 + 1686384778)) == ((1686384778 + 1686384778) - (1686384778 - 0)));
  }
}

method lift_130_0 (arg_134 : int, arg_135 : int, arg_136 : int)
  returns (arg_137 : int, arg_138 : int)
  requires (((arg_136 == 2092899167) && ((arg_135 == 742408993) && ((arg_134 == -1908823613) && true))))
  ensures (((arg_138 == 596088298) && ((arg_137 == -153886331) && true)))
{
  arg_137 := -153886331;
  arg_138 := 596088298;
  {
    ...
    lift_139 := lift_139;
    lift_144 := ();
    assert (arg_134 == ((-1 + -1908823613) + (-1908823612 - arg_134)));
    assert ((arg_137 + (-153886332 - arg_137)) == ((-307772662 - arg_137) + (-153886332 - arg_137)));
    assert ((arg_137 + (-153886332 - arg_137)) == ((-307772662 - arg_137) + (-153886332 - arg_137)));
  }
}
...
method lift_130_1 (arg_134 : int, arg_135 : int, arg_136 : int)
  returns (arg_137 : int, arg_138 : int)
  requires (((arg_136 == 1556585668) && ((arg_135 == -161363467) && ((arg_134 == 715380621) && true))))
  ensures (((arg_138 == 596088298) && ((arg_137 == -153886331) && true)))
{
  arg_137 := -153886331;
  arg_138 := 596088298;
  {
    ...
    lift_139 := lift_139;
    lift_144 := ();
    assert (((-3576903113 + arg_134) - (-715380623 + arg_134)) == ((-715380624 - arg_134) + (-715380624 - arg_134)));
    assert ((arg_137 + (-153886332 - arg_137)) == ((-307772662 - arg_137) + (-153886332 - arg_137)));
    assert ((arg_137 + (-153886332 - arg_137)) == ((-307772662 - arg_137) + (-153886332 - arg_137)));
  }
}
...
method lift_104_0 (arg_107 : int, arg_108 : int, arg_109 : int)
  returns (arg_110 : int)
  requires (((arg_109 == -1908823613) && ((arg_108 == 1264264106) && ((arg_107 == -161363467) && true))))
  ensures (((arg_110 == -1068054305) && true))
{
  arg_110 := -1068054305;
  {
    ...
    assert (((-79977606 < -79977606) || (-79977606 < -79977606)) || ((-79977606 + -79977606) < (-79977606 - 79977604)));
    lift_111 := arg_108;
    assert (((-161363470 - arg_107) - (-161363468 - arg_107)) == ((-161363468 - arg_107) + (-161363468 - arg_107)));
    lift_112 := lift_113;
    assert ((-685577873 + (-685577872 + 685577873)) < lift_115);
  }
}
...
method lift_45_0 (arg_48 : int, arg_49 : int)
  returns (arg_50 : int)
  requires (((arg_49 == 0) && ((arg_48 == 5) && true)))
  ensures (((arg_50 == 225055332) && true))
{
  arg_50 := 225055332;
  {
    var lift_59 := false;
    ...
    lift_58 := lift_55;
    assert (((757930959 - 2273792879) - (-757930960 + 757930959)) == ((0 - 757930959) + (-1 - 757930959)));
    assert (((arg_48 < arg_48) && (-1 == arg_48)) || ((-6 - 0) == (-1 - arg_48)));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    var lift_65 := lift_66;
    assert (((-161363470 - lift_29) - (-161363468 - lift_29)) == ((-161363468 - lift_29) + (-161363468 - lift_29)));
    if ((lift_65 !! lift_65 !! lift_68)) {
      ...
      {
        assert (((-2 - lift_116) == (-1 - lift_116)) || ((-1 - lift_116) == (-1 - 1264264106)));
        lift_118 := lift_118;
      }
      ...
      {
        assert (methoddefvar_47 == ((225055331 - 225055332) + (450110665 - methoddefvar_47)));
        assert (((-1 - 1123715806) == (-2 - -1)) || (lift_40 == (0 + 1123715805)));
      }
      assert (524324188 < 524324189);
    }
    ...
    {
      assert ((methoddefvar_145 + (-153886332 - methoddefvar_145)) == ((-307772662 - methoddefvar_145) + (-153886332 - methoddefvar_145)));
      assert (((1883462792 + 1883462793) - (1883462796 + 1883462792)) == ((1883462791 - 1883462792) + -2));
      assert (((990462795 < 990462795) || (990462795 < 990462795)) || ((-2 - 990462795) == (-1 - 990462796)));
    }
