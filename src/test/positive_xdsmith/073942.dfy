...
method lift_59_0 ()
  returns (arg_62 : int)
  requires (true)
  ensures (((arg_62 == 1272491805) && true))
{
  arg_62 := 1272491805;
  {
    var lift_65 := ();
    ...
    lift_63 := 79095491;
    assert (((-2544983614 + arg_62) - (-1272491808 + arg_62)) == ((1272491804 - arg_62) + (0 - arg_62)));
    assert (((-1150524694 - -1150524692) == (-1150524692 - -1150524690)) && ((-1150524692 == -1150524692) || (-1150524692 == -1150524692)));
    assert (((-1973098294 - lift_64) - (-845613554 - lift_64)) == ((-845613554 - lift_64) + (-845613554 - lift_64)));
    lift_65 := ();
  }
}
...
method lift_51_0 (arg_54 : int)
  returns (arg_55 : int)
  requires (((arg_54 == 23) && true))
  ensures (((arg_55 == -168340141) && true))
{
  arg_55 := -168340141;
  {
    var lift_56 := 34741753;
    assert ((lift_56 + (lift_56 - 69483511)) == ((34741754 - lift_56) + (34741747 - lift_56)));
  }
}

method lift_1_0 (arg_5 : int)
  returns (arg_6 : int, arg_7 : int)
  requires (((arg_5 == 1) && true))
  ensures (((arg_7 == 1733351550) && ((arg_6 == 1312621330) && true)))
{
  arg_6 := 1312621330;
  arg_7 := 1733351550;
  {
...
method Main () {
  ...
  );
  {
    ...
    var lift_83 := true;
    var lift_82 := lift_83;
    assert (((-3 + 2) < (lift_46.1 - 1027382723)) || (lift_46.1 == (3 - lift_46.1)));
    var methoddefvar_61 := lift_59_0();
    {
      ...
      assert (((-2544983614 + methoddefvar_61) - (-1272491808 + methoddefvar_61)) == ((1272491804 - methoddefvar_61) + (0 - methoddefvar_61)));
      lift_66 := (lift_67, lift_84, false);
      assert (((2 - 3) == (-168340141 + methoddefvar_53)) || ((-168340141 == methoddefvar_53) && (methoddefvar_53 == methoddefvar_53)));
