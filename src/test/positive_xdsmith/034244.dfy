...
method lift_376_0 (arg_379 : int)
  returns (arg_380 : int)
  requires (((arg_379 == 85) && true))
  ensures (((arg_380 == -1638133895) && true))
{
  arg_380 := -1638133895;
  {
    var lift_390 := 'G';
    ...
    lift_381 := lift_382;
    lift_383 := lift_383;
    assert (((arg_380 < 1638133897) && (arg_380 == arg_380)) || ((arg_380 == arg_380) && (arg_380 < 1638133897)));
    lift_390 := lift_390;
    assert (((arg_380 < 1638133897) && (arg_380 == arg_380)) || ((arg_380 == arg_380) && (arg_380 < 1638133897)));
  }
}
...
method lift_219_1 (arg_222 : int, arg_223 : int, arg_224 : int)
  returns (arg_225 : int)
  requires (((arg_224 == 5) && ((arg_223 == 398671956) && ((arg_222 == 911459884) && true))))
  ensures (((arg_225 == -242662653) && true))
{
  arg_225 := -242662653;
  {
    var lift_233 := arg_222;
    ...
    var lift_227 := 'U';
    var lift_226 := (lift_227, lift_228, lift_232);
    assert ((398671955 == (398671955 - arg_223)) || ((398671956 - -2) == (797343914 - arg_223)));
    assert (((arg_223 == arg_223) || (arg_223 == arg_223)) && ((398671955 - 398671957) < (398671955 - arg_223)));
    lift_226 := (lift_231, lift_228, lift_232);
  }
}
...
method lift_192_2 (arg_196 : int, arg_197 : int, arg_198 : int)
  returns (arg_199 : int, arg_200 : int)
  requires (((arg_198 == -838817062) && ((arg_197 == -273142889) && ((arg_196 == 752409162) && true))))
  ensures (((arg_200 == 1151575382) && ((arg_199 == -766403607) && true)))
{
  arg_199 := -766403607;
  arg_200 := 1151575382;
  {
...
method lift_69_0 (arg_73 : int, arg_74 : int)
  ...
  requires (((arg_74 == 398671956) && ((arg_73 == 398671956) && true)))
  ensures (((arg_76 == 1018611419) && ((arg_75 == -2011485522) && true)))
{
  arg_75 := -2011485522;
  arg_76 := 1018611419;
  {
    ...
    assert ((398671955 == (398671955 - arg_74)) || ((398671956 - -2) == (797343914 - arg_74)));
    lift_77 := lift_77;
    lift_83 := lift_83;
    lift_109 := arg_76;
  }
...
method lift_23_0 (arg_27 : int, arg_28 : int)
  ...
  requires (((arg_28 == 1163331262) && ((arg_27 == -683233590) && true)))
  ensures (((arg_30 == -1668338224) && ((arg_29 == -25696077) && true)))
{
  arg_29 := -25696077;
  arg_30 := -1668338224;
  {
...
method lift_1_0 (arg_4 : int, arg_5 : int)
  returns (arg_6 : int)
  requires (((arg_5 == 3) && ((arg_4 == 5) && true)))
  ensures (((arg_6 == 1808834909) && true))
{
  arg_6 := 1808834909;
  {
    var lift_12 := ();
    ...
    var lift_8 := {lift_9};
    var lift_7 := 2404578;
    assert (((2404575 == lift_7) && (lift_7 == lift_7)) || ((2404578 == lift_7) || (lift_7 == 2404578)));
    assert (((arg_6 == arg_6) || (arg_6 < arg_6)) && ((-1808834910 - arg_6) == (-5426504728 + arg_6)));
    assert (((1808834907 - 1808834909) == (-1808834908 + arg_6)) || ((arg_6 < arg_6) || (1808834907 < arg_6)));
    lift_8 := lift_10;
    assert (((lift_7 < lift_7) && (2404579 == lift_7)) || ((2404577 - 2404578) == (2404577 - lift_7)));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    {
      assert (((lift_20 < lift_20) && (lift_20 == lift_20)) || ((0 - lift_20) == (1 - 1163331263)));
    }
  }
  lift_45 := lift_52;
  {
    ...
    var lift_115 := (false, lift_64, lift_57);
    {
      ...
      var lift_112 := (lift_48, lift_113);
      {
        ...
        assert ((398671955 == (398671955 - lift_61)) || ((398671956 - -2) == (797343914 - lift_61)));
  ...
  if (lift_127().0(
    ...
    );
    {
      ...
      lift_265 := lift_265;
      {
        ...
        assert (((lift_254 + lift_254) + (-17216668 - -17216666)) < ((lift_254 - -17216665) + (-51650002 - lift_254)));
        lift_266 := lift_240;
        assert (((385288565 + -385288565) + -770577130) < ((385288565 - 770577130) + 385288565));
        lift_267 := lift_257;
        lift_270 := {
          lift_280,
      ...
      if (lift_253) {
        ...
        lift_303 := lift_304;
        assert (((lift_56 < lift_56) && (lift_56 == lift_56)) || ((1 < lift_56) || (lift_56 < lift_56)));
        lift_305 := lift_305;
      }
    }
    lift_306 := (lift_307(
  ...
  );
  {
    ...
    );
    {
      lift_509 := lift_509;
      lift_517 := lift_518;
      assert (((lift_364 == lift_364) && (1666560304 == lift_364)) && (lift_364 == (lift_364 - 0)));
    }
  }
}
