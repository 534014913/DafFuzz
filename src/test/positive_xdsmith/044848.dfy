  ...
  ensures (true)
{
  ...
  arg_136 := 971152150;
  {
    ...
    print "(params-for lift_128_0 arg_134 ", arg_134, ")\n";
    print "(meth-for lift_128_0)\n";
    {
      ...
      lift_149 := arg_133;
      print "(section 20 ", arg_132, "\n", ")\n";
      print "(section 21 ", arg_133, "\n", ")\n";
    }
    print "(rets-for lift_128_0 arg_135 ", arg_135, ")\n";
    print "(rets-for lift_128_0 arg_136 ", arg_136, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_125 := -205896820;
  {
    print "(meth-for lift_122_0)\n";
    {
      ...
      print "(section 16 ", arg_125, "\n", ")\n";
      lift_126 := lift_126;
      print "(section 17 ", arg_125, "\n", ")\n";
      print "(section 18 ", arg_125, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_35 := 2052498255;
  {
    ...
    print "(meth-for lift_30_0)\n";
    {
      ...
      var lift_36 := ();
      lift_36 := ();
      print "(section 14 ", arg_35, "\n", ")\n";
      lift_37 := lift_37;
      print "(section 15 ", lift_38, "\n", ")\n";
    }
...
method Main () {
  ...
  );
  {
    ...
    print "(section 0 ", lift_43.2, "\n", ")\n";
    {
      ...
      if (lift_17) {
        ...
        print "(section 2 ", methoddefvar_32, "\n", ")\n";
      }
      if (lift_42) {
  ...
  print "(section 6 ", (lift_63.2.1 as int), "\n", ")\n";
  if ((multiset(lift_98(lift_103)) in safeSeqTake(
    ...
    var methoddefvar_124 := lift_122_0();
    {
      ...
      }
      {
        ...
        print "(section 10 ", 1956683857, "\n", ")\n";
        print "(section 11 ", lift_80, "\n", ")\n";
      }
      print "(section 12 ", lift_118, "\n", ")\n";
      lift_152 := lift_153;
    }
    ...
    print 
      "(section 13 ",
      (multiset{(), lift_192, lift_192, lift_1, lift_193}[lift_195.2] as int),
      "\n",
      ")\n";
  } else {
