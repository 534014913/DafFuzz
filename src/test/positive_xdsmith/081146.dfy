...
method Main () {
  ...
  );
  {
    ...
    print 
      "(section 0 ",
      safeSeqRef(lift_112, lift_135, -800594892),
      "\n",
      ")\n";
    var methoddefvar_199 := lift_184_1(lift_93, 1090124954);
    {
      print "(section 1 ", 13276044, "\n", ")\n";
    }
    {
      if (false) {
        lift_200 := lift_200;
      } else {
        print "(section 2 ", lift_143, "\n", ")\n";
