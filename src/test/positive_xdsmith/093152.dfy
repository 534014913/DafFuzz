...
method lift_39_0 (arg_43 : int)
  ...
  requires (((arg_43 == 1480870872) && true))
  ensures (((arg_45 == 1086081452) && ((arg_44 == -1222813420) && true)))
{
  arg_44 := -1222813420;
  arg_45 := 1086081452;
  {
    ...
    var lift_46 := ();
    lift_46 := lift_47;
    assert (((1086081451 - arg_45) == (1086081451 - 1086081452)) || ((1086081450 - arg_45) == (1086081451 - arg_45)));
    assert (((332953150 - 332953149) == 1) && ((332953149 == 332953149) || (332953149 < 332953151)));
...
method lift_1_0 (arg_4 : int, arg_5 : int)
  returns (arg_6 : int)
  requires (((arg_5 == 1268200067) && ((arg_4 == -609583409) && true)))
  ensures (((arg_6 == 1480870872) && true))
{
  arg_6 := 1480870872;
  {
    var lift_26 := 'A';
...
method Main () {
  ...
  var methoddefvar_3 := lift_1_0(lift_27(lift_33).0, lift_34.0);
  {
    ...
    {
      lift_58 := lift_58;
      assert (methoddefvar_42 == 1086081452);
    }
    assert (((safeSeqRef(lift_59, lift_60, 1541163856) + safeSeqRef(
      lift_59,
      lift_60,
      1541163856
    )) + (-1541163857 - safeSeqRef(
      lift_59,
      lift_60,
      1541163856
    ))) < ((safeSeqRef(lift_59, lift_60, 1541163856) - 3082327712) + safeSeqRef(
      lift_59,
      lift_60,
      1541163856
    )));
    {
      ...
      if (true) {
        ...
        lift_61 := lift_63;
        lift_65 := lift_65;
        assert (((lift_37 == lift_37) || (lift_37 < lift_37)) && ((-190998501 - lift_37) == (-572995501 + lift_37)));
        lift_66 := lift_66;
      } else {
        assert false;
        assert false;
