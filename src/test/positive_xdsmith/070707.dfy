...
method lift_211_0 (arg_215 : int, arg_216 : int)
  ...
  requires (((arg_216 == -983081232) && ((arg_215 == -1746580856) && true)))
  ensures (((arg_218 == -1219210768) && ((arg_217 == -1390020668) && true)))
{
  arg_217 := -1390020668;
  arg_218 := -1219210768;
  {
    ...
    var lift_219 := true;
    lift_219 := lift_219;
    assert (((-1219210768 - arg_218) == (1219210768 + -1219210768)) && ((-3657632307 - arg_218) < (-3657632306 - arg_218)));
    lift_220 := lift_220;
  }
}
...
method lift_166_0 (arg_169 : int)
  returns (arg_170 : int)
  requires (((arg_169 == -297892388) && true))
  ensures (((arg_170 == 568839157) && true))
{
  arg_170 := 568839157;
  {
    var lift_201 := '$';
    ...
    lift_171 := lift_193;
    lift_201 := lift_191;
    assert (((arg_170 + arg_170) + (-568839158 - arg_170)) < ((arg_170 - 1137678314) + arg_170));
    assert (((-2363670340 + lift_178) - (-472734068 + lift_178)) == ((-472734069 - lift_178) + (-472734069 - lift_178)));
    assert (((arg_169 - 3) + 1) == ((arg_169 - 1) + (-297892389 - arg_169)));
  }
}

method lift_138_0 (arg_141 : int, arg_142 : int)
  returns (arg_143 : int)
  requires (((arg_142 == 0) && ((arg_141 == -81734547) && true)))
  ensures (((arg_143 == -472026986) && true))
{
  arg_143 := -472026986;
  {
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_168 := lift_166_0(lift_103);
    {
      lift_202 := lift_21;
      lift_203 := lift_204;
      assert (((lift_62 + lift_62) + (1027899586 + lift_62)) < ((-1027899585 - -1) + lift_62));
    }
  }
  ...
  );
  {
    ...
    assert (((lift_241.2 + lift_241.2) + (-2054160638 - lift_241.2)) < ((lift_241.2 + lift_241.2) - (2054160635 + 2054160635)));
