  ...
  ensures (true)
{
  ...
  arg_428 := 65635002;
  {
    ...
    print "(rets-for lift_422_0 arg_428 ", arg_428, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_344 := 1389452061;
  {
    print "(meth-for lift_339_0)\n";
    {
      ...
      lift_345 := arg_343;
      print "(section 53 ", 351411862, "\n", ")\n";
      print "(section 54 ", arg_344, "\n", ")\n";
      lift_346 := lift_346;
      print "(section 55 ", arg_344, "\n", ")\n";
    }
  ...
  ensures (true)
{
  ...
  arg_344 := 1389452061;
  {
    print "(meth-for lift_339_1)\n";
    {
      ...
      var lift_345 := arg_344;
      lift_345 := arg_343;
      print "(section 50 ", 351411862, "\n", ")\n";
      print "(section 51 ", arg_344, "\n", ")\n";
      lift_346 := lift_346;
      print "(section 52 ", arg_344, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_332 := 385926015;
  {
    ...
    print "(rets-for lift_328_0 arg_332 ", arg_332, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_332 := 385926015;
  {
    print "(params-for lift_328_1 arg_331 ", arg_331, ")\n";
    print "(meth-for lift_328_1)\n";
    {
      var lift_333 := -975582144;
      print "(section 46 ", lift_333, "\n", ")\n";
      print "(section 47 ", lift_333, "\n", ")\n";
    }
    print "(rets-for lift_328_1 arg_332 ", arg_332, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_332 := 385926015;
  {
    print "(params-for lift_328_2 arg_331 ", arg_331, ")\n";
    print "(meth-for lift_328_2)\n";
    {
      var lift_333 := -975582144;
      print "(section 44 ", lift_333, "\n", ")\n";
      print "(section 45 ", lift_333, "\n", ")\n";
    }
    print "(rets-for lift_328_2 arg_332 ", arg_332, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_273 := 2078989296;
  {
    ...
    print "(rets-for lift_266_0 arg_273 ", arg_273, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_254 := -404851820;
  {
    ...
    print "(rets-for lift_251_0 arg_254 ", arg_254, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_191 := -592601657;
  {
    ...
    print "(params-for lift_183_1 arg_189 ", arg_189, ")\n";
    print "(meth-for lift_183_1)\n";
    {
      var lift_192 := '/';
      lift_192 := lift_192;
      print "(section 40 ", arg_189, "\n", ")\n";
    }
    print "(rets-for lift_183_1 arg_190 ", arg_190, ")\n";
    print "(rets-for lift_183_1 arg_191 ", arg_191, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_130 := -1987473316;
  {
    ...
    print "(meth-for lift_124_0)\n";
    {
      ...
      print "(section 38 ", lift_131, "\n", ")\n";
      print "(section 39 ", 1707589537, "\n", ")\n";
      lift_132 := lift_132;
      lift_133 := lift_133;
    }
  ...
  ensures (true)
{
  ...
  arg_130 := -1987473316;
  {
    ...
    print "(meth-for lift_124_1)\n";
    {
      ...
      var lift_132 := ();
      var lift_131 := -1004354536;
      print "(section 36 ", lift_131, "\n", ")\n";
      print "(section 37 ", 1707589537, "\n", ")\n";
      lift_132 := lift_132;
      lift_133 := lift_133;
    }
    print "(rets-for lift_124_1 arg_129 ", arg_129, ")\n";
    print "(rets-for lift_124_1 arg_130 ", arg_130, ")\n";
  }
}
...
method Main () {
  ...
  if ((safeSeqRef(
    ...
    print 
      "(section 0 ",
      (multiset{(), lift_67, lift_68, lift_68, lift_69}[lift_70] as int),
      "\n",
      ")\n";
    {
      print "(section 1 ", lift_71.0, "\n", ")\n";
    }
  } else {
    ...
    if ((({
      ...
      print "(section 3 ", (lift_91 as int), "\n", ")\n";
    }
    print "(section 4 ", lift_92.0(), "\n", ")\n";
    {
  ...
  if ((lift_42.0.2 <= lift_52.1.1)) {
    ...
    );
    {
      var lift_281 := ();
      {
        print "(section 17 ", methoddefvar_268, "\n", ")\n";
      }
    ...
    print "(section 18 ", (('H', lift_14).1[|lift_14|] as int), "\n", ")\n";
  } else {
    ...
    var methoddefvar_354, methoddefvar_355 := lift_339_1();
    {
      ...
      var methoddefvar_356 := lift_328_1(lift_34);
      {
        ...
        print "(section 21 ", lift_106, "\n", ")\n";
        print "(section 22 ", lift_122, "\n", ")\n";
        lift_357 := {lift_360, lift_382, lift_359, ((), lift_367, lift_376)};
        lift_384 := lift_384;
        lift_389 := lift_389;
      }
      print "(section 23 ", 2095446728, "\n", ")\n";
      {
        lift_410 := lift_410;
        lift_411 := lift_197;
        print "(section 24 ", lift_388, "\n", ")\n";
        print "(section 25 ", lift_288, "\n", ")\n";
        lift_412 := 1308079534;
      }
      if (lift_60) {
        print "(section 26 ", -1237130500, "\n", ")\n";
        print "(section 27 ", methoddefvar_354, "\n", ")\n";
      } else {
        var lift_420 := lift_421;
        print "(section 28 ", lift_34, "\n", ")\n";
        lift_413 := lift_413;
        lift_420 := lift_421;
      }
    }
    {
      ...
      {
        print "(section 29 ", lift_370, "\n", ")\n";
      }
      print 
        "(section 30 ",
        ((var tmpData : multiset<(char, int, int)> := multiset{}; tmpData)[lift_120] as int),
        "\n",
        ")\n";
      var methoddefvar_431 := lift_328_2(lift_122);
      {
        print "(section 31 ", 1341414120, "\n", ")\n";
      }
      print "(section 32 ", (lift_395 as int), "\n", ")\n";
      {
        var lift_435 := ();
        var methoddefvar_432, methoddefvar_433 := lift_124_1(lift_260);
        {
          ...
          lift_435 := lift_178;
          lift_436 := lift_437;
          print "(section 33 ", lift_404, "\n", ")\n";
          lift_447 := -1753116014;
        }
      }
    }
    print "(section 34 ", lift_105, "\n", ")\n";
  }
}
