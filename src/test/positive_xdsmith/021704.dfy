  ...
  ensures (true)
{
  arg_448 := 696453131;
  {
    ...
    print "(meth-for lift_444_0)\n";
    {
      ...
      lift_449 := lift_449;
      print "(section 60 ", lift_455, "\n", ")\n";
      print "(section 61 ", arg_447, "\n", ")\n";
      print "(section 62 ", -482211941, "\n", ")\n";
      lift_456 := lift_456;
    }
  ...
  ensures (true)
{
  arg_379 := 301720224;
  {
    ...
    print "(meth-for lift_375_0)\n";
    {
      ...
      lift_380 := lift_380;
      print "(section 58 ", arg_379, "\n", ")\n";
      print "(section 59 ", arg_378, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_379 := 301720224;
  {
    ...
    print "(meth-for lift_375_1)\n";
    {
      ...
      var lift_380 := multiset{-798116776, lift_381, lift_382};
      lift_380 := lift_380;
      print "(section 56 ", arg_379, "\n", ")\n";
      print "(section 57 ", arg_378, "\n", ")\n";
    }
  ...
  ensures (true)
{
  arg_311 := -234332788;
  {
    ...
    print "(meth-for lift_305_0)\n";
    {
      ...
      print "(section 53 ", arg_310, "\n", ")\n";
      lift_312 := arg_309;
      print "(section 54 ", -1475106565, "\n", ")\n";
      lift_313 := lift_315;
    }
  ...
  ensures (true)
{
  arg_311 := -234332788;
  {
    ...
    print "(meth-for lift_305_1)\n";
    {
      ...
      var lift_313 := ('e', lift_314);
      var lift_312 := 1138987405;
      print "(section 51 ", arg_310, "\n", ")\n";
      lift_312 := arg_309;
      print "(section 52 ", -1475106565, "\n", ")\n";
      lift_313 := lift_315;
    }
  ...
  ensures (true)
{
  ...
  arg_247 := 1685942578;
  {
    ...
    print "(rets-for lift_242_0 arg_246 ", arg_246, ")\n";
  ...
  ensures (true)
{
  arg_164 := 1967667155;
  {
    ...
    {
      print "(section 49 ", arg_164, "\n", ")\n";
    }
    print "(rets-for lift_161_0 arg_164 ", arg_164, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_164 := 1967667155;
  {
    ...
    {
      print "(section 48 ", arg_164, "\n", ")\n";
    }
    print "(rets-for lift_161_1 arg_164 ", arg_164, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_149 := -1610533514;
  {
    ...
    {
      var lift_150 := 't';
      print "(section 44 ", arg_149, "\n", ")\n";
      print "(section 45 ", arg_149, "\n", ")\n";
      lift_150 := '-';
    }
  ...
  ensures (true)
{
  ...
  arg_149 := -1610533514;
  {
    ...
    {
      var lift_150 := 't';
      print "(section 42 ", arg_149, "\n", ")\n";
      print "(section 43 ", arg_149, "\n", ")\n";
      lift_150 := '-';
    }
    print "(rets-for lift_144_1 arg_148 ", arg_148, ")\n";
    print "(rets-for lift_144_1 arg_149 ", arg_149, ")\n";
  }
}
  ...
  ensures (true)
{
  ...
  arg_149 := -1610533514;
  {
    ...
    {
      var lift_150 := 't';
      print "(section 40 ", arg_149, "\n", ")\n";
      print "(section 41 ", arg_149, "\n", ")\n";
      lift_150 := '-';
    }
    print "(rets-for lift_144_2 arg_148 ", arg_148, ")\n";
    print "(rets-for lift_144_2 arg_149 ", arg_149, ")\n";
  }
}
...
method Main () {
  ...
  ) !in safeSeqRef(lift_66, lift_84, lift_79).0);
  {
    ...
    );
    {
      ...
      if (false) {
        print "(section 1 ", lift_75, "\n", ")\n";
        print "(section 2 ", lift_52, "\n", ")\n";
      } else {
        print "(section 3 ", -1997144776, "\n", ")\n";
        lift_112 := lift_117;
        print "(section 4 ", methoddefvar_88, "\n", ")\n";
    ...
    if (safeSeqRef(lift_118, -2063594386, lift_121).1) {
      ...
      );
      {
        ...
        print "(section 8 ", methoddefvar_132, "\n", ")\n";
      }
    } else {
      ...
      var methoddefvar_146, methoddefvar_147 := lift_144_0();
      {
        ...
        print "(section 11 ", lift_84, "\n", ")\n";
      }
      var methoddefvar_154 := lift_152_0(lift_75, lift_85);
      {
        lift_159 := lift_25;
        lift_160 := lift_26;
        print "(section 12 ", methoddefvar_154, "\n", ")\n";
      }
    ...
    );
    {
      ...
      {
        print "(section 18 ", methoddefvar_225, "\n", ")\n";
        print "(section 19 ", lift_295, "\n", ")\n";
      }
      var methoddefvar_299, methoddefvar_300 := lift_144_1();
      {
        lift_301 := lift_115;
        print "(section 20 ", -301049022, "\n", ")\n";
      }
      print "(section 21 ", lift_236, "\n", ")\n";
    }
    var methoddefvar_307 := lift_305_0(|lift_67|, |lift_320|, lift_323.2);
    {
      var lift_329 := lift_159;
      {
        ...
        lift_326 := lift_327;
        lift_329 := lift_330;
        print "(section 22 ", lift_296, "\n", ")\n";
        print "(section 23 ", lift_75, "\n", ")\n";
        lift_331 := lift_332;
      }
      if (lift_174) {
      ...
      print "(section 26 ", methoddefvar_307, "\n", ")\n";
      var methoddefvar_337 := lift_152_1(lift_63, 1363611227);
      {
        print "(section 27 ", lift_296, "\n", ")\n";
      }
    }
  }
  {
    ...
    var lift_342 := ();
    {
      ...
      var lift_363 := ();
      print "(section 28 ", (lift_282[lift_286] as int), "\n", ")\n";
      if ((lift_65 > lift_65)) {
        var lift_365 := 2140821700;
        lift_338 := 'g';
        var methoddefvar_340, methoddefvar_341 := lift_144_2();
        {
          print "(section 29 ", lift_58, "\n", ")\n";
          print "(section 30 ", lift_170, "\n", ")\n";
        }
        if (lift_129) {
          lift_342 := ();
        } else {
        ...
        );
        {
          ...
          lift_365 := 188328435;
          lift_366 := lift_367;
          print "(section 31 ", methoddefvar_347, "\n", ")\n";
        }
        lift_368 := lift_52;
      } else {
      ...
      if ((lift_52 < lift_368)) {
        var lift_413 := {lift_284, lift_286};
        {
          ...
          print "(section 34 ", lift_296, "\n", ")\n";
          lift_371 := lift_371;
        }
        var methoddefvar_372 := lift_161_1();
        {
          print "(section 35 ", 1683065784, "\n", ")\n";
          lift_373 := lift_200;
        }
        lift_374 := lift_35;
    ...
    print 
      "(section 36 ",
      |(lift_426 * lift_429 * (var tmpData : set<(char, (int, int, char))> := {}; tmpData))|,
      "\n",
      ")\n";
