...
method lift_247_0 ()
  ...
  requires (true)
  ensures (((arg_252 == -1802774159) && ((arg_251 == 1581117642) && true)))
{
  arg_251 := 1581117642;
  arg_252 := -1802774159;
  {
...
method Main () {
  ...
  assert (((0 - 1960837640) - (-653612546 + lift_1.0)) == ((lift_1.0 - 1) + (-653612547 - lift_1.0)));
  {
    ...
    if ((({lift_3, lift_3, lift_15} - lift_20) !! (lift_21 * {
      ...
      if ((
        ...
        {
          lift_53 := lift_47;
          assert (((lift_34 == lift_34) || (lift_34 < lift_34)) && ((-2113677970 + -2113677969) < lift_34));
        }
        assert (((-1307050647 - lift_13) < (-1307050646 - -435683548)) && ((lift_13 == lift_13) || (lift_13 == lift_13)));
        assert (((lift_24 < 24613241) && (lift_24 == lift_24)) || (1 == (lift_24 - lift_24)));
        lift_54 := lift_54;
      }
    } else {
      var lift_96 := lift_97;
    ...
    if (((lift_19 !in (var tmpData : seq<int> := []; tmpData)) <==> (lift_80 < lift_56 < lift_80) <==> (
      ...
      if ((lift_41 || lift_45)) {
        ...
        if (lift_31) {
          ...
          lift_231 := lift_231;
          assert (((-1252962570 - lift_25) - (-2505925141 - lift_25)) == (2 + (0 - lift_25)));
        }
      }
    }
  }
  {
    ...
    var methoddefvar_249, methoddefvar_250 := lift_247_0();
    {
      ...
      lift_270 := lift_43;
      assert ((lift_195 + (-3373387224 - -1686693612)) == ((-5060080835 - lift_195) + (-1686693613 - lift_195)));
