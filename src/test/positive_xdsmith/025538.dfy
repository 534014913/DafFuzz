  ...
  ensures (true)
{
  arg_111 := -1289097201;
  {
    ...
    print "(rets-for lift_108_0 arg_111 ", arg_111, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_111 := -1289097201;
  {
    print "(meth-for lift_108_1)\n";
    {
      var lift_113 := true;
      var lift_112 := [lift_113, lift_113, lift_113];
      print "(section 22 ", arg_111, "\n", ")\n";
      lift_112 := lift_112;
    }
    print "(rets-for lift_108_1 arg_111 ", arg_111, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_111 := -1289097201;
  {
    ...
    print "(rets-for lift_108_2 arg_111 ", arg_111, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_51 := -216110708;
  {
    print "(meth-for lift_48_0)\n";
    {
      ...
      var lift_53 := lift_54;
      var lift_52 := 'w';
      print "(section 18 ", 360505230, "\n", ")\n";
      lift_52 := 'k';
      lift_53 := lift_53;
    }
    print "(rets-for lift_48_0 arg_51 ", arg_51, ")\n";
  }
}
  ...
  ensures (true)
{
  arg_51 := -216110708;
  {
    print "(meth-for lift_48_1)\n";
    {
      ...
      var lift_53 := lift_54;
      var lift_52 := 'w';
      print "(section 17 ", 360505230, "\n", ")\n";
      lift_52 := 'k';
      lift_53 := lift_53;
    }
    print "(rets-for lift_48_1 arg_51 ", arg_51, ")\n";
  }
}
...
method Main () {
  ...
  );
  {
    ...
    {
      print "(section 0 ", 1028493847, "\n", ")\n";
      lift_56 := lift_61;
    }
    {
      {
        print "(section 1 ", lift_59, "\n", ")\n";
        lift_62 := lift_63;
  ...
  }
  {
    ...
    }
    {
      ...
      if ((lift_46 > lift_42 >= lift_46)) {
        ...
        {
          print "(section 7 ", 246172550, "\n", ")\n";
        }
        if (lift_36) {
          var lift_132 := '>';
          print "(section 8 ", lift_47, "\n", ")\n";
          print "(section 9 ", lift_42, "\n", ")\n";
          lift_123 := lift_124;
          lift_132 := lift_131;
          lift_133 := lift_133;
        } else {
  ...
  {
    print "(section 15 ", (lift_74 as int), "\n", ")\n";
  }
  lift_215 := lift_246.2(
    (lift_66 || lift_66),
    (lift_66 && lift_236),
