...
method lift_58_0 (arg_62 : int, arg_63 : int, arg_64 : int)
  ...
  requires (((arg_64 == -1660363400) && ((arg_63 == -1660363400) && ((arg_62 == 53263988) && true))))
  ensures (((arg_66 == 1797418501) && ((arg_65 == 1312577465) && true)))
{
  arg_65 := 1312577465;
  arg_66 := 1797418501;
  {
    ...
    assert (1797418504 == ((1797418502 + 1797418503) - arg_66));
    lift_67 := lift_75;
    assert (((arg_65 == 1312577465) && (2 < arg_65)) || ((arg_65 < arg_65) || (arg_65 < arg_65)));
    assert (((-725201537 == -725201537) || (-725201537 == -725201537)) && ((-725201537 + -725201537) < (-2175604605 - -725201537)));
    lift_79 := '&';
  }
}
...
method lift_51_0 (arg_54 : int, arg_55 : int)
  returns (arg_56 : int)
  requires (((arg_55 == 4) && ((arg_54 == 34) && true)))
  ensures (((arg_56 == 398930017) && true))
{
  arg_56 := 398930017;
  {
    var lift_57 := 'Q';
    assert (((-84427435 + 84427434) + (-1 - 84427434)) < ((84427434 - 84427435) + (-1 - 0)));
    lift_57 := lift_57;
    assert (((-172 - arg_54) - (-35 - arg_54)) == ((arg_54 - 104) - (-35 - arg_54)));
  }
}
