...
method lift_49_0 (arg_52 : int, arg_53 : int)
  returns (arg_54 : int)
  requires (((arg_53 == 421602306) && ((arg_52 == 421602306) && true)))
  ensures (((arg_54 == 1655834473) && true))
{
  arg_54 := 1655834473;
  {
    var lift_64 := 'Y';
    ...
    var lift_55 := 'c';
    assert ((arg_54 < (arg_54 + arg_54)) || (-1 == (arg_54 - 2)));
    lift_55 := lift_55;
    lift_56 := lift_61;
  }
}
...
method lift_30_0 (arg_34 : int, arg_35 : int)
  ...
  requires (((arg_35 == 112) && ((arg_34 == -398523792) && true)))
  ensures (((arg_37 == 288551565) && ((arg_36 == -1292098796) && true)))
{
  arg_36 := -1292098796;
  arg_37 := 288551565;
  {
  ...
  ))));
  {
    ...
    );
    {
      ...
      var methoddefvar_51 := lift_49_0(lift_20, lift_20);
      {
        ...
        assert ((0 == (398523791 + -398523792)) || (lift_43 < -398523792));
      }
      if (lift_69) {
        ...
        assert (((-498968404 + -498968404) + (-498968405 - -498968404)) < ((-498968404 - -498968405) + -498968404));
      }
      if (lift_48) {
        ...
        assert ((-476327572 + lift_7) < ((lift_7 + lift_7) - 952655142));
        assert ((lift_43 + (0 - 1)) == ((-398523793 - lift_43) + lift_43));
        assert ((lift_43 + (0 - 1)) == ((-398523793 - lift_43) + lift_43));
        assert (((-3876296387 == methoddefvar_32) && (-1292098796 == methoddefvar_32)) || ((-3876296388 - methoddefvar_32) == (-3876296388 - -1292098796)));
      }
    }
  }
}
