...
method lift_91_0 (arg_94 : int, arg_95 : int)
  returns (arg_96 : int)
  requires (((arg_95 == -396487903) && ((arg_94 == -1843605846) && true)))
  ensures (((arg_96 == -377061592) && true))
{
  arg_96 := -377061592;
  {
    var lift_105 := 'f';
    ...
    assert (((-617535492 - lift_97) - (-411690325 - lift_97)) == (lift_97 + (-205845167 - -205845166)));
    assert (((1843605845 + arg_94) == 2) || ((1843605847 + arg_94) == (-1843605845 - arg_94)));
    lift_98 := lift_104;
  }
}
...
method lift_41_0 (arg_45 : int, arg_46 : int)
  ...
  requires (((arg_46 == -421909972) && ((arg_45 == 0) && true)))
  ensures (((arg_48 == -990265562) && ((arg_47 == -396487903) && true)))
{
  arg_47 := -396487903;
  arg_48 := -990265562;
  {
    ...
    assert (0 == (arg_47 - (-792975806 - arg_47)));
    assert (((-2118161597 == -2118161594) || (-2118161594 < -2118161594)) || ((-2118161594 == -2118161594) && (-2118161594 == -2118161594)));
    assert (((-5 - arg_45) - (-3 - arg_45)) < (arg_45 + (-3 - -2)));
    lift_49 := lift_49;
  }
}
...
method Main () {
  ...
  assert (((331 - lift_1) - (110 + lift_1)) == (-222 + (333 - lift_1)));
  lift_3 := safeSeqRef(
