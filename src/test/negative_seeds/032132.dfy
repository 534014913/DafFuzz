...
method lift_247_0 (arg_250 : int, arg_251 : int)
  returns (arg_252 : int)
  requires (((arg_251 == -17187982) && ((arg_250 == -386769617) && true)))
  ensures (((arg_252 == -1787994423) && true))
{
  arg_252 := -1787994423;
  {
    var lift_253 := 'y';
...
method lift_219_0 ()
  returns (arg_222 : int)
  requires (true)
  ensures (((arg_222 == 752865894) && true))
{
  arg_222 := 752865894;
  {
    var lift_244 := ();
    ...
    assert (((arg_222 - 2258597683) + 1505731790) < 2);
    lift_223 := lift_224;
    lift_225 := (lift_224, lift_232, lift_228);
    assert ((lift_235 - (lift_235 + lift_235)) == -290527779);
    lift_236 := lift_237;
  }
}
...
method lift_176_0 (arg_179 : int, arg_180 : int)
  returns (arg_181 : int)
  requires (((arg_180 == 3) && ((arg_179 == -999576816) && true)))
  ensures (((arg_181 == -1290255513) && true))
{
  arg_181 := -1290255513;
  {
    ...
    lift_182 := -82884105;
    assert (((-43742982 + 43742976) - (43742977 - 43742976)) < ((43742974 - 43742976) - (43742975 - 43742976)));
    lift_183 := lift_189;
    assert (((lift_195 + lift_195) - (-313344123 + lift_195)) == ((-940032368 - lift_195) + (313344126 - -313344121)));
  }
}
  ...
  ensures (false)
{
  ...
  arg_106 := 342020235;
  {
    ...
    var lift_112 := '+';
    var lift_111 := multiset{lift_112, lift_112, lift_112, lift_113, lift_112};
...
method Main () {
  ...
  if ((((lift_13 == lift_31 == lift_13) in lift_34) || (({
    ...
    );
    {
      ...
      if (lift_48) {
        assert (-1290255514 < methoddefvar_178);
        lift_211 := lift_42;
        assert (((lift_168 == lift_168) && (lift_168 == lift_168)) && ((-1 - lift_168) == (-1095408537 - 0)));
        lift_214 := lift_90;
        lift_215 := lift_207;
      } else {
        assert false;
      ...
      assert ((2190817072 == (lift_168 + lift_168)) || ((lift_168 + lift_168) < (lift_168 - 1095408537)));
      lift_218 := lift_128;
      var methoddefvar_221 := lift_219_0();
      {
        lift_245 := lift_31;
        assert (((methoddefvar_221 - 2258597683) + 1505731790) < 2);
        lift_246 := lift_99;
      }
      var methoddefvar_249 := lift_247_0(lift_5, -17187982);
      {
        lift_254 := lift_205;
        assert (((-289784168 - lift_130) < (-289784167 - lift_130)) && ((-289784165 - -289784166) == (-289784165 - lift_130)));
        assert (((lift_152 == -1055323671) || (lift_152 < -1055323670)) || (lift_152 < (-1055323670 - 0)));
      }
    }
  }
  {
