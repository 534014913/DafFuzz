...
method lift_534_0 (arg_538 : int)
  ...
  requires (((arg_538 == -292753745) && true))
  ensures (((arg_540 == 1013232235) && ((arg_539 == -2123163582) && true)))
{
  arg_539 := -2123163582;
  arg_540 := 1013232235;
  {
...
method lift_438_1 ()
  returns (arg_441 : int)
  requires (true)
  ensures (((arg_441 == -291635156) && true))
{
  arg_441 := -291635156;
  {
    var lift_488 := (var tmpData : set<set<set<char>>> := {}; tmpData);
    ...
    var lift_442 := (lift_443, lift_450, lift_452);
    lift_442 := lift_455;
    assert (((-1 - lift_467) - (597040172 + lift_467)) == ((lift_467 - lift_467) + (-1194080344 - lift_467)));
    lift_469 := lift_473;
    lift_474 := (lift_476, false, lift_478);
    lift_480 := ([lift_475, lift_485, lift_476], lift_487);
  }
...
method lift_363_1 (arg_366 : int)
  returns (arg_367 : int)
  requires (((arg_366 == -1798712858) && true))
  ensures (((arg_367 == 1310361264) && true))
{
  arg_367 := 1310361264;
  {
    var lift_391 := false;
...
method lift_225_0 ()
  ...
  requires (true)
  ensures (((arg_230 == -153715011) && ((arg_229 == 1885014125) && true)))
{
  arg_229 := 1885014125;
  arg_230 := -153715011;
  {
...
method lift_183_0 (arg_186 : int, arg_187 : int, arg_188 : int)
  returns (arg_189 : int)
  requires (((arg_188 == 1360337711) && ((arg_187 == 1714830968) && ((arg_186 == 1053264527) && true))))
  ensures (((arg_189 == 1903015248) && true))
{
  arg_189 := 1903015248;
  {
    assert (((arg_186 + arg_186) + (-1053264528 - arg_186)) < ((arg_186 - 2106529054) + arg_186));
    assert (((arg_187 - 1) + (-1 - arg_187)) == ((-2 - 1714830968) + arg_187));
  }
}
...
method lift_169_1 (arg_173 : int, arg_174 : int)
  returns (arg_175 : int, arg_176 : int)
  requires (((arg_174 == -800196296) && ((arg_173 == -292753745) && true)))
  ensures (((arg_176 == 1900135019) && ((arg_175 == 1807410623) && true)))
{
  arg_175 := 1807410623;
  arg_176 := 1900135019;
  {
    ...
    var lift_178 := lift_179;
    var lift_177 := lift_178;
    assert (((arg_176 + arg_176) + (-1900135020 - arg_176)) < ((arg_176 - 3800270038) + arg_176));
    assert (((-712430507 - 712430507) == (712430507 - 2137291521)) && ((-2137291522 - 712430507) < (-712430507 - 712430507)));
    assert ((-2124888514 + (-8499554060 - -2124888514)) == ((-6374665544 - -2124888514) + (-6374665544 - -2124888514)));
    lift_177 := lift_177;
  }
}
...
method lift_55_0 (arg_58 : int, arg_59 : int)
  returns (arg_60 : int)
  requires (((arg_59 == 1053264527) && ((arg_58 == 944316866) && true)))
  ensures (((arg_60 == -504747768) && true))
{
  arg_60 := -504747768;
  {
    var lift_93 := 'q';
    ...
    assert (((1053264526 - arg_59) == (1053264526 - 1053264527)) || ((1053264527 - 1053264529) < (1053264527 - 1053264529)));
    lift_61 := (
      lift_76,
      {
...
method lift_40_1 (arg_44 : int)
  returns (arg_45 : int, arg_46 : int)
  requires (((arg_44 == 1053264527) && true))
  ensures (((arg_46 == -66246622) && ((arg_45 == 911885445) && true)))
{
  arg_45 := 911885445;
  arg_46 := -66246622;
  {
    ...
    var lift_47 := ();
    lift_47 := lift_47;
    assert (((-911885450 + arg_45) - (-911885448 + arg_45)) == ((911885444 - arg_45) + (911885444 - arg_45)));
    lift_48 := lift_47;
  }
}
...
method lift_1_0 (arg_5 : int, arg_6 : int)
  ...
  requires (((arg_6 == 1053264527) && ((arg_5 == 146095082) && true)))
  ensures (((arg_8 == -541900248) && ((arg_7 == -810154980) && true)))
{
  arg_7 := -810154980;
  arg_8 := -541900248;
  {
    var lift_9 := (var tmpData : seq<(char, char)> := []; tmpData);
    assert (((1053264526 - arg_6) == (1053264526 - 1053264527)) || ((1053264527 - 1053264529) < (1053264527 - 1053264529)));
    assert (((arg_8 == arg_8) || (arg_8 < arg_8)) && ((arg_8 + arg_8) == (-1625700744 - -541900248)));
    lift_9 := lift_9;
  }
}
...
method Main () {
  ...
  );
  {
    ...
    var methoddefvar_133, methoddefvar_134 := lift_40_1(lift_13);
    {
      lift_135 := lift_135;
      lift_138 := lift_138;
      assert (((-489125247 + 489125242) - (-489125245 + 489125242)) == ((489125241 - 489125242) + (489125241 - 489125242)));
      assert (((1053264526 - lift_14) == (1053264526 - 1053264527)) || ((1053264527 - 1053264529) < (1053264527 - 1053264529)));
      assert (((-1875461538 - lift_120) < (-1875461538 - lift_120)) || ((-1875461537 - lift_120) == (lift_120 - lift_120)));
    }
    lift_139 := lift_108.2;
  }
  if (safeSeqRef(
    ...
    var lift_151 := {lift_152, lift_152, (lift_153, ('t', lift_157), lift_150)};
    {
      ...
      assert (((lift_110.1 == lift_110.1) || (lift_110.1 < lift_110.1)) && ((-2761674063 - lift_110.1) < (-920558021 - 920558021)));
      if ((lift_151 > {lift_152, lift_152, lift_152, lift_160})) {
        ...
        {
          assert (((lift_139 == lift_139) && (lift_139 < lift_139)) || ((1 < lift_139) || (lift_139 < lift_139)));
          lift_181 := lift_127;
          lift_182 := ();
          assert (((lift_12 < lift_12) && (lift_12 < lift_12)) || ((-800196299 - -800196296) == (-800196299 - lift_12)));
        }
        var methoddefvar_185 := lift_183_0(lift_14, 1714830968, 1360337711);
        {
          assert (-1387661455 == ((lift_147 - 1) + (-1387661453 - -1387661452)));
          lift_190 := lift_191;
        }
        if (lift_124) {
          assert false;
          ...
          assert (((-1875461538 - lift_123) < (-1875461538 - lift_123)) || ((-1875461537 - lift_123) == (lift_123 - lift_123)));
          lift_217 := true;
        }
      }
    }
    {
      ...
      var methoddefvar_227, methoddefvar_228 := lift_225_0();
      {
        ...
        lift_242 := lift_242;
        lift_252 := lift_253;
        assert (((-461145034 < methoddefvar_228) && (methoddefvar_228 == -153715011)) || ((-153715010 - methoddefvar_228) == (-461145033 - methoddefvar_228)));
      }
    }
  } else {
  ...
  if (!(((multiset{(lift_263, -542680446)} + lift_502) in lift_507))) {
    ...
    var lift_525 := '/';
    {
      ...
      assert (-2 < ((-3 - |lift_284|) + (|lift_284| + |lift_284|)));
      {
        var lift_533 := {lift_430, lift_296, lift_264};
        var lift_532 := (lift_533, lift_119);
        var lift_531 := lift_197;
        if (true) {
          assert (((lift_113 + lift_113) - (-5396138574 - lift_113)) < lift_113);
        } else {
        ...
        var methoddefvar_526, methoddefvar_527 := lift_169_1(lift_250, lift_12);
        {
          ...
          lift_528 := lift_528;
          assert (((lift_413 == lift_413) || (lift_413 < lift_413)) && ((493064219 - lift_413) == (-493064225 + lift_413)));
          assert (-1 == ((lift_506 + 411858677) + (-137286226 + lift_506)));
          assert (((-1341851282 < -1341851282) && (-1341851282 == -1341851282)) || ((-1341851282 == -1341851282) && (-1341851282 == -1341851282)));
        }
        var methoddefvar_529 := lift_363_1(lift_114);
        {
          var lift_530 := lift_18;
          assert (((1714981401 == 1714981401) && (1714981401 == 1714981401)) && ((1714981398 - 1714981401) == (-1714981404 + 1714981401)));
          lift_530 := lift_297;
          lift_531 := lift_531;
          lift_532 := lift_532;
          assert (-1774792667 == ((-1774792665 - 1) + (-1774792664 - -1774792663)));
        }
      }
      var methoddefvar_536, methoddefvar_537 := lift_534_0(lift_251);
      {
        assert (((-1303954972 + 1303954967) - (-1303954970 + 1303954967)) == ((1303954966 - 1303954967) + (1303954966 - 1303954967)));
        lift_547 := lift_547;
        lift_550 := lift_550;
      }
    }
    var methoddefvar_553 := lift_438_1();
    {
      ...
      assert (lift_111 == 920558021);
      {
        ...
        lift_554 := lift_157;
        lift_556 := lift_559;
        assert (((855077976 - lift_213) == (855077976 - 855077977)) || ((855077975 - lift_213) == (855077976 - lift_213)));
      }
      if (lift_299) {
        var lift_570 := lift_571;
        lift_570 := lift_574;
        assert (((lift_203 == lift_203) && (lift_203 < lift_203)) || ((lift_203 < -564598953) && (lift_203 == lift_203)));
        assert (980007623 == (lift_521 - (-980007623 + -980007623)));
        lift_575 := lift_581;
        assert ((lift_251 + (0 - lift_251)) == ((-585507490 - lift_251) - lift_251));
      } else {
        assert false;
        assert false;
        lift_587 := lift_587;
      ...
      {
        assert (((lift_114 + lift_114) + (-1798712859 - lift_114)) < ((lift_114 - 5396138571) - (lift_114 + lift_114)));
        lift_603 := lift_604;
      }
    }
  } else {
