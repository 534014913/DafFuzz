...
method lift_37_0 ()
  returns (arg_40 : int)
  requires (true)
  ensures (((arg_40 == 1559212547) && true))
{
  arg_40 := 1559212547;
  {
    ...
    var lift_41 := 'i';
    lift_41 := lift_42;
    assert (((-830760327 - lift_44) < (-830760327 - lift_44)) || ((-830760327 - lift_44) == (-830760327 - -830760326)));
  }
}

method lift_1_0 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == -1086989473) && ((arg_5 == 2) && ((arg_4 == -899373905) && true))))
  ensures (((arg_7 == -807224644) && true))
{
  arg_7 := -807224644;
  {
    var lift_13 := '=';
    ...
    lift_8 := lift_11;
    assert (((arg_4 < arg_4) && (arg_4 < arg_4)) || ((-899373908 - -899373905) == (-899373908 - arg_4)));
...
method lift_1_1 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == -807224644) && ((arg_5 == -1086989473) && ((arg_4 == -1624513605) && true))))
  ensures (((arg_7 == -807224644) && true))
{
  arg_7 := -807224644;
  {
    ...
    var lift_8 := (-1170427157, lift_9);
    lift_8 := lift_11;
    assert (-1624513606 < arg_4);
    assert (((arg_5 - 2173978948) - (-1086989473 + -1086989473)) == ((arg_5 - 1) + (-1086989474 - arg_5)));
  }
}

method lift_1_2 (arg_4 : int, arg_5 : int, arg_6 : int)
  returns (arg_7 : int)
  requires (((arg_6 == 3) && ((arg_5 == -1086989473) && ((arg_4 == -1626497003) && true))))
  ensures (((arg_7 == -807224644) && true))
{
  arg_7 := -807224644;
  {
    ...
    var lift_8 := (-1170427157, lift_9);
    lift_8 := lift_11;
    assert (((-1 + arg_4) == (2 + -1626497006)) || ((arg_4 < arg_4) && (arg_4 < arg_4)));
    assert ((-4 == (-1086989477 - arg_5)) && (arg_5 == arg_5));
  }
}
...
method Main () {
  ...
  var lift_14 := (false, lift_15);
  {
    ...
    var methoddefvar_3 := lift_1_0(lift_14.1, |lift_16|, lift_24);
    {
      ...
      {
        assert (((2048938495 < 2048938495) && (2048938495 == 2048938495)) || ((2048938495 == 2048938495) || (2048938495 < 2048938495)));
      }
      ...
      {
        assert (((lift_31 < lift_31) || (350799460 < lift_31)) || ((350799459 - 350799461) < (lift_31 - 350799460)));
        lift_46 := lift_59;
        assert (((lift_31 < lift_31) || (350799460 < lift_31)) || ((350799459 - 350799461) < (lift_31 - 350799460)));
        assert (((lift_15 < lift_15) && (lift_15 < lift_15)) || ((-899373908 - -899373905) == (-899373908 - lift_15)));
        assert ((-4 == (-1086989477 - lift_24)) && (lift_24 == lift_24));
      }
      if (lift_21) {
        assert false;
        lift_60 := lift_53;
      } else {
        assert ((lift_15 + (-899373905 - -1)) == ((lift_15 - 899373906) - (lift_15 + lift_15)));
        lift_61 := lift_68;
        lift_76 := lift_21;
        assert (((lift_15 < lift_15) && (lift_15 < lift_15)) || ((-899373908 - -899373905) == (-899373908 - lift_15)));
      }
