...
method lift_41_0 (arg_44 : int, arg_45 : int)
  returns (arg_46 : int)
  requires (((arg_45 == -1191647186) && ((arg_44 == 231696690) && true)))
  ensures (((arg_46 == 344870953) && true))
{
  arg_46 := 344870953;
  {
    var lift_47 := arg_44;
    assert (((-1 - lift_47) == (-1 - lift_47)) && ((-1 - lift_47) == (-1 - 0)));
    assert (((arg_44 == arg_44) || (arg_44 < arg_44)) && ((231696690 == arg_44) || (arg_44 < arg_44)));
  }
}

method lift_41_1 (arg_44 : int, arg_45 : int)
  returns (arg_46 : int)
  requires (((arg_45 == 2) && ((arg_44 == 4) && true)))
  ensures (((arg_46 == 344870953) && true))
{
  arg_46 := 344870953;
  {
    var lift_47 := arg_44;
    assert (((-3 - 4) == (lift_47 + lift_47)) || ((-3 < lift_47) || (lift_47 < lift_47)));
    assert (((arg_44 - 5) - (arg_44 - arg_44)) == -1);
  }
}

method lift_21_0 (arg_25 : int, arg_26 : int, arg_27 : int)
  returns (arg_28 : int, arg_29 : int)
  requires (((arg_27 == 0) && ((arg_26 == -1191647186) && ((arg_25 == -716941854) && true))))
  ensures (((arg_29 == 914243368) && ((arg_28 == -1129089360) && true)))
{
  arg_28 := -1129089360;
  arg_29 := 914243368;
  {
...
method Main () {
  ...
  if ((((lift_1 - {lift_2, lift_2, lift_3} - lift_1) < lift_4.0) <== (
    ...
    );
    {
      ...
      {
        lift_48 := false;
        assert (((lift_30 + lift_30) - (-716941855 + lift_30)) == ((-2150825564 - lift_30) + (716941858 - -716941853)));
        lift_49 := lift_17;
        assert (((129584053 - 64792028) == lift_50) || ((64792023 - lift_50) == (64792024 - lift_50)));
        lift_52 := lift_39;
      }
      assert (((-760707543 - -760707542) < 1) || (-760707542 == (-1521415089 - -760707542)));
    }
    var methoddefvar_53 := lift_41_1(|lift_11|, (lift_54[lift_2] as int));
    {
      var lift_56 := 1648611281;
      assert (((-2 - lift_56) == (-1 - lift_56)) || ((-1 - lift_56) == (-1 - 1648611281)));
    }
    assert (((safeSeqRef(
    ...
    )) == (-3965178432 - -1321726144)));
    {
      ...
      if ((lift_1 >= lift_70)) {
        ...
        lift_110 := 'g';
        lift_111 := lift_111;
        assert (((-1 - lift_50) < (-1 - lift_50)) || ((lift_50 == -1) || (lift_50 == 64792025)));
        if (lift_52) {
    ...
    assert (((|safeSeqRef(
      ...
      -466892263,
      lift_126
    )|)) < ((|safeSeqRef(lift_125, -466892263, lift_126)| - 12) - (0 - 5)));
  } else {
    var lift_283 := 'O';
