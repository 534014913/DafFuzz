...
method lift_410_0 ()
  ...
  requires (true)
  ensures (((arg_415 == 274301994) && ((arg_414 == 1796764150) && true)))
{
  arg_414 := 1796764150;
  arg_415 := 274301994;
  {
...
method lift_333_0 (arg_336 : int, arg_337 : int, arg_338 : int)
  returns (arg_339 : int)
  requires (((arg_338 == -595647950) && ((arg_337 == -595647950) && ((arg_336 == -595647950) && true))))
  ensures (((arg_339 == -1707454167) && true))
{
  arg_339 := -1707454167;
  {
    var lift_340 := false;
...
method lift_143_0 (arg_147 : int, arg_148 : int, arg_149 : int)
  ...
  requires (((arg_149 == -860563126) && ((arg_148 == -181489661) && ((arg_147 == 2) && true))))
  ensures (((arg_151 == -507488550) && ((arg_150 == -265910508) && true)))
{
  arg_150 := -265910508;
  arg_151 := -507488550;
  {
    ...
    var lift_152 := true;
    assert (((-860563129 - arg_149) == (-860563129 - arg_149)) && ((-860563126 == arg_149) || (arg_149 < arg_149)));
    lift_152 := false;
    assert (((-1 - arg_147) < -1) || ((-1 - arg_147) < (-1 - arg_147)));
    lift_153 := lift_153;
    assert (((-1522465651 < arg_151) && (arg_151 < -507488549)) && ((-1522465653 - arg_151) < (-1522465652 - arg_151)));
  }
}

method lift_143_1 (arg_147 : int, arg_148 : int, arg_149 : int)
  returns (arg_150 : int, arg_151 : int)
  requires (((arg_149 == 95668267) && ((arg_148 == 353831877) && ((arg_147 == 457433338) && true))))
  ensures (((arg_151 == -507488550) && ((arg_150 == -265910508) && true)))
{
  arg_150 := -265910508;
  arg_151 := -507488550;
  {
    ...
    var lift_153 := multiset{[lift_154, lift_158, lift_158, lift_160]};
    var lift_152 := true;
    assert (((191336537 - 95668270) == arg_149) || ((95668265 - arg_149) == (95668266 - arg_149)));
    lift_152 := false;
    assert (arg_147 == 457433338);
    lift_153 := lift_153;
    assert (((-1522465651 < arg_151) && (arg_151 < -507488549)) && ((-1522465653 - arg_151) < (-1522465652 - arg_151)));
  }
}
...
method lift_121_0 (arg_124 : int, arg_125 : int, arg_126 : int)
  returns (arg_127 : int)
  requires (((arg_126 == 95668267) && ((arg_125 == -595647950) && ((arg_124 == 2) && true))))
  ensures (((arg_127 == -1064405801) && true))
{
  arg_127 := -1064405801;
  {
    var lift_129 := ();
...
method lift_121_1 (arg_124 : int, arg_125 : int, arg_126 : int)
  returns (arg_127 : int)
  requires (((arg_126 == -163228594) && ((arg_125 == -168693251) && ((arg_124 == -181489661) && true))))
  ensures (((arg_127 == -1064405801) && true))
{
  arg_127 := -1064405801;
  {
...
method lift_121_2 (arg_124 : int, arg_125 : int, arg_126 : int)
  returns (arg_127 : int)
  requires (((arg_126 == -595647950) && ((arg_125 == 444308197) && ((arg_124 == 0) && true))))
  ensures (((arg_127 == -1064405801) && true))
{
  arg_127 := -1064405801;
  {
...
method lift_67_0 (arg_70 : int)
  returns (arg_71 : int)
  requires (((arg_70 == 1663061078) && true))
  ensures (((arg_71 == 699498952) && true))
{
  arg_71 := 699498952;
  {
...
method lift_67_1 (arg_70 : int)
  returns (arg_71 : int)
  requires (((arg_70 == -1681000497) && true))
  ensures (((arg_71 == 699498952) && true))
{
  arg_71 := 699498952;
  {
...
method Main () {
  ...
  assert (((1391022907 + -1391022906) < (1391022908 + lift_1.2(
    ((), lift_4).1,
    874777022,
    |lift_18|,
    ("Wfee$BFPUxLt>g'H%q*eeH@H" !in lift_29),
    (lift_36 && lift_36)
  )(lift_37, lift_31, lift_38.1))) || ((lift_1.2(
    ((), lift_4).1,
    874777022,
    |lift_18|,
    ("Wfee$BFPUxLt>g'H%q*eeH@H" !in lift_29),
    (lift_36 && lift_36)
  )(lift_37, lift_31, lift_38.1) - -1391022904) < (lift_1.2(
    ((), lift_4).1,
    874777022,
    |lift_18|,
    ("Wfee$BFPUxLt>g'H%q*eeH@H" !in lift_29),
    (lift_36 && lift_36)
  )(lift_37, lift_31, lift_38.1) - -1391022904)));
  lift_42 := safeSeqRef(safeSeqTake(lift_50, lift_59), lift_37, lift_60.0).2;
  {
    ...
    var methoddefvar_69 := lift_67_0(lift_73.1);
    {
      ...
      assert (((lift_86 < lift_86) && (lift_86 < lift_86)) || ((-1 - 1663061078) == (-1 - lift_86)));
      if (false) {
        assert false;
        lift_87 := lift_90;
      } else {
      ...
      assert (((lift_59 == lift_59) || (lift_59 == lift_59)) && ((lift_59 + lift_59) < (-489685776 - lift_59)));
      if (lift_79) {
        ...
        lift_118 := lift_118;
        lift_119 := lift_119;
        assert ((lift_59 == -1) || (lift_59 < (163228596 - lift_59)));
        lift_120 := '"';
      }
    }
  ...
  if (lift_132.0(|(lift_142 + multiset{lift_93, ()} + lift_142)|)) {
    ...
    assert (((-2 - |safeSeqSlice3Colon(
      ...
      736389704,
      lift_59
    )|) + (0 - |safeSeqSlice3Colon(lift_35, lift_24, 736389704, lift_59)|)));
    ...
    );
    {
      ...
      {
        assert (((lift_86 + lift_86) < (4989183235 - lift_86)) && ((lift_86 < lift_86) || (1663061078 == lift_86)));
        assert (((1078030294 + -1078030295) < (-1078030294 - -1078030295)) && ((-1078030298 - -1078030294) < (-1078030297 - -1078030294)));
        lift_163 := [lift_93, lift_164];
        assert (-1 == (-914866677 - (-457433338 - lift_95)));
      }
      if (true) {
        var lift_165 := 'o';
        assert (0 == (-163228594 - lift_59));
        assert (((-797731526 - -265910508) == (-797731526 - methoddefvar_145)) || ((-797731526 - -265910508) == (-797731526 - methoddefvar_145)));
        lift_165 := lift_30;
        assert (((191336537 - 95668270) == lift_41) || ((95668265 - lift_41) == (95668266 - lift_41)));
      } else {
      ...
      {
        lift_173 := lift_211;
        assert (((lift_24 + -595647948) < lift_24) && ((lift_24 < 595647948) && (lift_24 == lift_24)));
        assert (-163228594 == lift_59);
      }
    }
    lift_248 := safeSeqRef(
      lift_254.0,
    ...
    );
    {
      ...
      if (lift_185) {
        ...
        assert ((lift_253 + (0 - lift_253)) == ((-1861616290 - lift_253) - lift_253));
        lift_277 := lift_164;
        lift_278 := lift_278;
      }
      lift_286 := lift_289;
      if (lift_189) {
        assert (((-403560801 - lift_292) < (-403560800 - lift_292)) && ((-403560798 - -403560799) == (-403560798 - lift_292)));
      } else {
        lift_298 := lift_298;
      }
    }
    {
      ...
      if (lift_276) {
        ...
        assert ((lift_306 == (-125378394 - lift_306)) || ((-188067594 - -62689197) == (-62689198 - lift_306)));
        ...
        if (lift_83) {
          ...
          assert (((lift_292 == lift_292) || (lift_292 < lift_292)) && ((lift_292 + lift_292) == (-1210682397 - -403560799)));
          lift_331 := lift_4;
          lift_332 := lift_318;
        }
        assert (((lift_322 + lift_322) == (-2171561532 - lift_322)) || ((-723853845 - lift_322) == -1));
      ...
      }
      {
        ...
        if (lift_233) {
          ...
          lift_387 := lift_82;
          lift_388 := lift_185;
          assert (((lift_292 + lift_292) + (-403560798 - -403560797)) < ((lift_292 - 403560795) + (-403560800 - lift_292)));
        } else {
          lift_389 := lift_397;
          lift_405 := lift_405;
          lift_408 := lift_279;
        ...
        var methoddefvar_412, methoddefvar_413 := lift_410_0();
        {
          ...
          assert ((-186372832 + (0 - -186372832)) == (-186372832 - (-372745664 - -186372832)));
          assert (0 == (-163228594 - lift_59));
          lift_433 := (var tmpData : seq<()> := []; tmpData);
          assert ((lift_379 == (lift_379 + lift_379)) || ((-2 < lift_379) || (lift_379 < lift_379)));
        }
        assert (((-1 - 626827920) < (-1 - 0)) && ((-2 - 626827920) < (-1 - 626827920)));
        {
          assert ((lift_253 + (0 - lift_253)) == ((-1861616290 - lift_253) - lift_253));
        }
      }
  ...
  assert (((-5 - (multiset(
    "Kpg=ExS;y==LzmNlFj%*HB~azRxhI$+;WdyGOD"
  )[lift_523.0.2] as int)) - (-3 - (multiset(
    "Kpg=ExS;y==LzmNlFj%*HB~azRxhI$+;WdyGOD"
  )[lift_523.0.2] as int))) < ((multiset(
    "Kpg=ExS;y==LzmNlFj%*HB~azRxhI$+;WdyGOD"
  )[lift_523.0.2] as int) + (-3 - -2)));
}
