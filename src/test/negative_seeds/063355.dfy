...
method lift_286_0 (arg_289 : int, arg_290 : int, arg_291 : int)
  returns (arg_292 : int)
  requires (((arg_291 == -1442235272) && ((arg_290 == 1) && ((arg_289 == 1) && true))))
  ensures (((arg_292 == 1351938607) && true))
{
  arg_292 := 1351938607;
  {
    var lift_298 := true;
    ...
    var lift_293 := ();
    assert (((-1228484819 < -1228484819) || (-1228484819 < -1228484819)) || ((-1228484819 + -1228484819) < (-1228484819 - 1228484817)));
    assert ((arg_291 + (-1442235273 - arg_291)) == ((-2884470544 - arg_291) + (-1442235273 - arg_291)));
    lift_293 := lift_293;
    assert (((-2 - arg_290) - (0 - arg_290)) == ((0 - arg_290) + (0 - arg_290)));
    lift_294 := lift_294;
  }
}
...
method lift_186_0 ()
  ...
  requires (true)
  ensures (((arg_191 == 2012676862) && ((arg_190 == -860847631) && true)))
{
  arg_190 := -860847631;
  arg_191 := 2012676862;
  {
    ...
    lift_192 := lift_193;
    assert (((arg_190 + 860847632) == 2) || ((arg_190 == -860847632) || (-860847631 == arg_190)));
    assert ((arg_191 + (-4025353722 - -2012676861)) < ((arg_191 - -2012676861) - (2012676861 - arg_191)));
    assert (((2012676862 == arg_191) || (arg_191 < arg_191)) || ((670892287 - arg_191) == (670892286 - arg_191)));
  }
}
  ...
  ensures (((arg_191 == 2012676862) && ((arg_190 == -860847631) && true)))
{
  ...
  arg_191 := 2012676862;
  {
    ...
    var lift_192 := lift_193;
    lift_192 := lift_193;
    assert (((arg_190 == arg_190) && (arg_190 == arg_190)) && ((arg_190 + arg_190) == (-2582542893 - -860847631)));
    assert (((arg_191 == arg_191) && (arg_191 == 2012676862)) || ((arg_191 < arg_191) || (arg_191 < arg_191)));
    assert (((0 - 2012676862) + (-1 - arg_191)) == ((arg_191 - 8050707449) - (0 - 2012676862)));
  }
}
...
method lift_161_0 (arg_164 : int)
  returns (arg_165 : int)
  requires (((arg_164 == -82310957) && true))
  ensures (((arg_165 == 917452517) && true))
{
  arg_165 := 917452517;
  {
    var lift_173 := false;
...
method lift_144_0 (arg_148 : int, arg_149 : int)
  ...
  requires (((arg_149 == 1836536651) && ((arg_148 == 1799175903) && true)))
  ensures (((arg_151 == -1543668158) && ((arg_150 == 826009859) && true)))
{
  arg_150 := 826009859;
  arg_151 := -1543668158;
  {
    assert (((-866035303 + 173207059) - (-173207061 + 173207059)) == ((-173207062 - 173207059) + (-173207062 - 173207059)));
    assert (((-1543668159 - arg_151) == (-1543668160 - arg_151)) || ((arg_151 - 1543668161) < (-1543668158 - 1543668160)));
  }
}

method lift_126_0 (arg_129 : int, arg_130 : int, arg_131 : int)
  returns (arg_132 : int)
  requires (((arg_131 == -503150507) && ((arg_130 == -1442235272) && ((arg_129 == -1063526353) && true))))
  ensures (((arg_132 == -1360091055) && true))
{
  arg_132 := -1360091055;
  {
    var lift_139 := true;
    ...
    assert (((-1686686085 - -1) - (-1 - 1686686081)) < ((-1686686082 + 1686686081) - (1686686081 - 0)));
    lift_133 := lift_135;
    assert (((arg_130 == arg_130) && (0 == arg_130)) || (arg_130 < (1 - 2)));
  }
}
...
method lift_45_1 (arg_48 : int)
  returns (arg_49 : int)
  requires (((arg_48 == 5) && true))
  ensures (((arg_49 == -1200863961) && true))
{
  arg_49 := -1200863961;
  {
    var lift_67 := 'Z';
    ...
    var lift_51 := ();
    var lift_50 := (lift_51, lift_52, lift_61);
    assert (((-1200863962 - arg_49) == (-1200863962 - -1200863961)) || ((-1200863963 - arg_49) == (-1200863962 - arg_49)));
    lift_50 := lift_50;
  }
}
...
method lift_45_2 (arg_48 : int)
  returns (arg_49 : int)
  requires (((arg_48 == 282526081) && true))
  ensures (((arg_49 == -1200863961) && true))
{
  arg_49 := -1200863961;
  {
    ...
    var lift_51 := ();
    var lift_50 := (lift_51, lift_52, lift_61);
    assert (((arg_49 == arg_49) || (arg_49 < arg_49)) && ((arg_49 + arg_49) == (-3602591883 - -1200863961)));
    lift_50 := lift_50;
  }
}
...
method lift_1_0 (arg_4 : int, arg_5 : int)
  returns (arg_6 : int)
  requires (((arg_5 == -132161898) && ((arg_4 == 12) && true)))
  ensures (((arg_6 == 81904399) && true))
{
  arg_6 := 81904399;
  {
    var lift_10 := ();
...
method Main () {
  ...
  );
  {
    ...
    if (lift_41.2) {
      ...
      var methoddefvar_128 := lift_126_0(lift_74, lift_78, lift_15);
      {
        ...
        assert (((lift_30 < lift_30) || (lift_30 == lift_30)) && ((lift_30 < 1644787546) || (lift_30 < lift_30)));
      }
      var methoddefvar_146, methoddefvar_147 := lift_144_0(lift_23, lift_121);
      {
        var lift_157 := (lift_153, lift_158);
        lift_152 := lift_157;
        assert ((lift_74 + (-1063526354 - lift_74)) == ((-2127052707 - lift_74) + (lift_74 - lift_74)));
      }
    }
    {
      var methoddefvar_163 := lift_161_0(lift_100);
      {
        assert (((lift_100 == lift_100) || (lift_100 == lift_100)) && ((lift_100 + lift_100) < (-246932865 - lift_100)));
      }
      assert (((lift_107 - lift_107) + (lift_107 + lift_107)) < lift_107);
    }
    ...
    var methoddefvar_231, methoddefvar_232 := lift_186_1();
    {
      ...
      assert (((lift_12 == lift_12) && (lift_12 < lift_12)) || ((lift_12 == lift_12) && (1611818004 < lift_12)));
      lift_233 := lift_233;
      assert (((-976005617 + lift_202) - (-976005615 + lift_202)) == ((976005611 - lift_202) + (976005611 - lift_202)));
      lift_234 := lift_201;
      assert (((440135122 - 440135123) == (440135122 - 440135123)) || ((440135122 - 440135123) == (440135122 - 440135123)));
    }
    assert (((-5 - |lift_228|) - (-3 - |lift_228|)) < (|lift_228| + (-3 - -2)));
  }
  ...
  if (((lift_83.2 as int) == ((lift_11, ()).0[lift_100] as int))) {
    ...
    {
      {
        lift_356 := lift_208;
        lift_357 := lift_357;
        assert (((-1315987614 - -1315987612) == (-1315987612 - -1315987610)) && ((-1315987612 == -1315987612) || (-1315987612 == -1315987612)));
        lift_364 := lift_240;
        lift_365 := lift_74;
      }
      var methoddefvar_366 := lift_45_2(lift_86);
      {
        lift_367 := lift_75;
        lift_368 := lift_368;
        assert (((-1623832964 - lift_107) == (-1623832964 - -1623832961)) || ((lift_107 < lift_107) || (lift_107 < lift_107)));
        lift_375 := 'V';
        assert (((-503150509 - -503150507) < (-503150508 - lift_13)) || ((-503150508 - lift_13) == (503150506 + -503150507)));
      }
      assert (((lift_249 + lift_249) - (-1985742092 - lift_249)) < ((lift_249 + 1985742094) + (-1985742092 - lift_249)));
      assert ((-1 + (-3717412715 - lift_207)) == lift_207);
      {
        var lift_376 := lift_73;
        assert (((lift_156 == lift_156) || (lift_156 < lift_156)) && ((-488566971 - lift_156) < (-162855657 - 162855657)));
        assert ((lift_318 - (1213551840 + lift_318)) == (lift_318 + -2427103679));
        assert (((-5878318278 + lift_116) - (-1175663656 + lift_116)) == ((-1175663657 - lift_116) + (-1175663657 - lift_116)));
        assert (((390771811 + -390771809) + (1 - 2)) < ((-390771808 - -390771808) - (-390771808 - 1)));
        lift_376 := lift_16;
      }
    }
    assert (((-1434341438 - -1434341436) < (-1434341437 - lift_377(
      lift_88,
      lift_208,
      lift_118,
      lift_387,
      lift_389
    ).1)) || ((-1434341437 - -1434341436) == (-1434341437 - lift_377(
      lift_88,
      lift_208,
      lift_118,
      lift_387,
    ...
    assert (((-2 - |(multiset{
      ...
      lift_396
    } + multiset{lift_396, lift_397, lift_398} + lift_404)|) == (-1 - 8)));
  }
}
