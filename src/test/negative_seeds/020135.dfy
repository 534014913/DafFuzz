...
method lift_49_0 (arg_52 : int)
  returns (arg_53 : int)
  requires (((arg_52 == -527414273) && true))
  ensures (((arg_53 == 1115830135) && true))
{
  arg_53 := 1115830135;
  {
    ...
    assert (((-2 - 1345034035) == (lift_54 + lift_54)) || ((lift_54 == 1345034035) || (lift_54 < lift_54)));
    assert (((arg_52 + arg_52) - (-527414272 - 527414274)) < arg_52);
    assert (((lift_54 < lift_54) || (1345034034 == lift_54)) || ((1345034035 - 1345034036) == (-1345034036 + lift_54)));
    lift_55 := lift_57;
    lift_60 := lift_60;
  }
}
...
method lift_28_0 (arg_31 : int, arg_32 : int, arg_33 : int)
  returns (arg_34 : int)
  requires (((arg_33 == -527414273) && ((arg_32 == -527414273) && ((arg_31 == -1994705697) && true))))
  ensures (((arg_34 == -1941273946) && true))
{
  arg_34 := -1941273946;
  {
...
method Main () {
  ...
  assert (((lift_1.1 as int) - (112 + 110)) == (-1 + (-3 - (lift_1.1 as int))));
  lift_5 := lift_20.2;
  ...
  );
  {
    ...
    assert (((|"-~DsF$WEeJLktNv"| + |"-~DsF$WEeJLktNv"|) + (-16 - |"-~DsF$WEeJLktNv"|)) < ((|"-~DsF$WEeJLktNv"| - 30) + |"-~DsF$WEeJLktNv"|));
    var methoddefvar_51 := lift_49_0(lift_45);
    {
      assert ((481761936 < lift_23) || ((481761932 - 481761937) == (481761928 - lift_23)));
      lift_61 := lift_61;
      assert (((-527414275 - lift_46) < (-527414274 - lift_46)) && ((-527414272 - -527414273) == (-527414272 - lift_46)));
      assert (((lift_19 - 1401738349) - lift_19) == ((-350434587 - 350434587) + (-350434588 - lift_19)));
    }
  }
}
