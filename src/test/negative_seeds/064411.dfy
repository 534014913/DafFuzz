...
method lift_217_0 (arg_220 : int, arg_221 : int)
  returns (arg_222 : int)
  requires (((arg_221 == -1416293920) && ((arg_220 == 297856010) && true)))
  ensures (((arg_222 == 886128845) && true))
{
  arg_222 := 886128845;
  {
    ...
    var lift_223 := ();
    lift_223 := ();
    assert (((arg_221 - 1416293920) < (-1416293920 + -1416293919)) || ((arg_221 == -1416293917) || (arg_221 < arg_221)));
    lift_224 := lift_237;
    assert (((0 - 3603930820) - lift_264) == ((lift_264 - 1) + (-1801965410 - lift_264)));
  }
}

method lift_217_1 (arg_220 : int, arg_221 : int)
  returns (arg_222 : int)
  requires (((arg_221 == 756374316) && ((arg_220 == -422077091) && true)))
  ensures (((arg_222 == 886128845) && true))
{
  arg_222 := 886128845;
  {
    ...
    var lift_223 := ();
    lift_223 := ();
    assert (((arg_221 + -756374316) + (-756374315 - arg_221)) < ((0 - 756374316) + arg_221));
    lift_224 := lift_237;
    assert ((1 == (1801965410 + lift_264)) || (1 < (lift_264 - -1801965411)));
  }
}

method lift_157_0 (arg_161 : int, arg_162 : int)
  returns (arg_163 : int, arg_164 : int)
  requires (((arg_162 == 1000605865) && ((arg_161 == -1460633778) && true)))
  ensures (((arg_164 == 982576946) && ((arg_163 == 1844207019) && true)))
{
  arg_163 := 1844207019;
  arg_164 := 982576946;
  {
...
method lift_128_0 (arg_131 : int)
  returns (arg_132 : int)
  requires (((arg_131 == 961522755) && true))
  ensures (((arg_132 == 829528179) && true))
{
  arg_132 := 829528179;
  {
    ...
    assert (((lift_133 < lift_133) && (700401045 == 700401046)) || ((-700401045 - 0) == (-1 - lift_133)));
    assert (((lift_133 == lift_133) && (lift_133 == lift_133)) && ((-700401045 - lift_133) < (-700401044 - 700401044)));
    lift_134 := lift_134;
    lift_135 := lift_133;
  }
}
  ...
  ensures (((arg_132 == 829528179) && true))
{
  arg_132 := 829528179;
  {
    ...
    var lift_134 := 't';
    var lift_133 := 700401044;
    assert (((lift_133 - 1400802089) - lift_133) == ((0 - 700401044) + (-1 - lift_133)));
    assert (((lift_133 < lift_133) && (700401045 == 700401046)) || ((-700401045 - 0) == (-1 - lift_133)));
    lift_134 := lift_134;
    lift_135 := lift_133;
  }
...
method lift_88_0 (arg_92 : int, arg_93 : int)
  ...
  requires (((arg_93 == 2042039978) && ((arg_92 == 2042039978) && true)))
  ensures (((arg_95 == -1669929553) && ((arg_94 == 293847736) && true)))
{
  arg_94 := 293847736;
  arg_95 := -1669929553;
  {
    ...
    var lift_96 := lift_97;
    assert (((1081491765 - 1081491766) < (1081491766 - 1081491765)) && ((1081491766 == 1081491766) || (1081491766 == 1081491766)));
    assert (2 == ((arg_92 - 2042039977) - -1));
    lift_96 := lift_96;
  }
}
...
method lift_58_0 (arg_62 : int)
  ...
  requires (((arg_62 == 1791051549) && true))
  ensures (((arg_64 == -495333431) && ((arg_63 == -3761316) && true)))
{
  arg_63 := -3761316;
  arg_64 := -495333431;
  {
    ...
    var lift_65 := ();
    lift_65 := lift_65;
    assert (((arg_62 < arg_62) && (1791051550 == arg_62)) || ((1791051548 - 1791051549) == (1791051548 - arg_62)));
    assert ((lift_66 < (706408149 - lift_66)) && ((353204074 == lift_66) || (lift_66 < lift_66)));
  }
}
...
method Main () {
  ...
  assert ((|((lift_1 * lift_1) * lift_1)| + (|((lift_1 * lift_1) * lift_1)| + |((lift_1 * lift_1) * lift_1)|)) == ((|((lift_1 * lift_1) * lift_1)| - 7) - (-4 - |((lift_1 * lift_1) * lift_1)|)));
  lift_12 := safeSeqRef(
    lift_31(
  ...
  );
  {
    ...
    );
    {
      ...
      var methoddefvar_90, methoddefvar_91 := lift_88_0(lift_24, lift_26);
      {
        ...
        lift_107 := lift_107;
        lift_108 := lift_118;
        assert (((784770014 - 784770016) + (784770017 - 784770013)) == ((-784770016 + 784770013) + 5));
      }
      var methoddefvar_130 := lift_128_0(lift_47);
      {
        assert (((2042039978 == lift_24) && (lift_24 == lift_24)) && ((lift_24 == lift_24) && (lift_24 == lift_24)));
      }
    }
    {
      ...
      assert (((-6298107426 - lift_136.2) < (-6298107425 - lift_136.2)) && ((-6298107424 < lift_136.2) || (lift_136.2 < lift_136.2)));
      {
        ...
        if (lift_57) {
          ...
          assert (((lift_44 + lift_44) < (1000605866 + lift_44)) && ((lift_44 < lift_44) || (lift_44 == 1000605865)));
          lift_141 := lift_147;
          lift_150 := {lift_151};
        }
        if (lift_56) {
      ...
      var methoddefvar_159, methoddefvar_160 := lift_157_0(lift_120, lift_44);
      {
        ...
        lift_215 := lift_117;
        lift_216 := lift_56;
        assert (((-232583158 - lift_201) + (232583156 - 232583158)) == ((232583156 - 232583158) - (lift_201 + lift_201)));
      }
      var methoddefvar_219 := lift_217_0(lift_146, -1416293920);
      {
        var lift_266 := false;
        assert ((lift_55 + (-2476626296 - -1238313148)) == ((-3714939443 - lift_55) + (-1238313149 - lift_55)));
        lift_265 := lift_214;
        lift_266 := lift_117;
        assert (0 == (-422077091 - lift_152));
      }
  ...
  {
    assert ((lift_270() + (0 - lift_270())) == ((-746349298 - lift_270(
