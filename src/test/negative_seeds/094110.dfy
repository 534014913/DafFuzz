...
method lift_309_0 ()
  returns (arg_312 : int)
  requires (true)
  ensures (((arg_312 == 447850316) && true))
{
  arg_312 := 447850316;
  {
    var lift_327 := false;
    ...
    lift_313 := lift_319;
    assert (((lift_326 - 4769884238) - (-1589961413 + lift_326)) == ((0 - 1589961412) + (-1 - lift_326)));
    lift_327 := lift_316;
    assert (((lift_326 + lift_326) + (-2 - lift_326)) < ((lift_326 + lift_326) - 1));
    assert (((-447850321 + arg_312) - (-447850319 + arg_312)) == ((447850315 - arg_312) + (447850315 - arg_312)));
  }
}
...
method lift_257_0 ()
  ...
  requires (true)
  ensures (((arg_262 == -870238197) && ((arg_261 == -173171213) && true)))
{
  arg_261 := -173171213;
  arg_262 := -870238197;
  {
    assert ((arg_262 - -870238200) == (-1 - (870238193 + arg_262)));
  }
}

method lift_212_0 (arg_215 : int, arg_216 : int, arg_217 : int)
  returns (arg_218 : int)
  requires (((arg_217 == -175784666) && ((arg_216 == -1843358831) && ((arg_215 == -1286116828) && true))))
  ensures (((arg_218 == 1979157910) && true))
{
  arg_218 := 1979157910;
  {
    var lift_229 := '>';
...
method lift_175_0 (arg_179 : int, arg_180 : int)
  ...
  requires (((arg_180 == 474814996) && ((arg_179 == -175784666) && true)))
  ensures (((arg_182 == 385722486) && ((arg_181 == -1307540268) && true)))
{
  arg_181 := -1307540268;
  arg_182 := 385722486;
  {
    assert ((arg_179 + (-351569332 - -175784666)) == ((-527353997 - arg_179) + (-175784667 - arg_179)));
  }
}

method lift_175_1 (arg_179 : int, arg_180 : int)
  returns (arg_181 : int, arg_182 : int)
  requires (((arg_180 == -2104371239) && ((arg_179 == 1389704815) && true)))
  ensures (((arg_182 == 385722486) && ((arg_181 == -1307540268) && true)))
{
  arg_181 := -1307540268;
  arg_182 := 385722486;
  {
    assert (arg_179 == ((-1389704815 - -2779409631) + (-1389704816 - -1389704815)));
  }
}

method lift_130_0 (arg_133 : int)
  returns (arg_134 : int)
  requires (((arg_133 == 1700777949) && true))
  ensures (((arg_134 == 1065200444) && true))
{
  arg_134 := 1065200444;
  {
    ...
    var lift_138 := multiset{lift_139, lift_146, lift_155, lift_146, lift_156};
    var lift_137 := false;
    var lift_136 := (lift_137, lift_138);
    var lift_135 := -1840345690;
    assert (((arg_133 - 1700777950) + (1700777949 - 1700777950)) == ((1700777949 + -1700777950) + -1));
    assert (-1840345690 == lift_135);
    assert (((arg_133 - 1700777950) + (1700777949 - 1700777950)) == ((1700777949 + -1700777950) + -1));
    assert (((1866148530 == 1866148530) || (1866148530 == 1866148530)) || ((1866148530 - 1866148531) == -1));
...
method lift_109_0 (arg_113 : int, arg_114 : int, arg_115 : int)
  ...
  requires (((arg_115 == -175784666) && ((arg_114 == 474814996) && ((arg_113 == -892010397) && true))))
  ensures (((arg_117 == -1472297184) && ((arg_116 == 1679370812) && true)))
{
  arg_116 := 1679370812;
  arg_117 := -1472297184;
  {
    ...
    lift_118 := lift_122;
    assert (arg_115 == ((arg_115 - 175784667) - (arg_115 - 1)));
    assert (((arg_113 < arg_113) || (arg_113 < arg_113)) || ((-892010400 - arg_113) == (arg_113 - -892010394)));
  }
}

method lift_109_1 (arg_113 : int, arg_114 : int, arg_115 : int)
  returns (arg_116 : int, arg_117 : int)
  requires (((arg_115 == -1653646387) && ((arg_114 == 1694426210) && ((arg_113 == -1207836198) && true))))
  ensures (((arg_117 == -1472297184) && ((arg_116 == 1679370812) && true)))
{
  arg_116 := 1679370812;
  arg_117 := -1472297184;
  {
    ...
    var lift_118 := [lift_119, lift_120];
    lift_118 := lift_122;
    assert (((-1653646387 == arg_115) && (arg_115 == arg_115)) || ((arg_115 == arg_115) && (arg_115 < arg_115)));
    assert ((1207836201 + (-1207836199 - arg_113)) == ((arg_113 + arg_113) - (-4831344794 - arg_113)));
  }
}
...
method lift_1_0 (arg_5 : int, arg_6 : int, arg_7 : int)
  ...
  requires (((arg_7 == 1986003892) && ((arg_6 == -1207836198) && ((arg_5 == 0) && true))))
  ensures (((arg_9 == 1347831459) && ((arg_8 == -1781303008) && true)))
{
  arg_8 := -1781303008;
  arg_9 := 1347831459;
  {
    ...
    var lift_11 := 'v';
    var lift_10 := lift_11;
    assert (((arg_7 < arg_7) && (1986003893 == arg_7)) || ((1986003891 - 1986003892) == (1986003891 - arg_7)));
    lift_10 := lift_11;
    lift_12 := lift_13;
    assert (((lift_16 + lift_16) + (1561388431 + lift_16)) < ((lift_16 - 0) + lift_16));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    if (lift_74.1) {
      var lift_97 := 'j';
      {
        assert (((methoddefvar_3 + methoddefvar_3) - (methoddefvar_3 + -1781303009)) == 1);
        lift_97 := '%';
      }
      assert (((1028191051 < 1028191051) && (1028191051 == 1028191050)) || ((1028191050 - 1028191051) == (1028191050 - 1028191051)));
      lift_98 := lift_98;
    } else {
      lift_106 := lift_108;
      assert false;
    ...
    assert (((474814995 - (false, lift_47).1) == -1) && (((
      false,
      lift_47
    ).1 == (false, lift_47).1) || ((false, lift_47).1 < (false, lift_47).1)));
    var methoddefvar_132 := lift_130_0(lift_46);
    {
      assert (((-2 - 2058328319) == (lift_56 + lift_56)) || ((lift_56 < -2) || (-2 < lift_56)));
      assert (((308633230 - 308633232) == (308633231 - 308633232)) || ((308633231 - 308633232) == (308633231 - 308633232)));
      assert (((-1210896166 + 1210896163) == (1210896167 - 1210896163)) || ((1210896163 == 1210896163) && (1210896163 < 1210896166)));
      assert (((lift_47 < 474814995) && (lift_47 == lift_47)) || ((lift_47 < lift_47) || (lift_47 < lift_47)));
    ...
    var methoddefvar_177, methoddefvar_178 := lift_175_0(lift_101, lift_47);
    {
      ...
      lift_195 := lift_195;
      lift_211 := lift_194;
      assert (((-1108268449 - -1108268447) < (-1108268448 - lift_55)) && ((-1108268449 - lift_55) < (-1108268448 - lift_55)));
    }
  }
  ...
  );
  {
    ...
    {
      assert (((1784020794 + lift_105) + (-892010398 + lift_105)) < lift_105);
      assert ((-1 - (lift_65 - -2104371237)) == 1);
      lift_246 := lift_246;
      lift_247 := lift_247;
    }
    {
      ...
      lift_249 := lift_173;
      {
        assert (((-2 - lift_56) == (-1 - lift_56)) || ((2058328319 == lift_56) || (lift_56 < lift_56)));
  ...
  var methoddefvar_259, methoddefvar_260 := lift_257_0();
  {
    ...
    assert ((lift_263() + (-987148 - lift_263())) == ((-1974294 - lift_263(
    ...
    if ((lift_233 == lift_266 >= {lift_234, lift_238, lift_267})) {
    ...
    } else {
      {
        var lift_298 := 'P';
        assert (((-1108268449 - -1108268447) < (-1108268448 - lift_55)) && ((-1108268449 - lift_55) < (-1108268448 - lift_55)));
        assert ((lift_101 + (-351569332 - -175784666)) == ((-527353997 - lift_101) + (-175784667 - lift_101)));
        lift_290 := lift_290;
        lift_298 := lift_171;
      }
      {
        var lift_299 := (var tmpData : set<seq<()>> := {}; tmpData);
        assert (((426982553 - 426982550) + (-426982554 + 426982551)) == ((426982551 - 426982550) + (426982549 - 426982550)));
        lift_299 := lift_300;
      }
      if (true) {
        var lift_307 := lift_189;
        assert ((lift_206 - (4 + lift_206)) == ((-727162465 + lift_206) + (727162462 - 727162461)));
        assert (((lift_103 + lift_103) + (-282020624 - lift_103)) < ((lift_103 - -564041246) + lift_103));
        assert (((-1277804479 < lift_209) && (lift_209 == lift_209)) || ((-425934825 == -425934825) && (-425934825 < lift_209)));
        lift_307 := lift_200;
        lift_308 := lift_77;
      } else {
        assert false;
    ...
    assert (safeSeqRef(lift_72, lift_64, lift_207) == ((2501326887 - safeSeqRef(
      lift_72,
      lift_64,
      lift_207
    )) - safeSeqRef(lift_72, lift_64, lift_207)));
    var methoddefvar_311 := lift_309_0();
    {
      assert (((-1864185822 - 1) + (1864185824 + -1864185822)) == ((-1864185822 - 1) + (-1864185820 - -1864185822)));
      lift_328 := lift_285;
      assert (((-1653646387 == lift_208) && (lift_208 == lift_208)) || ((lift_208 == lift_208) && (lift_208 < lift_208)));
      assert (((-1279775907 - -1279775904) - (-1279775905 - -1279775904)) == ((-1279775905 - -1279775904) + (-1279775905 - -1279775904)));
      assert (((lift_188 + lift_188) + (-1694426211 - lift_188)) < ((lift_188 - 3388852420) + lift_188));
    }
    var methoddefvar_329, methoddefvar_330 := lift_175_1(lift_63, lift_65);
    {
      ...
      assert (((-3388852421 + lift_188) + lift_188) < lift_188);
      lift_332 := lift_292;
      assert (((lift_105 == lift_105) || (lift_105 < lift_105)) && ((lift_105 + lift_105) == (-2676031191 - -892010397)));
    }
  }
  lift_334 := safeSeqRef(
