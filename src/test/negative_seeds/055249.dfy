...
method lift_331_0 ()
  returns (arg_334 : int)
  requires (true)
  ensures (((arg_334 == -1771851019) && true))
{
  arg_334 := -1771851019;
  {
    var lift_335 := 's';
...
method lift_299_0 (arg_303 : int, arg_304 : int)
  ...
  requires (((arg_304 == -170676070) && ((arg_303 == 2124283527) && true)))
  ensures (((arg_306 == -1731558853) && ((arg_305 == 665539236) && true)))
{
  arg_305 := 665539236;
  arg_306 := -1731558853;
  {
    ...
    lift_307 := lift_308;
    lift_309 := arg_303;
    assert (((arg_304 == arg_304) && (arg_304 == arg_304)) && ((arg_304 + arg_304) == (-512028210 - -170676070)));
    lift_310 := lift_310;
    lift_317 := lift_323;
  }
}
...
method lift_274_0 (arg_277 : int, arg_278 : int, arg_279 : int)
  returns (arg_280 : int)
  requires (((arg_279 == -663077803) && ((arg_278 == -1889317035) && ((arg_277 == 257351122) && true))))
  ensures (((arg_280 == 2073040956) && true))
{
  arg_280 := 2073040956;
  {
    ...
    assert (((1873074693 - 7492298771) - 1873074693) == ((-1873074692 - 1873074693) + (-1873074693 - 1873074693)));
    lift_281 := lift_281;
    assert (((-1545295241 + -1545295241) + (-1545295240 - -1545295241)) < ((-4635885722 - -1545295241) + 1));
  }
}
...
method lift_214_0 (arg_218 : int)
  ...
  requires (((arg_218 == -1889317035) && true))
  ensures (((arg_220 == 1681702464) && ((arg_219 == -620367767) && true)))
{
  arg_219 := -620367767;
  arg_220 := 1681702464;
  {
    ...
    var lift_221 := ();
    lift_221 := lift_222;
    assert (((-8408512328 + arg_220) - (-1681702466 + arg_220)) == ((-1681702467 - arg_220) + (-1681702467 - arg_220)));
    lift_223 := lift_229;
  }
}
...
method lift_180_0 ()
  ...
  requires (true)
  ensures (((arg_185 == 707063945) && ((arg_184 == -1409012954) && true)))
{
  arg_184 := -1409012954;
  arg_185 := 707063945;
  {
    ...
    lift_186 := true;
    assert (((-9776222903 + lift_189) - (-1955244581 + lift_189)) == ((-1955244582 - lift_189) + (-1955244582 - lift_189)));
  }
}
...
method lift_136_0 (arg_140 : int)
  ...
  requires (((arg_140 == -1676898035) && true))
  ensures (((arg_142 == -1940113131) && ((arg_141 == 825198774) && true)))
{
  arg_141 := 825198774;
  arg_142 := -1940113131;
  {
    assert ((arg_142 + (arg_142 + -1940113131)) == ((arg_142 + arg_142) - (0 - arg_142)));
    assert (arg_140 == (-1676898037 + (-1676898037 - -1676898037)));
  }
}
...
method Main () {
  ...
  assert (((-6342062033 - safeSeqRef(
    (lift_1(lift_8, lift_9, lift_14, lift_8) + safeSeqDrop(lift_23, lift_24) + (
      [
        ((), 1253500773, multiset{lift_15, lift_15, lift_19, lift_25, lift_25}),
        lift_29,
        ((), lift_8, lift_32),
        lift_45
      ],
  ...
  ))));
  {
    ...
    assert (((-5 - (lift_69(lift_73)[|lift_9|] as int)) - (-3 - (lift_69(
      lift_73
    )[|lift_9|] as int))) < ((lift_69(lift_73)[|lift_9|] as int) + (-3 - -2)));
    assert (((lift_75.1.2 == lift_75.1.2) || (lift_75.1.2 == lift_75.1.2)) && ((-4865043370 - lift_75.1.2) == (-4865043370 - -1621681123)));
  }
  ...
  );
  {
    ...
    var methoddefvar_216, methoddefvar_217 := lift_214_0(lift_107);
    {
      ...
      lift_240 := lift_240;
      assert (((lift_115 - 1676898036) == (-1676898035 + lift_115)) || ((lift_115 < 1) && (lift_115 < 0)));
      assert (((-1889317034 - lift_107) < (lift_107 + lift_107)) || ((-1889317034 - 2) < lift_107));
    }
    assert (-1 < |lift_82|);
  }
  if ((lift_161 < (lift_208.0 + (lift_82[lift_79] as int)))) {
    ...
    if ((safeSeqDrop(lift_61, -1275513009) in lift_250.1)) {
      ...
      {
        assert (((lift_8 + lift_8) + (-997961556 - lift_8)) < ((lift_8 - 1995923110) + lift_8));
        assert (((-170676072 - lift_203) < (-170676071 - lift_203)) && ((-170676069 - -170676070) == (-170676069 - lift_203)));
        lift_298 := lift_150;
      }
      var methoddefvar_301, methoddefvar_302 := lift_299_0(lift_271, lift_203);
      {
        ...
        assert (((-665539236 - 665539236) == (methoddefvar_301 - 1996617708)) && ((-1996617709 - methoddefvar_301) < (-665539236 - 665539236)));
        assert (((lift_68 + -906008861) + (-906008862 - lift_68)) < ((0 - 1) + (-2718026582 - lift_68)));
      ...
      }
      {
        ...
        {
          lift_330 := lift_298;
          assert (1 == ((1676898037 + lift_115) - (-1676898036 + 1676898037)));
        }
