...
method lift_183_0 (arg_186 : int, arg_187 : int, arg_188 : int)
  returns (arg_189 : int)
  requires (((arg_188 == -750004074) && ((arg_187 == -750004074) && ((arg_186 == -860054049) && true))))
  ensures (((arg_189 == -214372968) && true))
{
  arg_189 := -214372968;
  {
    var lift_204 := 'S';
    ...
    var lift_190 := [lift_191, lift_191, multiset{arg_186}, lift_192, lift_192];
    assert (-860054050 < arg_186);
    lift_190 := lift_190;
    assert (((-860054051 - -860054049) < (-860054050 - arg_186)) || ((-860054050 - arg_186) == (-860054050 - -860054049)));
    lift_193 := lift_193;
  }
}
...
method lift_107_0 (arg_111 : int, arg_112 : int, arg_113 : int)
  ...
  requires (((arg_113 == 563449727) && ((arg_112 == -874207634) && ((arg_111 == -1702534231) && true))))
  ensures (((arg_115 == -750004074) && ((arg_114 == 73298312) && true)))
{
  arg_114 := 73298312;
  arg_115 := -750004074;
  {
    ...
    lift_116 := lift_124;
    assert (73298311 < arg_114);
    assert ((arg_112 + (-874207635 - arg_112)) == ((-1748415268 - arg_112) + (-874207635 - arg_112)));
    assert (((-3405068462 - -1702534230) < arg_111) || ((-1702534230 - arg_111) == (arg_111 - -1702534230)));
    assert ((arg_112 + (-874207635 - arg_112)) == ((-1748415268 - arg_112) + (-874207635 - arg_112)));
  }
}
...
method lift_107_1 (arg_111 : int, arg_112 : int, arg_113 : int)
  returns (arg_114 : int, arg_115 : int)
  requires (((arg_113 == 1) && ((arg_112 == -860054049) && ((arg_111 == 563449727) && true))))
  ensures (((arg_115 == -750004074) && ((arg_114 == 73298312) && true)))
{
  arg_114 := 73298312;
  arg_115 := -750004074;
  {
    ...
    var lift_116 := lift_117;
    lift_116 := lift_124;
    assert (((73298310 - 73298312) < (73298311 - arg_114)) || ((73298310 - arg_114) == (73298311 - arg_114)));
    assert (((-860054051 - -860054049) < (-860054050 - arg_112)) || ((-860054050 - arg_112) == (-860054050 - -860054049)));
    assert (((1 - arg_111) < (arg_111 - arg_111)) || ((-563449729 - 0) == (-1 - arg_111)));
    assert (((-860054051 - -860054049) < (-860054050 - arg_112)) || ((-860054050 - arg_112) == (-860054050 - -860054049)));
  }
}
...
method lift_89_0 (arg_93 : int)
  ...
  requires (((arg_93 == -472754154) && true))
  ensures (((arg_95 == -140353568) && ((arg_94 == 889662833) && true)))
{
  arg_94 := 889662833;
  arg_95 := -140353568;
  {
    ...
    assert (((arg_94 + arg_94) + (-889662834 - arg_94)) < ((arg_94 - 1779325666) + arg_94));
    assert ((889662833 == arg_94) && ((arg_94 == arg_94) || (arg_94 == arg_94)));
    lift_96 := lift_99;
    assert (((-280707137 < arg_95) && (arg_95 == arg_95)) || ((arg_95 < arg_95) && (arg_95 < arg_95)));
  }
}
...
method lift_65_0 ()
  ...
  requires (true)
  ensures (((arg_70 == -936802150) && ((arg_69 == -1691427908) && true)))
{
  arg_69 := -1691427908;
  arg_70 := -936802150;
  {
    ...
    var lift_71 := lift_72;
    lift_71 := lift_71;
    assert ((1834050227 == 1834050227) && (1834050227 < 1834050228));
    assert (((-1691427909 - 3382855817) - (-1691427908 + arg_69)) == ((arg_69 - 1) + (-1691427909 - arg_69)));
    lift_73 := lift_73;
    assert (((-13236849 - lift_78) < (lift_78 - -13236849)) || ((-13236851 - lift_78) == (-13236852 - lift_78)));
  }
}

method lift_23_0 (arg_27 : int, arg_28 : int, arg_29 : int)
  returns (arg_30 : int, arg_31 : int)
  requires (((arg_29 == 2097146509) && ((arg_28 == -1783005903) && ((arg_27 == -1416413701) && true))))
  ensures (((arg_31 == 1011543174) && ((arg_30 == -1781147879) && true)))
{
  arg_30 := -1781147879;
  arg_31 := 1011543174;
  {
...
method lift_1_0 (arg_5 : int)
  ...
  requires (((arg_5 == 110) && true))
  ensures (((arg_7 == -1416413701) && ((arg_6 == 2097146509) && true)))
{
  arg_6 := 2097146509;
  arg_7 := -1416413701;
  {
    ...
    assert (arg_6 == 2097146509);
    assert (((arg_5 + arg_5) + (-109 - arg_5)) < ((108 + arg_5) - (109 - arg_5)));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    {
      assert (((-1783005905 - -1783005903) == (lift_35 - -1783005901)) && ((lift_35 == lift_35) || (lift_35 == lift_35)));
      lift_36 := lift_37;
  ...
  if (safeSeqRef(safeSeqTake(lift_41, lift_46), lift_47.1, lift_52.0).1) {
    ...
    assert (((-2120098364 == lift_62.0.2) || (lift_62.0.2 < lift_62.0.2)) || ((lift_62.0.2 == lift_62.0.2) && (lift_62.0.2 == -2120098361)));
    {
      ...
      {
        assert (((-1691427909 - methoddefvar_67) < methoddefvar_67) || ((-1691427908 + 0) == methoddefvar_67));
        assert (((-2120098365 - lift_46) == (-2120098364 - lift_46)) || ((-2120098364 - -2120098361) == (-2120098364 - lift_46)));
        assert (((lift_40 < lift_40) && (1011543175 == lift_40)) || ((1011543173 - 1011543174) == (1011543173 - lift_40)));
        lift_79 := lift_81;
        assert (((-472754156 - -472754154) < (-472754155 - lift_50)) || ((-472754156 - lift_50) == (-472754155 - lift_50)));
      }
      lift_87 := lift_58;
      ...
      assert ((((lift_87 as int) + -68) + (-1 - (lift_87 as int))) < (((lift_87 as int) - 68) + (-1 - 0)));
      ...
      {
        assert (((73298310 - 73298312) < (73298311 - methoddefvar_109)) || ((73298310 - methoddefvar_109) == (73298311 - methoddefvar_109)));
        lift_132 := lift_137;
        assert (((lift_142 + -1720108099) + (2580162147 + -860054049)) < ((lift_142 - -1720108098) + lift_142));
        assert (((-1492624094 - -1492624091) - (-1492624092 - -1492624091)) == ((-1492624092 - -1492624091) + (-1492624092 - -1492624091)));
        lift_146 := lift_106;
      }
    }
    ...
    );
    {
      ...
      {
        assert (((-860054051 - -860054049) < (-860054050 - lift_142)) || ((-860054050 - lift_142) == (-860054050 - -860054049)));
        assert (1386562329 == ((-1386562331 + 1386562332) - -1386562328));
        assert (((73298310 - 73298312) < (73298311 - methoddefvar_147)) || ((73298310 - methoddefvar_147) == (73298311 - methoddefvar_147)));
      }
      if (lift_86) {
        ...
        assert (((lift_50 - 472754156) == (lift_50 + lift_50)) || ((-472754154 == lift_50) || (lift_50 < lift_50)));
        assert (((1744510239 - 1744510238) - 3) == ((1744510238 - 1744510240) + (1744510238 - 1744510238)));
        assert (((-860054051 - -860054049) < (-860054050 - lift_144)) || ((-860054050 - lift_144) == (-860054050 - -860054049)));
        lift_151 := lift_151;
      } else {
        var lift_167 := (var tmpData : seq<set<(seq<bool>, int)>> := []; tmpData);
        lift_167 := lift_168;
      }
      assert (((-472754156 - -472754154) < (-472754155 - lift_51)) || ((-472754156 - lift_51) == (-472754155 - lift_51)));
