...
method lift_56_0 (arg_59 : int)
  returns (arg_60 : int)
  requires (((arg_59 == -1458202603) && true))
  ensures (((arg_60 == 1645856803) && true))
{
  arg_60 := 1645856803;
  {
    var lift_66 := ();
    ...
    lift_64 := lift_64;
    lift_65 := lift_66;
    assert (((-1458202605 - arg_59) - (-1458202604 - arg_59)) == (-1458202604 + (0 - arg_59)));
  }
}
...
method Main () {
  ...
  var lift_1 := -1706348358;
  {
    ...
    assert (((safeSeqRef(
      ...
      lift_1,
      lift_2
    ).2 < -1336893010) && (safeSeqRef(
      (var tmpData : seq<((), bool, int)> := []; tmpData),
      lift_1,
      lift_2
    ).2 == -1336893011)) || (safeSeqRef(
      (var tmpData : seq<((), bool, int)> := []; tmpData),
      lift_1,
      lift_2
    ).2 == (-8021358069 - safeSeqRef(
      (var tmpData : seq<((), bool, int)> := []; tmpData),
      lift_1,
      lift_2
    ).2)));
    assert (0 == ((-3412696716 - lift_7.1.1) - lift_7.1.1));
    lift_10 := lift_14.1;
    {
      var lift_48 := lift_49;
      ...
      var methoddefvar_39 := lift_37_0();
      {
        ...
        lift_51 := lift_20;
        lift_55 := lift_55;
        assert (((methoddefvar_39 - 2953789983) - (984596660 - 1969193321)) == (methoddefvar_39 + (-1 - methoddefvar_39)));
      }
    }
  }
  ...
  );
  {
    ...
    {
      var lift_94 := ();
      assert ((lift_81 + (-223297457 - lift_81)) == ((-446594912 - lift_81) + (-223297457 - lift_81)));
      lift_85 := lift_86;
      {
        lift_91 := lift_91;
        assert (((-5491023913 < lift_50) && (lift_50 == lift_50)) || ((lift_50 < lift_50) || (lift_50 < lift_50)));
        assert (((-3 - 1764555542) == (-3 - 1764555542)) && (1764555542 == 1764555542));
        assert (((lift_13 < lift_13) && (lift_13 < lift_13)) || ((lift_13 + lift_13) < (lift_13 - 17187980)));
        lift_94 := lift_3;
      }
      lift_95 := lift_96;
    }
