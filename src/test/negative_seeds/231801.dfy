...
method lift_157_0 ()
  ...
  requires (true)
  ensures (((arg_162 == 240080542) && ((arg_161 == 361361164) && true)))
{
  arg_161 := 361361164;
  arg_162 := 240080542;
  {
...
method lift_72_0 (arg_76 : int, arg_77 : int, arg_78 : int)
  ...
  requires (((arg_78 == 1067432690) && ((arg_77 == -1098130430) && ((arg_76 == 0) && true))))
  ensures (((arg_80 == 1304963193) && ((arg_79 == -833287097) && true)))
{
  arg_79 := -833287097;
  arg_80 := 1304963193;
  {
...
method lift_61_0 ()
  returns (arg_64 : int)
  requires (true)
  ensures (((arg_64 == 1547901561) && true))
{
  arg_64 := 1547901561;
  {
    var lift_66 := '_';
...
method lift_49_0 (arg_53 : int, arg_54 : int)
  ...
  requires (((arg_54 == -1098130430) && ((arg_53 == -1697606558) && true)))
  ensures (((arg_56 == 91041178) && ((arg_55 == -1338602180) && true)))
{
  arg_55 := -1338602180;
  arg_56 := 91041178;
  {
...
method Main () {
  ...
  lift_1 := lift_1;
  assert (((lift_21.0.2.2 + lift_21.0.2.2) + lift_21.0.2.2) < ((-246344537 - 246344537) + lift_21.0.2.2));
  if (((lift_31(lift_37, lift_38, lift_42, lift_44) < safeSeqRef(
    ...
    );
    {
      ...
      var methoddefvar_63 := lift_61_0();
      {
        ...
        assert ((lift_39 + (-3674311556 - lift_39)) == ((-2755733666 - lift_39) + (-2755733666 - lift_39)));
        lift_67 := lift_67;
        assert (((1 == lift_40) || (1 == lift_40)) || ((-918577888 - 0) == (-1837155776 - lift_40)));
      }
      if (lift_20) {
        assert false;
      } else {
        lift_71 := lift_29;
        assert (-1098130430 == lift_30);
      }
    }
    ...
    );
    {
      ...
      if (lift_146) {
        ...
        assert (((-1304963198 + methoddefvar_75) - (-1304963196 + methoddefvar_75)) == ((1304963192 - methoddefvar_75) + (1304963192 - methoddefvar_75)));
        assert (((-246344542 - lift_29) + (lift_29 + lift_29)) == ((-1231722698 - lift_29) - (lift_29 + lift_29)));
        assert (((-1304963198 + methoddefvar_75) - (-1304963196 + methoddefvar_75)) == ((1304963192 - methoddefvar_75) + (1304963192 - methoddefvar_75)));
        assert (((692929494 + lift_45) + 1) == ((lift_45 - 2) - (lift_45 - 1)));
        lift_156 := 1857978688;
      }
      var methoddefvar_159, methoddefvar_160 := lift_157_0();
      {
        assert (((-629550069 - -629550067) < (-629550068 - -629550067)) || ((-629550069 - -629550067) == (-629550068 - -629550067)));
      }
      {
        var lift_185 := '_';
        ...
        assert (-1098130430 == lift_30);
        assert (((methoddefvar_75 == methoddefvar_75) || (methoddefvar_75 < methoddefvar_75)) && ((-3914889581 - methoddefvar_75) < (-1304963194 - 1304963193)));
      }
      assert ((2 - (1 - lift_156)) < ((lift_156 + 1857978688) - lift_156));
      if (lift_188) {
        var lift_191 := ();
        ...
        lift_189 := lift_71;
        lift_190 := lift_190;
        assert (((lift_30 - 1098130429) == (-1098130430 + lift_30)) || ((lift_30 + lift_30) < (lift_30 - 2)));
        assert (((lift_187 + lift_187) + (-833287098 - lift_187)) < ((lift_187 - -1) + lift_187));
        lift_191 := lift_155;
      } else {
        assert false;
        assert false;
