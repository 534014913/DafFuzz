...
method lift_317_0 ()
  ...
  requires (true)
  ensures (((arg_322 == 342159604) && ((arg_321 == 1564820438) && true)))
{
  arg_321 := 1564820438;
  arg_322 := 342159604;
  {
...
method lift_309_0 (arg_313 : int)
  ...
  requires (((arg_313 == 2144639244) && true))
  ensures (((arg_315 == -2084858985) && ((arg_314 == -852268076) && true)))
{
  arg_314 := -852268076;
  arg_315 := -2084858985;
  {
    var lift_316 := true;
    lift_316 := lift_316;
    assert (((arg_314 + arg_314) < arg_314) && ((arg_314 < arg_314) || (-852268076 == arg_314)));
    assert ((-409666838 + (-409666839 - -409666838)) == ((-819333676 - -409666838) + (-409666839 - -409666838)));
  }
}

method lift_255_0 (arg_258 : int)
  returns (arg_259 : int)
  requires (((arg_258 == -516877274) && true))
  ensures (((arg_259 == 1221243404) && true))
{
  arg_259 := 1221243404;
  {
    var lift_260 := 1048504035;
    assert (((-3145512105 + 2097008070) + (2097008070 - lift_260)) == ((2097008070 - lift_260) - lift_260));
  }
}

method lift_255_1 (arg_258 : int)
  returns (arg_259 : int)
  requires (((arg_258 == 113742010) && true))
  ensures (((arg_259 == 1221243404) && true))
{
  arg_259 := 1221243404;
  {
    var lift_260 := 1048504035;
    assert (((lift_260 + lift_260) + (-1048504036 - lift_260)) < ((lift_260 - 2097008070) + lift_260));
  }
}

method lift_211_0 (arg_214 : int, arg_215 : int)
  returns (arg_216 : int)
  requires (((arg_215 == 817966090) && ((arg_214 == -451144753) && true)))
  ensures (((arg_216 == 835395752) && true))
{
  arg_216 := 835395752;
  {
    var lift_236 := false;
    ...
    lift_217 := lift_220;
    assert ((arg_215 - (3 + arg_215)) == ((arg_215 - 817966093) + (arg_215 - arg_215)));
    lift_227 := lift_227;
    assert ((arg_215 - (3 + arg_215)) == ((arg_215 - 817966093) + (arg_215 - arg_215)));
    lift_233 := lift_235;
  }
...
method lift_211_1 (arg_214 : int, arg_215 : int)
  returns (arg_216 : int)
  requires (((arg_215 == -608224676) && ((arg_214 == -1408958173) && true)))
  ensures (((arg_216 == 835395752) && true))
{
  arg_216 := 835395752;
  {
    ...
    var lift_217 := ((arg_214, true), lift_218);
    lift_217 := lift_220;
    assert (((arg_215 < arg_215) || (arg_215 < arg_215)) || ((arg_215 + arg_215) < (arg_215 - 608224674)));
    lift_227 := lift_227;
    assert (arg_215 < -608224675);
    lift_233 := lift_235;
  }
}
...
method lift_191_0 (arg_195 : int, arg_196 : int, arg_197 : int)
  ...
  requires (((arg_197 == -1614296817) && ((arg_196 == 817966090) && ((arg_195 == -219327032) && true))))
  ensures (((arg_199 == 1032979779) && ((arg_198 == -1744125236) && true)))
{
  arg_198 := -1744125236;
  arg_199 := 1032979779;
  {
    ...
    assert ((arg_196 - (3 + arg_196)) == ((arg_196 - 817966093) + (arg_196 - arg_196)));
    assert (arg_198 == -1744125236);
    assert ((arg_198 + (-3488250473 - -1744125236)) == ((-5232375708 - arg_198) + (-1744125237 - arg_198)));
    lift_200 := lift_200;
    assert (((-2146582423 < -2146582422) || (-2146582423 < -2146582423)) || ((-2146582425 - -2146582423) == (-2146582424 - -2146582423)));
  }
}
...
method lift_71_0 (arg_74 : int, arg_75 : int, arg_76 : int)
  returns (arg_77 : int)
  requires (((arg_76 == -343378620) && ((arg_75 == 570210335) && ((arg_74 == 557184982) && true))))
  ensures (((arg_77 == 1996229594) && true))
{
  arg_77 := 1996229594;
  {
    ...
    assert (((arg_76 - 343378619) == (-343378620 + arg_76)) || ((-343378620 == arg_76) || (arg_76 < arg_76)));
    lift_78 := lift_79;
    lift_109 := lift_111;
    lift_113 := lift_115;
  }
...
method Main () {
  ...
  );
  {
    ...
    }
    {
      ...
      {
        assert ((lift_24 + (-678972318 - lift_24)) == lift_24);
        lift_210 := lift_210;
      }
      var methoddefvar_213 := lift_211_0(-451144753, lift_120);
      {
        assert (((lift_119 - 2453898272) - (-817966091 + lift_119)) == ((0 - 817966090) + (-1 - lift_119)));
        assert (((-311889063 - 4) - -311889064) == ((-311889064 - -311889063) + (-311889068 - -311889066)));
        lift_237 := lift_238;
        assert ((lift_11 + (lift_11 + lift_11)) == ((-1292193185 - lift_11) - (lift_11 + 1292193185)));
        assert (((1 == lift_118) && (-1025924525 == lift_118)) || ((lift_118 + lift_118) < (lift_118 - 2)));
      }
      var methoddefvar_245 := lift_211_1(-1408958173, -608224676);
      {
        ...
        assert (((-77153970 - -77153968) < (-77153969 - lift_177)) || ((-77153970 - lift_177) == (-77153969 - lift_177)));
        lift_246 := lift_247;
        assert (lift_70 == -343378620);
        lift_254 := lift_254;
      }
      var methoddefvar_257 := lift_255_0(lift_12);
      {
        assert ((lift_121 - (3 + lift_121)) == ((lift_121 - 817966093) + (lift_121 - lift_121)));
    ...
    }
    {
      ...
      if (false) {
        ...
        assert (((2049751760 + -2049751761) + (-1 - 2049751760)) < ((2049751760 - 4099503522) - (0 - 2049751760)));
        lift_285 := lift_13;
        assert ((lift_242 < (-540765150 - -1)) && ((lift_242 + lift_242) == (-540765150 - 540765150)));
        lift_286 := lift_294;
        lift_295 := lift_295;
      }
      var methoddefvar_311, methoddefvar_312 := lift_309_0(lift_173);
      {
        assert (((-1593702986 + lift_180) == (1593702987 - lift_180)) || ((lift_180 == 1593702987) || (lift_180 < 1593702985)));
      }
      var methoddefvar_319, methoddefvar_320 := lift_317_0();
      {
        var lift_326 := lift_280;
        assert ((lift_119 - (3 + lift_119)) == ((lift_119 - 817966093) + (lift_119 - lift_119)));
        lift_325 := lift_120;
        lift_326 := false;
        assert (((-1550631822 - lift_12) == (-516877274 + lift_12)) || ((-516877276 - lift_12) == (-516877275 - lift_12)));
      }
      assert (((-1 + lift_327) - (-1927429010 - lift_327)) == lift_327);
      {
        assert (((-4842890451 - -1614296817) == (lift_183 + lift_183)) || ((-8071484086 - lift_183) == (-4842890451 - -1614296817)));
        assert (((-1417995139 - -1417995137) < (-1417995138 - lift_252)) || ((-1417995138 - lift_252) == (-1417995139 - lift_252)));
        assert (((-573268892 - -573268890) == (lift_251 - -573268888)) && ((lift_251 == lift_251) && (lift_251 == lift_251)));
      }
    }
    assert (((109 - (lift_38 as int)) - 1) == (((lift_38 as int) - 107) + (108 - (lift_38 as int))));
    {
      ...
      if (lift_164) {
        ...
        var lift_333 := 'Z';
        assert (((1391389487 - 1391389492) - (-1391389493 + 1391389492)) < ((1391389489 - 1391389490) + (1391389488 - 1391389489)));
        lift_333 := lift_285;
        assert (((1996229593 - methoddefvar_73) == (1996229593 - 1996229594)) || ((1996229593 - methoddefvar_73) == (1996229593 - 1996229594)));
        lift_334 := lift_336;
        lift_337 := lift_337;
      }
      {
        assert (((-5511833992 + lift_343) - (-1377958499 + lift_343)) == ((-1377958499 - 1377958497) - lift_343));
        lift_356 := lift_356;
      }
      var methoddefvar_360 := lift_255_1(lift_268);
      {
        lift_361 := lift_243;
        lift_363 := lift_366;
        assert (((754959510 - 754959510) < 754959510) && ((-3 - 754959510) < 754959510));
      }
    }
  }
}
