...
method lift_99_0 ()
  returns (arg_102 : int)
  requires (true)
  ensures (((arg_102 == -1653306204) && true))
{
  arg_102 := -1653306204;
  {
    assert (((0 - 4959918614) - (-1653306204 + arg_102)) == ((arg_102 - 1) + (-1653306205 - arg_102)));
  }
}
...
method lift_28_0 (arg_32 : int, arg_33 : int)
  ...
  requires (((arg_33 == 1320001681) && ((arg_32 == 1320001681) && true)))
  ensures (((arg_35 == 996561905) && ((arg_34 == 66531506) && true)))
{
  arg_34 := 66531506;
  arg_35 := 996561905;
  {
    ...
    var lift_36 := lift_37;
    lift_36 := lift_37;
    assert (((-1621821928 + lift_56) - (-324364386 + lift_56)) == ((-324364387 - lift_56) + (-324364387 - lift_56)));
    assert (((-1621821928 + lift_56) - (-324364386 + lift_56)) == ((-324364387 - lift_56) + (-324364387 - lift_56)));
    assert (((996561904 - arg_35) == (996561904 - 996561905)) || ((996561903 - arg_35) == (996561904 - arg_35)));
    lift_57 := lift_57;
  }
}
...
method lift_17_0 ()
  ...
  requires (true)
  ensures (((arg_22 == 1531206881) && ((arg_21 == 1320001681) && true)))
{
  arg_21 := 1320001681;
  arg_22 := 1531206881;
  {
    ...
    var lift_24 := true;
    var lift_23 := arg_22;
    assert (((lift_23 == 1531206881) && (lift_23 == lift_23)) || ((lift_23 < lift_23) || (lift_23 < lift_23)));
    assert (((-1531206886 + arg_22) - (-1531206884 + arg_22)) == ((1531206880 - arg_22) + (1531206880 - arg_22)));
    lift_24 := lift_24;
    assert (((-1320001686 + arg_21) - (-1320001684 + arg_21)) == ((1320001680 - arg_21) + (1320001680 - arg_21)));
    lift_25 := lift_25;
  }
}
  ...
  ensures (((arg_22 == 1531206881) && ((arg_21 == 1320001681) && true)))
{
  ...
  arg_22 := 1531206881;
  {
    ...
    var lift_24 := true;
    var lift_23 := arg_22;
    assert (((-1531206886 + lift_23) - (-1531206884 + lift_23)) == ((1531206880 - lift_23) + (1531206880 - lift_23)));
    assert (((-1531206886 + arg_22) - (-1531206884 + arg_22)) == ((1531206880 - arg_22) + (1531206880 - arg_22)));
    lift_24 := lift_24;
    assert (((-1320001681 - 1320001681) == (arg_21 - 3960005043)) && ((-3960005044 - arg_21) < (-1320001681 - 1320001681)));
    lift_25 := lift_25;
  }
}
...
method Main () {
  ...
  var methoddefvar_19, methoddefvar_20 := lift_17_0();
  {
    ...
    assert (((120270909 - 360812730) - (lift_75(
      lift_81,
      lift_82
    ) - 120270910)) == ((lift_75(
      lift_81,
      lift_82
    ) - 120270911) - (-120270910 + lift_75(lift_81, lift_82))));
  }
  lift_87 := lift_4;
  var methoddefvar_101 := lift_99_0();
  {
    var lift_103 := [1074045862, lift_84, methoddefvar_101];
    assert (((-1 - lift_75(lift_103, lift_104)) == (-2 - lift_75(
      lift_103,
      lift_104
    ))) || ((-1 - lift_75(lift_103, lift_104)) == (-1 - 120270909)));
  }
}
