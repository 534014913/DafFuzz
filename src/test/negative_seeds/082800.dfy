...
method lift_220_1 (arg_224 : int, arg_225 : int)
  returns (arg_226 : int, arg_227 : int)
  requires (((arg_225 == 2) && ((arg_224 == 1) && true)))
  ensures (((arg_227 == -2114509527) && ((arg_226 == 2087370240) && true)))
{
  arg_226 := 2087370240;
  arg_227 := -2114509527;
  {
    ...
    lift_228 := lift_229;
    lift_230 := lift_230;
    assert (((-2 - arg_224) - (0 - arg_224)) == ((0 - arg_224) + (0 - arg_224)));
  }
}
...
method lift_178_1 (arg_181 : int, arg_182 : int)
  returns (arg_183 : int)
  requires (((arg_182 == 4) && ((arg_181 == 76) && true)))
  ensures (((arg_183 == 114648442) && true))
{
  arg_183 := 114648442;
  {
    var lift_208 := ();
...
method lift_178_2 (arg_181 : int, arg_182 : int)
  returns (arg_183 : int)
  requires (((arg_182 == 1700233458) && ((arg_181 == -909377518) && true)))
  ensures (((arg_183 == 114648442) && true))
{
  arg_183 := 114648442;
  {
...
method Main () {
  ...
  if ((lift_26 !in (
    ...
    assert ((lift_125.0.1 + (-7294207103 - -4376524261)) == ((-4376524262 - lift_125.0.1) + lift_125.0.1));
    ...
    );
    {
      ...
      if (false) {
        ...
        var lift_376 := 'h';
        assert (((-1826089551 + lift_244) == (-5478268653 - lift_244)) || ((lift_244 < lift_244) && (lift_244 < lift_244)));
        assert (((-1826089551 + lift_244) == (-5478268653 - lift_244)) || ((lift_244 < lift_244) && (lift_244 < lift_244)));
        assert ((-1518343120 - (-759171560 - 759171559)) < ((759171558 - 759171559) + (-759171556 - 759171560)));
        lift_376 := lift_317;
        lift_377 := lift_377;
      }
      lift_380 := lift_79;
      {
        lift_381 := lift_116;
        assert (((-4221363009 + 1407121002) - -1) == ((-1407121004 - 1407121002) + (1407121002 - 1407121002)));
        assert (((lift_153 == lift_153) && (1947907711 == lift_153)) && ((lift_153 == lift_153) || (lift_153 == lift_153)));
      }
    }
    lift_382 := ((
      lift_327,
  ...
  );
  {
    ...
    var methoddefvar_492 := lift_178_2(-909377518, lift_413);
    {
      ...
      assert (lift_115 == (lift_115 - (259949367 - lift_115)));
      lift_493 := lift_498;
      lift_512 := lift_506;
      assert ((lift_153 == (3895815422 - lift_153)) && ((1947907710 - lift_153) < (lift_153 + lift_153)));
