...
method lift_27_0 (arg_30 : int)
  returns (arg_31 : int)
  requires (((arg_30 == 1261953748) && true))
  ensures (((arg_31 == -1210422523) && true))
{
  arg_31 := -1210422523;
  {
    ...
    {
      {
        ...
        {
          assert (((lift_18 - 1261953748) - (1261953747 + lift_18)) == ((-1261953746 - lift_18) + (1261953743 + -1261953744)));
        }
      }
      assert (((113 - (lift_17 as int)) == (113 - 114)) || ((112 - (lift_17 as int)) == (113 - (lift_17 as int))));
    }
  } else {
