...
method lift_122_0 (arg_126 : int)
  ...
  requires (((arg_126 == 852357320) && true))
  ensures (((arg_128 == -71437871) && ((arg_127 == -999597808) && true)))
{
  arg_127 := -999597808;
  arg_128 := -71437871;
  {
    ...
    assert (((277960001 < 277960001) && (277960001 == 277960001)) || ((277960001 == 277960001) || (277960001 < 277960001)));
    assert (((-999597807 + -4) - arg_127) < -1);
    assert (((-999597807 + -4) - arg_127) < -1);
    assert (((168679657 + -337359315) - -168679656) < ((-168679656 + -168679657) - (-168679656 + -168679656)));
    lift_129 := lift_130;
  }
}
...
method lift_75_0 (arg_79 : int, arg_80 : int)
  ...
  requires (((arg_80 == 3) && ((arg_79 == 696037237) && true)))
  ensures (((arg_82 == 316656457) && ((arg_81 == -1958568162) && true)))
{
  arg_81 := -1958568162;
  arg_82 := 316656457;
  {
    ...
    assert (((-3917136324 - arg_81) == arg_81) && ((arg_81 + arg_81) == (-5875704486 - arg_81)));
    lift_83 := lift_87;
    assert (((-1958568166 - arg_81) < (-1958568165 - -1958568162)) && ((-1958568164 == arg_81) || (-1958568164 < arg_81)));
  }
}

method lift_41_0 (arg_44 : int, arg_45 : int, arg_46 : int)
  returns (arg_47 : int)
  requires (((arg_46 == 852357320) && ((arg_45 == 1077481832) && ((arg_44 == 263438734) && true))))
  ensures (((arg_47 == -1373198698) && true))
{
  arg_47 := -1373198698;
  {
    var lift_52 := true;
    ...
    lift_49 := lift_49;
    lift_50 := lift_51;
    assert (((-263438739 + lift_48) - (-263438737 + lift_48)) == ((263438733 - lift_48) + (263438733 - lift_48)));
    assert ((4 + (852357319 - arg_46)) == ((3 + arg_46) - arg_46));
  }
}

method lift_41_1 (arg_44 : int, arg_45 : int, arg_46 : int)
  returns (arg_47 : int)
  requires (((arg_46 == 320105951) && ((arg_45 == 1064993376) && ((arg_44 == 872339528) && true))))
  ensures (((arg_47 == -1373198698) && true))
{
  arg_47 := -1373198698;
  {
    ...
    lift_49 := lift_49;
    lift_50 := lift_51;
    assert (((-2 - lift_48) == (-1 - lift_48)) || ((-1 - lift_48) == (-1 - 872339528)));
    assert (((arg_46 + arg_46) + (-320105952 - arg_46)) < ((arg_46 - 640211902) + arg_46));
  }
}

method lift_17_0 (arg_20 : int)
  returns (arg_21 : int)
  requires (((arg_20 == 997555653) && true))
  ensures (((arg_21 == 1251554616) && true))
{
  arg_21 := 1251554616;
  {
    var lift_32 := 'w';
...
method lift_1_0 ()
  ...
  requires (true)
  ensures (((arg_6 == 997555653) && ((arg_5 == 263438734) && true)))
{
  arg_5 := 263438734;
  arg_6 := 997555653;
  {
    ...
    var lift_8 := ();
    var lift_7 := ();
    assert ((1995111306 == (arg_6 + arg_6)) || ((arg_6 + arg_6) < (arg_6 - 997555654)));
    lift_7 := lift_8;
    lift_9 := ([lift_15, lift_14, lift_16], true, ('h', lift_14, arg_6));
    assert (((-479741958 - -479741953) + 1) == ((-479741958 - -479741957) + (-479741961 - -479741958)));
    assert (((-263438739 + arg_5) - (-263438737 + arg_5)) == ((263438733 - arg_5) + (263438733 - arg_5)));
  }
}
...
method Main () {
  ...
  var methoddefvar_3, methoddefvar_4 := lift_1_0();
  {
    ...
    var lift_33 := [lift_34, lift_37, lift_37];
    {
      ...
      {
        assert (((263438732 - methoddefvar_3) == (263438734 - 263438736)) && ((263438732 - methoddefvar_3) < (263438733 - methoddefvar_3)));
        lift_33 := lift_33;
        assert (((-1317193672 - methoddefvar_3) - (-263438735 - methoddefvar_3)) == (methoddefvar_3 - (526877469 - methoddefvar_3)));
        assert (((-263438739 + methoddefvar_3) - (-263438737 + methoddefvar_3)) == ((263438733 - methoddefvar_3) + (263438733 - methoddefvar_3)));
      }
      var methoddefvar_43 := lift_41_0(methoddefvar_3, 1077481832, lift_39);
      {
        var lift_58 := ();
        assert ((4 + (852357319 - lift_39)) == ((3 + lift_39) - lift_39));
        assert (1373198698 == (methoddefvar_43 - (-1373198698 + -1373198698)));
        lift_53 := [lift_57, lift_58, lift_56, lift_55, lift_59];
        assert (((-2010511383 + lift_35) - (-402102277 + lift_35)) == ((-402102278 - lift_35) + (-402102278 - lift_35)));
        assert (1373198698 == (methoddefvar_43 - (-1373198698 + -1373198698)));
      }
      if (lift_60) {
        lift_61 := lift_61;
        ...
        assert ((4 + (852357319 - lift_39)) == ((3 + lift_39) - lift_39));
        assert (((lift_38 + lift_38) + (-852357321 - lift_38)) < ((lift_38 - 1704714640) + lift_38));
      }
    }
    assert (lift_38 == 852357320);
  }
  ...
  );
  {
    ...
    if (('c' in lift_116)) {
      ...
      var methoddefvar_124, methoddefvar_125 := lift_122_0(lift_38);
      {
        ...
        lift_131 := lift_131;
        lift_132 := lift_133;
        assert (((1218021638 - lift_69) == (1218021638 - lift_69)) && ((1218021639 == lift_69) && (1218021639 == lift_69)));
        lift_138 := lift_59;
        assert (((1218021638 - lift_70) == (1218021638 - lift_70)) && ((1218021639 == lift_70) && (1218021639 == lift_70)));
      }
      lift_139 := lift_139;
      var methoddefvar_166 := lift_17_1(lift_68);
      {
        assert (((-1958568166 - methoddefvar_77) < (-1958568165 - -1958568162)) && ((-1958568164 == methoddefvar_77) || (-1958568164 < methoddefvar_77)));
        lift_167 := lift_167;
        lift_196 := lift_100;
        assert (((149701186 < 149701186) && (149701187 == 149701186)) || ((149701185 - 149701186) == (149701185 - 149701186)));
        assert (((-2101727899 + lift_172) - (lift_172 - -2101727898)) < ((-2101727898 + lift_172) + (2101727899 - 2101727900)));
      }
      var methoddefvar_197 := lift_41_1(lift_99, 1064993376, lift_182);
      {
        lift_198 := lift_199;
        assert (lift_189 == ((-789915990 + lift_189) + lift_189));
        assert (((-672366087 < -336183042) && (-672366087 == -672366087)) || ((-672366089 - -672366087) == (-672366088 - -672366087)));
      }
    }
  }
}
