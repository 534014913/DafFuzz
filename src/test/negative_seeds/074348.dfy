...
method lift_453_0 (arg_457 : int, arg_458 : int, arg_459 : int)
  ...
  requires (((arg_459 == -22177972) && ((arg_458 == 2) && ((arg_457 == 1296059048) && true))))
  ensures (((arg_461 == -1435675897) && ((arg_460 == 643133412) && true)))
{
  arg_460 := 643133412;
  arg_461 := -1435675897;
  {
    ...
    assert ((-337165161 + (-337165162 - -337165161)) == ((-674330324 - -337165161) - (-337165162 - -337165161)));
    assert (((-1929400241 + 643133412) - (-643133414 + arg_460)) == (arg_460 + (-1286266827 - arg_460)));
    lift_462 := lift_463;
    lift_465 := lift_465;
    assert (-1 == ((-22177972 - 2) - (arg_459 - 1)));
  }
}
...
method lift_413_0 ()
  ...
  requires (true)
  ensures (((arg_418 == -1458082261) && ((arg_417 == 769961613) && true)))
{
  arg_417 := 769961613;
  arg_418 := -1458082261;
  {
    ...
    lift_419 := lift_419;
    assert (((arg_417 < arg_417) && (arg_417 < arg_417)) || ((arg_417 == 769961613) && (arg_417 == arg_417)));
  }
}
...
method lift_277_0 (arg_280 : int, arg_281 : int, arg_282 : int)
  returns (arg_283 : int)
  requires (((arg_282 == -1290122248) && ((arg_281 == 1164584665) && ((arg_280 == -603328127) && true))))
  ensures (((arg_283 == 1794238625) && true))
{
  arg_283 := 1794238625;
  {
    var lift_291 := 'c';
    ...
    var lift_288 := multiset{lift_289, lift_289, lift_289, lift_290, lift_291};
    var lift_287 := true;
    var lift_286 := true;
    var lift_285 := lift_286;
    var lift_284 := -1894863318;
    assert ((arg_282 + (-5160488994 - arg_282)) == ((-3870366745 - arg_282) + (-3870366745 - arg_282)));
    lift_284 := arg_280;
    lift_285 := lift_285;
    lift_287 := true;
    lift_288 := lift_288;
...
method lift_128_1 (arg_131 : int)
  returns (arg_132 : int)
  requires (((arg_131 == 1164584665) && true))
  ensures (((arg_132 == -385771055) && true))
{
  arg_132 := -385771055;
  {
    var lift_137 := arg_131;
    ...
    var lift_134 := lift_135;
    var lift_133 := arg_131;
    assert (-2329169331 == ((lift_133 + -1164584666) - (lift_133 + lift_133)));
    lift_134 := lift_134;
    assert (((713431984 < 713431986) && (713431984 == 713431984)) || ((713431984 < 713431984) && (713431984 < 713431984)));
    assert ((lift_136 + (2084775617 - 4169551239)) < ((lift_136 - 2084775620) + (lift_136 - 2084775620)));
    assert (-2329169331 == ((lift_137 + -1164584666) - (lift_137 + lift_137)));
  }
}

method lift_128_2 (arg_131 : int)
  returns (arg_132 : int)
  requires (((arg_131 == -895080796) && true))
  ensures (((arg_132 == -385771055) && true))
{
  arg_132 := -385771055;
  {
    ...
    var lift_134 := lift_135;
    var lift_133 := arg_131;
    assert (((lift_133 == lift_133) || (lift_133 == lift_133)) && ((lift_133 + lift_133) < (-2685242382 - lift_133)));
    lift_134 := lift_134;
    assert (((713431984 < 713431986) && (713431984 == 713431984)) || ((713431984 < 713431984) && (713431984 < 713431984)));
    assert ((-4169551238 == (-2084775621 - lift_136)) || ((-2084775620 < lift_136) || (lift_136 == -2084775619)));
    assert (((lift_137 == lift_137) || (lift_137 == lift_137)) && ((lift_137 + lift_137) < (-2685242382 - lift_137)));
  }
}
...
method lift_81_0 (arg_85 : int)
  ...
  requires (((arg_85 == 155696224) && true))
  ensures (((arg_87 == 1768704414) && ((arg_86 == 84662921) && true)))
{
  arg_86 := 84662921;
  arg_87 := 1768704414;
  {
    ...
    lift_88 := lift_90;
    assert (((-1 - arg_85) + (155696224 - arg_85)) < (arg_85 - arg_85));
  }
}
  ...
  ensures (((arg_87 == 1768704414) && ((arg_86 == 84662921) && true)))
{
  ...
  arg_87 := 1768704414;
  {
    ...
    var lift_88 := (arg_85, lift_89);
    lift_88 := lift_90;
    assert ((arg_85 - (-1 + arg_85)) == ((5 - arg_85) - arg_85));
  }
}

method lift_81_3 (arg_85 : int)
  returns (arg_86 : int, arg_87 : int)
  requires (((arg_85 == -603328127) && true))
  ensures (((arg_87 == 1768704414) && ((arg_86 == 84662921) && true)))
{
  arg_86 := 84662921;
  arg_87 := 1768704414;
  {
    ...
    var lift_88 := (arg_85, lift_89);
    lift_88 := lift_90;
    assert (((0 - 1206656255) - (-603328127 + arg_85)) == ((arg_85 - 2) - (arg_85 - 1)));
  }
}
...
method lift_58_1 ()
  returns (arg_61 : int)
  requires (true)
  ensures (((arg_61 == 906172229) && true))
{
  arg_61 := 906172229;
  {
    assert (((arg_61 + arg_61) + (-906172227 - arg_61)) < ((arg_61 + arg_61) - (-906172227 + 906172226)));
  }
}
...
method lift_6_0 (arg_10 : int, arg_11 : int, arg_12 : int)
  ...
  requires (((arg_12 == 0) && ((arg_11 == 1490427586) && ((arg_10 == 42) && true))))
  ensures (((arg_14 == 1369233455) && ((arg_13 == 169954951) && true)))
{
  arg_13 := 169954951;
  arg_14 := 1369233455;
  {
    assert (((1962360143 + 1962360143) + (-1962360144 - 1962360143)) < ((1962360143 - 3924720286) + 1962360143));
    assert (((-169954954 - arg_13) < (-169954953 - arg_13)) && ((-169954953 - arg_13) < (-169954952 - 169954951)));
  }
}
...
method Main () {
  ...
  );
  {
    ...
    var lift_46 := 'G';
    assert (((lift_33.2 == -1908658895) || (-1908658895 < lift_33.2)) && ((-1908658894 < lift_33.2) || (-954329446 == lift_33.2)));
    if ((lift_38 <= lift_38 == lift_46)) {
      ...
      var lift_93 := lift_30;
      {
        assert (((-2 - 31230371) == (lift_56 + lift_56)) || ((-2 < lift_56) || (lift_56 < lift_56)));
        lift_63 := lift_80;
        assert (((lift_56 - 31230372) < 1) || ((31230369 - lift_56) == (31230370 - lift_56)));
        assert (((-2057040971 - 2057040971) == (2057040971 - 6171122913)) && ((2057040971 == 2057040971) || (2057040971 == 2057040971)));
      }
      assert ((lift_70 + (0 - lift_70)) == ((-1206656254 - lift_70) - lift_70));
      var methoddefvar_83, methoddefvar_84 := lift_81_0(155696224);
      {
        lift_92 := lift_93;
      }
      assert (((1 == lift_70) && (lift_70 < lift_70)) || ((-603328128 - lift_70) == (-603328128 - -603328127)));
      if (lift_19) {
        var lift_95 := ();
        assert (((lift_45 == lift_45) && (lift_45 == lift_45)) && (lift_45 == (-1908658892 - lift_45)));
        assert (((0 - 1206656255) - (-603328127 + lift_71)) == ((lift_71 - 2) - (lift_71 - 1)));
        lift_94 := lift_26;
        assert (((-169954954 - methoddefvar_8) < (-169954953 - methoddefvar_8)) && ((-169954953 - methoddefvar_8) < (-169954952 - 169954951)));
        lift_95 := lift_26;
      } else {
        lift_96 := lift_97;
        assert false;
  ...
  if ((|(
    ...
    if (!(lift_152.2)) {
      ...
      if ((lift_115 == lift_115)) {
        ...
        {
          var lift_195 := 'w';
          assert (lift_177 == -39343760);
          lift_195 := lift_69;
        }
        assert (((4578564638 + lift_173) < (4578564639 + lift_173)) && ((-4578564637 < lift_173) && (lift_173 == lift_173)));
        {
      ...
      assert (((lift_200.2 + lift_200.2) + (-2024426398 - lift_200.2)) < ((lift_200.2 - -4048852794) + lift_200.2));
    }
    var methoddefvar_240 := lift_128_1(lift_241.0);
    {
      ...
      if (lift_175) {
        ...
        assert (((1786334800 - lift_207) == (1786334800 - lift_207)) && ((1786334800 - 1786334801) == (1786334800 - lift_207)));
      } else {
    ...
    }
    {
      ...
      lift_264 := lift_264;
      {
        var methoddefvar_273 := lift_58_1();
        {
          ...
          assert (-2329169331 == ((lift_109 + -1164584666) - (lift_109 + lift_109)));
          lift_274 := lift_274;
        }
      }
      ...
      {
        lift_292 := lift_292;
        assert (((0 - lift_5) == (0 - lift_5)) && ((lift_5 == lift_5) && (1 < lift_5)));
        assert (((1769510157 - 1769510158) == (1769510157 - lift_260)) || ((1769510156 - lift_260) == (1769510157 - lift_260)));
      }
    }
  }
  if ((lift_300(lift_306) >= (lift_311.2 + (
    ...
    if (((lift_268 - lift_17 - lift_268) > (lift_270 + lift_17) > (lift_2 + lift_17))) {
      ...
      var lift_373 := lift_374;
      {
        ...
        if (lift_325) {
          ...
          assert (((2106296557 == 2106296557) || (2106296557 == 2106296557)) && ((2106296556 - 2106296558) < (2106296556 - 2106296557)));
        }
        {
          var lift_405 := {
            lift_262,
          ...
          assert (((-76002063 == lift_108) && (-76002062 == lift_108)) || ((-76002062 < lift_108) && (lift_108 < -76002059)));
          assert ((103554203 == lift_394) || ((lift_394 == lift_394) && (lift_394 < 103554202)));
          lift_404 := lift_36;
          assert (((1659234544 + 0) + (-1659234545 - lift_249)) == -1659234545);
          lift_405 := lift_405;
        }
      ...
      {
        lift_410 := true;
        assert (((-1358086820 == -1358086820) || (-1358086820 < -1358086820)) && ((-1358086820 - -1358086820) < (1358086819 - -1358086820)));
      }
      assert (((|lift_253| - 5) - (|lift_253| - |lift_253|)) == -1);
    }
    var methoddefvar_411, methoddefvar_412 := lift_81_2(|lift_35|);
    {
      ...
      {
        lift_420 := lift_434;
        assert (((-2685242389 - lift_333) < (-4475403982 - -2685242390)) || ((-2685242391 - lift_333) == (-2685242390 - lift_333)));
      }
      assert ((lift_357 + (-986020586 - -493010293)) == ((-1479030878 - lift_357) + (-493010294 - lift_357)));
      lift_439 := -272772902;
      assert (((lift_357 == lift_357) && (lift_357 == lift_357)) && ((lift_357 + lift_357) == (-1479030879 - -493010293)));
    ...
    );
    {
      ...
      lift_471 := lift_488;
      assert (((lift_487 == lift_487) || (lift_487 < lift_487)) && ((2010391081 - lift_487) == (-2010391087 + lift_487)));
    }
  } else {
    assert false;
  }
